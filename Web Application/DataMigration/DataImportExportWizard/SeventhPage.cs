// --------------------------------------------------------------------------------------------------------------------
// <copyright file="SeventhPage.cs" company="Varec, Inc.">
//   Copyright (c) Varec, Inc.  All rights reserved.
// </copyright>
// <summary>
//   Defines the SeventhPage type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace DataImportExportWizard
{
    ...
    /// The six page.
    /// </summary>
    public partial class SeventhPage : InternalWizardPage
    {
        #region Attributes
        /// <summary>
        ...
        #region Constructors
        /// <summary>
        /// Initializes a new instance of the <see cref="SeventhPage"/> class.
        /// </summary>
        public SeventhPage()
        {
        ...
        /// The e.
        /// </param>
        private void SeventhPage_SetActive(object sender, System.ComponentModel.CancelEventArgs e)
        {
        ...
        /// The e.
        /// </param>
        private void SeventhPage_WizardBack(object sender, WizardPageEventArgs e)
        {
            e.NewPage = "ThirdPage";
        }
        ...
        /// The e.
        /// </param>
        private void SeventhPage_WizardFinish(object sender, CancelEventArgs e)
        {
            try
            {
            ...
            {
                ((DataImportExportWizardSheet)GetWizard()).LoggerInstance.Error("SeventhPage_WizardFinish. " + ex.Message);
                System.Diagnostics.Trace.WriteLine(string.Format("SeventhPage_WizardFinish. {0}", ex.Message));
            }
        }
        ...
        private void ProcessDataMigration()
        {
            ...
            {
                ((DataImportExportWizardSheet)GetWizard()).LoggerInstance.Error("SeventhPage: ProcessDataMigration. " + ex.Message);
                System.Diagnostics.Trace.WriteLine(string.Format("SeventhPage: ProcessDataMigration. {0}", ex.Message));
                try
                {
                ...
                {
                    ((DataImportExportWizardSheet)GetWizard()).LoggerInstance.Error("SeventhPage: ProcessDataMigration. " + ex2.Message);
                    Trace.WriteLine(string.Format("SeventhPage: ProcessDataMigration. {0}", ex2.Message));
                }
            }
