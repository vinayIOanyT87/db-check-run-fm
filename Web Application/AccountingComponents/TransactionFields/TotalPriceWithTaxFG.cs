namespace TransactionFields
{
	...
	/// <summary>
	/// Summary description for TotalPriceWithExciseFG.
	/// </summary>
	public class TotalPriceWithTaxFG : NumericTextFieldGenerator, IHeaderField
	{
		public TotalPriceWithTaxFG()
		{
			virtualField = true;
		}
		...
		{
			return transaction.TotalPriceWithTax;
		}
