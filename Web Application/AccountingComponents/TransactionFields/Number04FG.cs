...
{
	/// <summary>
	/// Summary description for Number04FG.
	/// Author: Van Thompson
	/// Generic number transaction field needed for ADF
	/// </summary>
	public class Number04FG : NumericTextFieldGenerator, IHeaderField
	{
		public Number04FG()
		{
		}
		...
		{
			if (newValue == null)
				transaction.Number04 = null;
			else
				transaction.Number04 = new double?((double) newValue);
			OnFieldChanged();
		}
