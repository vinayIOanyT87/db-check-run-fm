namespace TransactionFields
{
	...
	public class TotalNetQuantityFG : NumericTextFieldGenerator, IHeaderField
	{
		#region Constructors
		/// <summary>
		/// This method is the default constructor for the Total Gross Quantity class.
		/// </summary>
		public TotalNetQuantityFG()
		{
			virtualField = true;
		}
		#endregion
		...
		{
			return transaction.TotalNetQuantity;
		}
