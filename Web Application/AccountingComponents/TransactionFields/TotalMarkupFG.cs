namespace TransactionFields
{
	...
	/// <summary>
	/// Summary description for TotalMarkupFG.
	/// </summary>
	public class TotalMarkupFG : NumericTextFieldGenerator, IHeaderField
	{
		public TotalMarkupFG()
		{
			virtualField = true;
		}
		...
		{
			return transaction.TotalMarkup;
		}
