///<Summary>
/// File Name:	InterfaceData08FG.cs
...
{
	public class InterfaceData08FG : TextFieldGenerator, IHeaderField
	{
		#region Constructors
		/// <summary>
		/// This is the default constructor for the Interface Data 01 Field Control.
		/// </summary>
		public InterfaceData08FG ( )
		{
		}
		#endregion
		...
		public string GetDataText ( TransactionDO trans )
		{
			if ( trans != null )
			{
				string InterfaceData08 = GetDataValue ( trans ) as string;
				return InterfaceData08;
			}
			else
			{
				return null;
		...
		public void SetDataValue ( TransactionDO trans, object newValue )
		{
			...
			trans.InterfaceData08 = stringTemp.Trim ( );
			OnFieldChanged ( );
		}
		#endregion
	}
