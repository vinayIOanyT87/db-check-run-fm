namespace TransactionFields
{
	...
	/// <summary>
	/// Summary description for TotalExciseFG.
	/// </summary>
	public class TotalExciseFG : NumericTextFieldGenerator, IHeaderField
	{
		public TotalExciseFG()
		{
			virtualField = true;
		}
		...
		{
			return transaction.TotalExcise;
		}
