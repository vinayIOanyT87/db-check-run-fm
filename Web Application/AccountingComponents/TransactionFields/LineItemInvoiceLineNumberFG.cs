namespace TransactionFields
{
	...
	/// </summary>
	public class LineItemInvoiceLineNumberFG : TextFieldGenerator, ILineItemField
	{
		public LineItemInvoiceLineNumberFG()
		{
		}
		...
		public override string FieldID
		{
			get
			{
				return "LineItem InvoiceLineNumber";
			}
		}
		...
		{
			return inLineItem.InvoiceLineNumber;
		}
		...
		{
			inLineItem.InvoiceLineNumber = newValue as string;
			OnFieldChanged();
		}
		#endregion
	}
