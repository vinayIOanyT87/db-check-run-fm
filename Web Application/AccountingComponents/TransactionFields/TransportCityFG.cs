namespace TransactionFields
{
	...
	public class TransportCityFG : TextFieldGenerator, ITransportLineItemField
	{
		#region Constructors
		/// <summary>
		/// This is the default constructor for the Transport City Field Generator.
		/// </summary>
		public TransportCityFG()
		{
		}
		#endregion
		...
		/// <summary>
		/// This method will return the city field value from the data object.
		/// </summary>
		...
		/// <summary>
		/// This method will return the city field text from the data object.
		/// </summary>
		/// <param name="transportLineItem"></param>
		/// <returns></returns>
		...
		{
			transportLineItem.City = newValue as string;
			OnFieldChanged();
		}
		#endregion
	}
