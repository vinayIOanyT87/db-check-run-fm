namespace TransactionFields
{
	...
	public class TransportAddress2FG : TextFieldGenerator, ITransportLineItemField
	{
		#region Constructors
		/// <summary>
		/// This is the default constructor for the Transport Address 2 Field Generator.
		/// </summary>
		public TransportAddress2FG()
		{
		}
		#endregion
		...
		public override string FieldID
		{
			get
			{
				return "TransportLineItem Address2";
			}
		}
		...
		/// <summary>
		/// This method will return the Address 2 field value from the data object.
		/// </summary>
		...
		/// <summary>
		/// This method will return the Address 2 field text from the data object.
		/// </summary>
		/// <param name="transportLineItem"></param>
		/// <returns></returns>
		...
		{
			transportLineItem.Address2 = newValue as string;
			OnFieldChanged();
		}
		#endregion
	}
