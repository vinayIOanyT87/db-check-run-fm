namespace TransactionFields
{
	...
	/// <summary>
	/// Summary description for LineItemFlag06FG.
	/// Author: Van Thompson
	/// Created for ADF requirements for generic flag fields on line/sub-line items
	/// </summary>
	public class LineItemFlag06FG : CheckBoxGenerator, ILineItemField, ISublineItemField
	{
		#region Public constants
		public const string CLIENT_SIDE_SCRIPT_LINEITEM_FLAG06 = "CLIENT_SIDE_SCRIPT_LINEITEM_FLAG06";
		public const string CLIENT_SIDE_KEY_LINEITEM_FLAG06 = "CLIENT_SIDE_KEY_LINEITEM_FLAG06";
		#endregion

		public LineItemFlag06FG()
		{
		}
		...
		{
			return lineItem.Flag06.ToString();
		}

		public void SetDataValue(LineItemDO lineItem, object newValue)
		{
			lineItem.Flag06 = (bool)newValue;
			OnFieldChanged();
		}
		...
		protected override void SpecializeControl(WebControl control)
		{
			...
			if (updatePanel != null)
			{
				...
				if (!string.IsNullOrEmpty(customClientScript))
				{
					...
					checkBox.Page.Session[CLIENT_SIDE_SCRIPT_LINEITEM_FLAG06] =
						"<script type=\"text/javascript\"><!--\n" +
						"var oLineItemFlag06CheckBox  = document.getElementById('" + checkBox.ClientID + "');\n " +
						"\n//--></script>";
