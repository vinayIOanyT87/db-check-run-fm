namespace TransactionFields
{
	...
	/// </summary>
	public class LineItemNumber01FG : NumericTextFieldGenerator, ILineItemField, ISublineItemField
	{
		public const string CLIENT_SIDE_SCRIPT_LINEITEM_NUMBER01 = "CLIENT_SIDE_SCRIPT_LINEITEM_NUMBER01";
		public const string CLIENT_SIDE_KEY_LINEITEM_NUMBER01 = "CLIENT_SIDE_KEY_LINEITEM_NUMBER01";

		public LineItemNumber01FG()
		{
		}
		...
		protected override void SpecializeControl(WebControl control)
		{
			...
			if (updatePanel != null)
			{
				...
				if (!string.IsNullOrEmpty(customClientScript))
				{
					...
					textBox.Page.Session[CLIENT_SIDE_SCRIPT_LINEITEM_NUMBER01] =
		...
		{
			if (inLineItem.Number01 == null)
			{
				return null;
			}

			return inLineItem.Number01.Value;
		}
		...
		public void SetDataValue(LineItemDO inLineItem, object newValue)
		{
			if (newValue == null)
			{
				inLineItem.Number01 = null;
			}
			else
			{
				inLineItem.Number01 = (double) newValue;
			}
		...
		{
			if (inSublineItem.Number01 == null)
			{
				return null;
			}

			return inSublineItem.Number01.Value;
		}
		...
		void ISublineItemField.SetDataValue(SubLineItemDO inSublineItem, object newValue)
		{
			if (newValue == null)
			{
				inSublineItem.Number01 = null;
			}
			else
			{
				inSublineItem.Number01 = (double) newValue;
			}
