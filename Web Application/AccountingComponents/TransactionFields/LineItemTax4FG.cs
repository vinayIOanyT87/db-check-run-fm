namespace TransactionFields
{
	...
	public class LineItemTax4FG : NumericTextFieldGenerator, ILineItemField
	{
		public const string CLIENT_SIDE_SCRIPT_LINEITEM_TAX4 = "CLIENT_SIDE_SCRIPT_LINEITEM_TAX4";
		public const string CLIENT_SIDE_KEY_LINEITEM_TAX4 = "CLIENT_SIDE_KEY_LINEITEM_TAX4";

		#region Constructors
		/// <summary>
		/// This is the default constructor for the line item Tax 4 field generator.
		/// </summary>
		public LineItemTax4FG()
		{
		}
		#endregion
		...
		public void SetDataValue(LineItemDO lineItem, object newValue)
		{
			...
			{
				lineItem.Tax4 = new double?((double) newValue);
			}
			OnFieldChanged();
		}
		#endregion
		...
		protected override void SpecializeControl(WebControl control)
		{
			...
			if (updatePanel != null)
			{
				...
				if (!string.IsNullOrEmpty(customClientScript))
				{
					...
					textBox.Page.Session[CLIENT_SIDE_SCRIPT_LINEITEM_TAX4] =
						"<script type=\"text/javascript\"><!--\n" +
						"var oLineItemTax4TextBox  = document.getElementById('" + textBox.ClientID + "');\n " +
						"var oHiddenLineItemTax4TextBox  = document.getElementById('" + hiddenField.ClientID + "');\n " +
						"\n//--></script>";
