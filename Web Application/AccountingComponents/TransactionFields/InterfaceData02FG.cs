///<Summary>
/// File Name:	InterfaceData02FG.cs
...
{
	public class InterfaceData02FG : TextFieldGenerator, IHeaderField
	{
		#region Constructors
		/// <summary>
		/// This is the default constructor for the Interface Data 01 Field Control.
		/// </summary>
		public InterfaceData02FG ( )
		{
		}
		#endregion
		...
		public string GetDataText ( TransactionDO trans )
		{
			if ( trans != null )
			{
				string interfaceData02 = GetDataValue ( trans ) as string;
				return interfaceData02;
			}
			else
			{
				return null;
		...
		public void SetDataValue ( TransactionDO trans, object newValue )
		{
			...
			trans.InterfaceData02 = stringTemp.Trim ( );
			OnFieldChanged ( );
		}
		#endregion
	}
