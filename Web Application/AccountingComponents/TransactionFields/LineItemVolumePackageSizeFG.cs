//******************************************************************************
//	FILE NAME:		LineItemVolumePackageSizeFG.cs
...
namespace TransactionFields
{
	...
	/// <summary>
	/// Summary description for LineItemVolumePackageSizeFG.
	/// </summary>
	public class LineItemVolumePackageSizeFG : TextFieldGenerator, ILineItemField, ISublineItemField
	{
		public LineItemVolumePackageSizeFG()
		{
		...
		public override string FieldID
		{
			get
			{
				return "LineItem VolumePackageSize";
			}
		}
		...
		public object GetDataValue(LineItemDO inLineItem)
		{
			...
			return product.VolumePackageSize;
		}
		...
		public void SetNewValue ( LineItemDO inLineItem)
		{
			...
			if (updatePanel != null)
			{
				...
				if (textBox != null)
				{
					textBox.Text = product.VolumePackageSize;
				}
			}
		}
		#endregion
