namespace TransactionFields
{
	...
	/// <summary>
	/// Summary description for LineItemNumber02FG.
	/// </summary>
	public class LineItemNumber02FG : NumericTextFieldGenerator, ILineItemField, ISublineItemField
	{
		public const string CLIENT_SIDE_SCRIPT_LINEITEM_NUMBER02 = "CLIENT_SIDE_SCRIPT_LINEITEM_NUMBER02";
		public const string CLIENT_SIDE_KEY_LINEITEM_NUMBER02 = "CLIENT_SIDE_KEY_LINEITEM_NUMBER02";

		public LineItemNumber02FG()
		{
		}
			...
			if (updatePanel != null)
			{
				...
				if (textBox != null)
				{
					...
					if (!string.IsNullOrEmpty(customClientScript))
					{
						...
						textBox.Page.Session[CLIENT_SIDE_SCRIPT_LINEITEM_NUMBER02] =
		...
		{
			if (inLineItem.Number02 == null)
			{
				return null;
			}

			return inLineItem.Number02.Value;
		}
		...
		public void SetDataValue(LineItemDO inLineItem, object newValue)
		{
			if (newValue == null)
			{
				inLineItem.Number02 = null;
			}
			else
			{
				inLineItem.Number02 = (double) newValue;
			}
		...
		{
			if (inSublineItem.Number02 == null)
			{
				return null;
			}

			return inSublineItem.Number02.Value;
		}
		...
		void ISublineItemField.SetDataValue(SubLineItemDO inSublineItem, object newValue)
		{
			if (newValue == null)
			{
				inSublineItem.Number02 = null;
			}
			else
			{
				inSublineItem.Number02 = (double) newValue;
			}
