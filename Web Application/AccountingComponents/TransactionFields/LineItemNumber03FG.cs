namespace TransactionFields
{
	...
	/// <summary>
	/// Summary description for LineItemNumber03FG.
	/// </summary>
	public class LineItemNumber03FG : NumericTextFieldGenerator, ILineItemField, ISublineItemField
	{
		public const string CLIENT_SIDE_SCRIPT_LINEITEM_NUMBER03 = "CLIENT_SIDE_SCRIPT_LINEITEM_NUMBER03";
		public const string CLIENT_SIDE_KEY_LINEITEM_NUMBER03 = "CLIENT_SIDE_KEY_LINEITEM_NUMBER03";

		public LineItemNumber03FG()
		{
		}
			...
			if (updatePanel != null)
			{
				...
				if (textBox != null)
				{
					...
					if (!string.IsNullOrEmpty(customClientScript))
					{
						...
						textBox.Page.Session[CLIENT_SIDE_SCRIPT_LINEITEM_NUMBER03] =
		...
		{
			if (inLineItem.Number03 == null)
			{
				return null;
			}

			return inLineItem.Number03.Value;
		}
		...
		public void SetDataValue(LineItemDO inLineItem, object newValue)
		{
			if (newValue == null)
			{
				inLineItem.Number03 = null;
			}
			else
			{
				inLineItem.Number03 = (double) newValue;
			}
		...
		{
			if (inSublineItem.Number03 == null)
			{
				return null;
			}

			return inSublineItem.Number03.Value;
		}
		...
		void ISublineItemField.SetDataValue(SubLineItemDO inSublineItem, object newValue)
		{
			if (newValue == null)
			{
				inSublineItem.Number03 = null;
			}
			else
			{
				inSublineItem.Number03 = (double) newValue;
			}
