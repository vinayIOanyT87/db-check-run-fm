namespace TransactionFields
{
	...
	public class TotalMassQuantityFG : NumericTextFieldGenerator, IHeaderField
	{
		#region Constructors
		/// <summary>
		/// This method is the default constructor for the Total Gross Quantity class.
		/// </summary>
		public TotalMassQuantityFG()
		{
			virtualField = true;
		}
		#endregion
		...
		{
			return transaction.TotalMassQuantity;
		}
