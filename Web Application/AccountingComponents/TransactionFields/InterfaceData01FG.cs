///<Summary>
/// File Name:	InterfaceData01FG.cs
...
{
	public class InterfaceData01FG : TextFieldGenerator, IHeaderField
	{
		#region Constructors
		/// <summary>
		/// This is the default constructor for the Interface Data 01 Field Control.
		/// </summary>
		public InterfaceData01FG ( )
		{
		}
		#endregion
		...
		public string GetDataText ( TransactionDO trans )
		{
			if ( trans != null )
			{
				string interfaceData01 = GetDataValue ( trans ) as string;
				return interfaceData01;
			}
			else
			{
				return null;
		...
		public void SetDataValue ( TransactionDO trans, object newValue )
		{
			...
			trans.InterfaceData01 = stringTemp.Trim ( );
			OnFieldChanged ( );
		}
		#endregion
	}
