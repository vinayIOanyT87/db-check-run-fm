namespace TransactionFields
{
	...
	/// <summary>
	/// Summary description for LineItemNumber06FG.
	/// </summary>
	public class LineItemNumber06FG : NumericTextFieldGenerator, ILineItemField, ISublineItemField
	{
		public const string CLIENT_SIDE_SCRIPT_LINEITEM_NUMBER06 = "CLIENT_SIDE_SCRIPT_LINEITEM_NUMBER06";
		public const string CLIENT_SIDE_KEY_LINEITEM_NUMBER06 = "CLIENT_SIDE_KEY_LINEITEM_NUMBER06";

		public LineItemNumber06FG()
		{
		}
			...
			if (updatePanel != null)
			{
				...
				if (textBox != null)
				{
					...
					if (!string.IsNullOrEmpty(customClientScript))
					{
						...
						textBox.Page.Session[CLIENT_SIDE_SCRIPT_LINEITEM_NUMBER06] =
		...
		{
			if (inLineItem.Number06 == null)
			{
				return null;
			}

			return inLineItem.Number06.Value;
		}
		...
		public void SetDataValue(LineItemDO inLineItem, object newValue)
		{
			if (newValue == null)
			{
				inLineItem.Number06 = null;
			}
			else
			{
				inLineItem.Number06 = (double) newValue;
			}
		...
		{
			if (inSublineItem.Number06 == null)
			{
				return null;
			}

			return inSublineItem.Number06.Value;
		}
		...
		void ISublineItemField.SetDataValue(SubLineItemDO inSublineItem, object newValue)
		{
			if (newValue == null)
			{
				inSublineItem.Number06 = null;
			}
			else
			{
				inSublineItem.Number06 = (double) newValue;
			}
