namespace TransactionFields
{
	...
	/// </summary>
	public class LineItemFlag01FG : CheckBoxGenerator, ILineItemField, ISublineItemField
	{
		#region Public constants
		public const string CLIENT_SIDE_SCRIPT_LINEITEM_FLAG01 = "CLIENT_SIDE_SCRIPT_LINEITEM_FLAG01";
		public const string CLIENT_SIDE_KEY_LINEITEM_FLAG01 = "CLIENT_SIDE_KEY_LINEITEM_FLAG01";
		#endregion

		public LineItemFlag01FG()
		{
		}
		...
		{
			return lineItem.Flag01.ToString();
		}

		public void SetDataValue(LineItemDO lineItem, object newValue)
		{
			lineItem.Flag01 = (bool) newValue;
			OnFieldChanged();
		}
		...
		protected override void SpecializeControl(WebControl control)
		{
			...
			if (updatePanel != null)
			{
				...
				if (!string.IsNullOrEmpty(customClientScript))
				{
					...
					checkBox.Page.Session[CLIENT_SIDE_SCRIPT_LINEITEM_FLAG01] =
						"<script type=\"text/javascript\"><!--\n" +
						"var oLineItemFlag01CheckBox  = document.getElementById('" + checkBox.ClientID + "');\n " +
						"\n//--></script>";
