namespace TransactionFields
{
	...
	/// </summary>
	public class LineItemCleanLinePackQuantityFG : NumericTextFieldGenerator, ILineItemField, ISublineItemField
	{
		public const string CLIENT_SIDE_SCRIPT_LINEITEM_NUMBER01 = "CLIENT_SIDE_SCRIPT_LINEITEM_CLEANLINEPACKQUANTITY";
		public const string CLIENT_SIDE_KEY_LINEITEM_NUMBER01 = "CLIENT_SIDE_KEY_LINEITEM_CLEANLINEPACKQUANTITY";

		public LineItemCleanLinePackQuantityFG()
		{
		}
		...
		public override string FieldID
		{
			get
			{
				return "LineItem CleanLinePackQuantity";
			}
		}
		...
		{
			if (inLineItem.CleanLinePackQuantity == null)
			{
				return null;
			}

			return inLineItem.CleanLinePackQuantity.Value;
		}
		...
		public void SetDataValue(LineItemDO inLineItem, object newValue)
		{
			if (newValue == null)
			{
				inLineItem.CleanLinePackQuantity = null;
			}
			else
			{
				inLineItem.CleanLinePackQuantity = (double) newValue;
			}
		...
		{
			if (inSublineItem.CleanLinePackQuantity == null)
			{
				return null;
			}

			return inSublineItem.CleanLinePackQuantity.Value;
		}
		...
		void ISublineItemField.SetDataValue(SubLineItemDO inSublineItem, object newValue)
		{
			if (newValue == null)
			{
				inSublineItem.CleanLinePackQuantity = null;
			}
			else
			{
				inSublineItem.CleanLinePackQuantity = (double) newValue;
			}
