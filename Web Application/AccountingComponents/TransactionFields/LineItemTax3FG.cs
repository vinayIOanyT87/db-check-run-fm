namespace TransactionFields
{
	...
	public class LineItemTax3FG : NumericTextFieldGenerator, ILineItemField
	{
		public const string CLIENT_SIDE_SCRIPT_LINEITEM_TAX3 = "CLIENT_SIDE_SCRIPT_LINEITEM_TAX3";
		public const string CLIENT_SIDE_KEY_LINEITEM_TAX3 = "CLIENT_SIDE_KEY_LINEITEM_TAX3";

		#region Constructors
		/// <summary>
		/// This is the default constructor for the line item Tax 3 field generator.
		/// </summary>
		public LineItemTax3FG()
		{
		}
		#endregion
		...
		{
			if (inLineItem.Tax3 == null)
			{
				return null;
			}

			return inLineItem.Tax3.Value;
		}
		...
		public void SetDataValue(LineItemDO inLineItem, object newValue)
		{
			if (newValue == null)
			{
				inLineItem.Tax3 = null;
			}
			else
			{
				inLineItem.Tax3 = (double) newValue;
			}
		...
		protected override void SpecializeControl(WebControl control)
		{
			...
			if (updatePanel != null)
			{
				...
				if (!string.IsNullOrEmpty(customClientScript))
				{
					...
					textBox.Page.Session[CLIENT_SIDE_SCRIPT_LINEITEM_TAX3] =
						"<script type=\"text/javascript\"><!--\n" +
						"var oLineItemTax3TextBox  = document.getElementById('" + textBox.ClientID + "');\n " +
						"var oHiddenLineItemTax3TextBox  = document.getElementById('" + hiddenField.ClientID + "');\n " +
						"\n//--></script>";
