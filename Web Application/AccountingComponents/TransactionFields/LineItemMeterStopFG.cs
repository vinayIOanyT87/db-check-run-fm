namespace TransactionFields
{
    ...
    /// <summary>
	/// Summary description for LineItemMeterStopFG.
	/// </summary>
	public class LineItemMeterStopFG : NumericTextFieldGenerator, ILineItemField, ISublineItemField
	{
		public LineItemMeterStopFG()
		{
		}
		...
		{
			if (inLineItem.MeterReading.MeterStop == null)
			{
				return null;
			}

			return inLineItem.MeterReading.MeterStop.Value;
		}
		...
		{
			if (inSublineItem.MeterReading.MeterStop == null)
			{
				return null;
			}

			return inSublineItem.MeterReading.MeterStop.Value;
		}
		...
		protected override void SpecializeControl(WebControl control)
		{
			...
			if (updatePanel != null)
			{
				...
				string meterStopID = control.Controls[0].ClientID;
				string meterStartID = meterStopID.Replace("Stop", "Start");
				string meterTotalID = meterStopID.Replace("Stop", "Total");
				string grossID = meterStopID.Replace("MeterStop", "GrossQuantity");
