namespace TransactionFields
{
	...
	/// <summary>
	/// Summary description for LineItemNumber04FG.
	/// </summary>
	public class LineItemNumber04FG : NumericTextFieldGenerator, ILineItemField, ISublineItemField
	{
		public const string CLIENT_SIDE_SCRIPT_LINEITEM_NUMBER04 = "CLIENT_SIDE_SCRIPT_LINEITEM_NUMBER04";
		public const string CLIENT_SIDE_KEY_LINEITEM_NUMBER04 = "CLIENT_SIDE_KEY_LINEITEM_NUMBER04";

		public LineItemNumber04FG()
		{
		}
			...
			if (updatePanel != null)
			{
				...
				if (textBox != null)
				{
					...
					if (!string.IsNullOrEmpty(customClientScript))
					{
						...
						textBox.Page.Session[CLIENT_SIDE_SCRIPT_LINEITEM_NUMBER04] =
		...
		{
			if (inLineItem.Number04 == null)
			{
				return null;
			}

			return inLineItem.Number04.Value;
		}
		...
		public void SetDataValue(LineItemDO inLineItem, object newValue)
		{
			if (newValue == null)
			{
				inLineItem.Number04 = null;
			}
			else
			{
				inLineItem.Number04 = (double) newValue;
			}
		...
		{
			if (inSublineItem.Number04 == null)
			{
				return null;
			}

			return inSublineItem.Number04.Value;
		}
		...
		void ISublineItemField.SetDataValue(SubLineItemDO inSublineItem, object newValue)
		{
			if (newValue == null)
			{
				inSublineItem.Number04 = null;
			}
			else
			{
				inSublineItem.Number04 = (double) newValue;
			}
