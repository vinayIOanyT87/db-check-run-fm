namespace TransactionFields
{
	...
	public class LineItemTax2FG : NumericTextFieldGenerator, ILineItemField
	{
		public const string CLIENT_SIDE_SCRIPT_LINEITEM_TAX2 = "CLIENT_SIDE_SCRIPT_LINEITEM_TAX2";
		public const string CLIENT_SIDE_KEY_LINEITEM_TAX2 = "CLIENT_SIDE_KEY_LINEITEM_TAX2";

		#region Constructors
		/// <summary>
		/// This is the default constructor for the line item Tax 2 field generator.
		/// </summary>
		public LineItemTax2FG()
		{
		}
		#endregion
		...
		{
			if (inLineItem.Tax2 == null)
			{
				return null;
			}

			return inLineItem.Tax2.Value;
		}
		...
		public void SetDataValue(LineItemDO inLineItem, object newValue)
		{
			if (newValue == null)
			{
				inLineItem.Tax2 = null;
			}
			else
			{
				inLineItem.Tax2 = (double) newValue;
			}
		...
		protected override void SpecializeControl(WebControl control)
		{
			...
			if (updatePanel != null)
			{
				...
				if (!string.IsNullOrEmpty(customClientScript))
				{
					...
					textBox.Page.Session[CLIENT_SIDE_SCRIPT_LINEITEM_TAX2] =
						"<script type=\"text/javascript\"><!--\n" +
						"var oLineItemTax2TextBox  = document.getElementById('" + textBox.ClientID + "');\n " +
						"var oHiddenLineItemTax2TextBox  = document.getElementById('" + hiddenField.ClientID + "');\n " +
						"\n//--></script>";
