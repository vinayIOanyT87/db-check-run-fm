namespace TransactionFields
{
	...
	public class LineItemCustomProductsLabelFG : FieldGenerator, ILineItemField
    {
        ...
        {
            get { return "LineItem CustomProductsLabel"; }
        }
        ...
        public object GetDataValue(LineItemDO inLineItem)
        {
			...
			if (inLineItem.AssociatedTransactions != null)
            {
                ...
                {
                    if (!uniqueList.Contains(tx.Product))
                    {
                        uniqueList.Add(tx.Product);
                    }
                }
