///<Summary>
/// File Name:	InterfaceData07FG.cs
...
{
	public class InterfaceData07FG : TextFieldGenerator, IHeaderField
	{
		#region Constructors
		/// <summary>
		/// This is the default constructor for the Interface Data 01 Field Control.
		/// </summary>
		public InterfaceData07FG ( )
		{
		}
		#endregion
		...
		public string GetDataText ( TransactionDO trans )
		{
			if ( trans != null )
			{
				string InterfaceData07 = GetDataValue ( trans ) as string;
				return InterfaceData07;
			}
			else
			{
				return null;
		...
		public void SetDataValue ( TransactionDO trans, object newValue )
		{
			...
			trans.InterfaceData07 = stringTemp.Trim ( );
			OnFieldChanged ( );
		}
		#endregion
	}
