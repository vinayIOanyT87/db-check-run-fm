///<Summary>
/// File Name:	InterfaceData06FG.cs
...
{
	public class InterfaceData06FG : TextFieldGenerator, IHeaderField
	{
		#region Constructors
		/// <summary>
		/// This is the default constructor for the Interface Data 01 Field Control.
		/// </summary>
		public InterfaceData06FG ( )
		{
		}
		#endregion
		...
		public string GetDataText ( TransactionDO trans )
		{
			if ( trans != null )
			{
				string InterfaceData06 = GetDataValue ( trans ) as string;
				return InterfaceData06;
			}
			else
			{
				return null;
		...
		public void SetDataValue ( TransactionDO trans, object newValue )
		{
			...
			trans.InterfaceData06 = stringTemp.Trim ( );
			OnFieldChanged ( );
		}
		#endregion
	}
