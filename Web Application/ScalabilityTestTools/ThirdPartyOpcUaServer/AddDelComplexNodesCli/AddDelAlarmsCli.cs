    ...
    public class AddDelAlarmsCli 
    {
        ...
        public AddDelAlarmsCli(string serverUrl)
        {
           ...
           // mailBox.registerMailbox(MailBoxName);
            ...
            application.LoadApplicationConfiguration(Environment.CurrentDirectory + @"\NodeManagementClient.Config.xml", false);
        ...
        public bool Connect()
        {
            try
            {
                ...
                else
                {
                    ...
                    EndpointDescription endpointDescription = SelectEndpoint(m_serverUrl);
		...
		private string m_serverUrl = "http://18vj8v1:62549/AlarmsServer/None";
