...
namespace FMUAAlarmPlugins
{
	...
	public class ComplexPoint2Factory : IDynamicEntityFactory
	{
		...
		{
			return new ComplexPoint2(systemContext, parentNode, namespaceIndex, (string)inputParams[NameKey], (string)inputParams[NodeIdKey],
		...
		{
			return typeof(ComplexPoint2).Name;
		}
