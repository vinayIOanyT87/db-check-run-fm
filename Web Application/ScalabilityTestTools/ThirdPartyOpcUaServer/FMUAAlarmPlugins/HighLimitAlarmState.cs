...
namespace FMUAAlarmPlugins
{
    ...
    /// </summary>
    class HighLimitAlarmState : ExclusiveLimitAlarmState
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MyExclusiveLimitAlarmState"/> class.
        /// </summary>
        /// <param name="parent"></param>
        internal HighLimitAlarmState(NodeState parent)
            : base(parent)
        { }

        public void UpdateState(ISystemContext context, double value, double highLimit)
        {
            try
            {
        ...
        protected override void ProcessVariableChanged(ISystemContext context, object value)
        {
            ...
            if (HighLimit != null)
            {
                UpdateState(context, pressure, HighLimit.Value);
            }             
        }
