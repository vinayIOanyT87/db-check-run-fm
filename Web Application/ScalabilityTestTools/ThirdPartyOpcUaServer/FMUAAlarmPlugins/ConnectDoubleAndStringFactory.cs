...
namespace FMUAAlarmPlugins
{
    ...
    public class ConnectDoubleAndStringFactory : IDynamicEntityFactory
    {
        ...
        {
            return new ConnectDoubleAndString(systemContext, parentNode, namespaceIndex, (string)inputParams[ToNodeIdKey], predefinedNodes);
        }

        public string GetDynamicEntityTypeName()
        {
            return typeof(ConnectDoubleAndString).Name;
        }
