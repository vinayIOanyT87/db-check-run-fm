...
namespace FMUAAlarmPlugins
{
	...
	public class ComplexPoint : FolderState
	{
		public ComplexPoint(
			...
			: base(parent)
		{
			...
			{
				string paramType = (string)param.Value;
				switch (paramType)
				{
					case "System.Float":
						var floatParams = new ParameterCollection();
						floatParams[InputTypeFloatFactory.NameKey] = param.ParameterName;
						floatParams[InputTypeFloatFactory.NodeIdKey] = new NodeId(name + "_" + param.ParameterName, namespaceIndex).ToString();
					...
					case "System.Double":
						...
						doubleParams[InputTypeDoubleFactory.NodeIdKey] = new NodeId(name + "_" + param.ParameterName, namespaceIndex).ToString();
					...
					case "System.String":
						...
						stringParams[InputTypeStringFactory.NodeIdKey] = new NodeId(name + "_" + param.ParameterName, namespaceIndex).ToString();
