...
namespace FMUAAlarmPlugins
{
    ...
    /// </summary>
    public class HighLimitMonitor : BaseDataVariableState<double>
    {
        #region Constructors
        /// <summary>
            ...
            double highLimit)
        {
            ...
            m_alarm = new HighLimitAlarmState(this);
            ...
            m_alarm.HighLimit.AccessLevel = AccessLevels.CurrentReadOrWrite;
            m_alarm.HighLimit.UserAccessLevel = AccessLevels.CurrentReadOrWrite;
            m_alarm.HighLimit.OnSimpleWriteValue += this.NodeValueSimpleEventHandler;
        }
        ...
        public NodeState GetHighLimitNode()
        {
            return m_alarm.HighLimit;
        }

        #endregion

        #region Private Fields
        private HighLimitAlarmState m_alarm;
        #endregion
    }
}
