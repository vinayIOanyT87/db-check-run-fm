...
/****** Object:  StoredProcedure [dbo].[Migrate_FMD6SHIPMENTCONTRACTWithShippingDocumentUserDataToFMD8UserData]    Script Date: 03/15/2010 11:39:45 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Migrate_FMD6SHIPMENTCONTRACTWithShippingDocumentUserDataToFMD8UserData]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Migrate_FMD6SHIPMENTCONTRACTWithShippingDocumentUserDataToFMD8UserData]
GO

CREATE PROCEDURE [dbo].[Migrate_FMD6SHIPMENTCONTRACTWithShippingDocumentUserDataToFMD8UserData]
 /*=============================================
 Author:			Eric Simmons
...
EXEC Migrate_FMD6SHIPMENTCONTRACTWithShippingDocumentUserDataToFMD8UserData 2,NULL
...
*/
	...
	/* UserData20 */convert(nvarchar(20),isnull(dbo.ConvertFromSIUnits(tas.Density * 1000.0,p.DensityUnitIndex,p.DensityDecimalPlaces),0.0)),
	/* UserData21 */convert(nvarchar(20),isnull(dbo.ConvertFromSIUnits(tas.FlashPoint,p.TemperatureUnitIndex,p.TemperatureDecimalPlaces),0)),
	...
	INNER JOIN ConsolidatedDB.dbo.tblProducts p on ta.ProductID = p.ProductCode
	...
	and (p.SiteIndex = s.SiteIndex8 or p.SiteIndex = -1)
