...
/****** Object:  StoredProcedure [dbo].[Migrate_FMD6DETERMINEUserDataToFMD8UserData]    Script Date: 03/15/2010 11:39:45 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Migrate_FMD6DETERMINEUserDataToFMD8UserData]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Migrate_FMD6DETERMINEUserDataToFMD8UserData]
GO



CREATE PROCEDURE [dbo].[Migrate_FMD6DETERMINEUserDataToFMD8UserData]
 /*=============================================
 Author:			Eric Simmons
...
EXEC Migrate_FMD6DETERMINEUserDataToFMD8UserData 2, null
...
SELECT Value AS Value8, LEFT(RIGHT(value,2),1) AS Value6 INTO #TMP_USERDATALIST
FROM [ConsolidatedDB].[dbo].[tblUserDataListValues] WHERE UserDataFieldIndex=17
...
*/	
	...
	/* UserData2 */ @blank,
	/* UserData3 */ @blank,
	/* UserData4 */ISNULL((SELECT TOP 1 Value8 FROM #TMP_USERDATALIST WHERE Value6 = ta.UserData2),''),
	/* UserData5 */@blank,
	/* UserData6 */@blank,
	/* UserData7 */@blank,
	/* UserData8 */@blank,
	...
	/* UserData22 */@blank,
	/* UserData23 */@blank,
	/* UserData24 */CASE ta.IncreaseFlag WHEN 1 THEN 'Gain' ELSE 'Loss' END,
