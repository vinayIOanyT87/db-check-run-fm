...
/****** Object:  StoredProcedure [dbo].[Migrate_FMD6SHIPMENTTRANSFERWithoutShippingDocumentFieldsToFMD8LineItems]    Script Date: 03/15/2010 11:39:45 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Migrate_FMD6SHIPMENTTRANSFERWithoutShippingDocumentFieldsToFMD8LineItems]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Migrate_FMD6SHIPMENTTRANSFERWithoutShippingDocumentFieldsToFMD8LineItems]
GO


CREATE PROCEDURE [dbo].[Migrate_FMD6SHIPMENTTRANSFERWithoutShippingDocumentFieldsToFMD8LineItems]
 /*=============================================
 Author:			Eric Simmons
...
EXEC Migrate_FMD6SHIPMENTTRANSFERWithoutShippingDocumentFieldsToFMD8LineItems 2, null
...
*/	
	...
	/* MeterStart */NULL,
	/* MeterStop */NULL,
	/* GrossQuantity */ -1.0 * (abs(isnull(ta.GrossVolume,0)) / 1000.0),
	...
	/* CLIN */ta.UserData12,
	/* NetQuantity */ -1.0 * (abs(isnull(ta.GrossVolume,0)) / 1000.0),
	...
	from AccountingDB6.dbo.t_Acct_Tx5 ta
	JOIN #TMPSITES s ON s.SiteIndex6 = ta.SiteIndex
	INNER JOIN ConsolidatedDB.dbo.tblTransactions tt ON tt.TransID = ta.TransactionID
