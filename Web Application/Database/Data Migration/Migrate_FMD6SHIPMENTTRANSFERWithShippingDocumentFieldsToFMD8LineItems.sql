...
/****** Object:  StoredProcedure [dbo].[Migrate_FMD6SHIPMENTTRANSFERWithShippingDocumentFieldsToFMD8LineItems]    Script Date: 03/15/2010 11:39:45 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Migrate_FMD6SHIPMENTTRANSFERWithShippingDocumentFieldsToFMD8LineItems]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Migrate_FMD6SHIPMENTTRANSFERWithShippingDocumentFieldsToFMD8LineItems]
GO


CREATE PROCEDURE [dbo].[Migrate_FMD6SHIPMENTTRANSFERWithShippingDocumentFieldsToFMD8LineItems]
 /*=============================================
 Author:			Eric Simmons
...
EXEC Migrate_FMD6SHIPMENTTRANSFERWithShippingDocumentFieldsToFMD8LineItems 2,NULL
...
--	ta.SiteIndex = @siteIndex6 and 
	...
	/* MeterStart */NULL,
	/* MeterStop */NULL,
	/* GrossQuantity */ abs(isnull(taf.GrossQuantity,0)) * -1.0 / 1000.0,
	/* Temperature */ taf.ObservedTemperature,
	/* Vcf */ NULL,
	/* Density */ taf.ObservedDensity * 1000.0,
	...
	/* CLIN */ta.UserData12,
	/* NetQuantity */ abs(isnull(taf.NetQuantity,0)) * -1.0 / 1000.0,
	...
	/* BatchNumber */ta.UserData15,  --JES 4/11/2010
