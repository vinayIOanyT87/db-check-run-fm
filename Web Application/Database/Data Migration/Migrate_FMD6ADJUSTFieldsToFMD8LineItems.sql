...
GO
/****** Object:  StoredProcedure [dbo].[Migrate_FMD6ADJUSTFieldsToFMD8LineItems]    Script Date: 03/15/2010 11:39:45 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Migrate_FMD6ADJUSTFieldsToFMD8LineItems]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Migrate_FMD6ADJUSTFieldsToFMD8LineItems]
GO


CREATE PROCEDURE [dbo].[Migrate_FMD6ADJUSTFieldsToFMD8LineItems]
 /*=============================================
 Author:			Eric Simmons
...
EXEC Migrate_FMD6ADJUSTFieldsToFMD8LineItems 2, null
...
*/
	...
	/* Vcf */ ta.VCF,
	/* Density */ ta.Density,
	/* Product */ (Select top 1 isnull(tp.ProductID,'') from #TMP_PRODUCT_INDEX_MAP tp where ProductID6 = ta.ProductID),
	/* ProductCode */ta.ProductID,
	/* ProductType */'Component',
	/* ProductPrice */NULL,
	/* ProductIndex */(Select top 1 isnull(tp.ProductIndex8,0) from #TMP_PRODUCT_INDEX_MAP tp where ProductID6 = ta.ProductID),
	/* CLIN */@blank,
