...
GO
/****** Object:  StoredProcedure [dbo].[Migrate_FMD6REQUESTFieldsToFMD8LineItems]    Script Date: 03/15/2010 11:39:45 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Migrate_FMD6REQUESTFieldsToFMD8LineItems]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Migrate_FMD6REQUESTFieldsToFMD8LineItems]
GO


CREATE PROCEDURE [dbo].[Migrate_FMD6REQUESTFieldsToFMD8LineItems]
 /*=============================================
 Author:			Eric Simmons
...
EXEC Migrate_FMD6REQUESTFieldsToFMD8LineItems 2, null
