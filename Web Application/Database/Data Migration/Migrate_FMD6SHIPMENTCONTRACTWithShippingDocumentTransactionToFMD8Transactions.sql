...
/****** Object:  StoredProcedure [dbo].[Migrate_FMD6SHIPMENTCONTRACTWithShippingDocumentTransactionToFMD8Transactions]    Script Date: 03/15/2010 11:39:45 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Migrate_FMD6SHIPMENTCONTRACTWithShippingDocumentTransactionToFMD8Transactions]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Migrate_FMD6SHIPMENTCONTRACTWithShippingDocumentTransactionToFMD8Transactions]
GO

CREATE PROCEDURE [dbo].[Migrate_FMD6SHIPMENTCONTRACTWithShippingDocumentTransactionToFMD8Transactions]
 /*=============================================
 Author:			Eric Simmons
...
EXEC Migrate_FMD6SHIPMENTCONTRACTWithShippingDocumentTransactionToFMD8Transactions 2,NULL
...
*/
	...
	ta.Alias = @aliasName6 and isnull(ta.UserData12,'') <> '' and
	...
	/* RequestedDeliveryDate */ CASE ISDATE(ta.UserData17) WHEN 0 THEN NULL ELSE convert(date,ta.UserData17) END,
	...
	/* ShippingDocumentNumber */ ta.UserData10,
	...
	/* SourceEquipmentType1 */ NULL,
	/* SourceEquipmentModel1 */ NULL,
	...
	/* Date01 */ CASE ISDATE(ta.UserData9) WHEN 0 THEN NULL ELSE convert(date,ta.UserData9) END,
	/* Date02 */ NULL,
	/* Date03 */ NULL,
	/* Date04 */ NULL,
	/* LegacyNumber */ @blank,
	/* Country */ @blank,
	/* ContactInfo */ @blank,
	/* AssociatedDocNumber */ ta.UserData13, -- CHK 4/9/2010
	/* AssociatedCLIN */ ta.UserData12, -- CHK 4/9/2010
	...
	/* FuelCardIndex */ NULL,
	/* FuelCardID */ @blank,
	/* AssociatedTransportOrderNumber */ ta.UserData19, -- CHK 4/9/2010
