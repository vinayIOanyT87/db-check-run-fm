...
/****** Object:  StoredProcedure [dbo].[Migrate_FMD6DEFUELUserDataToFMD8UserData]    Script Date: 03/15/2010 11:39:45 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Migrate_FMD6DEFUELUserDataToFMD8UserData]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Migrate_FMD6DEFUELUserDataToFMD8UserData]
GO

CREATE PROCEDURE [dbo].[Migrate_FMD6DEFUELUserDataToFMD8UserData]
 /*=============================================
 Author:			Eric Simmons
...
EXEC Migrate_FMD6DEFUELUserDataToFMD8UserData 2,null
