...
/****** Object:  StoredProcedure [dbo].[Migrate_FMD6SHIPMENTCONTRACTWithoutShippingDocumentTransactionToFMD8Transactions]    Script Date: 03/15/2010 11:39:45 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Migrate_FMD6SHIPMENTCONTRACTWithoutShippingDocumentTransactionToFMD8Transactions]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Migrate_FMD6SHIPMENTCONTRACTWithoutShippingDocumentTransactionToFMD8Transactions]
GO

CREATE PROCEDURE [dbo].[Migrate_FMD6SHIPMENTCONTRACTWithoutShippingDocumentTransactionToFMD8Transactions]
 /*=============================================
 Author:			Eric Simmons
...
EXEC Migrate_FMD6SHIPMENTCONTRACTWithoutShippingDocumentTransactionToFMD8Transactions 2,NULL
...
SELECT S8.[ID], S6.SiteIndex AS SiteIndex6, S8.SiteIndex AS SiteIndex8 INTO #TMPSITES
...
(Select isnull(COUNT(TransactionID),0) from AccountingDB6.dbo.t_Acct_Tx5 ta
	WHERE
