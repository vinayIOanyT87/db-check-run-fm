...
/****** Object:  StoredProcedure [dbo].[Migrate_FMD6SHIPMENTTRANSFERWithoutShippingDocumentTransactionToFMD8Transactions]    Script Date: 03/15/2010 11:39:45 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[Migrate_FMD6SHIPMENTTRANSFERWithoutShippingDocumentTransactionToFMD8Transactions]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[Migrate_FMD6SHIPMENTTRANSFERWithoutShippingDocumentTransactionToFMD8Transactions]
GO

CREATE PROCEDURE [dbo].[Migrate_FMD6SHIPMENTTRANSFERWithoutShippingDocumentTransactionToFMD8Transactions]
 /*=============================================
 Author:			Eric Simmons
...
EXEC Migrate_FMD6SHIPMENTTRANSFERWithoutShippingDocumentTransactionToFMD8Transactions 2, null
