...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalUpdates_tblUserDataListValueIata]
...
BEGIN
    ...
    END
        ...
        FROM (
            ...
            FROM (
                SELECT TOP(@sync_batch_size_tblUserDataListValueIata) WITH TIES [dbo].[tblUserDataListValueIata].[UserDataListValueIataGuid],[dbo].[tblUserDataListValueIata].[UserDataFieldIataGuid],[dbo].[tblUserDataListValueIata].[Value],[dbo].[tblUserDataListValueIata].[CreatedDate],[dbo].[tblUserDataListValueIata].[CreatedBy],[dbo].[tblUserDataListValueIata].[UpdatedDate],[dbo].[tblUserDataListValueIata].[UpdatedBy],CT.UpdatedRowVersion AS '_RowVersion'
                    FROM [dbo].[tblUserDataListValueIata]
