...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalUpdates_tblUserDataListValueProduct]
...
BEGIN
    ...
    END
        ...
        FROM (
            ...
            FROM (
                SELECT TOP(@sync_batch_size_tblUserDataListValueProduct) WITH TIES [dbo].[tblUserDataListValueProduct].[UserDataListValueProductGuid],[dbo].[tblUserDataListValueProduct].[UserDataFieldProductGuid],[dbo].[tblUserDataListValueProduct].[Value],[dbo].[tblUserDataListValueProduct].[CreatedDate],[dbo].[tblUserDataListValueProduct].[CreatedBy],[dbo].[tblUserDataListValueProduct].[UpdatedDate],[dbo].[tblUserDataListValueProduct].[UpdatedBy],CT.UpdatedRowVersion AS '_RowVersion'
                    FROM [dbo].[tblUserDataListValueProduct]
