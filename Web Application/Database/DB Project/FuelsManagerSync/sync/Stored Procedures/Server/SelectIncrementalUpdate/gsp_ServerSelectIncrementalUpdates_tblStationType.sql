...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalUpdates_tblStationType]
...
BEGIN
    ...
    END
        ...
        SELECT TOP(@sync_batch_size_tblStationType) WITH TIES [lookup].[tblStationType].[StationTypeIndex],[lookup].[tblStationType].[StationTypeCode],[lookup].[tblStationType].[StationTypeName],[lookup].[tblStationType].[StationTypeGuid],[lookup].[tblStationType].[CreatedDate],[lookup].[tblStationType].[CreatedBy],[lookup].[tblStationType].[UpdatedDate],[lookup].[tblStationType].[UpdatedBy],CT.UpdatedRowVersion AS '_RowVersion'
            FROM [lookup].[tblStationType]
