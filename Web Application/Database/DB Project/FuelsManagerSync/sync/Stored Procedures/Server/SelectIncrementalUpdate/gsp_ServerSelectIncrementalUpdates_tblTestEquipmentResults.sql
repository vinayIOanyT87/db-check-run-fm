...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalUpdates_tblTestEquipmentResults]
...
BEGIN
    ...
    END
        ...
        SELECT TOP(@sync_batch_size_tblTestEquipmentResults) WITH TIES [dbo].[tblTestEquipmentResults].[TestName],[dbo].[tblTestEquipmentResults].[Measurement],[dbo].[tblTestEquipmentResults].[TestDate],[dbo].[tblTestEquipmentResults].[DeleteFlag],[dbo].[tblTestEquipmentResults].[CreatedDate],[dbo].[tblTestEquipmentResults].[CreatedBy],[dbo].[tblTestEquipmentResults].[UpdatedDate],[dbo].[tblTestEquipmentResults].[UpdatedBy],[dbo].[tblTestEquipmentResults].[PerformedBy],[dbo].[tblTestEquipmentResults].[Supervisor],[dbo].[tblTestEquipmentResults].[Flag01],[dbo].[tblTestEquipmentResults].[Flag02],[dbo].[tblTestEquipmentResults].[TestCode],[dbo].[tblTestEquipmentResults].[TestEquipmentResultGuid],[dbo].[tblTestEquipmentResults].[LookupTestSetStatusIndex],[dbo].[tblTestEquipmentResults].[TestSetEquipmentResultGuid],CT.UpdatedRowVersion AS '_RowVersion'
            FROM [dbo].[tblTestEquipmentResults]
