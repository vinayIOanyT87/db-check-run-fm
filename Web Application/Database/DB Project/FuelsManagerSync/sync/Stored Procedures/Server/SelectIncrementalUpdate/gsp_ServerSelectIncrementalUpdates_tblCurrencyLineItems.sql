...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalUpdates_tblCurrencyLineItems]
...
BEGIN
    ...
    END
        ...
        SELECT TOP(@sync_batch_size_tblCurrencyLineItems) WITH TIES [dbo].[tblCurrencyLineItems].[Date],[dbo].[tblCurrencyLineItems].[Rate],[dbo].[tblCurrencyLineItems].[CreatedBy],[dbo].[tblCurrencyLineItems].[CreatedDate],[dbo].[tblCurrencyLineItems].[UpdatedBy],[dbo].[tblCurrencyLineItems].[UpdatedDate],[dbo].[tblCurrencyLineItems].[CurrencyLineItemGuid],[dbo].[tblCurrencyLineItems].[CurrencyGuid],CT.UpdatedRowVersion AS '_RowVersion'
            FROM [dbo].[tblCurrencyLineItems]
