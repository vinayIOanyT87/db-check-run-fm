...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalUpdates_tblTrendPenToPointTrend]
...
BEGIN
	...
	BEGIN
        ...
        SELECT [map].[tblTrendPenToPointTrend].[TrendPenToPointTrendGuid],[map].[tblTrendPenToPointTrend].[PointTagGuid],[map].[tblTrendPenToPointTrend].[TrendGuid],[map].[tblTrendPenToPointTrend].[PenColor],[map].[tblTrendPenToPointTrend].[CreatedDate],[map].[tblTrendPenToPointTrend].[CreatedBy],[map].[tblTrendPenToPointTrend].[UpdatedDate],[map].[tblTrendPenToPointTrend].[UpdatedBy],CT.UpdatedRowVersion AS '_RowVersion'
            FROM [map].[tblTrendPenToPointTrend]
