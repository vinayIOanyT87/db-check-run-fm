...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalUpdates_tblUserDataListValueCompany]
...
BEGIN
    ...
    END
        ...
        FROM (
            ...
            FROM (
                SELECT TOP(@sync_batch_size_tblUserDataListValueCompany) WITH TIES [dbo].[tblUserDataListValueCompany].[UserDataListValueCompanyGuid],[dbo].[tblUserDataListValueCompany].[UserDataFieldCompanyGuid],[dbo].[tblUserDataListValueCompany].[Value],[dbo].[tblUserDataListValueCompany].[CreatedDate],[dbo].[tblUserDataListValueCompany].[CreatedBy],[dbo].[tblUserDataListValueCompany].[UpdatedDate],[dbo].[tblUserDataListValueCompany].[UpdatedBy],CT.UpdatedRowVersion AS '_RowVersion'
                    FROM [dbo].[tblUserDataListValueCompany]
