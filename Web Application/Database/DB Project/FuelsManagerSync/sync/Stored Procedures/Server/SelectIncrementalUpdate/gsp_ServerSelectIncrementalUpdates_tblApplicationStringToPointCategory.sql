...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalUpdates_tblApplicationStringToPointCategory]
...
BEGIN
    ...
    END
        ...
        SELECT [map].[tblApplicationStringToPointCategory].[ApplicationStringToPointCategoryGuid],[map].[tblApplicationStringToPointCategory].[ApplicationStringGuid],[map].[tblApplicationStringToPointCategory].[PointGuid],[map].[tblApplicationStringToPointCategory].[Sequence],[map].[tblApplicationStringToPointCategory].[CreatedDate],[map].[tblApplicationStringToPointCategory].[CreatedBy],[map].[tblApplicationStringToPointCategory].[UpdatedDate],[map].[tblApplicationStringToPointCategory].[UpdatedBy],CT.UpdatedRowVersion AS '_RowVersion'
            FROM [map].[tblApplicationStringToPointCategory]
