...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalUpdates_tblMobileDeviceProfilePrinter]
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM [track].[tblMobileDeviceProfilePrinter] CT
    ...
    BEGIN
        ;   WITH existingData AS (
            ...
            USING (SELECT @MobileDeviceProfilePrinterGUID,@MobileDeviceProfileGUID,@PrinterID,@BaudRate,@COMPort,@DataBits,@StopBits,@UseXonXoff,@XonChar,@XoffChar,@BufferSize,@Parity,@CreatedBy,@UpdatedBy,@CreatedDate,@UpdatedDate
