...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalUpdates_tblTransactionLineItemUserData]
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM [track].[tblTransactionLineItemUserData] CT
    ...
    BEGIN
        ;   WITH existingData AS (
                SELECT [dbo].[tblTransactionLineItemUserData].[UserData1],[dbo].[tblTransactionLineItemUserData].[UserData2],[dbo].[tblTransactionLineItemUserData].[UserData3],[dbo].[tblTransactionLineItemUserData].[UserData4],[dbo].[tblTransactionLineItemUserData].[UserData5],[dbo].[tblTransactionLineItemUserData].[UserData6],[dbo].[tblTransactionLineItemUserData].[UserData7],[dbo].[tblTransactionLineItemUserData].[UserData8],[dbo].[tblTransactionLineItemUserData].[UserData9],[dbo].[tblTransactionLineItemUserData].[UserData10],[dbo].[tblTransactionLineItemUserData].[UserData11],[dbo].[tblTransactionLineItemUserData].[UserData12],[dbo].[tblTransactionLineItemUserData].[UserData13],[dbo].[tblTransactionLineItemUserData].[UserData14],[dbo].[tblTransactionLineItemUserData].[UserData15],[dbo].[tblTransactionLineItemUserData].[UserData16],[dbo].[tblTransactionLineItemUserData].[UserData17],[dbo].[tblTransactionLineItemUserData].[UserData18],[dbo].[tblTransactionLineItemUserData].[UserData19],[dbo].[tblTransactionLineItemUserData].[UserData20],[dbo].[tblTransactionLineItemUserData].[UserData21],[dbo].[tblTransactionLineItemUserData].[UserData22],[dbo].[tblTransactionLineItemUserData].[UserData23],[dbo].[tblTransactionLineItemUserData].[UserData24],[dbo].[tblTransactionLineItemUserData].[CreatedBy],[dbo].[tblTransactionLineItemUserData].[CreatedDate],[dbo].[tblTransactionLineItemUserData].[UpdatedBy],[dbo].[tblTransactionLineItemUserData].[UpdatedDate],[dbo].[tblTransactionLineItemUserData].[TransactionLineItemUserDataGuid],[dbo].[tblTransactionLineItemUserData].[TransactionLineItemGuid]
