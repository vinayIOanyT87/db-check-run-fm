...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalUpdates_tblHouseCards]
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM [track].[tblHouseCards] CT
    ...
    BEGIN
        ;   WITH existingData AS (
                SELECT [dbo].[tblHouseCards].[ID],[dbo].[tblHouseCards].[Number],[dbo].[tblHouseCards].[CreatedDate],[dbo].[tblHouseCards].[CreatedBy],[dbo].[tblHouseCards].[UpdatedDate],[dbo].[tblHouseCards].[UpdatedBy],[dbo].[tblHouseCards].[HouseCardGuid],[dbo].[tblHouseCards].[SiteGuid],[dbo].[tblHouseCards].[DriverPersonnelGuid]
            ...
            USING (SELECT @ID,@Number,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy,@HouseCardGuid,@SiteGuid,@DriverPersonnelGuid
