...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblProductToPresetFlowControlledAdditive]
...
BEGIN
    ...
    DELETE [map].[tblProductToPresetFlowControlledAdditive]  
        ...
        WHERE ProductToPresetFlowControlledAdditiveGuid = @ProductToPresetFlowControlledAdditiveGuid
