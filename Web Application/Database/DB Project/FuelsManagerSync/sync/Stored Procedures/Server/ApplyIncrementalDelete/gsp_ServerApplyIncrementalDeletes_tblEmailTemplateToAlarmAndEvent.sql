...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblEmailTemplateToAlarmAndEvent]
...
BEGIN
    ...
    DELETE [map].[tblEmailTemplateToAlarmAndEvent]  
        ...
        WHERE EmailTemplateToAlarmAndEventGuid = @EmailTemplateToAlarmAndEventGuid
