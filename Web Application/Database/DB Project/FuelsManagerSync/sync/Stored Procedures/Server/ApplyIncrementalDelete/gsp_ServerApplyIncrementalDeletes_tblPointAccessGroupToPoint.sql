...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblPointAccessGroupToPoint]
...
BEGIN
    ...
    DELETE [map].[tblPointAccessGroupToPoint]  
        ...
        WHERE PointAccessGroupToPointGuid = @PointAccessGroupToPointGuid
