...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblEntityQualityTagToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityQualityTagToSite]  
        ...
        WHERE QualityTagToSiteGuid = @QualityTagToSiteGuid
