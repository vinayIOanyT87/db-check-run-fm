...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblLedgerAggregateColumnToTransactionAlias]
...
BEGIN
    ...
    DELETE [map].[tblLedgerAggregateColumnToTransactionAlias]  
