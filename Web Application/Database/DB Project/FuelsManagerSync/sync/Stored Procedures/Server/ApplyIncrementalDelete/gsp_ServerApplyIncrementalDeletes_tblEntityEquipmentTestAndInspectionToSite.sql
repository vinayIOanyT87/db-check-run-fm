...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblEntityEquipmentTestAndInspectionToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityEquipmentTestAndInspectionToSite]  
        ...
        WHERE EquipmentTestAndInspectionToSiteGuid = @EquipmentTestAndInspectionToSiteGuid
