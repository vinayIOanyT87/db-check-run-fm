...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblEntityAppointmentEquipmentToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityAppointmentEquipmentToSite]  
        ...
        WHERE AppointmentEquipmentToSiteGuid = @AppointmentEquipmentToSiteGuid
