...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblEntityDispatchConfigurationToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityDispatchConfigurationToSite]  
        ...
        WHERE DispatchConfigurationToSiteGuid = @DispatchConfigurationToSiteGuid
