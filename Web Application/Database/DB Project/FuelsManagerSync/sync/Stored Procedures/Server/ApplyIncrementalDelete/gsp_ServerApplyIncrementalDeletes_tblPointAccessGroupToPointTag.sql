...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblPointAccessGroupToPointTag]
...
BEGIN
    ...
    DELETE [map].[tblPointAccessGroupToPointTag]  
        ...
        WHERE PointAccessGroupToPointTagGuid = @PointAccessGroupToPointTagGuid
