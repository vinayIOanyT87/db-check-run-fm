...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblEntityEmailGroupToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityEmailGroupToSite]  
        ...
        WHERE EmailGroupToSiteGuid = @EmailGroupToSiteGuid
