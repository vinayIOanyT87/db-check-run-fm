...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblEntityFuelCardToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityFuelCardToSite]  
        ...
        WHERE FuelCardToSiteGuid = @FuelCardToSiteGuid
