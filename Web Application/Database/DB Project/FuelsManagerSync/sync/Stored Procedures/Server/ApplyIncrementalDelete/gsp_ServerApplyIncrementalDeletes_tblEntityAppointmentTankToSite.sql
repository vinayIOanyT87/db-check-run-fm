...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblEntityAppointmentTankToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityAppointmentTankToSite]  
        ...
        WHERE AppointmentTankToSiteGuid = @AppointmentTankToSiteGuid
