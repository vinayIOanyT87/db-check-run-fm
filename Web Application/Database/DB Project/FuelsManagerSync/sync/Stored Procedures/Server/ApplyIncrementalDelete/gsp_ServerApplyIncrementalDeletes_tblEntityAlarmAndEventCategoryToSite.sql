...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblEntityAlarmAndEventCategoryToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityAlarmAndEventCategoryToSite]  
        ...
        WHERE AlarmAndEventCategoryToSiteGuid = @AlarmAndEventCategoryToSiteGuid
