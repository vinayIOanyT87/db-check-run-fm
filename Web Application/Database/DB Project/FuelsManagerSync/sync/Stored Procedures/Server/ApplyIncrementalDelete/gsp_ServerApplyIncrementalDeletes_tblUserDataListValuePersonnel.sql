...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblUserDataListValuePersonnel]
...
BEGIN
    ...
    DELETE [dbo].[tblUserDataListValuePersonnel]  
        ...
        WHERE UserDataListValuePersonnelGuid = @UserDataListValuePersonnelGuid
