...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblProcessVariableNoAdditiveOutputPermissive]
...
BEGIN
    ...
    DELETE [dbo].[tblProcessVariableNoAdditiveOutputPermissive]  
