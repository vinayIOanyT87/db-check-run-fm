...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblPointAccessGroupToPointAlarmTest]
...
BEGIN
    ...
    DELETE [map].[tblPointAccessGroupToPointAlarmTest]  
        ...
        WHERE PointAccessGroupToPointAlarmTestGuid = @PointAccessGroupToPointAlarmTestGuid
