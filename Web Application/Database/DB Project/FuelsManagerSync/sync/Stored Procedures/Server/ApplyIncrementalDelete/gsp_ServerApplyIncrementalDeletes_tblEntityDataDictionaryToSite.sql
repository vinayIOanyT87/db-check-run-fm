...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblEntityDataDictionaryToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityDataDictionaryToSite]  
        ...
        WHERE DataDictionaryToSiteGuid = @DataDictionaryToSiteGuid
