...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblQuantityDisplay]
...
BEGIN
    ...
    DELETE [lookup].[tblQuantityDisplay]  
        ...
        WHERE QuantityDisplayIndex = @QuantityDisplayIndex
