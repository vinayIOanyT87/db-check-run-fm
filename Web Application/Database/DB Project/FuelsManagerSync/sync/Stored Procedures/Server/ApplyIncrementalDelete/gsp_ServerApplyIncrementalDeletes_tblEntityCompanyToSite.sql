...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblEntityCompanyToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityCompanyToSite]  
        ...
        WHERE CompanyToSiteGuid = @CompanyToSiteGuid
