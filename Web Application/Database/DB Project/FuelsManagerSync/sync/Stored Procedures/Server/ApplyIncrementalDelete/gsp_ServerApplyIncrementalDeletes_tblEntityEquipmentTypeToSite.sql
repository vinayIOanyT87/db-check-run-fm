...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblEntityEquipmentTypeToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityEquipmentTypeToSite]  
        ...
        WHERE EquipmentTypeToSiteGuid = @EquipmentTypeToSiteGuid
