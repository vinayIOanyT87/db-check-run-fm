...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblQualificationPersonQualificationToEquipmentType]
...
BEGIN
    ...
    DELETE [map].[tblQualificationPersonQualificationToEquipmentType]  
