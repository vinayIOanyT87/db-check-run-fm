...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblEntityLedgerViewToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityLedgerViewToSite]  
        ...
        WHERE LedgerViewToSiteGuid = @LedgerViewToSiteGuid
