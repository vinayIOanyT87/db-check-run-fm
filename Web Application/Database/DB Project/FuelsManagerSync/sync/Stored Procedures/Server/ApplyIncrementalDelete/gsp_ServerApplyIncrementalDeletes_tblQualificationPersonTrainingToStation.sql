...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblQualificationPersonTrainingToStation]
...
BEGIN
    ...
    DELETE [map].[tblQualificationPersonTrainingToStation]  
        ...
        WHERE QualificationPersonTrainingToStationGuid = @QualificationPersonTrainingToStationGuid
