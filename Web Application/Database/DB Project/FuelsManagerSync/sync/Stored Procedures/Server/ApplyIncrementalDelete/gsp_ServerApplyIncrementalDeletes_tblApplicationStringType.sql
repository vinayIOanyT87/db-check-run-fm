...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblApplicationStringType]
...
BEGIN
    ...
    DELETE [lookup].[tblApplicationStringType]  
        ...
        WHERE ApplicationStringTypeIndex = @ApplicationStringTypeIndex
