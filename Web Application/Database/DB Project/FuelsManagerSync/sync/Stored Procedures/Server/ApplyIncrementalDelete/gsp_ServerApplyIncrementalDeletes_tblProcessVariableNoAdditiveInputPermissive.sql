...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblProcessVariableNoAdditiveInputPermissive]
...
BEGIN
    ...
    DELETE [dbo].[tblProcessVariableNoAdditiveInputPermissive]  
