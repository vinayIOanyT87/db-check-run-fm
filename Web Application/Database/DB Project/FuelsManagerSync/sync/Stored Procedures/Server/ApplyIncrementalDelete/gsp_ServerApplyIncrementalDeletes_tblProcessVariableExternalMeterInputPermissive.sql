...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblProcessVariableExternalMeterInputPermissive]
...
BEGIN
    ...
    DELETE [dbo].[tblProcessVariableExternalMeterInputPermissive]  
