...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblCustomToolbarCommandType]
...
BEGIN
    ...
    DELETE [lookup].[tblCustomToolbarCommandType]  
        ...
        WHERE CustomToolbarCommandTypeIndex = @CustomToolbarCommandTypeIndex
