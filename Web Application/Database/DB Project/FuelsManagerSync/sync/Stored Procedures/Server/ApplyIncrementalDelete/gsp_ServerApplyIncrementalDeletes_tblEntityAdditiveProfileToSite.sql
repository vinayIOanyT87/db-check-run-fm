...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblEntityAdditiveProfileToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityAdditiveProfileToSite]  
        ...
        WHERE AdditiveProfileToSiteGuid = @AdditiveProfileToSiteGuid
