...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblEntityPersonnelToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityPersonnelToSite]  
        ...
        WHERE PersonnelToSiteGuid = @PersonnelToSiteGuid
