...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblDispatchGridColumnType]
...
BEGIN
    ...
    DELETE [lookup].[tblDispatchGridColumnType]  
        ...
        WHERE DispatchGridColumnTypeIndex = @DispatchGridColumnTypeIndex
