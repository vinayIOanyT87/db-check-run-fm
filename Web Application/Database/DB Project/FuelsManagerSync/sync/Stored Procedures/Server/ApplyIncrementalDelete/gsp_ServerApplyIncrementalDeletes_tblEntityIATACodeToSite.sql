...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblEntityIATACodeToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityIATACodeToSite]  
        ...
        WHERE IATACodeToSiteGuid = @IATACodeToSiteGuid
