...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblFuelCardLimitToFuelCard]
...
BEGIN
    ...
    DELETE [map].[tblFuelCardLimitToFuelCard]  
        ...
        WHERE FuelCardLimitToFuelCardGuid = @FuelCardLimitToFuelCardGuid
