...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblProductToVruTrackingConfig]
...
BEGIN
    ...
    DELETE [map].[tblProductToVruTrackingConfig]  
        ...
        WHERE ProductToVruTrackingConfigGuid = @ProductToVruTrackingConfigGuid
