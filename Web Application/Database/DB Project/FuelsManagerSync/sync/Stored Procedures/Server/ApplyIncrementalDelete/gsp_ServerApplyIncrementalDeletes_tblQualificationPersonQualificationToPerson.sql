...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblQualificationPersonQualificationToPerson]
...
BEGIN
    ...
    DELETE [map].[tblQualificationPersonQualificationToPerson]  
