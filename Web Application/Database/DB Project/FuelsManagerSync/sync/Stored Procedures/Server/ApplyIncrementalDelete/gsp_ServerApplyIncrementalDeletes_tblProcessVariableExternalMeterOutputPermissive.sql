...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblProcessVariableExternalMeterOutputPermissive]
...
BEGIN
    ...
    DELETE [dbo].[tblProcessVariableExternalMeterOutputPermissive]  
        ...
        WHERE ProcessVariableProductToOffloadExternalMeterGuid = @ProcessVariableProductToOffloadExternalMeterGuid
