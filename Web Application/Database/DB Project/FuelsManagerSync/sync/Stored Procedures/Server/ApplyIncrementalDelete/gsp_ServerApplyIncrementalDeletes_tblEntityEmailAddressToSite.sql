...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblEntityEmailAddressToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityEmailAddressToSite]  
        ...
        WHERE EmailAddressToSiteGuid = @EmailAddressToSiteGuid
