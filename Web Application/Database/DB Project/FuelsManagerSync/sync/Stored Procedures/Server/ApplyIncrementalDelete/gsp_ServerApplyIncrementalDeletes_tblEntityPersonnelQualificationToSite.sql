...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblEntityPersonnelQualificationToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityPersonnelQualificationToSite]  
        ...
        WHERE PersonnelQualificationToSiteGuid = @PersonnelQualificationToSiteGuid
