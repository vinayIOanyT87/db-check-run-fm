...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblTransactionFieldType]
...
BEGIN
    ...
    DELETE [lookup].[tblTransactionFieldType]  
        ...
        WHERE TransactionFieldTypeIndex = @TransactionFieldTypeIndex
