...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblTestDefinitionToTestSetDefinition]
...
BEGIN
    ...
    DELETE [map].[tblTestDefinitionToTestSetDefinition]  
        ...
        WHERE TestDefinitionToTestSetDefinitionGuid = @TestDefinitionToTestSetDefinitionGuid
