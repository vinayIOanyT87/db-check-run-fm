...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblEntityEntryMessageToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityEntryMessageToSite]  
        ...
        WHERE EntryMessageToSiteGuid = @EntryMessageToSiteGuid
