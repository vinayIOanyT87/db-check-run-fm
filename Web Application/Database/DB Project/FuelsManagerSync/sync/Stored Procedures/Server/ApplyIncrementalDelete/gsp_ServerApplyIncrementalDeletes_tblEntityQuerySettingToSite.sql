...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblEntityQuerySettingToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityQuerySettingToSite]  
        ...
        WHERE QuerySettingToSiteGuid = @QuerySettingToSiteGuid
