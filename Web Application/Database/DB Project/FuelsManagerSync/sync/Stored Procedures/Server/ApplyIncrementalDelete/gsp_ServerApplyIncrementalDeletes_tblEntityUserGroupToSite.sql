...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblEntityUserGroupToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityUserGroupToSite]  
        ...
        WHERE UserGroupToSiteGuid = @UserGroupToSiteGuid
