...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblPointAccessGroupToAlarmTest]
...
BEGIN
    ...
    DELETE [map].[tblPointAccessGroupToAlarmTest]  
        ...
        WHERE PointAccessGroupToAlarmTestGuid = @PointAccessGroupToAlarmTestGuid
