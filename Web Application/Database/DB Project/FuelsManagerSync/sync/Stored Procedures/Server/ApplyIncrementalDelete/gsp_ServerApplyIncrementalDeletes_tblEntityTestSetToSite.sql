...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblEntityTestSetToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityTestSetToSite]  
        ...
        WHERE TestSetToSiteGuid = @TestSetToSiteGuid
