...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblUserDataListValueTransactionAlias]
...
BEGIN
    ...
    DELETE [dbo].[tblUserDataListValueTransactionAlias]  
        ...
        WHERE UserDataListValueTransactionAliasGuid = @UserDataListValueTransactionAliasGuid
