...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblEngineeringUnit]
...
BEGIN
    ...
    DELETE [lookup].[tblEngineeringUnit]  
        ...
        WHERE EngineeringUnitIndex = @EngineeringUnitIndex
