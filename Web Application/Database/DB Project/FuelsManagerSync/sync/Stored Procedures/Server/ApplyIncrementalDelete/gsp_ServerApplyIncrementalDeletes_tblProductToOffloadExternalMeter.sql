...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblProductToOffloadExternalMeter]
...
BEGIN
    ...
    DELETE [map].[tblProductToOffloadExternalMeter]  
        ...
        WHERE ProductToOffloadExternalMeterGuid = @ProductToOffloadExternalMeterGuid
