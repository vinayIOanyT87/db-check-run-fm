...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblGroupToLedgerView]
...
BEGIN
    ...
    DELETE [map].[tblGroupToLedgerView]  
        ...
        WHERE GroupToLedgerViewGuid = @GroupToLedgerViewGuid
