...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblEntityProductToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityProductToSite]  
        ...
        WHERE ProductToSiteGuid = @ProductToSiteGuid
