...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblTransactionQuality]
...
BEGIN
    ...
    DELETE [lookup].[tblTransactionQuality]  
        ...
        WHERE TransactionQualityIndex = @TransactionQualityIndex
