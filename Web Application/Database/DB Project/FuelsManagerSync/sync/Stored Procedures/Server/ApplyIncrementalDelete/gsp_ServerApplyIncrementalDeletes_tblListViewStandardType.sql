...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblListViewStandardType]
...
BEGIN
    ...
    DELETE [lookup].[tblListViewStandardType]  
        ...
        WHERE ListViewStandardTypeIndex = @ListViewStandardTypeIndex
