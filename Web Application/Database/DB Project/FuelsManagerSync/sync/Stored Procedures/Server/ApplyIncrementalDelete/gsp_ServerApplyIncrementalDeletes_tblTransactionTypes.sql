...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblTransactionTypes]
...
BEGIN
    ...
    DELETE [lookup].[tblTransactionTypes]  
        ...
        WHERE TransactionTypesIndex = @TransactionTypesIndex
