...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblQualificationEquipmentTagAndLicenseToStation]
...
BEGIN
    ...
    DELETE [map].[tblQualificationEquipmentTagAndLicenseToStation]  
        ...
        WHERE QualificationEquipmentTagAndLicenseToStationGuid = @QualificationEquipmentTagAndLicenseToStationGuid
