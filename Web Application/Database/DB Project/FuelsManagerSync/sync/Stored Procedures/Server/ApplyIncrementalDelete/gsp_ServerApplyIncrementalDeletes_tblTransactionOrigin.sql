...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblTransactionOrigin]
...
BEGIN
    ...
    DELETE [lookup].[tblTransactionOrigin]  
        ...
        WHERE TransactionOriginIndex = @TransactionOriginIndex
