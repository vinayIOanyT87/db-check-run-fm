...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblEntityPersonnelTrainingToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityPersonnelTrainingToSite]  
        ...
        WHERE PersonnelTrainingToSiteGuid = @PersonnelTrainingToSiteGuid
