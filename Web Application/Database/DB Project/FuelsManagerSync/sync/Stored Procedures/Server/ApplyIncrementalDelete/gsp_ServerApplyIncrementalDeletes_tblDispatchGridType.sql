...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblDispatchGridType]
...
BEGIN
    ...
    DELETE [lookup].[tblDispatchGridType]  
        ...
        WHERE DispatchGridTypeIndex = @DispatchGridTypeIndex
