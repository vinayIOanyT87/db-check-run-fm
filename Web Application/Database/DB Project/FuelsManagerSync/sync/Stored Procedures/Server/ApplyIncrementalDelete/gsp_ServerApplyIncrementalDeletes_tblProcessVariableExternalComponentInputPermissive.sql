...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblProcessVariableExternalComponentInputPermissive]
...
BEGIN
    ...
    DELETE [dbo].[tblProcessVariableExternalComponentInputPermissive]  
