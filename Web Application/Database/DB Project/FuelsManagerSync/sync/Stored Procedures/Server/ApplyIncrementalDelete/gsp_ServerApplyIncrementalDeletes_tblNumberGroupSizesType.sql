...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblNumberGroupSizesType]
...
BEGIN
    ...
    DELETE [lookup].[tblNumberGroupSizesType]  
        ...
        WHERE NumberGroupSizesTypeIndex = @NumberGroupSizesTypeIndex
