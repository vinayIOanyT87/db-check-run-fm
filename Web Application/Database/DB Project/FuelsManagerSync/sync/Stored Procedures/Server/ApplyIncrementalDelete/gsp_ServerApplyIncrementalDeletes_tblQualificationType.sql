...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblQualificationType]
...
BEGIN
    ...
    DELETE [lookup].[tblQualificationType]  
        ...
        WHERE QualificationTypeIndex = @QualificationTypeIndex
