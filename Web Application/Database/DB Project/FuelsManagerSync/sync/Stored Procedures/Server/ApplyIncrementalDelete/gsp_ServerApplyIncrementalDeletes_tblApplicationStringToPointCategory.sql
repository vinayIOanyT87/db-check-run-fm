...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblApplicationStringToPointCategory]
...
BEGIN
    ...
    DELETE [map].[tblApplicationStringToPointCategory]  
        ...
        WHERE ApplicationStringToPointCategoryGuid = @ApplicationStringToPointCategoryGuid
