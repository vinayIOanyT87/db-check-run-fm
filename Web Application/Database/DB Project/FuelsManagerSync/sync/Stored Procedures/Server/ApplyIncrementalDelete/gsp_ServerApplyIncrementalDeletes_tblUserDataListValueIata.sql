...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblUserDataListValueIata]
...
BEGIN
    ...
    DELETE [dbo].[tblUserDataListValueIata]  
        ...
        WHERE UserDataListValueIataGuid = @UserDataListValueIataGuid
