...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblCustomToolbarType]
...
BEGIN
    ...
    DELETE [lookup].[tblCustomToolbarType]  
        ...
        WHERE CustomToolbarTypeIndex = @CustomToolbarTypeIndex
