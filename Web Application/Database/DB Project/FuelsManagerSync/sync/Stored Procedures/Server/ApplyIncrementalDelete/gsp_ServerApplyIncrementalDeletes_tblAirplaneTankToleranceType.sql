...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblAirplaneTankToleranceType]
...
BEGIN
    ...
    DELETE [lookup].[tblAirplaneTankToleranceType]  
        ...
        WHERE TankToleranceTypeIndex = @TankToleranceTypeIndex
