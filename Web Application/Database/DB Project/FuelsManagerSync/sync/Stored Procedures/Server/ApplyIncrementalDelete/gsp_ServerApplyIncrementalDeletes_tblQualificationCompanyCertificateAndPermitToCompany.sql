...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblQualificationCompanyCertificateAndPermitToCompany]
...
BEGIN
    ...
    DELETE [map].[tblQualificationCompanyCertificateAndPermitToCompany]  
