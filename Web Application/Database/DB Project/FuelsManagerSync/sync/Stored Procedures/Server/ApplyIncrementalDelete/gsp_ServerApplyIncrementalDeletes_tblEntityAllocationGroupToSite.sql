...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblEntityAllocationGroupToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityAllocationGroupToSite]  
        ...
        WHERE AllocationGroupToSiteGuid = @AllocationGroupToSiteGuid
