...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblEntityLedgerAggregateColumnToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityLedgerAggregateColumnToSite]  
        ...
        WHERE LedgerAggregateColumnToSiteGuid = @LedgerAggregateColumnToSiteGuid
