...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblUserDataListValueUser]
...
BEGIN
    ...
    DELETE [dbo].[tblUserDataListValueUser]  
        ...
        WHERE UserDataListValueUserGuid = @UserDataListValueUserGuid
