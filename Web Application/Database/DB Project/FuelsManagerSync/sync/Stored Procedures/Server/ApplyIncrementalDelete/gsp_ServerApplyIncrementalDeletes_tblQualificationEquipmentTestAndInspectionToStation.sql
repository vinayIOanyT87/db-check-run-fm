...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblQualificationEquipmentTestAndInspectionToStation]
...
BEGIN
    ...
    DELETE [map].[tblQualificationEquipmentTestAndInspectionToStation]  
        ...
        WHERE QualificationEquipmentTestAndInspectionToStationGuid = @QualificationEquipmentTestAndInspectionToStationGuid
