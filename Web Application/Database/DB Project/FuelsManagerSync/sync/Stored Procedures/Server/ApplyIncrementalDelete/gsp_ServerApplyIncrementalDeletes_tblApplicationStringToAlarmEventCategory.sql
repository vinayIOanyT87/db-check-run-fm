...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblApplicationStringToAlarmEventCategory]
...
BEGIN
    ...
    DELETE [map].[tblApplicationStringToAlarmEventCategory]  
        ...
        WHERE ApplicationStringToAlarmEventCategoryGuid = @ApplicationStringToAlarmEventCategoryGuid
