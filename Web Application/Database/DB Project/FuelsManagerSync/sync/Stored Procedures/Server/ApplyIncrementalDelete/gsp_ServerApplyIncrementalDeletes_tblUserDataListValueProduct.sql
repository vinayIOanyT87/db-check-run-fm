...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblUserDataListValueProduct]
...
BEGIN
    ...
    DELETE [dbo].[tblUserDataListValueProduct]  
        ...
        WHERE UserDataListValueProductGuid = @UserDataListValueProductGuid
