...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblApplicationStringToEmailAddress]
...
BEGIN
    ...
    DELETE [map].[tblApplicationStringToEmailAddress]  
        ...
        WHERE ApplicationStringToEmailAddressGuid = @ApplicationStringToEmailAddressGuid
