...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblTransactionStatus]
...
BEGIN
    ...
    DELETE [lookup].[tblTransactionStatus]  
        ...
        WHERE TransactionStatusIndex = @TransactionStatusIndex
