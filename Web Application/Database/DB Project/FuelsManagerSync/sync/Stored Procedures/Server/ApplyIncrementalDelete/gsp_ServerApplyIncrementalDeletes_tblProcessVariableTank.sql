...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblProcessVariableTank]
...
BEGIN
    ...
    DELETE [dbo].[tblProcessVariableTank]  
        ...
        WHERE ProcessVariableTankGuid = @ProcessVariableTankGuid
