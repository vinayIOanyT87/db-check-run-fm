...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblExportResultType]
...
BEGIN
    ...
    DELETE [lookup].[tblExportResultType]  
        ...
        WHERE ExportResultTypeIndex = @ExportResultTypeIndex
