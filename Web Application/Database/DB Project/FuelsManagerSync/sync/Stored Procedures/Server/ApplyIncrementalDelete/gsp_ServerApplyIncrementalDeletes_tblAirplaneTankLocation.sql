...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblAirplaneTankLocation]
...
BEGIN
    ...
    DELETE [lookup].[tblAirplaneTankLocation]  
        ...
        WHERE TankLocationIndex = @TankLocationIndex
