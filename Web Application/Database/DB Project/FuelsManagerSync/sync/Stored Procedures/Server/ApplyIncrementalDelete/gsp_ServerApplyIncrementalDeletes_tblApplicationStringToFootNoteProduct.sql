...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblApplicationStringToFootNoteProduct]
...
BEGIN
    ...
    DELETE [map].[tblApplicationStringToFootNoteProduct]  
        ...
        WHERE ApplicationStringToFootNoteProductGuid = @ApplicationStringToFootNoteProductGuid
