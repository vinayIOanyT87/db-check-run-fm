...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblEntityAlarmAndEventToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityAlarmAndEventToSite]  
        ...
        WHERE AlarmAndEventToSiteGuid = @AlarmAndEventToSiteGuid
