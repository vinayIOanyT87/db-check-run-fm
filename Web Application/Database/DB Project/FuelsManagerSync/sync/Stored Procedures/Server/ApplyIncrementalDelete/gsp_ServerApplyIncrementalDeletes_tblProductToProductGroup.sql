...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblProductToProductGroup]
...
BEGIN
    ...
    DELETE [map].[tblProductToProductGroup]  
        ...
        WHERE ProductToProductGroupGuid = @ProductToProductGroupGuid
