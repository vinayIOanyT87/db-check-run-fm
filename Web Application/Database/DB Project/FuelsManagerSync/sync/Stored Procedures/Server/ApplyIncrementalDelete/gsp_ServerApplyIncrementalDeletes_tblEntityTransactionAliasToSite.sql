...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblEntityTransactionAliasToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityTransactionAliasToSite]  
        ...
        WHERE TransactionAliasToSiteGuid = @TransactionAliasToSiteGuid
