...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblEntityStandingOfferToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityStandingOfferToSite]  
        ...
        WHERE StandingOfferToSiteGuid = @StandingOfferToSiteGuid
