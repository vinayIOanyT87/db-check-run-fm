...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblProcessVariableAdditiveOutputPermissive]
...
BEGIN
    ...
    DELETE [dbo].[tblProcessVariableAdditiveOutputPermissive]  
