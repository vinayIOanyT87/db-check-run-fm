...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblMessageFrequencyType]
...
BEGIN
    ...
    DELETE [lookup].[tblMessageFrequencyType]  
        ...
        WHERE MessageFrequencyTypeIndex = @MessageFrequencyTypeIndex
