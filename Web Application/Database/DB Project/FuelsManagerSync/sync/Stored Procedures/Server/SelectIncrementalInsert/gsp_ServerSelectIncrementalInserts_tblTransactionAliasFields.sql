...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblTransactionAliasFields]
...
@sync_batch_size_tblTransactionAliasFields int,
@sync_bypass_insert_update_extraction bit,
@sync_request_type int,
@sync_first_time_sync_option_tblTransactionAliasFields int
AS
BEGIN
    ...
    IF (@sync_batch_size_tblTransactionAliasFields IS NULL OR 
        (@sync_batch_size_tblTransactionAliasFields IS NOT NULL AND @sync_batch_size_tblTransactionAliasFields = 0))
    BEGIN
        SET @sync_batch_size_tblTransactionAliasFields = 2147483647;
    END

    -- Get a list of the Owned/Assigned Entities and locate any newly inserted entities
    -- and/or any new entity site assignments (if assignable).
        SELECT [AliasID],[DbName],[DisplayOrder],[DisplayName],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy],[Required],[Virtual],[TransactionAliasFieldGuid],[LookupTransactionFieldTypeIndex],[TransactionAliasGuid],[UserGroupGuid],[DispatchField],[ClearOnNew],[ReadOnly],[Visibility],[DefaultValueType],[DefaultValue],_RowVersion
        FROM (
            SELECT TOP(@sync_batch_size_tblTransactionAliasFields) WITH TIES [dbo].[tblTransactionAliasFields].[AliasID],[dbo].[tblTransactionAliasFields].[DbName],[dbo].[tblTransactionAliasFields].[DisplayOrder],[dbo].[tblTransactionAliasFields].[DisplayName],[dbo].[tblTransactionAliasFields].[CreatedDate],[dbo].[tblTransactionAliasFields].[CreatedBy],[dbo].[tblTransactionAliasFields].[UpdatedDate],[dbo].[tblTransactionAliasFields].[UpdatedBy],[dbo].[tblTransactionAliasFields].[Required],[dbo].[tblTransactionAliasFields].[Virtual],[dbo].[tblTransactionAliasFields].[TransactionAliasFieldGuid],[dbo].[tblTransactionAliasFields].[LookupTransactionFieldTypeIndex],[dbo].[tblTransactionAliasFields].[TransactionAliasGuid],[dbo].[tblTransactionAliasFields].[UserGroupGuid],[dbo].[tblTransactionAliasFields].[DispatchField],[dbo].[tblTransactionAliasFields].[ClearOnNew],[dbo].[tblTransactionAliasFields].[ReadOnly],[dbo].[tblTransactionAliasFields].[Visibility],[dbo].[tblTransactionAliasFields].[DefaultValueType],[dbo].[tblTransactionAliasFields].[DefaultValue],sync.udf_GetMaxRowVersion(CT.InsertedRowVersion,MAPCT.InsertedRowVersion,NULL) AS '_RowVersion'
                FROM [dbo].[tblTransactionAliasFields]
                    INNER JOIN (SELECT [TransactionAliasToSiteGuid],[TransactionAliasGuid],[OwnerSiteGuid],[AssignedToSiteGuid] FROM [dbo].[udf_GetAssignedTransactionAliasListForSite](@sync_context_site_guid)) data
                        ON [dbo].[tblTransactionAliasFields].[TransactionAliasGuid] = data.[TransactionAliasGuid]
