...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblListViews]
...
@sync_batch_size_tblListViews int,
@sync_bypass_insert_update_extraction bit,
@sync_request_type int,
@sync_first_time_sync_option_tblListViews int
AS
BEGIN
    ...
    IF (@sync_batch_size_tblListViews IS NULL OR 
        (@sync_batch_size_tblListViews IS NOT NULL AND @sync_batch_size_tblListViews = 0))
    BEGIN
        SET @sync_batch_size_tblListViews = 2147483647;
    END

    -- Get a list of the Owned/Assigned Entities and locate any newly inserted entities
    -- and/or any new entity site assignments (if assignable).
    SELECT TOP(@sync_batch_size_tblListViews) WITH TIES [CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy],[ID],[ListViewGuid],[SiteGuid],[LookupListViewTypeIndex],[LookupListViewStandardTypeIndex],[LedgerAggregateColumnGuid],[TransactionAliasGuid],_RowVersion
    FROM (
        SELECT [CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy],[ID],[ListViewGuid],[SiteGuid],[LookupListViewTypeIndex],[LookupListViewStandardTypeIndex],[LedgerAggregateColumnGuid],[TransactionAliasGuid],_RowVersion
        FROM (
            SELECT TOP(@sync_batch_size_tblListViews) WITH TIES [dbo].[tblListViews].[CreatedDate],[dbo].[tblListViews].[CreatedBy],[dbo].[tblListViews].[UpdatedDate],[dbo].[tblListViews].[UpdatedBy],[dbo].[tblListViews].[ID],[dbo].[tblListViews].[ListViewGuid],[dbo].[tblListViews].[SiteGuid],[dbo].[tblListViews].[LookupListViewTypeIndex],[dbo].[tblListViews].[LookupListViewStandardTypeIndex],[dbo].[tblListViews].[LedgerAggregateColumnGuid],[dbo].[tblListViews].[TransactionAliasGuid],sync.udf_GetMaxRowVersion(CT.InsertedRowVersion,MAPCT.InsertedRowVersion,NULL) AS '_RowVersion'
                FROM [dbo].[tblListViews]
                    INNER JOIN (SELECT [ListViewToSiteGuid],[ListViewGuid],[LedgerAggregateColumnGuid],[TransactionAliasGuid],[OwnerSiteGuid],[AssignedToSiteGuid] FROM [dbo].[udf_GetAssignedListViewListForSite](@sync_context_site_guid)) data
                        ON [dbo].[tblListViews].[ListViewGuid] = data.[ListViewGuid]
            ...
            SELECT TOP(@sync_batch_size_tblListViews) WITH TIES [dbo].[tblListViews].[CreatedDate],[dbo].[tblListViews].[CreatedBy],[dbo].[tblListViews].[UpdatedDate],[dbo].[tblListViews].[UpdatedBy],[dbo].[tblListViews].[ID],[dbo].[tblListViews].[ListViewGuid],[dbo].[tblListViews].[SiteGuid],[dbo].[tblListViews].[LookupListViewTypeIndex],[dbo].[tblListViews].[LookupListViewStandardTypeIndex],[dbo].[tblListViews].[LedgerAggregateColumnGuid],[dbo].[tblListViews].[TransactionAliasGuid],sync.udf_GetMaxRowVersion(CT.InsertedRowVersion,MAPCT.InsertedRowVersion,NULL) AS '_RowVersion'
                FROM [dbo].[tblListViews]
                    INNER JOIN (SELECT [LedgerViewToSiteGuid],[ListViewGuid],[LedgerAggregateColumnGuid],[TransactionAliasGuid],[OwnerSiteGuid],[AssignedToSiteGuid] FROM [dbo].[udf_GetAssignedLedgerViewListForSite](@sync_context_site_guid)) data1
                        ON [dbo].[tblListViews].[ListViewGuid] = data1.[ListViewGuid]
                    INNER JOIN [track].[tblListViews] CT
                        ON CT.PK_ListViewGuid = [dbo].[tblListViews].[ListViewGuid] 
