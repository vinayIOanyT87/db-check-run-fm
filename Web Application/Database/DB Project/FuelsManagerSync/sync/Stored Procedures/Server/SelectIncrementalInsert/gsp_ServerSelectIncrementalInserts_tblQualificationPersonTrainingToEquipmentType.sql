...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblQualificationPersonTrainingToEquipmentType]
...
@sync_batch_size_tblQualificationPersonTrainingToEquipmentType int,
@sync_bypass_insert_update_extraction bit,
@sync_request_type int,
@sync_first_time_sync_option_tblQualificationPersonTrainingToEquipmentType int
AS
BEGIN
    ...
    IF (@sync_batch_size_tblQualificationPersonTrainingToEquipmentType IS NULL OR 
        (@sync_batch_size_tblQualificationPersonTrainingToEquipmentType IS NOT NULL AND @sync_batch_size_tblQualificationPersonTrainingToEquipmentType = 0))
    BEGIN
        SET @sync_batch_size_tblQualificationPersonTrainingToEquipmentType = 2147483647;
    END

    -- Get a list of the Owned/Assigned Entities and locate any newly inserted entities
    -- and/or any new entity site assignments (if assignable).
        SELECT TOP(@sync_batch_size_tblQualificationPersonTrainingToEquipmentType) WITH TIES [QualificationPersonTrainingToEquipmentTypeGuid],[QualificationGuid],[EquipmentTypeGuid],[Sequence],[Instructor],[DateCompleted],[DateDue],[ExpirationDate],[ID],[Rating],[HistoricalRecord],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy],[SiteGuid],_RowVersion
        FROM (
            SELECT TOP(@sync_batch_size_tblQualificationPersonTrainingToEquipmentType) WITH TIES [map].[tblQualificationPersonTrainingToEquipmentType].[QualificationPersonTrainingToEquipmentTypeGuid],[map].[tblQualificationPersonTrainingToEquipmentType].[QualificationGuid],[map].[tblQualificationPersonTrainingToEquipmentType].[EquipmentTypeGuid],[map].[tblQualificationPersonTrainingToEquipmentType].[Sequence],[map].[tblQualificationPersonTrainingToEquipmentType].[Instructor],[map].[tblQualificationPersonTrainingToEquipmentType].[DateCompleted],[map].[tblQualificationPersonTrainingToEquipmentType].[DateDue],[map].[tblQualificationPersonTrainingToEquipmentType].[ExpirationDate],[map].[tblQualificationPersonTrainingToEquipmentType].[ID],[map].[tblQualificationPersonTrainingToEquipmentType].[Rating],[map].[tblQualificationPersonTrainingToEquipmentType].[HistoricalRecord],[map].[tblQualificationPersonTrainingToEquipmentType].[CreatedDate],[map].[tblQualificationPersonTrainingToEquipmentType].[CreatedBy],[map].[tblQualificationPersonTrainingToEquipmentType].[UpdatedDate],[map].[tblQualificationPersonTrainingToEquipmentType].[UpdatedBy],[map].[tblQualificationPersonTrainingToEquipmentType].[SiteGuid],sync.udf_GetMaxRowVersion(CT.InsertedRowVersion,MAPCT.InsertedRowVersion,MAPCT2.InsertedRowVersion) AS '_RowVersion'
                FROM [map].[tblQualificationPersonTrainingToEquipmentType]
                    INNER JOIN (SELECT [PersonnelTrainingToSiteGuid],[QualificationGuid],[OwnerSiteGuid],[AssignedToSiteGuid] FROM [dbo].[udf_GetAssignedQualificationPersonnelTrainingListForSite](@sync_context_site_guid)) data
                        ON [map].[tblQualificationPersonTrainingToEquipmentType].[QualificationGuid] = data.[QualificationGuid]
                    INNER JOIN (SELECT [EquipmentTypeToSiteGuid],[EquipmentTypeGuid],[OwnerSiteGuid],[AssignedToSiteGuid] FROM [dbo].[udf_GetAssignedEquipmentTypeListForSite](@sync_context_site_guid)) data1
                        ON [map].[tblQualificationPersonTrainingToEquipmentType].[EquipmentTypeGuid] = data1.[EquipmentTypeGuid]
