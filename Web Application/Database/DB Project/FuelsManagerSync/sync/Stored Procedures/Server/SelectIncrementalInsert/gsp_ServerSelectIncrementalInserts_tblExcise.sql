...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblExcise]
...
@sync_first_time_sync_option_tblExcise int
AS
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblExcise IS NOT NULL AND @sync_first_time_sync_option_tblExcise = 1))
