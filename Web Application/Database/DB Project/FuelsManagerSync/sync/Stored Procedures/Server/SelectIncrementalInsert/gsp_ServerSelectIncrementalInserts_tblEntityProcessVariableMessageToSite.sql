...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblEntityProcessVariableMessageToSite]
...
@sync_first_time_sync_option_tblEntityProcessVariableMessageToSite int
AS
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblEntityProcessVariableMessageToSite IS NOT NULL AND @sync_first_time_sync_option_tblEntityProcessVariableMessageToSite = 1))
    ...
    SELECT TOP(@sync_batch_size_tblEntityProcessVariableMessageToSite) WITH TIES [map].[tblEntityProcessVariableMessageToSite].[ProcessVariableMessageToSiteGuid],[map].[tblEntityProcessVariableMessageToSite].[ApplicationStringGuid],[map].[tblEntityProcessVariableMessageToSite].[SiteGuid],[map].[tblEntityProcessVariableMessageToSite].[CreatedDate],[map].[tblEntityProcessVariableMessageToSite].[CreatedBy],[map].[tblEntityProcessVariableMessageToSite].[UpdatedDate],[map].[tblEntityProcessVariableMessageToSite].[UpdatedBy],[map].[tblEntityProcessVariableMessageToSite].[AssignedFromSiteGuid],CT.InsertedRowVersion AS '_RowVersion'
        FROM [map].[tblEntityProcessVariableMessageToSite]
