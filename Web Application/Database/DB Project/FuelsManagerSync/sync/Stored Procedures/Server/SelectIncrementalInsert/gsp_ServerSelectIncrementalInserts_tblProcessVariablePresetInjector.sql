...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblProcessVariablePresetInjector]
...
@sync_first_time_sync_option_tblProcessVariablePresetInjector int
AS
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblProcessVariablePresetInjector IS NOT NULL AND @sync_first_time_sync_option_tblProcessVariablePresetInjector = 1))
