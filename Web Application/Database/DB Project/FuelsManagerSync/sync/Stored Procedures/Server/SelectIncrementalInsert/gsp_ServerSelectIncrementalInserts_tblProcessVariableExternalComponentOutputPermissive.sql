...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblProcessVariableExternalComponentOutputPermissive]
...
@sync_first_time_sync_option_tblProcessVariableExternalComponentOutputPermissive int
AS
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblProcessVariableExternalComponentOutputPermissive IS NOT NULL AND @sync_first_time_sync_option_tblProcessVariableExternalComponentOutputPermissive = 1))
