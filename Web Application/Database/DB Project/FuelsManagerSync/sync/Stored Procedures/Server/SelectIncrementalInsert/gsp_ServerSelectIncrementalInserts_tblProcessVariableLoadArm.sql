...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblProcessVariableLoadArm]
...
@sync_first_time_sync_option_tblProcessVariableLoadArm int
AS
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblProcessVariableLoadArm IS NOT NULL AND @sync_first_time_sync_option_tblProcessVariableLoadArm = 1))
