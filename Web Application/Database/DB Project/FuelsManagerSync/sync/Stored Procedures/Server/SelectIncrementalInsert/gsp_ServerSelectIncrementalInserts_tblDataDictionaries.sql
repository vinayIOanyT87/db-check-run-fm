...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblDataDictionaries]
...
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblDataDictionaries IS NOT NULL AND @sync_first_time_sync_option_tblDataDictionaries = 1))
