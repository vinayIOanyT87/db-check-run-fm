...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblTrend]
...
@sync_first_time_sync_option_tblTrend int
AS
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblTrend IS NOT NULL AND @sync_first_time_sync_option_tblTrend = 1))
    ...
    SELECT TOP(@sync_batch_size_tblTrend) WITH TIES [dbo].[tblTrend].[ID],[dbo].[tblTrend].[Description],[dbo].[tblTrend].[Mode],[dbo].[tblTrend].[PeriodType],[dbo].[tblTrend].[Period],[dbo].[tblTrend].[Start],[dbo].[tblTrend].[End],[dbo].[tblTrend].[CreatedDate],[dbo].[tblTrend].[CreatedBy],[dbo].[tblTrend].[UpdatedDate],[dbo].[tblTrend].[UpdatedBy],[dbo].[tblTrend].[TrendGuid],[dbo].[tblTrend].[SiteGuid],[dbo].[tblTrend].[PointTemplateGuid],CT.InsertedRowVersion AS '_RowVersion'
        FROM [dbo].[tblTrend]
