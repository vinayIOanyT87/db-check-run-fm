...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblEntityCompanyToSite]
...
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblEntityCompanyToSite IS NOT NULL AND @sync_first_time_sync_option_tblEntityCompanyToSite = 1))
