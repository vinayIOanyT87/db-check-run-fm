...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblUserDataFieldIata]
...
@sync_batch_size_tblUserDataFieldIata int,
@sync_bypass_insert_update_extraction bit,
@sync_request_type int,
@sync_first_time_sync_option_tblUserDataFieldIata int
AS
BEGIN
    ...
    IF (@sync_batch_size_tblUserDataFieldIata IS NULL OR 
        (@sync_batch_size_tblUserDataFieldIata IS NOT NULL AND @sync_batch_size_tblUserDataFieldIata = 0))
    BEGIN
        SET @sync_batch_size_tblUserDataFieldIata = 2147483647;
    END

    -- Get a list of the Owned/Assigned Entities and locate any newly inserted entities
    -- and/or any new entity site assignments (if assignable).
    SELECT TOP(@sync_batch_size_tblUserDataFieldIata) WITH TIES [UserDataFieldIataGuid],[TransactionAliasGuid],[SiteGuid],[Number],[DisplayOrder],[DisplayName],[LookupUserDataTypeIndex],[Required],[UserGroupGuid],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy],[DispatchField],[ClearOnNew],[ReadOnly],[Visibility],[DefaultValue],_RowVersion
    FROM (
        SELECT [UserDataFieldIataGuid],[TransactionAliasGuid],[SiteGuid],[Number],[DisplayOrder],[DisplayName],[LookupUserDataTypeIndex],[Required],[UserGroupGuid],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy],[DispatchField],[ClearOnNew],[ReadOnly],[Visibility],[DefaultValue],_RowVersion
        FROM (
            SELECT TOP(@sync_batch_size_tblUserDataFieldIata) WITH TIES [dbo].[tblUserDataFieldIata].[UserDataFieldIataGuid],[dbo].[tblUserDataFieldIata].[TransactionAliasGuid],[dbo].[tblUserDataFieldIata].[SiteGuid],[dbo].[tblUserDataFieldIata].[Number],[dbo].[tblUserDataFieldIata].[DisplayOrder],[dbo].[tblUserDataFieldIata].[DisplayName],[dbo].[tblUserDataFieldIata].[LookupUserDataTypeIndex],[dbo].[tblUserDataFieldIata].[Required],[dbo].[tblUserDataFieldIata].[UserGroupGuid],[dbo].[tblUserDataFieldIata].[CreatedDate],[dbo].[tblUserDataFieldIata].[CreatedBy],[dbo].[tblUserDataFieldIata].[UpdatedDate],[dbo].[tblUserDataFieldIata].[UpdatedBy],[dbo].[tblUserDataFieldIata].[DispatchField],[dbo].[tblUserDataFieldIata].[ClearOnNew],[dbo].[tblUserDataFieldIata].[ReadOnly],[dbo].[tblUserDataFieldIata].[Visibility],[dbo].[tblUserDataFieldIata].[DefaultValue],CT.InsertedRowVersion AS '_RowVersion'
                FROM [dbo].[tblUserDataFieldIata]
                    INNER JOIN [track].[tblUserDataFieldIata] CT
                        ON CT.PK_UserDataFieldIataGuid = [dbo].[tblUserDataFieldIata].[UserDataFieldIataGuid] 
                WHERE ( [dbo].[tblUserDataFieldIata].[SiteGuid] = @sync_context_site_guid )
            ...
            SELECT TOP(@sync_batch_size_tblUserDataFieldIata) WITH TIES [dbo].[tblUserDataFieldIata].[UserDataFieldIataGuid],[dbo].[tblUserDataFieldIata].[TransactionAliasGuid],[dbo].[tblUserDataFieldIata].[SiteGuid],[dbo].[tblUserDataFieldIata].[Number],[dbo].[tblUserDataFieldIata].[DisplayOrder],[dbo].[tblUserDataFieldIata].[DisplayName],[dbo].[tblUserDataFieldIata].[LookupUserDataTypeIndex],[dbo].[tblUserDataFieldIata].[Required],[dbo].[tblUserDataFieldIata].[UserGroupGuid],[dbo].[tblUserDataFieldIata].[CreatedDate],[dbo].[tblUserDataFieldIata].[CreatedBy],[dbo].[tblUserDataFieldIata].[UpdatedDate],[dbo].[tblUserDataFieldIata].[UpdatedBy],[dbo].[tblUserDataFieldIata].[DispatchField],[dbo].[tblUserDataFieldIata].[ClearOnNew],[dbo].[tblUserDataFieldIata].[ReadOnly],[dbo].[tblUserDataFieldIata].[Visibility],[dbo].[tblUserDataFieldIata].[DefaultValue],sync.udf_GetMaxRowVersion(CT.InsertedRowVersion,MAPCT.InsertedRowVersion,NULL) AS '_RowVersion'
                FROM [dbo].[tblUserDataFieldIata]
                    INNER JOIN (SELECT [UserDataToSiteGuid],[UserDataFieldIataGuid],[OwnerSiteGuid],[AssignedToSiteGuid] FROM [dbo].[udf_GetAssignedUserDataFieldIataListForSite](@sync_context_site_guid)) data
                        ON [dbo].[tblUserDataFieldIata].[UserDataFieldIataGuid] = data.[UserDataFieldIataGuid]
                    INNER JOIN [track].[tblUserDataFieldIata] CT
                        ON CT.PK_UserDataFieldIataGuid = [dbo].[tblUserDataFieldIata].[UserDataFieldIataGuid] 
