...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblArchivedUsers]
...
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblArchivedUsers IS NOT NULL AND @sync_first_time_sync_option_tblArchivedUsers = 1))
