...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblProcessVariableExternalMeterOutputPermissive]
...
@sync_first_time_sync_option_tblProcessVariableExternalMeterOutputPermissive int
AS
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblProcessVariableExternalMeterOutputPermissive IS NOT NULL AND @sync_first_time_sync_option_tblProcessVariableExternalMeterOutputPermissive = 1))
