...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblQualificationEquipmentTestAndInspectionToEquipment]
...
@sync_first_time_sync_option_tblQualificationEquipmentTestAndInspectionToEquipment int
AS
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblQualificationEquipmentTestAndInspectionToEquipment IS NOT NULL AND @sync_first_time_sync_option_tblQualificationEquipmentTestAndInspectionToEquipment = 1))
