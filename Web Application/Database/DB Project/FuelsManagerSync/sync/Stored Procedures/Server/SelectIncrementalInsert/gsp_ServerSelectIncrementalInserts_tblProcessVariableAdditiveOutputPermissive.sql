...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblProcessVariableAdditiveOutputPermissive]
...
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblProcessVariableAdditiveOutputPermissive IS NOT NULL AND @sync_first_time_sync_option_tblProcessVariableAdditiveOutputPermissive = 1))
