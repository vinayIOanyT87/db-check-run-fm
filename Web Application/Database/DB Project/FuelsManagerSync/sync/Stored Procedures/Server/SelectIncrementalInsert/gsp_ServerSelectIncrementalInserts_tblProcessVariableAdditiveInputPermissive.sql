...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblProcessVariableAdditiveInputPermissive]
...
@sync_batch_size_tblProcessVariableAdditiveInputPermissive int,
@sync_bypass_insert_update_extraction bit,
@sync_request_type int,
@sync_first_time_sync_option_tblProcessVariableAdditiveInputPermissive int
AS
BEGIN
    ...
    IF (@sync_batch_size_tblProcessVariableAdditiveInputPermissive IS NULL OR 
        (@sync_batch_size_tblProcessVariableAdditiveInputPermissive IS NOT NULL AND @sync_batch_size_tblProcessVariableAdditiveInputPermissive = 0))
    BEGIN
        SET @sync_batch_size_tblProcessVariableAdditiveInputPermissive = 2147483647;
    END

    -- Get a list of the Owned/Assigned Entities and locate any newly inserted entities
    -- and/or any new entity site assignments (if assignable).
        SELECT TOP(@sync_batch_size_tblProcessVariableAdditiveInputPermissive) WITH TIES [ProcessVariableProductToPresetInjectorGuid],[LookupProcessVariableTypeIndex],[InstanceNumber],[ProductToPresetInjectorGuid],[OPCConnectionGuid],[OPCItemID],[DataType],[ServerEngineeringUnitsIndex],[Quality],[SIValue],[LookupSIValueVariantTypeIndex],[DateTimeStamp],[Maximum],[LookupMaximumVariantTypeIndex],[Minimum],[LookupMinimumVariantTypeIndex],[DataTypeEnabled],[Input],[InputEnabled],[MessageApplicationStringGuid],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy],_RowVersion
        FROM (
            SELECT TOP(@sync_batch_size_tblProcessVariableAdditiveInputPermissive) WITH TIES [dbo].[tblProcessVariableAdditiveInputPermissive].[ProcessVariableProductToPresetInjectorGuid],[dbo].[tblProcessVariableAdditiveInputPermissive].[LookupProcessVariableTypeIndex],[dbo].[tblProcessVariableAdditiveInputPermissive].[InstanceNumber],[dbo].[tblProcessVariableAdditiveInputPermissive].[ProductToPresetInjectorGuid],[dbo].[tblProcessVariableAdditiveInputPermissive].[OPCConnectionGuid],[dbo].[tblProcessVariableAdditiveInputPermissive].[OPCItemID],[dbo].[tblProcessVariableAdditiveInputPermissive].[DataType],[dbo].[tblProcessVariableAdditiveInputPermissive].[ServerEngineeringUnitsIndex],[dbo].[tblProcessVariableAdditiveInputPermissive].[Quality],[dbo].[tblProcessVariableAdditiveInputPermissive].[SIValue],[dbo].[tblProcessVariableAdditiveInputPermissive].[LookupSIValueVariantTypeIndex],[dbo].[tblProcessVariableAdditiveInputPermissive].[DateTimeStamp],[dbo].[tblProcessVariableAdditiveInputPermissive].[Maximum],[dbo].[tblProcessVariableAdditiveInputPermissive].[LookupMaximumVariantTypeIndex],[dbo].[tblProcessVariableAdditiveInputPermissive].[Minimum],[dbo].[tblProcessVariableAdditiveInputPermissive].[LookupMinimumVariantTypeIndex],[dbo].[tblProcessVariableAdditiveInputPermissive].[DataTypeEnabled],[dbo].[tblProcessVariableAdditiveInputPermissive].[Input],[dbo].[tblProcessVariableAdditiveInputPermissive].[InputEnabled],[dbo].[tblProcessVariableAdditiveInputPermissive].[MessageApplicationStringGuid],[dbo].[tblProcessVariableAdditiveInputPermissive].[CreatedDate],[dbo].[tblProcessVariableAdditiveInputPermissive].[CreatedBy],[dbo].[tblProcessVariableAdditiveInputPermissive].[UpdatedDate],[dbo].[tblProcessVariableAdditiveInputPermissive].[UpdatedBy],CT.InsertedRowVersion AS '_RowVersion'
                FROM [dbo].[tblProcessVariableAdditiveInputPermissive]
                    INNER JOIN (SELECT [ProcessVariableProductToPresetInjectorGuid],[ProductToPresetInjectorGuid],[OPCConnectionGuid],[MessageApplicationStringGuid],[OwnerSiteGuid] FROM [dbo].[udf_GetAssociatedProcessVariableAdditiveInputPermissiveListForSite](@sync_context_site_guid)) data
                        ON [dbo].[tblProcessVariableAdditiveInputPermissive].[ProcessVariableProductToPresetInjectorGuid] = data.[ProcessVariableProductToPresetInjectorGuid]
