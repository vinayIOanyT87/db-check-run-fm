...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblTransactionTransportLineItems]
...
@sync_first_time_sync_option_tblTransactionTransportLineItems int
AS
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblTransactionTransportLineItems IS NOT NULL AND @sync_first_time_sync_option_tblTransactionTransportLineItems = 1))
    ...
    END
        ...
        -- We only do this on tblTransactionTransportLineItems so we know what which tblTransactionTransportLineItems records are being processed.
        -- Synchronization will only synchronize other dependent records that are associated with the tblTransactionTransportLineItems records
        -- that were included.
    ...
    -- 
    SELECT [dbo].[tblTransactionTransportLineItems].[TransportOrderNumber],[dbo].[tblTransactionTransportLineItems].[TransVersion],[dbo].[tblTransactionTransportLineItems].[LocationName],[dbo].[tblTransactionTransportLineItems].[Address1],[dbo].[tblTransactionTransportLineItems].[Address2],[dbo].[tblTransactionTransportLineItems].[City],[dbo].[tblTransactionTransportLineItems].[State],[dbo].[tblTransactionTransportLineItems].[Zip],[dbo].[tblTransactionTransportLineItems].[POCName],[dbo].[tblTransactionTransportLineItems].[POCPhone],[dbo].[tblTransactionTransportLineItems].[CreatedBy],[dbo].[tblTransactionTransportLineItems].[CreatedDate],[dbo].[tblTransactionTransportLineItems].[UpdatedBy],[dbo].[tblTransactionTransportLineItems].[UpdatedDate],[dbo].[tblTransactionTransportLineItems].[TransactionTransportLineItemGuid],[dbo].[tblTransactionTransportLineItems].[TransactionGuid],CT.InsertedRowVersion AS '_RowVersion'
        FROM [dbo].[tblTransactionTransportLineItems]
