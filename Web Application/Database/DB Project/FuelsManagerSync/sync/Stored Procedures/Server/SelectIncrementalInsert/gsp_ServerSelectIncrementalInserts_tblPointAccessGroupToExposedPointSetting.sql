...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblPointAccessGroupToExposedPointSetting]
...
@sync_batch_size_tblPointAccessGroupToExposedPointSetting int,
@sync_bypass_insert_update_extraction bit,
@sync_request_type int,
@sync_first_time_sync_option_tblPointAccessGroupToExposedPointSetting int
AS
BEGIN
    ...
    IF (@sync_batch_size_tblPointAccessGroupToExposedPointSetting IS NULL OR 
        (@sync_batch_size_tblPointAccessGroupToExposedPointSetting IS NOT NULL AND @sync_batch_size_tblPointAccessGroupToExposedPointSetting = 0))
    BEGIN
        SET @sync_batch_size_tblPointAccessGroupToExposedPointSetting = 2147483647;
    END

    -- Get a list of the Owned/Assigned Entities and locate any newly inserted entities
    -- and/or any new entity site assignments (if assignable).
    SELECT TOP(@sync_batch_size_tblPointAccessGroupToExposedPointSetting) WITH TIES [map].[tblPointAccessGroupToExposedPointSetting].[PointAccessGroupToExposedSettingGuid],[map].[tblPointAccessGroupToExposedPointSetting].[PointAccessGroupGuid],[map].[tblPointAccessGroupToExposedPointSetting].[PointSettingGuid],[map].[tblPointAccessGroupToExposedPointSetting].[PropertyID],[map].[tblPointAccessGroupToExposedPointSetting].[View],[map].[tblPointAccessGroupToExposedPointSetting].[Modify],[map].[tblPointAccessGroupToExposedPointSetting].[CreatedDate],[map].[tblPointAccessGroupToExposedPointSetting].[CreatedBy],[map].[tblPointAccessGroupToExposedPointSetting].[UpdatedDate],[map].[tblPointAccessGroupToExposedPointSetting].[UpdatedBy],CT.InsertedRowVersion AS '_RowVersion'
        FROM [map].[tblPointAccessGroupToExposedPointSetting]
            INNER JOIN [dbo].[tblPointAccessGroup] ON [dbo].[tblPointAccessGroup].[PointAccessGroupGuid] = [map].[tblPointAccessGroupToExposedPointSetting].[PointAccessGroupGuid]
