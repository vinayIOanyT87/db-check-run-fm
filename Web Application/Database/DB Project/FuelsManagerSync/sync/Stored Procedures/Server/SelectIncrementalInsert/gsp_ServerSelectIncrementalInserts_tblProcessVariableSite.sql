...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblProcessVariableSite]
...
@sync_first_time_sync_option_tblProcessVariableSite int
AS
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblProcessVariableSite IS NOT NULL AND @sync_first_time_sync_option_tblProcessVariableSite = 1))
