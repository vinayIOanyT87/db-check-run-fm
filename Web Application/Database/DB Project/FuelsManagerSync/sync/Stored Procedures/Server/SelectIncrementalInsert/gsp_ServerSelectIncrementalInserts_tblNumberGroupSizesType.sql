...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblNumberGroupSizesType]
...
@sync_first_time_sync_option_tblNumberGroupSizesType int
AS
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblNumberGroupSizesType IS NOT NULL AND @sync_first_time_sync_option_tblNumberGroupSizesType = 1))
