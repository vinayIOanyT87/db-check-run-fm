...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblCompanyBillToToShipper]
...
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblCompanyBillToToShipper IS NOT NULL AND @sync_first_time_sync_option_tblCompanyBillToToShipper = 1))
