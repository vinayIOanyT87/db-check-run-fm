...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblQualificationEquipmentTagAndLicenseToStation]
...
@sync_batch_size_tblQualificationEquipmentTagAndLicenseToStation int,
@sync_bypass_insert_update_extraction bit,
@sync_request_type int,
@sync_first_time_sync_option_tblQualificationEquipmentTagAndLicenseToStation int
AS
BEGIN
    ...
    IF (@sync_batch_size_tblQualificationEquipmentTagAndLicenseToStation IS NULL OR 
        (@sync_batch_size_tblQualificationEquipmentTagAndLicenseToStation IS NOT NULL AND @sync_batch_size_tblQualificationEquipmentTagAndLicenseToStation = 0))
    BEGIN
        SET @sync_batch_size_tblQualificationEquipmentTagAndLicenseToStation = 2147483647;
    END

    -- Get a list of the Owned/Assigned Entities and locate any newly inserted entities
    -- and/or any new entity site assignments (if assignable).
        SELECT TOP(@sync_batch_size_tblQualificationEquipmentTagAndLicenseToStation) WITH TIES [QualificationEquipmentTagAndLicenseToStationGuid],[QualificationGuid],[StationGuid],[Sequence],[Instructor],[DateCompleted],[DateDue],[ExpirationDate],[ID],[Rating],[HistoricalRecord],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy],_RowVersion
        FROM (
            SELECT TOP(@sync_batch_size_tblQualificationEquipmentTagAndLicenseToStation) WITH TIES [map].[tblQualificationEquipmentTagAndLicenseToStation].[QualificationEquipmentTagAndLicenseToStationGuid],[map].[tblQualificationEquipmentTagAndLicenseToStation].[QualificationGuid],[map].[tblQualificationEquipmentTagAndLicenseToStation].[StationGuid],[map].[tblQualificationEquipmentTagAndLicenseToStation].[Sequence],[map].[tblQualificationEquipmentTagAndLicenseToStation].[Instructor],[map].[tblQualificationEquipmentTagAndLicenseToStation].[DateCompleted],[map].[tblQualificationEquipmentTagAndLicenseToStation].[DateDue],[map].[tblQualificationEquipmentTagAndLicenseToStation].[ExpirationDate],[map].[tblQualificationEquipmentTagAndLicenseToStation].[ID],[map].[tblQualificationEquipmentTagAndLicenseToStation].[Rating],[map].[tblQualificationEquipmentTagAndLicenseToStation].[HistoricalRecord],[map].[tblQualificationEquipmentTagAndLicenseToStation].[CreatedDate],[map].[tblQualificationEquipmentTagAndLicenseToStation].[CreatedBy],[map].[tblQualificationEquipmentTagAndLicenseToStation].[UpdatedDate],[map].[tblQualificationEquipmentTagAndLicenseToStation].[UpdatedBy],sync.udf_GetMaxRowVersion(CT.InsertedRowVersion,MAPCT.InsertedRowVersion,MAPCT2.InsertedRowVersion) AS '_RowVersion'
                FROM [map].[tblQualificationEquipmentTagAndLicenseToStation]
                    INNER JOIN (SELECT [EquipmentTagAndLicenseToSiteGuid],[QualificationGuid],[OwnerSiteGuid],[AssignedToSiteGuid] FROM [dbo].[udf_GetAssignedQualificationEquipmentTagAndLicenseListForSite](@sync_context_site_guid)) data
                        ON [map].[tblQualificationEquipmentTagAndLicenseToStation].[QualificationGuid] = data.[QualificationGuid]
                    INNER JOIN (SELECT [StationGuid],[OwnerSiteGuid] FROM [dbo].[udf_GetAssociatedStationListForSite](@sync_context_site_guid)) data1
                        ON [map].[tblQualificationEquipmentTagAndLicenseToStation].[StationGuid] = data1.[StationGuid]
