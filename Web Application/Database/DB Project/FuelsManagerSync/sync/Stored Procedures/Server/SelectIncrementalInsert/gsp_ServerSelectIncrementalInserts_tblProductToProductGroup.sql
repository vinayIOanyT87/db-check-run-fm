...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblProductToProductGroup]
...
@sync_first_time_sync_option_tblProductToProductGroup int
AS
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblProductToProductGroup IS NOT NULL AND @sync_first_time_sync_option_tblProductToProductGroup = 1))
