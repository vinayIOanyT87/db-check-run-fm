...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblAppointmentPersonnel]
...
@sync_batch_size_tblAppointmentPersonnel int,
@sync_bypass_insert_update_extraction bit,
@sync_request_type int,
@sync_first_time_sync_option_tblAppointmentPersonnel int
AS
BEGIN
    ...
    IF (@sync_batch_size_tblAppointmentPersonnel IS NULL OR 
        (@sync_batch_size_tblAppointmentPersonnel IS NOT NULL AND @sync_batch_size_tblAppointmentPersonnel = 0))
    BEGIN
        SET @sync_batch_size_tblAppointmentPersonnel = 2147483647;
    END

    -- Get a list of the Owned/Assigned Entities and locate any newly inserted entities
    -- and/or any new entity site assignments (if assignable).
        SELECT TOP(@sync_batch_size_tblAppointmentPersonnel) WITH TIES [AppointmentPersonnelGuid],[PersonnelGuid],[TestSetDefinitionGuid],[SiteGuid],[AssetText],[AppointmentCategory],[AppointmentIsSingle],[ScheduleOnWeekends],[ScheduleOnHolidays],[StartDate],[Duration],[AppointmentPeriod],[AppointmentPeriodText],[Description],[AppointmentTimeInterval],[AppointmentDayOfTheWeekText],[AppointmentDayOfTheWeek],[AppointmentReoccuranceInterval],[AppointmentOption2Selected],[AppointmentTimeOptionSelectionText],[AppointmentTimeOptionSelection],[AppointmentMonthSelectionText],[AppointmentMonthSelection],[AppointmentDayOfTheMonth],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy],_RowVersion
        FROM (
            SELECT TOP(@sync_batch_size_tblAppointmentPersonnel) WITH TIES [dbo].[tblAppointmentPersonnel].[AppointmentPersonnelGuid],[dbo].[tblAppointmentPersonnel].[PersonnelGuid],[dbo].[tblAppointmentPersonnel].[TestSetDefinitionGuid],[dbo].[tblAppointmentPersonnel].[SiteGuid],[dbo].[tblAppointmentPersonnel].[AssetText],[dbo].[tblAppointmentPersonnel].[AppointmentCategory],[dbo].[tblAppointmentPersonnel].[AppointmentIsSingle],[dbo].[tblAppointmentPersonnel].[ScheduleOnWeekends],[dbo].[tblAppointmentPersonnel].[ScheduleOnHolidays],[dbo].[tblAppointmentPersonnel].[StartDate],[dbo].[tblAppointmentPersonnel].[Duration],[dbo].[tblAppointmentPersonnel].[AppointmentPeriod],[dbo].[tblAppointmentPersonnel].[AppointmentPeriodText],[dbo].[tblAppointmentPersonnel].[Description],[dbo].[tblAppointmentPersonnel].[AppointmentTimeInterval],[dbo].[tblAppointmentPersonnel].[AppointmentDayOfTheWeekText],[dbo].[tblAppointmentPersonnel].[AppointmentDayOfTheWeek],[dbo].[tblAppointmentPersonnel].[AppointmentReoccuranceInterval],[dbo].[tblAppointmentPersonnel].[AppointmentOption2Selected],[dbo].[tblAppointmentPersonnel].[AppointmentTimeOptionSelectionText],[dbo].[tblAppointmentPersonnel].[AppointmentTimeOptionSelection],[dbo].[tblAppointmentPersonnel].[AppointmentMonthSelectionText],[dbo].[tblAppointmentPersonnel].[AppointmentMonthSelection],[dbo].[tblAppointmentPersonnel].[AppointmentDayOfTheMonth],[dbo].[tblAppointmentPersonnel].[CreatedDate],[dbo].[tblAppointmentPersonnel].[CreatedBy],[dbo].[tblAppointmentPersonnel].[UpdatedDate],[dbo].[tblAppointmentPersonnel].[UpdatedBy],sync.udf_GetMaxRowVersion(CT.InsertedRowVersion,MAPCT.InsertedRowVersion,NULL) AS '_RowVersion'
                FROM [dbo].[tblAppointmentPersonnel]
                    INNER JOIN (SELECT [AppointmentPersonnelToSiteGuid],[AppointmentPersonnelGuid],[OwnerSiteGuid],[AssignedToSiteGuid] FROM [dbo].[udf_GetAssignedAppointmentPersonnelListForSite](@sync_context_site_guid)) data
                        ON [dbo].[tblAppointmentPersonnel].[AppointmentPersonnelGuid] = data.[AppointmentPersonnelGuid]
                    ...
                    INNER JOIN [track].[tblEntityAppointmentPersonnelToSite] MAPCT
                        ON MAPCT.PK_AppointmentPersonnelToSiteGuid = data.[AppointmentPersonnelToSiteGuid] 
