...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblProductToPresetInjector]
...
@sync_batch_size_tblProductToPresetInjector int,
@sync_bypass_insert_update_extraction bit,
@sync_request_type int,
@sync_first_time_sync_option_tblProductToPresetInjector int
AS
BEGIN
    ...
    IF (@sync_batch_size_tblProductToPresetInjector IS NULL OR 
        (@sync_batch_size_tblProductToPresetInjector IS NOT NULL AND @sync_batch_size_tblProductToPresetInjector = 0))
    BEGIN
        SET @sync_batch_size_tblProductToPresetInjector = 2147483647;
    END

    -- Get a list of the Owned/Assigned Entities and locate any newly inserted entities
    -- and/or any new entity site assignments (if assignable).
        SELECT TOP(@sync_batch_size_tblProductToPresetInjector) WITH TIES [ProductToPresetInjectorGuid],[ProductGuid],[AssignedToLoadArmGuid],[Sequence],[BlendPercentage],[AdditiveRate],[Ratio],[AdditiveCycleVolume],[Tolerance],[PresetNumber],[AdditiveProfileGuid],[TankGuid],[MeterID],[ShipToProductID],[ShipToProductCode],[ShipToLoadRackDisplayText],[UnavailableInventoryGross],[UnavailableInventoryNet],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy],[AssignedToMeterGuid],_RowVersion
        FROM (
            SELECT TOP(@sync_batch_size_tblProductToPresetInjector) WITH TIES [map].[tblProductToPresetInjector].[ProductToPresetInjectorGuid],[map].[tblProductToPresetInjector].[ProductGuid],[map].[tblProductToPresetInjector].[AssignedToLoadArmGuid],[map].[tblProductToPresetInjector].[Sequence],[map].[tblProductToPresetInjector].[BlendPercentage],[map].[tblProductToPresetInjector].[AdditiveRate],[map].[tblProductToPresetInjector].[Ratio],[map].[tblProductToPresetInjector].[AdditiveCycleVolume],[map].[tblProductToPresetInjector].[Tolerance],[map].[tblProductToPresetInjector].[PresetNumber],[map].[tblProductToPresetInjector].[AdditiveProfileGuid],[map].[tblProductToPresetInjector].[TankGuid],[map].[tblProductToPresetInjector].[MeterID],[map].[tblProductToPresetInjector].[ShipToProductID],[map].[tblProductToPresetInjector].[ShipToProductCode],[map].[tblProductToPresetInjector].[ShipToLoadRackDisplayText],[map].[tblProductToPresetInjector].[UnavailableInventoryGross],[map].[tblProductToPresetInjector].[UnavailableInventoryNet],[map].[tblProductToPresetInjector].[CreatedDate],[map].[tblProductToPresetInjector].[CreatedBy],[map].[tblProductToPresetInjector].[UpdatedDate],[map].[tblProductToPresetInjector].[UpdatedBy],[map].[tblProductToPresetInjector].[AssignedToMeterGuid],sync.udf_GetMaxRowVersion(CT.InsertedRowVersion,MAPCT.InsertedRowVersion,MAPCT2.InsertedRowVersion) AS '_RowVersion'
                FROM [map].[tblProductToPresetInjector]
                    ...
                    INNER JOIN (SELECT [LoadArmGuid],[BayAStationGuid],[BayBStationGuid],[OwnerSiteGuid],[CreatedDate],[UpdatedDate] FROM [dbo].[udf_GetAssociatedLoadArmListForSite](@sync_context_site_guid)) data1
                        ON [map].[tblProductToPresetInjector].[AssignedToLoadArmGuid] = data1.[LoadArmGuid]
