...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblProcessVariableExternalMeterInputPermissive]
...
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblProcessVariableExternalMeterInputPermissive IS NOT NULL AND @sync_first_time_sync_option_tblProcessVariableExternalMeterInputPermissive = 1))
