...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblListViewFields]
...
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblListViewFields IS NOT NULL AND @sync_first_time_sync_option_tblListViewFields = 1))
