...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblPointAccessGroupToPointTag]
...
@sync_first_time_sync_option_tblPointAccessGroupToPointTag int
AS
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblPointAccessGroupToPointTag IS NOT NULL AND @sync_first_time_sync_option_tblPointAccessGroupToPointTag = 1))
