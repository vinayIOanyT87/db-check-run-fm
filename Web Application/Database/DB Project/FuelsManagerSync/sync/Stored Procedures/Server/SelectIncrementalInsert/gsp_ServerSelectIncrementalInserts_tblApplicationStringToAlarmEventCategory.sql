...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblApplicationStringToAlarmEventCategory]
...
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblApplicationStringToAlarmEventCategory IS NOT NULL AND @sync_first_time_sync_option_tblApplicationStringToAlarmEventCategory = 1))
