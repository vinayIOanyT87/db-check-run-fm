...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblTrendPenToPointTrend]
...
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblTrendPenToPointTrend IS NOT NULL AND @sync_first_time_sync_option_tblTrendPenToPointTrend = 1))
