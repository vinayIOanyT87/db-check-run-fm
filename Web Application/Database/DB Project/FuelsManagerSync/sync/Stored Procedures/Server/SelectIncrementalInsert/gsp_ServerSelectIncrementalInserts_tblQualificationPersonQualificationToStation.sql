...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblQualificationPersonQualificationToStation]
...
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblQualificationPersonQualificationToStation IS NOT NULL AND @sync_first_time_sync_option_tblQualificationPersonQualificationToStation = 1))
