...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblPointTagAlarmStatus]
...
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblPointTagAlarmStatus IS NOT NULL AND @sync_first_time_sync_option_tblPointTagAlarmStatus = 1))
