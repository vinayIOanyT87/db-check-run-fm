...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblAirplaneTank]
...
@sync_first_time_sync_option_tblAirplaneTank int
AS
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblAirplaneTank IS NOT NULL AND @sync_first_time_sync_option_tblAirplaneTank = 1))
    ...
    -- and/or any new entity site assignments (if assignable).
        ...
        FROM (
            SELECT TOP(@sync_batch_size_tblAirplaneTank) WITH TIES [dbo].[tblAirplaneTank].[Alias],[dbo].[tblAirplaneTank].[AirlineTankId],[dbo].[tblAirplaneTank].[Description],[dbo].[tblAirplaneTank].[Capacity],[dbo].[tblAirplaneTank].[Position],[dbo].[tblAirplaneTank].[Location],[dbo].[tblAirplaneTank].[DisplayOrder],[dbo].[tblAirplaneTank].[TankGuid],[dbo].[tblAirplaneTank].[EquipmentTypeGuid],[dbo].[tblAirplaneTank].[CreatedDate],[dbo].[tblAirplaneTank].[CreatedBy],[dbo].[tblAirplaneTank].[UpdatedDate],[dbo].[tblAirplaneTank].[UpdatedBy],CT.InsertedRowVersion AS '_RowVersion'
                FROM [dbo].[tblAirplaneTank]
