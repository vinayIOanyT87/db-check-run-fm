...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblTanks]
...
@sync_batch_size_tblTanks int,
@sync_bypass_insert_update_extraction bit,
@sync_request_type int,
@sync_first_time_sync_option_tblTanks int
AS
BEGIN
    ...
    IF (@sync_batch_size_tblTanks IS NULL OR 
        (@sync_batch_size_tblTanks IS NOT NULL AND @sync_batch_size_tblTanks = 0))
    BEGIN
        SET @sync_batch_size_tblTanks = 2147483647;
    END

    -- Get a list of the Owned/Assigned Entities and locate any newly inserted entities
    -- and/or any new entity site assignments (if assignable).
    SELECT TOP(@sync_batch_size_tblTanks) WITH TIES [dbo].[tblTanks].[TankID],[dbo].[tblTanks].[CreatedDate],[dbo].[tblTanks].[CreatedBy],[dbo].[tblTanks].[UpdatedDate],[dbo].[tblTanks].[UpdatedBy],[dbo].[tblTanks].[TankGuid],[dbo].[tblTanks].[SiteGuid],[dbo].[tblTanks].[LookupVesselTypeIndex],[dbo].[tblTanks].[ManagerCompanyGuid],[dbo].[tblTanks].[ProductGuid],[dbo].[tblTanks].[HiddenDate],[dbo].[tblTanks].[AssetTrackingDeviceGuid],[dbo].[tblTanks].[LookupDeviceTankTypeIndex],[dbo].[tblTanks].[Latitude],[dbo].[tblTanks].[Longitude],[dbo].[tblTanks].[TankConfigurationNumber],[dbo].[tblTanks].[Zoom],[dbo].[tblTanks].[OwnerCompanyGuid],CT.InsertedRowVersion AS '_RowVersion'
        FROM [dbo].[tblTanks]
