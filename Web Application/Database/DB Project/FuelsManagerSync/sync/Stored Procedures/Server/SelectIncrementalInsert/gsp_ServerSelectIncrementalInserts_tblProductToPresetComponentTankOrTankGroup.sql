...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblProductToPresetComponentTankOrTankGroup]
...
@sync_batch_size_tblProductToPresetComponentTankOrTankGroup int,
@sync_bypass_insert_update_extraction bit,
@sync_request_type int,
@sync_first_time_sync_option_tblProductToPresetComponentTankOrTankGroup int
AS
BEGIN
    ...
    IF (@sync_batch_size_tblProductToPresetComponentTankOrTankGroup IS NULL OR 
        (@sync_batch_size_tblProductToPresetComponentTankOrTankGroup IS NOT NULL AND @sync_batch_size_tblProductToPresetComponentTankOrTankGroup = 0))
    BEGIN
        SET @sync_batch_size_tblProductToPresetComponentTankOrTankGroup = 2147483647;
    END

    -- Get a list of the Owned/Assigned Entities and locate any newly inserted entities
    -- and/or any new entity site assignments (if assignable).
        SELECT TOP(@sync_batch_size_tblProductToPresetComponentTankOrTankGroup) WITH TIES [ProductToPresetComponentTankOrTankGroupGuid],[ProductGuid],[AssignedToLoadArmGuid],[Sequence],[BlendPercentage],[AdditiveRate],[Ratio],[AdditiveCycleVolume],[Tolerance],[PresetNumber],[AdditiveProfileGuid],[TankGuid],[TankGroupApplicationStringGuid],[MeterID],[ShipToProductID],[ShipToProductCode],[ShipToLoadRackDisplayText],[UnavailableInventoryGross],[UnavailableInventoryNet],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy],[AssignedToMeterGuid],_RowVersion
        FROM (
            SELECT TOP(@sync_batch_size_tblProductToPresetComponentTankOrTankGroup) WITH TIES [map].[tblProductToPresetComponentTankOrTankGroup].[ProductToPresetComponentTankOrTankGroupGuid],[map].[tblProductToPresetComponentTankOrTankGroup].[ProductGuid],[map].[tblProductToPresetComponentTankOrTankGroup].[AssignedToLoadArmGuid],[map].[tblProductToPresetComponentTankOrTankGroup].[Sequence],[map].[tblProductToPresetComponentTankOrTankGroup].[BlendPercentage],[map].[tblProductToPresetComponentTankOrTankGroup].[AdditiveRate],[map].[tblProductToPresetComponentTankOrTankGroup].[Ratio],[map].[tblProductToPresetComponentTankOrTankGroup].[AdditiveCycleVolume],[map].[tblProductToPresetComponentTankOrTankGroup].[Tolerance],[map].[tblProductToPresetComponentTankOrTankGroup].[PresetNumber],[map].[tblProductToPresetComponentTankOrTankGroup].[AdditiveProfileGuid],[map].[tblProductToPresetComponentTankOrTankGroup].[TankGuid],[map].[tblProductToPresetComponentTankOrTankGroup].[TankGroupApplicationStringGuid],[map].[tblProductToPresetComponentTankOrTankGroup].[MeterID],[map].[tblProductToPresetComponentTankOrTankGroup].[ShipToProductID],[map].[tblProductToPresetComponentTankOrTankGroup].[ShipToProductCode],[map].[tblProductToPresetComponentTankOrTankGroup].[ShipToLoadRackDisplayText],[map].[tblProductToPresetComponentTankOrTankGroup].[UnavailableInventoryGross],[map].[tblProductToPresetComponentTankOrTankGroup].[UnavailableInventoryNet],[map].[tblProductToPresetComponentTankOrTankGroup].[CreatedDate],[map].[tblProductToPresetComponentTankOrTankGroup].[CreatedBy],[map].[tblProductToPresetComponentTankOrTankGroup].[UpdatedDate],[map].[tblProductToPresetComponentTankOrTankGroup].[UpdatedBy],[map].[tblProductToPresetComponentTankOrTankGroup].[AssignedToMeterGuid],sync.udf_GetMaxRowVersion(CT.InsertedRowVersion,MAPCT.InsertedRowVersion,MAPCT2.InsertedRowVersion) AS '_RowVersion'
                FROM [map].[tblProductToPresetComponentTankOrTankGroup]
                    INNER JOIN (SELECT [ProductToSiteGuid],[ProductGuid],[OwnerSiteGuid],[AssignedToSiteGuid] FROM [dbo].[udf_GetAssignedProductListForSite](@sync_context_site_guid)) data
                        ON [map].[tblProductToPresetComponentTankOrTankGroup].[ProductGuid] = data.[ProductGuid]
                    INNER JOIN (SELECT [LoadArmGuid],[BayAStationGuid],[BayBStationGuid],[OwnerSiteGuid],[CreatedDate],[UpdatedDate] FROM [dbo].[udf_GetAssociatedLoadArmListForSite](@sync_context_site_guid)) data1
                        ON [map].[tblProductToPresetComponentTankOrTankGroup].[AssignedToLoadArmGuid] = data1.[LoadArmGuid]
