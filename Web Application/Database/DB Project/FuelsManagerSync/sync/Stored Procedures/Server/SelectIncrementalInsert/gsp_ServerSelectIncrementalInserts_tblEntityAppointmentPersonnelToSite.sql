...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblEntityAppointmentPersonnelToSite]
...
@sync_batch_size_tblEntityAppointmentPersonnelToSite int,
@sync_bypass_insert_update_extraction bit,
@sync_request_type int,
@sync_first_time_sync_option_tblEntityAppointmentPersonnelToSite int
AS
BEGIN
    ...
    IF (@sync_batch_size_tblEntityAppointmentPersonnelToSite IS NULL OR 
        (@sync_batch_size_tblEntityAppointmentPersonnelToSite IS NOT NULL AND @sync_batch_size_tblEntityAppointmentPersonnelToSite = 0))
    BEGIN
        SET @sync_batch_size_tblEntityAppointmentPersonnelToSite = 2147483647;
    END

    -- Get a list of the Owned/Assigned Entities and locate any newly inserted entities
    -- and/or any new entity site assignments (if assignable).
    SELECT TOP(@sync_batch_size_tblEntityAppointmentPersonnelToSite) WITH TIES [map].[tblEntityAppointmentPersonnelToSite].[AppointmentPersonnelToSiteGuid],[map].[tblEntityAppointmentPersonnelToSite].[AppointmentPersonnelGuid],[map].[tblEntityAppointmentPersonnelToSite].[SiteGuid],[map].[tblEntityAppointmentPersonnelToSite].[CreatedDate],[map].[tblEntityAppointmentPersonnelToSite].[CreatedBy],[map].[tblEntityAppointmentPersonnelToSite].[UpdatedDate],[map].[tblEntityAppointmentPersonnelToSite].[UpdatedBy],[map].[tblEntityAppointmentPersonnelToSite].[AssignedFromSiteGuid],CT.InsertedRowVersion AS '_RowVersion'
        FROM [map].[tblEntityAppointmentPersonnelToSite]
