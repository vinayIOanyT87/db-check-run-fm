...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblApplicationStringToFootNoteAdditiveProfile]
...
@sync_first_time_sync_option_tblApplicationStringToFootNoteAdditiveProfile int
AS
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblApplicationStringToFootNoteAdditiveProfile IS NOT NULL AND @sync_first_time_sync_option_tblApplicationStringToFootNoteAdditiveProfile = 1))
