...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblProcessVariableNoAdditiveOutputPermissive]
...
@sync_first_time_sync_option_tblProcessVariableNoAdditiveOutputPermissive int
AS
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblProcessVariableNoAdditiveOutputPermissive IS NOT NULL AND @sync_first_time_sync_option_tblProcessVariableNoAdditiveOutputPermissive = 1))
