...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblProcessVariableRecipeOutputPermissive]
...
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblProcessVariableRecipeOutputPermissive IS NOT NULL AND @sync_first_time_sync_option_tblProcessVariableRecipeOutputPermissive = 1))
