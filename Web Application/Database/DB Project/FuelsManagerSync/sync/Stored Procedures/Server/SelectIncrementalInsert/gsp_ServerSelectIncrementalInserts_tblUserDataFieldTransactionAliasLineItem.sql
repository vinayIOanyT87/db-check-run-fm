...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblUserDataFieldTransactionAliasLineItem]
...
@sync_batch_size_tblUserDataFieldTransactionAliasLineItem int,
@sync_bypass_insert_update_extraction bit,
@sync_request_type int,
@sync_first_time_sync_option_tblUserDataFieldTransactionAliasLineItem int
AS
BEGIN
    ...
    IF (@sync_batch_size_tblUserDataFieldTransactionAliasLineItem IS NULL OR 
        (@sync_batch_size_tblUserDataFieldTransactionAliasLineItem IS NOT NULL AND @sync_batch_size_tblUserDataFieldTransactionAliasLineItem = 0))
    BEGIN
        SET @sync_batch_size_tblUserDataFieldTransactionAliasLineItem = 2147483647;
    END

    -- Get a list of the Owned/Assigned Entities and locate any newly inserted entities
    -- and/or any new entity site assignments (if assignable).
    SELECT TOP(@sync_batch_size_tblUserDataFieldTransactionAliasLineItem) WITH TIES [UserDataFieldTransactionAliasLineItemGuid],[TransactionAliasGuid],[SiteGuid],[Number],[DisplayOrder],[DisplayName],[LookupUserDataTypeIndex],[Required],[UserGroupGuid],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy],[DispatchField],[ClearOnNew],[ReadOnly],[Visibility],[DefaultValue],_RowVersion
    FROM (
        SELECT [UserDataFieldTransactionAliasLineItemGuid],[TransactionAliasGuid],[SiteGuid],[Number],[DisplayOrder],[DisplayName],[LookupUserDataTypeIndex],[Required],[UserGroupGuid],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy],[DispatchField],[ClearOnNew],[ReadOnly],[Visibility],[DefaultValue],_RowVersion
        FROM (
            SELECT TOP(@sync_batch_size_tblUserDataFieldTransactionAliasLineItem) WITH TIES [dbo].[tblUserDataFieldTransactionAliasLineItem].[UserDataFieldTransactionAliasLineItemGuid],[dbo].[tblUserDataFieldTransactionAliasLineItem].[TransactionAliasGuid],[dbo].[tblUserDataFieldTransactionAliasLineItem].[SiteGuid],[dbo].[tblUserDataFieldTransactionAliasLineItem].[Number],[dbo].[tblUserDataFieldTransactionAliasLineItem].[DisplayOrder],[dbo].[tblUserDataFieldTransactionAliasLineItem].[DisplayName],[dbo].[tblUserDataFieldTransactionAliasLineItem].[LookupUserDataTypeIndex],[dbo].[tblUserDataFieldTransactionAliasLineItem].[Required],[dbo].[tblUserDataFieldTransactionAliasLineItem].[UserGroupGuid],[dbo].[tblUserDataFieldTransactionAliasLineItem].[CreatedDate],[dbo].[tblUserDataFieldTransactionAliasLineItem].[CreatedBy],[dbo].[tblUserDataFieldTransactionAliasLineItem].[UpdatedDate],[dbo].[tblUserDataFieldTransactionAliasLineItem].[UpdatedBy],[dbo].[tblUserDataFieldTransactionAliasLineItem].[DispatchField],[dbo].[tblUserDataFieldTransactionAliasLineItem].[ClearOnNew],[dbo].[tblUserDataFieldTransactionAliasLineItem].[ReadOnly],[dbo].[tblUserDataFieldTransactionAliasLineItem].[Visibility],[dbo].[tblUserDataFieldTransactionAliasLineItem].[DefaultValue],CT.InsertedRowVersion AS '_RowVersion'
                FROM [dbo].[tblUserDataFieldTransactionAliasLineItem]
                ...
                WHERE ( [dbo].[tblUserDataFieldTransactionAliasLineItem].[SiteGuid] = @sync_context_site_guid )
            ...
            SELECT TOP(@sync_batch_size_tblUserDataFieldTransactionAliasLineItem) WITH TIES [dbo].[tblUserDataFieldTransactionAliasLineItem].[UserDataFieldTransactionAliasLineItemGuid],[dbo].[tblUserDataFieldTransactionAliasLineItem].[TransactionAliasGuid],[dbo].[tblUserDataFieldTransactionAliasLineItem].[SiteGuid],[dbo].[tblUserDataFieldTransactionAliasLineItem].[Number],[dbo].[tblUserDataFieldTransactionAliasLineItem].[DisplayOrder],[dbo].[tblUserDataFieldTransactionAliasLineItem].[DisplayName],[dbo].[tblUserDataFieldTransactionAliasLineItem].[LookupUserDataTypeIndex],[dbo].[tblUserDataFieldTransactionAliasLineItem].[Required],[dbo].[tblUserDataFieldTransactionAliasLineItem].[UserGroupGuid],[dbo].[tblUserDataFieldTransactionAliasLineItem].[CreatedDate],[dbo].[tblUserDataFieldTransactionAliasLineItem].[CreatedBy],[dbo].[tblUserDataFieldTransactionAliasLineItem].[UpdatedDate],[dbo].[tblUserDataFieldTransactionAliasLineItem].[UpdatedBy],[dbo].[tblUserDataFieldTransactionAliasLineItem].[DispatchField],[dbo].[tblUserDataFieldTransactionAliasLineItem].[ClearOnNew],[dbo].[tblUserDataFieldTransactionAliasLineItem].[ReadOnly],[dbo].[tblUserDataFieldTransactionAliasLineItem].[Visibility],[dbo].[tblUserDataFieldTransactionAliasLineItem].[DefaultValue],sync.udf_GetMaxRowVersion(CT.InsertedRowVersion,MAPCT.InsertedRowVersion,NULL) AS '_RowVersion'
                FROM [dbo].[tblUserDataFieldTransactionAliasLineItem]
                    INNER JOIN (SELECT [UserDataFieldTransactionAliasLineItemGuid],[TransactionAliasToSiteGuid],[UserGroupToSiteGuid],[OwnerSiteGuid] FROM [dbo].[udf_GetAssignedUserDataFieldTransactionAliasLineItemListForSite](@sync_context_site_guid)) data
                        ON [dbo].[tblUserDataFieldTransactionAliasLineItem].[UserDataFieldTransactionAliasLineItemGuid] = data.[UserDataFieldTransactionAliasLineItemGuid]
                    INNER JOIN [track].[tblUserDataFieldTransactionAliasLineItem] CT
                        ON CT.PK_UserDataFieldTransactionAliasLineItemGuid = [dbo].[tblUserDataFieldTransactionAliasLineItem].[UserDataFieldTransactionAliasLineItemGuid] 
