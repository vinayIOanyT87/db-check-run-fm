...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblOpcUaServer]
...
@sync_first_time_sync_option_tblOpcUaServer int
AS
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblOpcUaServer IS NOT NULL AND @sync_first_time_sync_option_tblOpcUaServer = 1))
    ...
    SELECT TOP(@sync_batch_size_tblOpcUaServer) WITH TIES [dbo].[tblOpcUaServer].[OpcUaServerGuid],[dbo].[tblOpcUaServer].[ServerEndPoint],[dbo].[tblOpcUaServer].[SecurityMode],[dbo].[tblOpcUaServer].[SecurityPolicy],[dbo].[tblOpcUaServer].[MessageEncoding],[dbo].[tblOpcUaServer].[UserIdentityMethod],[dbo].[tblOpcUaServer].[UserId],[dbo].[tblOpcUaServer].[UserPassword],[dbo].[tblOpcUaServer].[UserCertificatePath],[dbo].[tblOpcUaServer].[SiteGuid],[dbo].[tblOpcUaServer].[CreatedDate],[dbo].[tblOpcUaServer].[CreatedBy],[dbo].[tblOpcUaServer].[UpdatedDate],[dbo].[tblOpcUaServer].[UpdatedBy],CT.InsertedRowVersion AS '_RowVersion'
        FROM [dbo].[tblOpcUaServer]
