...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblProductToUnavailableInventoryCompany]
...
@sync_batch_size_tblProductToUnavailableInventoryCompany int,
@sync_bypass_insert_update_extraction bit,
@sync_request_type int,
@sync_first_time_sync_option_tblProductToUnavailableInventoryCompany int
AS
BEGIN
    ...
    IF (@sync_batch_size_tblProductToUnavailableInventoryCompany IS NULL OR 
        (@sync_batch_size_tblProductToUnavailableInventoryCompany IS NOT NULL AND @sync_batch_size_tblProductToUnavailableInventoryCompany = 0))
    BEGIN
        SET @sync_batch_size_tblProductToUnavailableInventoryCompany = 2147483647;
    END

    -- Get a list of the Owned/Assigned Entities and locate any newly inserted entities
    -- and/or any new entity site assignments (if assignable).
        SELECT TOP(@sync_batch_size_tblProductToUnavailableInventoryCompany) WITH TIES [ProductToUnavailableInventoryCompanyGuid],[ProductGuid],[AssignedToCompanyGuid],[Sequence],[BlendPercentage],[AdditiveRate],[Ratio],[AdditiveCycleVolume],[Tolerance],[PresetNumber],[AdditiveProfileGuid],[TankGuid],[MeterID],[ShipToProductID],[ShipToProductCode],[ShipToLoadRackDisplayText],[UnavailableInventoryGross],[UnavailableInventoryNet],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy],_RowVersion
        FROM (
            SELECT TOP(@sync_batch_size_tblProductToUnavailableInventoryCompany) WITH TIES [map].[tblProductToUnavailableInventoryCompany].[ProductToUnavailableInventoryCompanyGuid],[map].[tblProductToUnavailableInventoryCompany].[ProductGuid],[map].[tblProductToUnavailableInventoryCompany].[AssignedToCompanyGuid],[map].[tblProductToUnavailableInventoryCompany].[Sequence],[map].[tblProductToUnavailableInventoryCompany].[BlendPercentage],[map].[tblProductToUnavailableInventoryCompany].[AdditiveRate],[map].[tblProductToUnavailableInventoryCompany].[Ratio],[map].[tblProductToUnavailableInventoryCompany].[AdditiveCycleVolume],[map].[tblProductToUnavailableInventoryCompany].[Tolerance],[map].[tblProductToUnavailableInventoryCompany].[PresetNumber],[map].[tblProductToUnavailableInventoryCompany].[AdditiveProfileGuid],[map].[tblProductToUnavailableInventoryCompany].[TankGuid],[map].[tblProductToUnavailableInventoryCompany].[MeterID],[map].[tblProductToUnavailableInventoryCompany].[ShipToProductID],[map].[tblProductToUnavailableInventoryCompany].[ShipToProductCode],[map].[tblProductToUnavailableInventoryCompany].[ShipToLoadRackDisplayText],[map].[tblProductToUnavailableInventoryCompany].[UnavailableInventoryGross],[map].[tblProductToUnavailableInventoryCompany].[UnavailableInventoryNet],[map].[tblProductToUnavailableInventoryCompany].[CreatedDate],[map].[tblProductToUnavailableInventoryCompany].[CreatedBy],[map].[tblProductToUnavailableInventoryCompany].[UpdatedDate],[map].[tblProductToUnavailableInventoryCompany].[UpdatedBy],sync.udf_GetMaxRowVersion(CT.InsertedRowVersion,MAPCT.InsertedRowVersion,MAPCT2.InsertedRowVersion) AS '_RowVersion'
                FROM [map].[tblProductToUnavailableInventoryCompany]
                    INNER JOIN (SELECT [ProductToSiteGuid],[ProductGuid],[OwnerSiteGuid],[AssignedToSiteGuid] FROM [dbo].[udf_GetAssignedProductListForSite](@sync_context_site_guid)) data
                        ON [map].[tblProductToUnavailableInventoryCompany].[ProductGuid] = data.[ProductGuid]
                    INNER JOIN (SELECT [CompanyToSiteGuid],[CompanyGuid],[OwnerSiteGuid],[AssignedToSiteGuid] FROM [dbo].[udf_GetAssignedCompanyListForSite](@sync_context_site_guid)) data1
                        ON [map].[tblProductToUnavailableInventoryCompany].[AssignedToCompanyGuid] = data1.[CompanyGuid]
