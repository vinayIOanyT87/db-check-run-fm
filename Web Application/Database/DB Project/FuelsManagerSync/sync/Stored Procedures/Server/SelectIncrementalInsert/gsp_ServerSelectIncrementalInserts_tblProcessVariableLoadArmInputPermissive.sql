...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblProcessVariableLoadArmInputPermissive]
...
@sync_batch_size_tblProcessVariableLoadArmInputPermissive int,
@sync_bypass_insert_update_extraction bit,
@sync_request_type int,
@sync_first_time_sync_option_tblProcessVariableLoadArmInputPermissive int
AS
BEGIN
    ...
    IF (@sync_batch_size_tblProcessVariableLoadArmInputPermissive IS NULL OR 
        (@sync_batch_size_tblProcessVariableLoadArmInputPermissive IS NOT NULL AND @sync_batch_size_tblProcessVariableLoadArmInputPermissive = 0))
    BEGIN
        SET @sync_batch_size_tblProcessVariableLoadArmInputPermissive = 2147483647;
    END
    ...
    SELECT TOP(@sync_batch_size_tblProcessVariableLoadArmInputPermissive) WITH TIES [dbo].[tblProcessVariableLoadArmInputPermissive].[ProcessVariableLoadArmGuid],[dbo].[tblProcessVariableLoadArmInputPermissive].[LookupProcessVariableTypeIndex],[dbo].[tblProcessVariableLoadArmInputPermissive].[InstanceNumber],[dbo].[tblProcessVariableLoadArmInputPermissive].[LoadArmGuid],[dbo].[tblProcessVariableLoadArmInputPermissive].[OPCConnectionGuid],[dbo].[tblProcessVariableLoadArmInputPermissive].[OPCItemID],[dbo].[tblProcessVariableLoadArmInputPermissive].[DataType],[dbo].[tblProcessVariableLoadArmInputPermissive].[ServerEngineeringUnitsIndex],[dbo].[tblProcessVariableLoadArmInputPermissive].[Quality],[dbo].[tblProcessVariableLoadArmInputPermissive].[SIValue],[dbo].[tblProcessVariableLoadArmInputPermissive].[LookupSIValueVariantTypeIndex],[dbo].[tblProcessVariableLoadArmInputPermissive].[DateTimeStamp],[dbo].[tblProcessVariableLoadArmInputPermissive].[Maximum],[dbo].[tblProcessVariableLoadArmInputPermissive].[LookupMaximumVariantTypeIndex],[dbo].[tblProcessVariableLoadArmInputPermissive].[Minimum],[dbo].[tblProcessVariableLoadArmInputPermissive].[LookupMinimumVariantTypeIndex],[dbo].[tblProcessVariableLoadArmInputPermissive].[DataTypeEnabled],[dbo].[tblProcessVariableLoadArmInputPermissive].[Input],[dbo].[tblProcessVariableLoadArmInputPermissive].[InputEnabled],[dbo].[tblProcessVariableLoadArmInputPermissive].[MessageApplicationStringGuid],[dbo].[tblProcessVariableLoadArmInputPermissive].[CreatedDate],[dbo].[tblProcessVariableLoadArmInputPermissive].[CreatedBy],[dbo].[tblProcessVariableLoadArmInputPermissive].[UpdatedDate],[dbo].[tblProcessVariableLoadArmInputPermissive].[UpdatedBy], CT.InsertedRowVersion AS '_RowVersion'
        FROM [dbo].[tblProcessVariableLoadArmInputPermissive]
            INNER JOIN (SELECT [LoadArmGuid],[BayAStationGuid],[BayBStationGuid],[OwnerSiteGuid],[CreatedDate],[UpdatedDate] FROM [dbo].[udf_GetAssociatedLoadArmListForSite](@sync_context_site_guid)) data
                ON [dbo].[tblProcessVariableLoadArmInputPermissive].[LoadArmGuid] = data.[LoadArmGuid]
