...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblAppointmentTank]
...
@sync_first_time_sync_option_tblAppointmentTank int
AS
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblAppointmentTank IS NOT NULL AND @sync_first_time_sync_option_tblAppointmentTank = 1))
