...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblUserDataListValueProduct]
...
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblUserDataListValueProduct IS NOT NULL AND @sync_first_time_sync_option_tblUserDataListValueProduct = 1))
