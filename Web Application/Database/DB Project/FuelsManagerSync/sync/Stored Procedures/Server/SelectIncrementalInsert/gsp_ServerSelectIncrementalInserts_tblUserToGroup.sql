...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblUserToGroup]
...
@sync_first_time_sync_option_tblUserToGroup int
AS
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblUserToGroup IS NOT NULL AND @sync_first_time_sync_option_tblUserToGroup = 1))
