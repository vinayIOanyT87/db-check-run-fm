...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblPointAccessGroupToPointAlarmTest]
...
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblPointAccessGroupToPointAlarmTest IS NOT NULL AND @sync_first_time_sync_option_tblPointAccessGroupToPointAlarmTest = 1))
	...
	BEGIN
		...
		WHERE ((CT.InsertedRowVersion IS NOT NULL)
				...
				AND (CT.InsertedContext IS NULL OR CT.DeletedContext <> @sync_client_id_binary))     -- USE THE CLIENT ID HERE SO WE DO NOT RETURN WHAT WAS JUST RECEIVED
