...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblProductToPresetFlowControlledAdditive]
...
@sync_batch_size_tblProductToPresetFlowControlledAdditive int,
@sync_bypass_insert_update_extraction bit,
@sync_request_type int,
@sync_first_time_sync_option_tblProductToPresetFlowControlledAdditive int
AS
BEGIN
    ...
    IF (@sync_batch_size_tblProductToPresetFlowControlledAdditive IS NULL OR 
        (@sync_batch_size_tblProductToPresetFlowControlledAdditive IS NOT NULL AND @sync_batch_size_tblProductToPresetFlowControlledAdditive = 0))
    BEGIN
        SET @sync_batch_size_tblProductToPresetFlowControlledAdditive = 2147483647;
    END

    -- Get a list of the Owned/Assigned Entities and locate any newly inserted entities
    -- and/or any new entity site assignments (if assignable).
        SELECT TOP(@sync_batch_size_tblProductToPresetFlowControlledAdditive) WITH TIES [ProductToPresetFlowControlledAdditiveGuid],[ProductGuid],[AssignedToLoadArmGuid],[Sequence],[BlendPercentage],[AdditiveRate],[Ratio],[AdditiveCycleVolume],[Tolerance],[PresetNumber],[AdditiveProfileGuid],[TankGuid],[MeterID],[ShipToProductID],[ShipToProductCode],[ShipToLoadRackDisplayText],[UnavailableInventoryGross],[UnavailableInventoryNet],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy],[AssignedToMeterGuid],_RowVersion
        FROM (
            SELECT TOP(@sync_batch_size_tblProductToPresetFlowControlledAdditive) WITH TIES [map].[tblProductToPresetFlowControlledAdditive].[ProductToPresetFlowControlledAdditiveGuid],[map].[tblProductToPresetFlowControlledAdditive].[ProductGuid],[map].[tblProductToPresetFlowControlledAdditive].[AssignedToLoadArmGuid],[map].[tblProductToPresetFlowControlledAdditive].[Sequence],[map].[tblProductToPresetFlowControlledAdditive].[BlendPercentage],[map].[tblProductToPresetFlowControlledAdditive].[AdditiveRate],[map].[tblProductToPresetFlowControlledAdditive].[Ratio],[map].[tblProductToPresetFlowControlledAdditive].[AdditiveCycleVolume],[map].[tblProductToPresetFlowControlledAdditive].[Tolerance],[map].[tblProductToPresetFlowControlledAdditive].[PresetNumber],[map].[tblProductToPresetFlowControlledAdditive].[AdditiveProfileGuid],[map].[tblProductToPresetFlowControlledAdditive].[TankGuid],[map].[tblProductToPresetFlowControlledAdditive].[MeterID],[map].[tblProductToPresetFlowControlledAdditive].[ShipToProductID],[map].[tblProductToPresetFlowControlledAdditive].[ShipToProductCode],[map].[tblProductToPresetFlowControlledAdditive].[ShipToLoadRackDisplayText],[map].[tblProductToPresetFlowControlledAdditive].[UnavailableInventoryGross],[map].[tblProductToPresetFlowControlledAdditive].[UnavailableInventoryNet],[map].[tblProductToPresetFlowControlledAdditive].[CreatedDate],[map].[tblProductToPresetFlowControlledAdditive].[CreatedBy],[map].[tblProductToPresetFlowControlledAdditive].[UpdatedDate],[map].[tblProductToPresetFlowControlledAdditive].[UpdatedBy],[map].[tblProductToPresetFlowControlledAdditive].[AssignedToMeterGuid],sync.udf_GetMaxRowVersion(CT.InsertedRowVersion,MAPCT.InsertedRowVersion,MAPCT2.InsertedRowVersion) AS '_RowVersion'
                FROM [map].[tblProductToPresetFlowControlledAdditive]
                    INNER JOIN (SELECT [ProductToSiteGuid],[ProductGuid],[OwnerSiteGuid],[AssignedToSiteGuid] FROM [dbo].[udf_GetAssignedProductListForSite](@sync_context_site_guid)) data
                        ON [map].[tblProductToPresetFlowControlledAdditive].[ProductGuid] = data.[ProductGuid]
                    INNER JOIN (SELECT [LoadArmGuid],[BayAStationGuid],[BayBStationGuid],[OwnerSiteGuid],[CreatedDate],[UpdatedDate] FROM [dbo].[udf_GetAssociatedLoadArmListForSite](@sync_context_site_guid)) data1
                        ON [map].[tblProductToPresetFlowControlledAdditive].[AssignedToLoadArmGuid] = data1.[LoadArmGuid]
