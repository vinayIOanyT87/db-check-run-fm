...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblProcessVariableExternalComponentInputPermissive]
...
@sync_first_time_sync_option_tblProcessVariableExternalComponentInputPermissive int
AS
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblProcessVariableExternalComponentInputPermissive IS NOT NULL AND @sync_first_time_sync_option_tblProcessVariableExternalComponentInputPermissive = 1))
