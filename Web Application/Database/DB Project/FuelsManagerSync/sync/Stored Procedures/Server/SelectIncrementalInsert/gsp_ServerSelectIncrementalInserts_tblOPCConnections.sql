...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblOPCConnections]
...
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblOPCConnections IS NOT NULL AND @sync_first_time_sync_option_tblOPCConnections = 1))
