...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblUserDataListValueSite]
...
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblUserDataListValueSite IS NOT NULL AND @sync_first_time_sync_option_tblUserDataListValueSite = 1))
