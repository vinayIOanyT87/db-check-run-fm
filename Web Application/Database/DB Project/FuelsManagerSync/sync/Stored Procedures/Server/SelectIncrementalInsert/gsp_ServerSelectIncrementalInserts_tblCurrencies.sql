...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblCurrencies]
...
@sync_first_time_sync_option_tblCurrencies int
AS
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblCurrencies IS NOT NULL AND @sync_first_time_sync_option_tblCurrencies = 1))
    ...
    SELECT TOP(@sync_batch_size_tblCurrencies) WITH TIES [dbo].[tblCurrencies].[Country],[dbo].[tblCurrencies].[UnitDisplayName],[dbo].[tblCurrencies].[DisplayFlag],[dbo].[tblCurrencies].[CreatedBy],[dbo].[tblCurrencies].[CreatedDate],[dbo].[tblCurrencies].[UpdatedBy],[dbo].[tblCurrencies].[UpdatedDate],[dbo].[tblCurrencies].[CurrencyGuid],[dbo].[tblCurrencies].[SiteGuid],[dbo].[tblCurrencies].[LookupCurrencyUnitIndex],CT.InsertedRowVersion AS '_RowVersion'
        FROM [dbo].[tblCurrencies]
