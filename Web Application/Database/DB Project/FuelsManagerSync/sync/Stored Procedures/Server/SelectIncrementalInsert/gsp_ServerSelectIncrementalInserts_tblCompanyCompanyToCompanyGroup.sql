...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblCompanyCompanyToCompanyGroup]
...
@sync_first_time_sync_option_tblCompanyCompanyToCompanyGroup int
AS
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblCompanyCompanyToCompanyGroup IS NOT NULL AND @sync_first_time_sync_option_tblCompanyCompanyToCompanyGroup = 1))
