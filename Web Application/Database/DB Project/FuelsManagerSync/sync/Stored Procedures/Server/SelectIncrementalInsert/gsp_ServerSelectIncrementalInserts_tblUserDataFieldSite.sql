...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblUserDataFieldSite]
...
@sync_batch_size_tblUserDataFieldSite int,
@sync_bypass_insert_update_extraction bit,
@sync_request_type int,
@sync_first_time_sync_option_tblUserDataFieldSite int
AS
BEGIN
    ...
    IF (@sync_batch_size_tblUserDataFieldSite IS NULL OR 
        (@sync_batch_size_tblUserDataFieldSite IS NOT NULL AND @sync_batch_size_tblUserDataFieldSite = 0))
    BEGIN
        SET @sync_batch_size_tblUserDataFieldSite = 2147483647;
    END

    -- Get a list of the Owned/Assigned Entities and locate any newly inserted entities
    -- and/or any new entity site assignments (if assignable).
    SELECT TOP(@sync_batch_size_tblUserDataFieldSite) WITH TIES [UserDataFieldSiteGuid],[TransactionAliasGuid],[SiteGuid],[Number],[DisplayOrder],[DisplayName],[LookupUserDataTypeIndex],[Required],[UserGroupGuid],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy],[DispatchField],[ClearOnNew],[ReadOnly],[Visibility],[DefaultValue],_RowVersion
    FROM (
        SELECT [UserDataFieldSiteGuid],[TransactionAliasGuid],[SiteGuid],[Number],[DisplayOrder],[DisplayName],[LookupUserDataTypeIndex],[Required],[UserGroupGuid],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy],[DispatchField],[ClearOnNew],[ReadOnly],[Visibility],[DefaultValue],_RowVersion
        FROM (
            SELECT TOP(@sync_batch_size_tblUserDataFieldSite) WITH TIES [dbo].[tblUserDataFieldSite].[UserDataFieldSiteGuid],[dbo].[tblUserDataFieldSite].[TransactionAliasGuid],[dbo].[tblUserDataFieldSite].[SiteGuid],[dbo].[tblUserDataFieldSite].[Number],[dbo].[tblUserDataFieldSite].[DisplayOrder],[dbo].[tblUserDataFieldSite].[DisplayName],[dbo].[tblUserDataFieldSite].[LookupUserDataTypeIndex],[dbo].[tblUserDataFieldSite].[Required],[dbo].[tblUserDataFieldSite].[UserGroupGuid],[dbo].[tblUserDataFieldSite].[CreatedDate],[dbo].[tblUserDataFieldSite].[CreatedBy],[dbo].[tblUserDataFieldSite].[UpdatedDate],[dbo].[tblUserDataFieldSite].[UpdatedBy],[dbo].[tblUserDataFieldSite].[DispatchField],[dbo].[tblUserDataFieldSite].[ClearOnNew],[dbo].[tblUserDataFieldSite].[ReadOnly],[dbo].[tblUserDataFieldSite].[Visibility],[dbo].[tblUserDataFieldSite].[DefaultValue],CT.InsertedRowVersion AS '_RowVersion'
                FROM [dbo].[tblUserDataFieldSite]
                    INNER JOIN [track].[tblUserDataFieldSite] CT
                        ON CT.PK_UserDataFieldSiteGuid = [dbo].[tblUserDataFieldSite].[UserDataFieldSiteGuid] 
                WHERE ( [dbo].[tblUserDataFieldSite].[SiteGuid] = @sync_context_site_guid )
            ...
            SELECT TOP(@sync_batch_size_tblUserDataFieldSite) WITH TIES [dbo].[tblUserDataFieldSite].[UserDataFieldSiteGuid],[dbo].[tblUserDataFieldSite].[TransactionAliasGuid],[dbo].[tblUserDataFieldSite].[SiteGuid],[dbo].[tblUserDataFieldSite].[Number],[dbo].[tblUserDataFieldSite].[DisplayOrder],[dbo].[tblUserDataFieldSite].[DisplayName],[dbo].[tblUserDataFieldSite].[LookupUserDataTypeIndex],[dbo].[tblUserDataFieldSite].[Required],[dbo].[tblUserDataFieldSite].[UserGroupGuid],[dbo].[tblUserDataFieldSite].[CreatedDate],[dbo].[tblUserDataFieldSite].[CreatedBy],[dbo].[tblUserDataFieldSite].[UpdatedDate],[dbo].[tblUserDataFieldSite].[UpdatedBy],[dbo].[tblUserDataFieldSite].[DispatchField],[dbo].[tblUserDataFieldSite].[ClearOnNew],[dbo].[tblUserDataFieldSite].[ReadOnly],[dbo].[tblUserDataFieldSite].[Visibility],[dbo].[tblUserDataFieldSite].[DefaultValue],sync.udf_GetMaxRowVersion(CT.InsertedRowVersion,MAPCT.InsertedRowVersion,NULL) AS '_RowVersion'
                FROM [dbo].[tblUserDataFieldSite]
                    INNER JOIN (SELECT [UserDataToSiteGuid],[UserDataFieldSiteGuid],[OwnerSiteGuid],[AssignedToSiteGuid] FROM [dbo].[udf_GetAssignedUserDataFieldSiteListForSite](@sync_context_site_guid)) data
                        ON [dbo].[tblUserDataFieldSite].[UserDataFieldSiteGuid] = data.[UserDataFieldSiteGuid]
                    INNER JOIN [track].[tblUserDataFieldSite] CT
                        ON CT.PK_UserDataFieldSiteGuid = [dbo].[tblUserDataFieldSite].[UserDataFieldSiteGuid] 
