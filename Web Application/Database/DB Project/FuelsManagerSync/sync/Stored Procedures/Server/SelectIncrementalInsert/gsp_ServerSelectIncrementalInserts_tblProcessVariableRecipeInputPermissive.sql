...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblProcessVariableRecipeInputPermissive]
...
@sync_batch_size_tblProcessVariableRecipeInputPermissive int,
@sync_bypass_insert_update_extraction bit,
@sync_request_type int,
@sync_first_time_sync_option_tblProcessVariableRecipeInputPermissive int
AS
BEGIN
    ...
    IF (@sync_batch_size_tblProcessVariableRecipeInputPermissive IS NULL OR 
        (@sync_batch_size_tblProcessVariableRecipeInputPermissive IS NOT NULL AND @sync_batch_size_tblProcessVariableRecipeInputPermissive = 0))
    BEGIN
        SET @sync_batch_size_tblProcessVariableRecipeInputPermissive = 2147483647;
    END
    ...
    SELECT TOP(@sync_batch_size_tblProcessVariableRecipeInputPermissive) WITH TIES [dbo].[tblProcessVariableRecipeInputPermissive].[ProcessVariableProductToPresetRecipeGuid],[dbo].[tblProcessVariableRecipeInputPermissive].[LookupProcessVariableTypeIndex],[dbo].[tblProcessVariableRecipeInputPermissive].[InstanceNumber],[dbo].[tblProcessVariableRecipeInputPermissive].[ProductToPresetRecipeGuid],[dbo].[tblProcessVariableRecipeInputPermissive].[OPCConnectionGuid],[dbo].[tblProcessVariableRecipeInputPermissive].[OPCItemID],[dbo].[tblProcessVariableRecipeInputPermissive].[DataType],[dbo].[tblProcessVariableRecipeInputPermissive].[ServerEngineeringUnitsIndex],[dbo].[tblProcessVariableRecipeInputPermissive].[Quality],[dbo].[tblProcessVariableRecipeInputPermissive].[SIValue],[dbo].[tblProcessVariableRecipeInputPermissive].[LookupSIValueVariantTypeIndex],[dbo].[tblProcessVariableRecipeInputPermissive].[DateTimeStamp],[dbo].[tblProcessVariableRecipeInputPermissive].[Maximum],[dbo].[tblProcessVariableRecipeInputPermissive].[LookupMaximumVariantTypeIndex],[dbo].[tblProcessVariableRecipeInputPermissive].[Minimum],[dbo].[tblProcessVariableRecipeInputPermissive].[LookupMinimumVariantTypeIndex],[dbo].[tblProcessVariableRecipeInputPermissive].[DataTypeEnabled],[dbo].[tblProcessVariableRecipeInputPermissive].[Input],[dbo].[tblProcessVariableRecipeInputPermissive].[InputEnabled],[dbo].[tblProcessVariableRecipeInputPermissive].[MessageApplicationStringGuid],[dbo].[tblProcessVariableRecipeInputPermissive].[CreatedDate],[dbo].[tblProcessVariableRecipeInputPermissive].[CreatedBy],[dbo].[tblProcessVariableRecipeInputPermissive].[UpdatedDate],[dbo].[tblProcessVariableRecipeInputPermissive].[UpdatedBy], sync.udf_GetMaxRowVersion(CT.InsertedRowVersion,MAPCT.InsertedRowVersion, NULL) AS '_RowVersion' 
        FROM [dbo].[tblProcessVariableRecipeInputPermissive]
            INNER JOIN (SELECT [ProductToPresetRecipeGuid],[ProductGuid],[AssignedToLoadArmGuid],[OwnerSiteGuid] FROM ProductToPresetRecipe_CTE) data
                ON [dbo].[tblProcessVariableRecipeInputPermissive].[ProductToPresetRecipeGuid] = data.[ProductToPresetRecipeGuid]
