...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblPersonnel]
...
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblPersonnel IS NOT NULL AND @sync_first_time_sync_option_tblPersonnel = 1))
