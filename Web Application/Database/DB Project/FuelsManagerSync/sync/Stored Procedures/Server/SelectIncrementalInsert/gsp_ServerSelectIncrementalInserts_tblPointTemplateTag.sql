...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblPointTemplateTag]
...
@sync_first_time_sync_option_tblPointTemplateTag int
AS
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblPointTemplateTag IS NOT NULL AND @sync_first_time_sync_option_tblPointTemplateTag = 1))
