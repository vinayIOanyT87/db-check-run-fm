...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblProcessVariableEquipment]
...
@sync_first_time_sync_option_tblProcessVariableEquipment int
AS
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblProcessVariableEquipment IS NOT NULL AND @sync_first_time_sync_option_tblProcessVariableEquipment = 1))
