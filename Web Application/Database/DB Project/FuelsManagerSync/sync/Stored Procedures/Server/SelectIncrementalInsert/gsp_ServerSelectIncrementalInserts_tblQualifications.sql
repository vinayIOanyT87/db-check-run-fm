...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblQualifications]
...
@sync_first_time_sync_option_tblQualifications int
AS
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblQualifications IS NOT NULL AND @sync_first_time_sync_option_tblQualifications = 1))
