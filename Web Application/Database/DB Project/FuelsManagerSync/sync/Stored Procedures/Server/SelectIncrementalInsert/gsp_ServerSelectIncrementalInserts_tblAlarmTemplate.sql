...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblAlarmTemplate]
...
@sync_first_time_sync_option_tblAlarmTemplate int
AS
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblAlarmTemplate IS NOT NULL AND @sync_first_time_sync_option_tblAlarmTemplate = 1))
