...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblQualificationCompanyCertificateAndPermitToCompany]
...
@sync_first_time_sync_option_tblQualificationCompanyCertificateAndPermitToCompany int
AS
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblQualificationCompanyCertificateAndPermitToCompany IS NOT NULL AND @sync_first_time_sync_option_tblQualificationCompanyCertificateAndPermitToCompany = 1))
