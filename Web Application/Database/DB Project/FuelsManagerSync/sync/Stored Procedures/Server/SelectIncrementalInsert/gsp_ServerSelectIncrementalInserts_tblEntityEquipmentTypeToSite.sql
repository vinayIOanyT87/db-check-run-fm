...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblEntityEquipmentTypeToSite]
...
@sync_first_time_sync_option_tblEntityEquipmentTypeToSite int
AS
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblEntityEquipmentTypeToSite IS NOT NULL AND @sync_first_time_sync_option_tblEntityEquipmentTypeToSite = 1))
    ...
    SELECT TOP(@sync_batch_size_tblEntityEquipmentTypeToSite) WITH TIES [map].[tblEntityEquipmentTypeToSite].[EquipmentTypeToSiteGuid],[map].[tblEntityEquipmentTypeToSite].[EquipmentTypeGuid],[map].[tblEntityEquipmentTypeToSite].[SiteGuid],[map].[tblEntityEquipmentTypeToSite].[CreatedDate],[map].[tblEntityEquipmentTypeToSite].[CreatedBy],[map].[tblEntityEquipmentTypeToSite].[UpdatedDate],[map].[tblEntityEquipmentTypeToSite].[UpdatedBy],[map].[tblEntityEquipmentTypeToSite].[AssignedFromSiteGuid],CT.InsertedRowVersion AS '_RowVersion'
        FROM [map].[tblEntityEquipmentTypeToSite]
