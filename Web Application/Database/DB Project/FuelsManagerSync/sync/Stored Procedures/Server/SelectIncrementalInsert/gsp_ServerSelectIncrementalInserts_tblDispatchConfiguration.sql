...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblDispatchConfiguration]
...
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblDispatchConfiguration IS NOT NULL AND @sync_first_time_sync_option_tblDispatchConfiguration = 1))
