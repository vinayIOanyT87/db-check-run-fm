...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblAlarmPriorities]
...
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblAlarmPriorities IS NOT NULL AND @sync_first_time_sync_option_tblAlarmPriorities = 1))
