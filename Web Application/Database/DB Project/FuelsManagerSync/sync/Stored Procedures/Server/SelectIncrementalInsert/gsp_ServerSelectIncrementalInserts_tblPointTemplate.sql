...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblPointTemplate]
...
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblPointTemplate IS NOT NULL AND @sync_first_time_sync_option_tblPointTemplate = 1))
