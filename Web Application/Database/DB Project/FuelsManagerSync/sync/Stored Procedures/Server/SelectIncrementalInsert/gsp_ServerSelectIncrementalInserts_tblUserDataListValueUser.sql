...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblUserDataListValueUser]
...
@sync_batch_size_tblUserDataListValueUser int,
@sync_bypass_insert_update_extraction bit,
@sync_request_type int,
@sync_first_time_sync_option_tblUserDataListValueUser int
AS
BEGIN
    ...
    IF (@sync_batch_size_tblUserDataListValueUser IS NULL OR 
        (@sync_batch_size_tblUserDataListValueUser IS NOT NULL AND @sync_batch_size_tblUserDataListValueUser = 0))
    BEGIN
        SET @sync_batch_size_tblUserDataListValueUser = 2147483647;
    END

    -- Get a list of the Owned/Assigned Entities and locate any newly inserted entities
    -- and/or any new entity site assignments (if assignable).
    SELECT TOP(@sync_batch_size_tblUserDataListValueUser) WITH TIES [UserDataListValueUserGuid],[UserDataFieldUserGuid],[Value],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy],_RowVersion
    FROM (
        SELECT [UserDataListValueUserGuid],[UserDataFieldUserGuid],[Value],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy],_RowVersion
        FROM (
            SELECT TOP(@sync_batch_size_tblUserDataListValueUser) WITH TIES [dbo].[tblUserDataListValueUser].[UserDataListValueUserGuid],[dbo].[tblUserDataListValueUser].[UserDataFieldUserGuid],[dbo].[tblUserDataListValueUser].[Value],[dbo].[tblUserDataListValueUser].[CreatedDate],[dbo].[tblUserDataListValueUser].[CreatedBy],[dbo].[tblUserDataListValueUser].[UpdatedDate],[dbo].[tblUserDataListValueUser].[UpdatedBy],CT.InsertedRowVersion AS '_RowVersion'
                FROM [dbo].[tblUserDataListValueUser]
                    INNER JOIN [dbo].[tblUserDataFieldUser] data
                        ON [dbo].[tblUserDataListValueUser].[UserDataFieldUserGuid] = data.[UserDataFieldUserGuid]
        ...
        FROM (
            SELECT TOP(@sync_batch_size_tblUserDataListValueUser) WITH TIES [dbo].[tblUserDataListValueUser].[UserDataListValueUserGuid],[dbo].[tblUserDataListValueUser].[UserDataFieldUserGuid],[dbo].[tblUserDataListValueUser].[Value],[dbo].[tblUserDataListValueUser].[CreatedDate],[dbo].[tblUserDataListValueUser].[CreatedBy],[dbo].[tblUserDataListValueUser].[UpdatedDate],[dbo].[tblUserDataListValueUser].[UpdatedBy],sync.udf_GetMaxRowVersion(CT.InsertedRowVersion,MAPCT.InsertedRowVersion,MAPCT2.InsertedRowVersion) AS '_RowVersion'
                FROM [dbo].[tblUserDataListValueUser]
                    ...
                    INNER JOIN [track].[tblUserDataFieldUser] MAPCT2
                        ON MAPCT2.PK_UserDataFieldUserGuid = data.[UserDataFieldUserGuid]
