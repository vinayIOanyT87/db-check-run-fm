...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblQualificationEquipmentTagAndLicenseToEquipment]
...
@sync_batch_size_tblQualificationEquipmentTagAndLicenseToEquipment int,
@sync_bypass_insert_update_extraction bit,
@sync_request_type int,
@sync_first_time_sync_option_tblQualificationEquipmentTagAndLicenseToEquipment int
AS
BEGIN
    ...
    IF (@sync_batch_size_tblQualificationEquipmentTagAndLicenseToEquipment IS NULL OR 
        (@sync_batch_size_tblQualificationEquipmentTagAndLicenseToEquipment IS NOT NULL AND @sync_batch_size_tblQualificationEquipmentTagAndLicenseToEquipment = 0))
    BEGIN
        SET @sync_batch_size_tblQualificationEquipmentTagAndLicenseToEquipment = 2147483647;
    END

    -- Get a list of the Owned/Assigned Entities and locate any newly inserted entities
    -- and/or any new entity site assignments (if assignable).
        SELECT TOP(@sync_batch_size_tblQualificationEquipmentTagAndLicenseToEquipment) WITH TIES [QualificationEquipmentTagAndLicenseToEquipmentGuid],[QualificationGuid],[EquipmentGuid],[Sequence],[Instructor],[DateCompleted],[DateDue],[ExpirationDate],[ID],[Rating],[HistoricalRecord],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy],_RowVersion
        FROM (
            SELECT TOP(@sync_batch_size_tblQualificationEquipmentTagAndLicenseToEquipment) WITH TIES [map].[tblQualificationEquipmentTagAndLicenseToEquipment].[QualificationEquipmentTagAndLicenseToEquipmentGuid],[map].[tblQualificationEquipmentTagAndLicenseToEquipment].[QualificationGuid],[map].[tblQualificationEquipmentTagAndLicenseToEquipment].[EquipmentGuid],[map].[tblQualificationEquipmentTagAndLicenseToEquipment].[Sequence],[map].[tblQualificationEquipmentTagAndLicenseToEquipment].[Instructor],[map].[tblQualificationEquipmentTagAndLicenseToEquipment].[DateCompleted],[map].[tblQualificationEquipmentTagAndLicenseToEquipment].[DateDue],[map].[tblQualificationEquipmentTagAndLicenseToEquipment].[ExpirationDate],[map].[tblQualificationEquipmentTagAndLicenseToEquipment].[ID],[map].[tblQualificationEquipmentTagAndLicenseToEquipment].[Rating],[map].[tblQualificationEquipmentTagAndLicenseToEquipment].[HistoricalRecord],[map].[tblQualificationEquipmentTagAndLicenseToEquipment].[CreatedDate],[map].[tblQualificationEquipmentTagAndLicenseToEquipment].[CreatedBy],[map].[tblQualificationEquipmentTagAndLicenseToEquipment].[UpdatedDate],[map].[tblQualificationEquipmentTagAndLicenseToEquipment].[UpdatedBy],sync.udf_GetMaxRowVersion(CT.InsertedRowVersion,MAPCT.InsertedRowVersion,MAPCT2.InsertedRowVersion) AS '_RowVersion'
                FROM [map].[tblQualificationEquipmentTagAndLicenseToEquipment]
                    INNER JOIN (SELECT [EquipmentTagAndLicenseToSiteGuid],[QualificationGuid],[OwnerSiteGuid],[AssignedToSiteGuid] FROM [dbo].[udf_GetAssignedQualificationEquipmentTagAndLicenseListForSite](@sync_context_site_guid)) data
                        ON [map].[tblQualificationEquipmentTagAndLicenseToEquipment].[QualificationGuid] = data.[QualificationGuid]
                    INNER JOIN (SELECT [EquipmentToSiteGuid],[EquipmentGuid],[OwnerSiteGuid],[AssignedToSiteGuid] FROM [dbo].[udf_GetAssignedEquipmentListForSite](@sync_context_site_guid)) data1
                        ON [map].[tblQualificationEquipmentTagAndLicenseToEquipment].[EquipmentGuid] = data1.[EquipmentGuid]
                    ...
                    INNER JOIN [track].[tblEntityEquipmentTagAndLicenseToSite] MAPCT
                        ON MAPCT.PK_EquipmentTagAndLicenseToSiteGuid = data.[EquipmentTagAndLicenseToSiteGuid]
