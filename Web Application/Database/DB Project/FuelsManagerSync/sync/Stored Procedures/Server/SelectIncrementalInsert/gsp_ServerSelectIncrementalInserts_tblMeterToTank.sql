...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblMeterToTank]
...
@sync_first_time_sync_option_tblMeterToTank int
AS
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblMeterToTank IS NOT NULL AND @sync_first_time_sync_option_tblMeterToTank = 1))
    ...
    SELECT TOP(@sync_batch_size_tblMeterToTank) WITH TIES [map].[tblMeterToTank].[MeterToTankGuid],[map].[tblMeterToTank].[MeterGuid],[map].[tblMeterToTank].[TankGuid],[map].[tblMeterToTank].[CreatedDate],[map].[tblMeterToTank].[CreatedBy],[map].[tblMeterToTank].[UpdatedDate],[map].[tblMeterToTank].[UpdatedBy],CT.InsertedRowVersion AS '_RowVersion'
        FROM [map].[tblMeterToTank]
