...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblMobileDeviceProfilePrinter]
...
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblMobileDeviceProfilePrinter IS NOT NULL AND @sync_first_time_sync_option_tblMobileDeviceProfilePrinter = 1))
