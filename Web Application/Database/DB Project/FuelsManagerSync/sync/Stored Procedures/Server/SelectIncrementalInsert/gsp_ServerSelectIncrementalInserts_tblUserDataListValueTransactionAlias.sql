...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblUserDataListValueTransactionAlias]
...
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblUserDataListValueTransactionAlias IS NOT NULL AND @sync_first_time_sync_option_tblUserDataListValueTransactionAlias = 1))
