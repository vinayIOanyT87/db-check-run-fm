...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblProcessVariableStation]
...
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblProcessVariableStation IS NOT NULL AND @sync_first_time_sync_option_tblProcessVariableStation = 1))
