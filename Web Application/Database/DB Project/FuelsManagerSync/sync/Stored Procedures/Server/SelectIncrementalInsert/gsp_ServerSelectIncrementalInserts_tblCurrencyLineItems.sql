...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblCurrencyLineItems]
...
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblCurrencyLineItems IS NOT NULL AND @sync_first_time_sync_option_tblCurrencyLineItems = 1))
