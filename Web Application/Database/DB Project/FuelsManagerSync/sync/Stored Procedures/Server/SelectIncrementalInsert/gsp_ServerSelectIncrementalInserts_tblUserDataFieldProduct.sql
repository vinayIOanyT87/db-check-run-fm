...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblUserDataFieldProduct]
...
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblUserDataFieldProduct IS NOT NULL AND @sync_first_time_sync_option_tblUserDataFieldProduct = 1))
