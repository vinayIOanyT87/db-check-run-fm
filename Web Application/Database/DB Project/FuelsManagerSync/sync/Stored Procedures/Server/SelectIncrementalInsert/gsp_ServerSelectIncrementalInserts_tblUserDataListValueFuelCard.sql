...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblUserDataListValueFuelCard]
...
@sync_batch_size_tblUserDataListValueFuelCard int,
@sync_bypass_insert_update_extraction bit,
@sync_request_type int,
@sync_first_time_sync_option_tblUserDataListValueFuelCard int
AS
BEGIN
    ...
    IF (@sync_batch_size_tblUserDataListValueFuelCard IS NULL OR 
        (@sync_batch_size_tblUserDataListValueFuelCard IS NOT NULL AND @sync_batch_size_tblUserDataListValueFuelCard = 0))
    BEGIN
        SET @sync_batch_size_tblUserDataListValueFuelCard = 2147483647;
    END

    -- Get a list of the Owned/Assigned Entities and locate any newly inserted entities
    -- and/or any new entity site assignments (if assignable).
    SELECT TOP(@sync_batch_size_tblUserDataListValueFuelCard) WITH TIES [UserDataListValueFuelCardGuid],[UserDataFieldFuelCardGuid],[Value],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy],_RowVersion
    FROM (
        SELECT [UserDataListValueFuelCardGuid],[UserDataFieldFuelCardGuid],[Value],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy],_RowVersion
        FROM (
            SELECT TOP(@sync_batch_size_tblUserDataListValueFuelCard) WITH TIES [dbo].[tblUserDataListValueFuelCard].[UserDataListValueFuelCardGuid],[dbo].[tblUserDataListValueFuelCard].[UserDataFieldFuelCardGuid],[dbo].[tblUserDataListValueFuelCard].[Value],[dbo].[tblUserDataListValueFuelCard].[CreatedDate],[dbo].[tblUserDataListValueFuelCard].[CreatedBy],[dbo].[tblUserDataListValueFuelCard].[UpdatedDate],[dbo].[tblUserDataListValueFuelCard].[UpdatedBy],CT.InsertedRowVersion AS '_RowVersion'
                FROM [dbo].[tblUserDataListValueFuelCard]
                    INNER JOIN [dbo].[tblUserDataFieldFuelCard] data
                        ON [dbo].[tblUserDataListValueFuelCard].[UserDataFieldFuelCardGuid] = data.[UserDataFieldFuelCardGuid]
        ...
        FROM (
            SELECT TOP(@sync_batch_size_tblUserDataListValueFuelCard) WITH TIES [dbo].[tblUserDataListValueFuelCard].[UserDataListValueFuelCardGuid],[dbo].[tblUserDataListValueFuelCard].[UserDataFieldFuelCardGuid],[dbo].[tblUserDataListValueFuelCard].[Value],[dbo].[tblUserDataListValueFuelCard].[CreatedDate],[dbo].[tblUserDataListValueFuelCard].[CreatedBy],[dbo].[tblUserDataListValueFuelCard].[UpdatedDate],[dbo].[tblUserDataListValueFuelCard].[UpdatedBy],sync.udf_GetMaxRowVersion(CT.InsertedRowVersion,MAPCT.InsertedRowVersion,MAPCT2.InsertedRowVersion) AS '_RowVersion'
                FROM [dbo].[tblUserDataListValueFuelCard]
                    ...
                    INNER JOIN [track].[tblUserDataFieldFuelCard] MAPCT2
                        ON MAPCT2.PK_UserDataFieldFuelCardGuid = data.[UserDataFieldFuelCardGuid]
