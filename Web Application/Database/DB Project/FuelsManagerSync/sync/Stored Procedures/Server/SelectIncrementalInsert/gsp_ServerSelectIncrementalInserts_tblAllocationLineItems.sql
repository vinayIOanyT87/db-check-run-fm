...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblAllocationLineItems]
...
@sync_batch_size_tblAllocationLineItems int,
@sync_bypass_insert_update_extraction bit,
@sync_request_type int,
@sync_first_time_sync_option_tblAllocationLineItems int
AS
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblAllocationLineItems IS NOT NULL AND @sync_first_time_sync_option_tblAllocationLineItems = 1))
    ...
    IF (@sync_batch_size_tblAllocationLineItems IS NULL OR 
        (@sync_batch_size_tblAllocationLineItems IS NOT NULL AND @sync_batch_size_tblAllocationLineItems = 0))
    BEGIN
        SET @sync_batch_size_tblAllocationLineItems = 2147483647;
    END

    -- Get a list of the Owned/Assigned Entities and locate any newly inserted entities
    -- and/or any new entity site assignments (if assignable).
    SELECT TOP(@sync_batch_size_tblAllocationLineItems) WITH TIES [dbo].[tblAllocationLineItems].[Limit],[dbo].[tblAllocationLineItems].[Next],[dbo].[tblAllocationLineItems].[ResetMultiple],[dbo].[tblAllocationLineItems].[ResetDate],[dbo].[tblAllocationLineItems].[CreatedDate],[dbo].[tblAllocationLineItems].[CreatedBy],[dbo].[tblAllocationLineItems].[UpdatedDate],[dbo].[tblAllocationLineItems].[UpdatedBy],[dbo].[tblAllocationLineItems].[AllocationLineItemGuid],[dbo].[tblAllocationLineItems].[LookupAllocationTypeIndex],[dbo].[tblAllocationLineItems].[LookupResetMethodIndex],[dbo].[tblAllocationLineItems].[LookupResetPeriodIndex],[dbo].[tblAllocationLineItems].[AllocationGuid],[dbo].[tblAllocationLineItems].[AssignedProductGuid],[dbo].[tblAllocationLineItems].[AssignedApplicationStringGuid],CT.InsertedRowVersion AS '_RowVersion'
        FROM [dbo].[tblAllocationLineItems]
             INNER JOIN [dbo].[tblAllocations] ON [dbo].[tblAllocationLineItems].[AllocationGuid] = [dbo].[tblAllocations].[AllocationGuid] 
        ...
        WHERE ( [dbo].[tblAllocations].[SiteGuid] = @sync_context_site_guid )
