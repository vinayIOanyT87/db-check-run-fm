...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblProductToBlendComponent]
...
@sync_first_time_sync_option_tblProductToBlendComponent int
AS
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblProductToBlendComponent IS NOT NULL AND @sync_first_time_sync_option_tblProductToBlendComponent = 1))
