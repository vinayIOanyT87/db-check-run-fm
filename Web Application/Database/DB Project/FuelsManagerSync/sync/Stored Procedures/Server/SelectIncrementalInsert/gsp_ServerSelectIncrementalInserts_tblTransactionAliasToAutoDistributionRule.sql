...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblTransactionAliasToAutoDistributionRule]
...
@sync_batch_size_tblTransactionAliasToAutoDistributionRule int,
@sync_bypass_insert_update_extraction bit,
@sync_request_type int,
@sync_first_time_sync_option_tblTransactionAliasToAutoDistributionRule int
AS
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblTransactionAliasToAutoDistributionRule IS NOT NULL AND @sync_first_time_sync_option_tblTransactionAliasToAutoDistributionRule = 1))
        OR (@sync_bypass_insert_update_extraction IS NOT NULL AND @sync_bypass_insert_update_extraction = 1))
    BEGIN
        SELECT [map].[tblTransactionAliasToAutoDistributionRule].[TransactionAliasToAutoDistributionRuleGuid],[map].[tblTransactionAliasToAutoDistributionRule].[AutoDistributionRuleGuid],[map].[tblTransactionAliasToAutoDistributionRule].[TransactionAliasGuid],[map].[tblTransactionAliasToAutoDistributionRule].[CreatedDate],[map].[tblTransactionAliasToAutoDistributionRule].[CreatedBy],[map].[tblTransactionAliasToAutoDistributionRule].[UpdatedDate],[map].[tblTransactionAliasToAutoDistributionRule].[UpdatedBy], [map].[tblTransactionAliasToAutoDistributionRule].[_RowVersion]
    ...
    IF (@sync_batch_size_tblTransactionAliasToAutoDistributionRule IS NULL OR 
        (@sync_batch_size_tblTransactionAliasToAutoDistributionRule IS NOT NULL AND @sync_batch_size_tblTransactionAliasToAutoDistributionRule = 0))
    BEGIN
        SET @sync_batch_size_tblTransactionAliasToAutoDistributionRule = 2147483647;
    END


    -- Get a list of the Owned/Assigned Entities and locate any newly inserted entities
    -- and/or any new entity site assignments (if assignable).
        SELECT [TransactionAliasToAutoDistributionRuleGuid],[AutoDistributionRuleGuid],[TransactionAliasGuid],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy],_RowVersion
        FROM (
            SELECT TOP(@sync_batch_size_tblTransactionAliasToAutoDistributionRule) WITH TIES [map].[tblTransactionAliasToAutoDistributionRule].[TransactionAliasToAutoDistributionRuleGuid],[map].[tblTransactionAliasToAutoDistributionRule].[AutoDistributionRuleGuid],[map].[tblTransactionAliasToAutoDistributionRule].[TransactionAliasGuid],[map].[tblTransactionAliasToAutoDistributionRule].[CreatedDate],[map].[tblTransactionAliasToAutoDistributionRule].[CreatedBy],[map].[tblTransactionAliasToAutoDistributionRule].[UpdatedDate],[map].[tblTransactionAliasToAutoDistributionRule].[UpdatedBy],sync.udf_GetMaxRowVersion(CT.InsertedRowVersion,MAPCT.InsertedRowVersion,MAPCT2.InsertedRowVersion) AS '_RowVersion'
                FROM [map].[tblTransactionAliasToAutoDistributionRule]
                    INNER JOIN (SELECT [TransactionAliasToSiteGuid],[TransactionAliasGuid],[OwnerSiteGuid],[AssignedToSiteGuid] FROM [dbo].[udf_GetAssignedTransactionAliasListForSite](@sync_context_site_guid)) data
                        ON [map].[tblTransactionAliasToAutoDistributionRule].[TransactionAliasGuid] = data.[TransactionAliasGuid]
                    INNER JOIN (SELECT [AutoDistributionRuleToSiteGuid],[AutoDistributionRuleGuid],[OwnerSiteGuid],[AssignedToSiteGuid] FROM [dbo].[udf_GetAssignedAutoDistributionRuleListForSite](@sync_context_site_guid)) data1
                        ON [map].[tblTransactionAliasToAutoDistributionRule].[AutoDistributionRuleGuid] = data1.[AutoDistributionRuleGuid]
