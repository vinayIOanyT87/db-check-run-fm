...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblScheduleTerminalOperation]
...
@sync_batch_size_tblScheduleTerminalOperation int,
@sync_bypass_insert_update_extraction bit,
@sync_request_type int,
@sync_first_time_sync_option_tblScheduleTerminalOperation int
AS
BEGIN
    ...
    IF (@sync_batch_size_tblScheduleTerminalOperation IS NULL OR 
        (@sync_batch_size_tblScheduleTerminalOperation IS NOT NULL AND @sync_batch_size_tblScheduleTerminalOperation = 0))
    BEGIN
        SET @sync_batch_size_tblScheduleTerminalOperation = 2147483647;
    END

    -- Get a list of the Owned/Assigned Entities and locate any newly inserted entities
    -- and/or any new entity site assignments (if assignable).
    SELECT TOP(@sync_batch_size_tblScheduleTerminalOperation) WITH TIES [dbo].[tblScheduleTerminalOperation].[ScheduleTerminalOperationGuid],[dbo].[tblScheduleTerminalOperation].[SiteGuid],[dbo].[tblScheduleTerminalOperation].[LookupDayOfWeekIndex],[dbo].[tblScheduleTerminalOperation].[Enabled],[dbo].[tblScheduleTerminalOperation].[OpeningTime],[dbo].[tblScheduleTerminalOperation].[ClosingTime],[dbo].[tblScheduleTerminalOperation].[EndOfDayEnabled],[dbo].[tblScheduleTerminalOperation].[EndOfDayTime],[dbo].[tblScheduleTerminalOperation].[CreatedDate],[dbo].[tblScheduleTerminalOperation].[CreatedBy],[dbo].[tblScheduleTerminalOperation].[UpdatedDate],[dbo].[tblScheduleTerminalOperation].[UpdatedBy],CT.InsertedRowVersion AS '_RowVersion'
        FROM [dbo].[tblScheduleTerminalOperation]
        ...
        WHERE ( [dbo].[tblScheduleTerminalOperation].[SiteGuid] = @sync_context_site_guid )
