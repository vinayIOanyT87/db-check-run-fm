...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblUserDataFieldFuelCard]
...
@sync_first_time_sync_option_tblUserDataFieldFuelCard int
AS
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblUserDataFieldFuelCard IS NOT NULL AND @sync_first_time_sync_option_tblUserDataFieldFuelCard = 1))
    ...
    FROM (
        ...
        FROM (
            SELECT TOP(@sync_batch_size_tblUserDataFieldFuelCard) WITH TIES [dbo].[tblUserDataFieldFuelCard].[UserDataFieldFuelCardGuid],[dbo].[tblUserDataFieldFuelCard].[TransactionAliasGuid],[dbo].[tblUserDataFieldFuelCard].[SiteGuid],[dbo].[tblUserDataFieldFuelCard].[Number],[dbo].[tblUserDataFieldFuelCard].[DisplayOrder],[dbo].[tblUserDataFieldFuelCard].[DisplayName],[dbo].[tblUserDataFieldFuelCard].[LookupUserDataTypeIndex],[dbo].[tblUserDataFieldFuelCard].[Required],[dbo].[tblUserDataFieldFuelCard].[UserGroupGuid],[dbo].[tblUserDataFieldFuelCard].[CreatedDate],[dbo].[tblUserDataFieldFuelCard].[CreatedBy],[dbo].[tblUserDataFieldFuelCard].[UpdatedDate],[dbo].[tblUserDataFieldFuelCard].[UpdatedBy],[dbo].[tblUserDataFieldFuelCard].[DispatchField],[dbo].[tblUserDataFieldFuelCard].[ClearOnNew],[dbo].[tblUserDataFieldFuelCard].[ReadOnly],[dbo].[tblUserDataFieldFuelCard].[Visibility],[dbo].[tblUserDataFieldFuelCard].[DefaultValue],CT.InsertedRowVersion AS '_RowVersion'
                FROM [dbo].[tblUserDataFieldFuelCard]
