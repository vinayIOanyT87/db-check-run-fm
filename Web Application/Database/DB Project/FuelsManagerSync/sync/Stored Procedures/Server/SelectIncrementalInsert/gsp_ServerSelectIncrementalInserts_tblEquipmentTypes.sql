...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblEquipmentTypes]
...
@sync_first_time_sync_option_tblEquipmentTypes int
AS
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblEquipmentTypes IS NOT NULL AND @sync_first_time_sync_option_tblEquipmentTypes = 1))
