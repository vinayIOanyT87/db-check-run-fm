...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerSelectIncrementalInserts_tblTransactionLineItemUserData]
...
BEGIN
    ...
    IF ((@sync_request_type = 4 AND (@sync_first_time_sync_option_tblTransactionLineItemUserData IS NOT NULL AND @sync_first_time_sync_option_tblTransactionLineItemUserData = 1))
