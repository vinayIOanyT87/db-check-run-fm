...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalInserts_tblEntityRecordVersioningFieldConfig]
...
BEGIN
    ...
    ;   MERGE [erv].[tblEntityRecordVersioningFieldConfig] AS existingData
        USING (SELECT @FieldConfigGuid 'FieldConfigGuid',@EntitySegmentTemplateGuid 'EntitySegmentTemplateGuid',@SiteGroupGuid 'SiteGroupGuid',@TargetField 'TargetField',@IsExternalAttribute 'IsExternalAttribute',@InternalFieldName 'InternalFieldName',@FilterValueGuid 'FilterValueGuid',@FilterValueName 'FilterValueName',@InheritedControlMode 'InheritedControlMode',@ForwardControlMode 'ForwardControlMode',@CreatedDate 'CreatedDate',@CreatedBy 'CreatedBy',@UpdatedDate 'UpdatedDate',@UpdatedBy 'UpdatedBy'
