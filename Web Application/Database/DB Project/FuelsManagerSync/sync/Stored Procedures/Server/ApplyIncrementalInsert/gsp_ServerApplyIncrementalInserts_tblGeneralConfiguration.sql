...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalInserts_tblGeneralConfiguration]
...
BEGIN
    ...
    ;   MERGE [dbo].[tblGeneralConfiguration] AS existingData
        USING (SELECT @Method 'Method',@ConsortiumFlag 'ConsortiumFlag',@ShowDeletedTrxFlag 'ShowDeletedTrxFlag',@AllowUndeleteFlag 'AllowUndeleteFlag',@ReverseTrxDateMode 'ReverseTrxDateMode',@ForcedCloseout 'ForcedCloseout',@SecurityCode 'SecurityCode',@AuthorizationCode 'AuthorizationCode',@MeterTolerance 'MeterTolerance',@CreatedBy 'CreatedBy',@CreatedDate 'CreatedDate',@UpdatedBy 'UpdatedBy',@UpdatedDate 'UpdatedDate',@SetBeginInventoryToZeroFlag 'SetBeginInventoryToZeroFlag',@GeneralConfigurationGuid 'GeneralConfigurationGuid',@SiteGuid 'SiteGuid'
