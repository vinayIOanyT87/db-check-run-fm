...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalUpdates_tblTransactionTypes]
...
BEGIN
    ...
    END
        ...
        SELECT TOP(@sync_batch_size_tblTransactionTypes) WITH TIES [lookup].[tblTransactionTypes].[TransactionTypesIndex],[lookup].[tblTransactionTypes].[TransactionTypesCode],[lookup].[tblTransactionTypes].[TransactionTypesName],[lookup].[tblTransactionTypes].[TransactionTypesGuid],[lookup].[tblTransactionTypes].[CreatedDate],[lookup].[tblTransactionTypes].[CreatedBy],[lookup].[tblTransactionTypes].[UpdatedDate],[lookup].[tblTransactionTypes].[UpdatedBy],CT.UpdatedRowVersion AS '_RowVersion'
            FROM [lookup].[tblTransactionTypes]
