...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalUpdates_tblDataDictionaries]
...
BEGIN
    ...
    END
        ...
        FROM (
            ...
            FROM (
                SELECT TOP(@sync_batch_size_tblDataDictionaries) WITH TIES [dbo].[tblDataDictionaries].[Key],[dbo].[tblDataDictionaries].[Value],[dbo].[tblDataDictionaries].[CreatedDate],[dbo].[tblDataDictionaries].[CreatedBy],[dbo].[tblDataDictionaries].[UpdatedDate],[dbo].[tblDataDictionaries].[UpdatedBy],[dbo].[tblDataDictionaries].[DataDictionaryGuid],[dbo].[tblDataDictionaries].[SiteGuid],CT.UpdatedRowVersion AS '_RowVersion'
                    FROM [dbo].[tblDataDictionaries]
