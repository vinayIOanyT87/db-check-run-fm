...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalUpdates_tblTestSetStatus]
...
BEGIN
    ...
    END
        ...
        SELECT TOP(@sync_batch_size_tblTestSetStatus) WITH TIES [lookup].[tblTestSetStatus].[TestSetStatusIndex],[lookup].[tblTestSetStatus].[TestSetStatusCode],[lookup].[tblTestSetStatus].[TestSetStatusName],[lookup].[tblTestSetStatus].[TestSetStatusGuid],[lookup].[tblTestSetStatus].[CreatedDate],[lookup].[tblTestSetStatus].[CreatedBy],[lookup].[tblTestSetStatus].[UpdatedDate],[lookup].[tblTestSetStatus].[UpdatedBy],CT.UpdatedRowVersion AS '_RowVersion'
            FROM [lookup].[tblTestSetStatus]
