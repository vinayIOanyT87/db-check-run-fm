...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalUpdates_tblProcessVariablePresetInjector]
...
@sync_batch_size_tblProcessVariablePresetInjector int,
...
BEGIN
    ...
    IF (@sync_batch_size_tblProcessVariablePresetInjector IS NULL OR 
        (@sync_batch_size_tblProcessVariablePresetInjector IS NOT NULL AND @sync_batch_size_tblProcessVariablePresetInjector = 0))
    BEGIN
        SET @sync_batch_size_tblProcessVariablePresetInjector = 2147483647;
    END
        ...
        -- First identify the ProductToPresetInjector records that will be synchronized as an insert.  This is driven by our change tracking as well as by the ProductToPresetInjector change tracking
        ; WITH ProductToPresetInjector_CTE ([ProductToPresetInjectorGuid],[ProductGuid],[AssignedToLoadArmGuid],[TankGuid],[OwnerSiteGuid])
        AS (
            SELECT [map].[tblProductToPresetInjector].[ProductToPresetInjectorGuid],[map].[tblProductToPresetInjector].[ProductGuid],[map].[tblProductToPresetInjector].[AssignedToLoadArmGuid],[map].[tblProductToPresetInjector].[TankGuid],data.[OwnerSiteGuid]
                FROM [map].[tblProductToPresetInjector]
                    INNER JOIN (SELECT [ProductToSiteGuid],[ProductGuid],[OwnerSiteGuid],[AssignedToSiteGuid] FROM [dbo].[udf_GetAssignedProductListForSite](@sync_context_site_guid)) data
                        ON [map].[tblProductToPresetInjector].[ProductGuid] = data.[ProductGuid]
        ...
        -- Now that we know which ProductToPresetInjector records would have been inserted, we can focus on whether these records have been inserted or the loadarm, similar to an entity assignment
        SELECT TOP(@sync_batch_size_tblProcessVariablePresetInjector) WITH TIES [dbo].[tblProcessVariablePresetInjector].[ProcessVariablePresetInjectorGuid],[dbo].[tblProcessVariablePresetInjector].[LookupProcessVariableTypeIndex],[dbo].[tblProcessVariablePresetInjector].[InstanceNumber],[dbo].[tblProcessVariablePresetInjector].[ProductToPresetInjectorGuid],[dbo].[tblProcessVariablePresetInjector].[OPCConnectionGuid],[dbo].[tblProcessVariablePresetInjector].[OPCItemID],[dbo].[tblProcessVariablePresetInjector].[DataType],[dbo].[tblProcessVariablePresetInjector].[ServerEngineeringUnitsIndex],[dbo].[tblProcessVariablePresetInjector].[Quality],[dbo].[tblProcessVariablePresetInjector].[SIValue],[dbo].[tblProcessVariablePresetInjector].[LookupSIValueVariantTypeIndex],[dbo].[tblProcessVariablePresetInjector].[DateTimeStamp],[dbo].[tblProcessVariablePresetInjector].[Maximum],[dbo].[tblProcessVariablePresetInjector].[LookupMaximumVariantTypeIndex],[dbo].[tblProcessVariablePresetInjector].[Minimum],[dbo].[tblProcessVariablePresetInjector].[LookupMinimumVariantTypeIndex],[dbo].[tblProcessVariablePresetInjector].[DataTypeEnabled],[dbo].[tblProcessVariablePresetInjector].[Input],[dbo].[tblProcessVariablePresetInjector].[InputEnabled],[dbo].[tblProcessVariablePresetInjector].[MessageApplicationStringGuid],[dbo].[tblProcessVariablePresetInjector].[CreatedDate],[dbo].[tblProcessVariablePresetInjector].[CreatedBy],[dbo].[tblProcessVariablePresetInjector].[UpdatedDate],[dbo].[tblProcessVariablePresetInjector].[UpdatedBy], sync.udf_GetMaxRowVersion(CT.UpdatedRowVersion,MAPCT.UpdatedRowVersion, NULL) AS '_RowVersion' 
            FROM [dbo].[tblProcessVariablePresetInjector]
                INNER JOIN (SELECT [ProductToPresetInjectorGuid],[ProductGuid],[AssignedToLoadArmGuid],[TankGuid],[OwnerSiteGuid] FROM ProductToPresetInjector_CTE) data
                    ON [dbo].[tblProcessVariablePresetInjector].[ProductToPresetInjectorGuid] = data.[ProductToPresetInjectorGuid]
                ...
                INNER JOIN [track].[tblProductToPresetInjector] MAPCT
                    ON MAPCT.PK_ProductToPresetInjectorGuid = data.[ProductToPresetInjectorGuid]
