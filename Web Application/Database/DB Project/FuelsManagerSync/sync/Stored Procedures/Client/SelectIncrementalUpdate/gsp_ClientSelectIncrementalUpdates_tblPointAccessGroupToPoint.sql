...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalUpdates_tblPointAccessGroupToPoint]
...
BEGIN
    ...
    END
 	...
 	-- Updates associated with Points
	IF 0 <> (SELECT COUNT(*) FROM #SyncTable)
	BEGIN

        SELECT [map].[tblPointAccessGroupToPoint].[PointAccessGroupToPointGuid],[map].[tblPointAccessGroupToPoint].[PointAccessGroupGuid],[map].[tblPointAccessGroupToPoint].[PointGuid],[map].[tblPointAccessGroupToPoint].[CreatedDate],[map].[tblPointAccessGroupToPoint].[CreatedBy],[map].[tblPointAccessGroupToPoint].[UpdatedDate],[map].[tblPointAccessGroupToPoint].[UpdatedBy],CT.UpdatedRowVersion AS '_RowVersion'
            FROM [map].[tblPointAccessGroupToPoint]
	...
	ELSE
	BEGIN
        SELECT TOP(@sync_batch_size_tblPointAccessGroupToPoint) WITH TIES [map].[tblPointAccessGroupToPoint].[PointAccessGroupToPointGuid],[map].[tblPointAccessGroupToPoint].[PointAccessGroupGuid],[map].[tblPointAccessGroupToPoint].[PointGuid],[map].[tblPointAccessGroupToPoint].[CreatedDate],[map].[tblPointAccessGroupToPoint].[CreatedBy],[map].[tblPointAccessGroupToPoint].[UpdatedDate],[map].[tblPointAccessGroupToPoint].[UpdatedBy],CT.UpdatedRowVersion AS '_RowVersion'
            FROM [map].[tblPointAccessGroupToPoint]
            INNER JOIN [track].[tblPointAccessGroupToPoint] CT ON CT.PK_PointAccessGroupToPointGuid = [map].[tblPointAccessGroupToPoint].[PointAccessGroupToPointGuid] 
