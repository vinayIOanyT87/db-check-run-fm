...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalUpdates_tblEntityQuerySettingToSite]
...
BEGIN
    ...
    END
        ...
        SELECT TOP(@sync_batch_size_tblEntityQuerySettingToSite) WITH TIES [map].[tblEntityQuerySettingToSite].[QuerySettingToSiteGuid],[map].[tblEntityQuerySettingToSite].[SiteGuid],[map].[tblEntityQuerySettingToSite].[MapToSiteGuid],[map].[tblEntityQuerySettingToSite].[CreatedDate],[map].[tblEntityQuerySettingToSite].[CreatedBy],[map].[tblEntityQuerySettingToSite].[UpdatedDate],[map].[tblEntityQuerySettingToSite].[UpdatedBy],[map].[tblEntityQuerySettingToSite].[AssignedFromSiteGuid],CT.UpdatedRowVersion AS '_RowVersion'
            FROM [map].[tblEntityQuerySettingToSite]
