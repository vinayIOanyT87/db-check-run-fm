...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectDeleteConflicts_tblExportResults]
...
BEGIN
    ...
    --
    SELECT CT.PK_ExportResultGuid 'ExportResultGuid', CT.DeletedContext, CT.DeletedRowVersion AS '_RowVersion'
        ...
        WHERE (CT.DeletedRowVersion > @sync_last_received_anchor_varbinary)
                ...
                AND (CT.PK_ExportResultGuid = @ExportResultGuid)
