...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblProcessVariableExternalComponentBlendPercentage]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblProcessVariableExternalComponentBlendPercentage) WITH TIES CT.PK_ProcessVariableProductToPresetExternalComponentGuid 'ProcessVariableProductToPresetExternalComponentGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblProcessVariableExternalComponentBlendPercentage] CT
