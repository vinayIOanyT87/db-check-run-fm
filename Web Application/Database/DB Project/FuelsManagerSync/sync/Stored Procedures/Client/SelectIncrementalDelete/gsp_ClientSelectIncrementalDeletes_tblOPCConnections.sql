...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblOPCConnections]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblOPCConnections) WITH TIES CT.PK_OPCConnectionGuid 'OPCConnectionGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblOPCConnections] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_OPCConnectionGuid 'OPCConnectionGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblOPCConnections] CT
            WHERE 1=2
    END
