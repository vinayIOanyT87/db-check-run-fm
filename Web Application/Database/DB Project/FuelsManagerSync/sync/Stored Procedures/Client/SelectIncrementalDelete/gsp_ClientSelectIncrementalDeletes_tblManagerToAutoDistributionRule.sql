...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblManagerToAutoDistributionRule]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblManagerToAutoDistributionRule) WITH TIES CT.PK_ManagerToAutoDistributionRuleGuid 'ManagerToAutoDistributionRuleGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblManagerToAutoDistributionRule] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_ManagerToAutoDistributionRuleGuid 'ManagerToAutoDistributionRuleGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblManagerToAutoDistributionRule] CT
            WHERE 1=2
    END
