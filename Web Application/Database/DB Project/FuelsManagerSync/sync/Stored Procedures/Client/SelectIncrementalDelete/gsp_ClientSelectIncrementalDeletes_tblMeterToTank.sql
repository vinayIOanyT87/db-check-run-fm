...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblMeterToTank]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblMeterToTank) WITH TIES CT.PK_MeterToTankGuid 'MeterToTankGuid', CT.DeletedRowVersion '_RowVersion'
    ...
    ELSE
    BEGIN
        SELECT CT.PK_MeterToTankGuid 'MeterToTankGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblMeterToTank] CT
            WHERE 1=2
    END
