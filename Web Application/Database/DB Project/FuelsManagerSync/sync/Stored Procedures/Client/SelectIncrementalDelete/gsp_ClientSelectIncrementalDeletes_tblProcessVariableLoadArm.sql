...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblProcessVariableLoadArm]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblProcessVariableLoadArm) WITH TIES CT.PK_ProcessVariableLoadArmGuid 'ProcessVariableLoadArmGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblProcessVariableLoadArm] CT
