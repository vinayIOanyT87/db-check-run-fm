...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblProductToAdditiveProfile]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblProductToAdditiveProfile) WITH TIES CT.PK_ProductToAdditiveProfileGuid 'ProductToAdditiveProfileGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblProductToAdditiveProfile] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_ProductToAdditiveProfileGuid 'ProductToAdditiveProfileGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblProductToAdditiveProfile] CT
            WHERE 1=2
    END
