...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblListViewFields]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblListViewFields) WITH TIES CT.PK_ListViewFieldGuid 'ListViewFieldGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblListViewFields] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_ListViewFieldGuid 'ListViewFieldGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblListViewFields] CT
            WHERE 1=2
    END
