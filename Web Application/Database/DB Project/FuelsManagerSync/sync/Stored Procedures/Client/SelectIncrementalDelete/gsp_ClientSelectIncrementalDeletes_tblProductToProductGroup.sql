...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblProductToProductGroup]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblProductToProductGroup) WITH TIES CT.PK_ProductToProductGroupGuid 'ProductToProductGroupGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblProductToProductGroup] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_ProductToProductGroupGuid 'ProductToProductGroupGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblProductToProductGroup] CT
            WHERE 1=2
    END
