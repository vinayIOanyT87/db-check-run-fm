...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblTestEquipmentResults]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblTestEquipmentResults) WITH TIES CT.PK_TestEquipmentResultGuid 'TestEquipmentResultGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblTestEquipmentResults] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_TestEquipmentResultGuid 'TestEquipmentResultGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblTestEquipmentResults] CT
            WHERE 1=2
    END
