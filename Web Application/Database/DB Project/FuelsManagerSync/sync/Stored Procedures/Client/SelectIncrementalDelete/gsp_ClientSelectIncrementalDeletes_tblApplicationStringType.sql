...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblApplicationStringType]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblApplicationStringType) WITH TIES CT.PK_ApplicationStringTypeIndex 'ApplicationStringTypeIndex', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblApplicationStringType] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_ApplicationStringTypeIndex 'ApplicationStringTypeIndex', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblApplicationStringType] CT
            WHERE 1=2
    END
