...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblUserDataFieldFuelCard]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblUserDataFieldFuelCard) WITH TIES CT.PK_UserDataFieldFuelCardGuid 'UserDataFieldFuelCardGuid', CT.DeletedRowVersion '_RowVersion'
    ...
    ELSE
    BEGIN
        SELECT CT.PK_UserDataFieldFuelCardGuid 'UserDataFieldFuelCardGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblUserDataFieldFuelCard] CT
            WHERE 1=2
    END
