...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblProcessVariableExternalComponentInputPermissive]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblProcessVariableExternalComponentInputPermissive) WITH TIES CT.PK_ProcessVariableProductToPresetExternalComponentGuid 'ProcessVariableProductToPresetExternalComponentGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblProcessVariableExternalComponentInputPermissive] CT
