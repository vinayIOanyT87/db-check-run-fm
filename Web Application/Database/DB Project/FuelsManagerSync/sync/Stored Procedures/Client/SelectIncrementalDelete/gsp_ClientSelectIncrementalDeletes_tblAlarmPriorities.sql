...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblAlarmPriorities]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblAlarmPriorities) WITH TIES CT.PK_AlarmPriorityGuid 'AlarmPriorityGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblAlarmPriorities] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_AlarmPriorityGuid 'AlarmPriorityGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblAlarmPriorities] CT
            WHERE 1=2
    END
