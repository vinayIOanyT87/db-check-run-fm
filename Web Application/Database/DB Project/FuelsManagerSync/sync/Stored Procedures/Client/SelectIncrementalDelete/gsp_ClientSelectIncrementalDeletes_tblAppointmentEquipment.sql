...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblAppointmentEquipment]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblAppointmentEquipment) WITH TIES CT.PK_AppointmentEquipmentGuid 'AppointmentEquipmentGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblAppointmentEquipment] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_AppointmentEquipmentGuid 'AppointmentEquipmentGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblAppointmentEquipment] CT
            WHERE 1=2
    END
