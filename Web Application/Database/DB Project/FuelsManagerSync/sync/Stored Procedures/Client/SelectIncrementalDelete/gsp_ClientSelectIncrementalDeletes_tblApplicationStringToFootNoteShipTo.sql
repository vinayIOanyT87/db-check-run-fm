...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblApplicationStringToFootNoteShipTo]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblApplicationStringToFootNoteShipTo) WITH TIES CT.PK_ApplicationStringToFootNoteShipToGuid 'ApplicationStringToFootNoteShipToGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblApplicationStringToFootNoteShipTo] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_ApplicationStringToFootNoteShipToGuid 'ApplicationStringToFootNoteShipToGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblApplicationStringToFootNoteShipTo] CT
            WHERE 1=2
    END
