...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblPointGroupColumns]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblPointGroupColumns) WITH TIES CT.PK_PointGroupColumnsGuid 'PointGroupColumnsGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblPointGroupColumns] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_PointGroupColumnsGuid 'PointGroupColumnsGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblPointGroupColumns] CT
            WHERE 1=2
    END
