...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblUserDataListValueSite]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblUserDataListValueSite) WITH TIES CT.PK_UserDataListValueSiteGuid 'UserDataListValueSiteGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblUserDataListValueSite] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_UserDataListValueSiteGuid 'UserDataListValueSiteGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblUserDataListValueSite] CT
            WHERE 1=2
    END
