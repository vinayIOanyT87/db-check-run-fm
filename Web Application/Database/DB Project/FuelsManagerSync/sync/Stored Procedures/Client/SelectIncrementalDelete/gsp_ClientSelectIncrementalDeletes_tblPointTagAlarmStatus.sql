...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblPointTagAlarmStatus]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT CT.PK_PointTagAlarmStatusGuid 'PointTagAlarmStatusGuid', CT.[FK_ParentPK] 'AlarmTestGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblPointTagAlarmStatus] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_PointTagAlarmStatusGuid 'PointTagAlarmStatusGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblPointTagAlarmStatus] CT
            WHERE 1=2
    END
