...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblUserDataType]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblUserDataType) WITH TIES CT.PK_UserDataTypeIndex 'UserDataTypeIndex', CT.DeletedRowVersion '_RowVersion'
    ...
    ELSE
    BEGIN
        SELECT CT.PK_UserDataTypeIndex 'UserDataTypeIndex', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblUserDataType] CT
            WHERE 1=2
    END
