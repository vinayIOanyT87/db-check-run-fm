...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblQualificationEquipmentTestAndInspectionToEquipment]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblQualificationEquipmentTestAndInspectionToEquipment) WITH TIES CT.PK_QualificationEquipmentTestAndInspectionToEquipmentGuid 'QualificationEquipmentTestAndInspectionToEquipmentGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblQualificationEquipmentTestAndInspectionToEquipment] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_QualificationEquipmentTestAndInspectionToEquipmentGuid 'QualificationEquipmentTestAndInspectionToEquipmentGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblQualificationEquipmentTestAndInspectionToEquipment] CT
            WHERE 1=2
    END
