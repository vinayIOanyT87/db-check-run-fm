...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblPointTag]
...
BEGIN
    ...
    BEGIN 
        ...
        END
			...
			SELECT CT.PK_PointTagGuid 'PointTagGuid', CT.[FK_ParentPK] 'PointGuid', CT.DeletedRowVersion '_RowVersion'
			FROM [track].[tblPointTag] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_PointTagGuid 'PointTagGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblPointTag] CT
            WHERE 1=2
    END
