...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblNotes]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblNotes) WITH TIES CT.PK_NoteGuid 'NoteGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblNotes] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_NoteGuid 'NoteGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblNotes] CT
            WHERE 1=2
    END
