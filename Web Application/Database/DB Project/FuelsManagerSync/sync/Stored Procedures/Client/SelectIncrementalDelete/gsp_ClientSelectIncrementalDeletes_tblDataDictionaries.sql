...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblDataDictionaries]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblDataDictionaries) WITH TIES CT.PK_DataDictionaryGuid 'DataDictionaryGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblDataDictionaries] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_DataDictionaryGuid 'DataDictionaryGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblDataDictionaries] CT
            WHERE 1=2
    END
