...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblProcessVariableNoAdditiveInputPermissive]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblProcessVariableNoAdditiveInputPermissive) WITH TIES CT.PK_ProcessVariableLoadArmGuid 'ProcessVariableLoadArmGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblProcessVariableNoAdditiveInputPermissive] CT
