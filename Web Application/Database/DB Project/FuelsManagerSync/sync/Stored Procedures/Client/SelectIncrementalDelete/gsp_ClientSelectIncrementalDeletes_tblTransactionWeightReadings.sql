...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblTransactionWeightReadings]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblTransactionWeightReadings) WITH TIES CT.PK_TransactionWeightReadingGuid 'TransactionWeightReadingGuid', CT.[FK_ParentPK] 'TransactionGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblTransactionWeightReadings] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_TransactionWeightReadingGuid 'TransactionWeightReadingGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblTransactionWeightReadings] CT
            WHERE 1=2
    END
