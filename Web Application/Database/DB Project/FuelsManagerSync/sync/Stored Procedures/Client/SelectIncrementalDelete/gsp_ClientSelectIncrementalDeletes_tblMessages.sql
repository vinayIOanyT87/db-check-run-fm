...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblMessages]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblMessages) WITH TIES CT.PK_MessageGuid 'MessageGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblMessages] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_MessageGuid 'MessageGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblMessages] CT
            WHERE 1=2
    END
