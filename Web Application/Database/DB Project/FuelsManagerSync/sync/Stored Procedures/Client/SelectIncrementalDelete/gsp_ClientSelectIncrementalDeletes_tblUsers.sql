...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblUsers]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblUsers) WITH TIES CT.PK_UserGuid 'UserGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblUsers] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_UserGuid 'UserGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblUsers] CT
            WHERE 1=2
    END
