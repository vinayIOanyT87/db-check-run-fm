...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblMobileDeviceProfilePrinter]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblMobileDeviceProfilePrinter) WITH TIES CT.PK_MobileDeviceProfilePrinterGUID 'MobileDeviceProfilePrinterGUID', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblMobileDeviceProfilePrinter] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_MobileDeviceProfilePrinterGUID 'MobileDeviceProfilePrinterGUID', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblMobileDeviceProfilePrinter] CT
            WHERE 1=2
    END
