...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblUserDataListValueCompany]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblUserDataListValueCompany) WITH TIES CT.PK_UserDataListValueCompanyGuid 'UserDataListValueCompanyGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblUserDataListValueCompany] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_UserDataListValueCompanyGuid 'UserDataListValueCompanyGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblUserDataListValueCompany] CT
            WHERE 1=2
    END
