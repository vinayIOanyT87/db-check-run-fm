...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblCompanies]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblCompanies) WITH TIES CT.PK_CompanyGuid 'CompanyGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblCompanies] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_CompanyGuid 'CompanyGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblCompanies] CT
            WHERE 1=2
    END
