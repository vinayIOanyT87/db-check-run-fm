...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblCurrencies]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblCurrencies) WITH TIES CT.PK_CurrencyGuid 'CurrencyGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblCurrencies] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_CurrencyGuid 'CurrencyGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblCurrencies] CT
            WHERE 1=2
    END
