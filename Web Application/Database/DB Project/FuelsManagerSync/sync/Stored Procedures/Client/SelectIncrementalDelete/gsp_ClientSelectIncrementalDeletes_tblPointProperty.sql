...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblPointProperty]
...
BEGIN
    ...
    BEGIN 
        ...
        END
			...
			SELECT CT.PK_PointPropertyGuid 'PointPropertyGuid', CT.[FK_ParentPK] 'PointGuid', CT.DeletedRowVersion '_RowVersion'
    ...
    ELSE
    BEGIN
        SELECT CT.PK_PointPropertyGuid 'PointPropertyGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblPointProperty] CT
            WHERE 1=2
    END
