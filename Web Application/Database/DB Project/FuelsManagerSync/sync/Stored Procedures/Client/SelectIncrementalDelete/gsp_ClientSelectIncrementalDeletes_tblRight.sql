...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblRight]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblRight) WITH TIES CT.PK_RightIndex 'RightIndex', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblRight] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_RightIndex 'RightIndex', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblRight] CT
            WHERE 1=2
    END
