...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblUserToGroup]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblUserToGroup) WITH TIES CT.PK_UserToGroupGuid 'UserToGroupGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblUserToGroup] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_UserToGroupGuid 'UserToGroupGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblUserToGroup] CT
            WHERE 1=2
    END
