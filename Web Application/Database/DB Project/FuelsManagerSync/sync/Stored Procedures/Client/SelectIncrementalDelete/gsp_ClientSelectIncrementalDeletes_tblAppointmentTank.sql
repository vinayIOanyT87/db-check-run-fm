...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblAppointmentTank]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblAppointmentTank) WITH TIES CT.PK_AppointmentTankGuid 'AppointmentTankGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblAppointmentTank] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_AppointmentTankGuid 'AppointmentTankGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblAppointmentTank] CT
            WHERE 1=2
    END
