...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblUserDataFieldUser]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblUserDataFieldUser) WITH TIES CT.PK_UserDataFieldUserGuid 'UserDataFieldUserGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblUserDataFieldUser] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_UserDataFieldUserGuid 'UserDataFieldUserGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblUserDataFieldUser] CT
            WHERE 1=2
    END
