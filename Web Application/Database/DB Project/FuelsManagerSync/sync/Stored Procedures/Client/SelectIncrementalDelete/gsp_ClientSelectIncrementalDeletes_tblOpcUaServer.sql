...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblOpcUaServer]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblOpcUaServer) WITH TIES CT.PK_OpcUaServerGuid 'OpcUaServerGuid', CT.DeletedRowVersion '_RowVersion'
    ...
    ELSE
    BEGIN
        SELECT CT.PK_OpcUaServerGuid 'OpcUaServerGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblOpcUaServer] CT
            WHERE 1=2
    END
