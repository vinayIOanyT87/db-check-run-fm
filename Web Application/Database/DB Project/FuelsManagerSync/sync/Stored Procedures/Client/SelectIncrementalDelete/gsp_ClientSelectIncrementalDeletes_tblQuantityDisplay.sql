...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblQuantityDisplay]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblQuantityDisplay) WITH TIES CT.PK_QuantityDisplayIndex 'QuantityDisplayIndex', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblQuantityDisplay] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_QuantityDisplayIndex 'QuantityDisplayIndex', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblQuantityDisplay] CT
            WHERE 1=2
    END
