...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblPersonnel]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblPersonnel) WITH TIES CT.PK_PersonnelGuid 'PersonnelGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblPersonnel] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_PersonnelGuid 'PersonnelGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblPersonnel] CT
            WHERE 1=2
    END
