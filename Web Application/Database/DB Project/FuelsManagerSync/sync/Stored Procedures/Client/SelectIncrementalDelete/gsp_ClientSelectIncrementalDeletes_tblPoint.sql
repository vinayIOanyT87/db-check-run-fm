...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblPoint]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblPoint) WITH TIES CT.PK_PointGuid 'PointGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblPoint] CT
                INNER JOIN #SyncTable 
                    ON #SyncTable.PK = CT.[PK_PointGuid]
    ...
    ELSE
    BEGIN
        SELECT CT.PK_PointGuid 'PointGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblPoint] CT
            WHERE 1=2
    END
