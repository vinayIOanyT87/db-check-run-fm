...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblUserDataFieldCompany]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblUserDataFieldCompany) WITH TIES CT.PK_UserDataFieldCompanyGuid 'UserDataFieldCompanyGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblUserDataFieldCompany] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_UserDataFieldCompanyGuid 'UserDataFieldCompanyGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblUserDataFieldCompany] CT
            WHERE 1=2
    END
