...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblProducts]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblProducts) WITH TIES CT.PK_ProductGuid 'ProductGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblProducts] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_ProductGuid 'ProductGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblProducts] CT
            WHERE 1=2
    END
