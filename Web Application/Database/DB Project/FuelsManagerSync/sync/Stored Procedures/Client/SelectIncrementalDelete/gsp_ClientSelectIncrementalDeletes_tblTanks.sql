...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblTanks]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblTanks) WITH TIES CT.PK_TankGuid 'TankGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblTanks] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_TankGuid 'TankGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblTanks] CT
            WHERE 1=2
    END
