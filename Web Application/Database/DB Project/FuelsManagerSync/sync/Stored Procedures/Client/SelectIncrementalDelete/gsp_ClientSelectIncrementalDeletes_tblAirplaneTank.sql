...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblAirplaneTank]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblAirplaneTank) WITH TIES CT.PK_TankGuid 'TankGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblAirplaneTank] CT
