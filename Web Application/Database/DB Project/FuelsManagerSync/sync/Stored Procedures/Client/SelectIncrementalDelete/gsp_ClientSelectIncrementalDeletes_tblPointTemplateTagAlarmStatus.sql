...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblPointTemplateTagAlarmStatus]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblPointTemplateTagAlarmStatus) WITH TIES CT.PK_PointTemplateTagAlarmStatusGuid 'PointTemplateTagAlarmStatusGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblPointTemplateTagAlarmStatus] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_PointTemplateTagAlarmStatusGuid 'PointTemplateTagAlarmStatusGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblPointTemplateTagAlarmStatus] CT
            WHERE 1=2
    END
