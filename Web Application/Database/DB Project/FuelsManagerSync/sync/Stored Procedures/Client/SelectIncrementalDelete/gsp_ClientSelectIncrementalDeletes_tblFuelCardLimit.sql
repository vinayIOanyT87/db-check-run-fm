...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblFuelCardLimit]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblFuelCardLimit) WITH TIES CT.PK_FuelCardLimitGuid 'FuelCardLimitGuid', CT.DeletedRowVersion '_RowVersion'
    ...
    ELSE
    BEGIN
        SELECT CT.PK_FuelCardLimitGuid 'FuelCardLimitGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblFuelCardLimit] CT
            WHERE 1=2
    END
