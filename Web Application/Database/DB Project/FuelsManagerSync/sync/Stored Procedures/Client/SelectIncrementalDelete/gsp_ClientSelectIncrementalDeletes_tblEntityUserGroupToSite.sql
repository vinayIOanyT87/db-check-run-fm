...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblEntityUserGroupToSite]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblEntityUserGroupToSite) WITH TIES CT.PK_UserGroupToSiteGuid 'UserGroupToSiteGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblEntityUserGroupToSite] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_UserGroupToSiteGuid 'UserGroupToSiteGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblEntityUserGroupToSite] CT
            WHERE 1=2
    END
