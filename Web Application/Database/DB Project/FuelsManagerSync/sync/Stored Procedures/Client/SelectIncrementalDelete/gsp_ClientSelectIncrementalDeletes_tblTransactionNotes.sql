...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblTransactionNotes]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblTransactionNotes) WITH TIES CT.PK_TransactionNoteGuid 'TransactionNoteGuid', CT.[FK_ParentPK] 'TransactionGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblTransactionNotes] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_TransactionNoteGuid 'TransactionNoteGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblTransactionNotes] CT
            WHERE 1=2
    END
