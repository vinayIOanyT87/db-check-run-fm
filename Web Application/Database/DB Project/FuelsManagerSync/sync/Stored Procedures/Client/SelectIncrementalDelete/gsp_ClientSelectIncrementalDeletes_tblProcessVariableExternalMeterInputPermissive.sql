...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblProcessVariableExternalMeterInputPermissive]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblProcessVariableExternalMeterInputPermissive) WITH TIES CT.PK_ProcessVariableProductToOffloadExternalMeterGuid 'ProcessVariableProductToOffloadExternalMeterGuid', CT.DeletedRowVersion '_RowVersion'
