...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblUserDataListValueTransactionAlias]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblUserDataListValueTransactionAlias) WITH TIES CT.PK_UserDataListValueTransactionAliasGuid 'UserDataListValueTransactionAliasGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblUserDataListValueTransactionAlias] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_UserDataListValueTransactionAliasGuid 'UserDataListValueTransactionAliasGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblUserDataListValueTransactionAlias] CT
            WHERE 1=2
    END
