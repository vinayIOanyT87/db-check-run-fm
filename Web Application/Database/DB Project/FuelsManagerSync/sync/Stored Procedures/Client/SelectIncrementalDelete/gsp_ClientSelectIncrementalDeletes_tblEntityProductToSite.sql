...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblEntityProductToSite]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblEntityProductToSite) WITH TIES CT.PK_ProductToSiteGuid 'ProductToSiteGuid', CT.DeletedRowVersion '_RowVersion'
    ...
    ELSE
    BEGIN
        SELECT CT.PK_ProductToSiteGuid 'ProductToSiteGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblEntityProductToSite] CT
            WHERE 1=2
    END
