...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblProcessVariableOffloadExternalMeter]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblProcessVariableOffloadExternalMeter) WITH TIES CT.PK_ProcessVariableProductToOffloadExternalMeterGuid 'ProcessVariableProductToOffloadExternalMeterGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblProcessVariableOffloadExternalMeter] CT
