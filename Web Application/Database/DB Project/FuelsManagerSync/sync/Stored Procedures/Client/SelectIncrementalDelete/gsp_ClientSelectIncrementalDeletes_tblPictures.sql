...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblPictures]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblPictures) WITH TIES CT.PK_PictureGuid 'PictureGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblPictures] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_PictureGuid 'PictureGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblPictures] CT
            WHERE 1=2
    END
