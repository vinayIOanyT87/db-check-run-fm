...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblPointTemplateTag]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblPointTemplateTag) WITH TIES CT.PK_PointTemplateTagGuid 'PointTemplateTagGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblPointTemplateTag] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_PointTemplateTagGuid 'PointTemplateTagGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblPointTemplateTag] CT
            WHERE 1=2
    END
