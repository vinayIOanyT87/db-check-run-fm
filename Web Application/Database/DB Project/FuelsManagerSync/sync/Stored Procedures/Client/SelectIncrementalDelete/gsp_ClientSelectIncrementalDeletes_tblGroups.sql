...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblGroups]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblGroups) WITH TIES CT.PK_GroupGuid 'GroupGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblGroups] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_GroupGuid 'GroupGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblGroups] CT
            WHERE 1=2
    END
