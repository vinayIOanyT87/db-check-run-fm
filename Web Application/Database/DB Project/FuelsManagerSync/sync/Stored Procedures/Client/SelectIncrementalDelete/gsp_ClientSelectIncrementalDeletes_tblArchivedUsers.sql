...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblArchivedUsers]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblArchivedUsers) WITH TIES CT.PK_ArchivedUserGuid 'ArchivedUserGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblArchivedUsers] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_ArchivedUserGuid 'ArchivedUserGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblArchivedUsers] CT
            WHERE 1=2
    END
