...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblExcise]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblExcise) WITH TIES CT.PK_ExciseGuid 'ExciseGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblExcise] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_ExciseGuid 'ExciseGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblExcise] CT
            WHERE 1=2
    END
