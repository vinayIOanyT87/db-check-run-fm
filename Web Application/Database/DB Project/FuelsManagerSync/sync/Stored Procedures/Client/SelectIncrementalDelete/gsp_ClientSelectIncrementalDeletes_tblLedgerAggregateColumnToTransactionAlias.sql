...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblLedgerAggregateColumnToTransactionAlias]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblLedgerAggregateColumnToTransactionAlias) WITH TIES CT.PK_LedgerAggregateColumnToTransactionAliasGuid 'LedgerAggregateColumnToTransactionAliasGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblLedgerAggregateColumnToTransactionAlias] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_LedgerAggregateColumnToTransactionAliasGuid 'LedgerAggregateColumnToTransactionAliasGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblLedgerAggregateColumnToTransactionAlias] CT
            WHERE 1=2
    END
