...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblAccessibilityConfigurationSettings]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblAccessibilityConfigurationSettings) WITH TIES CT.PK_AccessibilityConfigurationSettingGuid 'AccessibilityConfigurationSettingGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblAccessibilityConfigurationSettings] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_AccessibilityConfigurationSettingGuid 'AccessibilityConfigurationSettingGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblAccessibilityConfigurationSettings] CT
            WHERE 1=2
    END
