...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblEntityProcessVariableMessageToSite]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblEntityProcessVariableMessageToSite) WITH TIES CT.PK_ProcessVariableMessageToSiteGuid 'ProcessVariableMessageToSiteGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblEntityProcessVariableMessageToSite] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_ProcessVariableMessageToSiteGuid 'ProcessVariableMessageToSiteGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblEntityProcessVariableMessageToSite] CT
            WHERE 1=2
    END
