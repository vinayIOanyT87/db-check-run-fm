...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblCompanyBillToToShipper]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblCompanyBillToToShipper) WITH TIES CT.PK_CompanyBillToToShipperGuid 'CompanyBillToToShipperGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblCompanyBillToToShipper] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_CompanyBillToToShipperGuid 'CompanyBillToToShipperGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblCompanyBillToToShipper] CT
            WHERE 1=2
    END
