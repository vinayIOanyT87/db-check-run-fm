...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblTrend]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblTrend) WITH TIES CT.PK_TrendGuid 'TrendGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblTrend] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_TrendGuid 'TrendGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblTrend] CT
            WHERE 1=2
    END
