...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblTransactionTransportLineItems]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblTransactionTransportLineItems) WITH TIES CT.PK_TransactionTransportLineItemGuid 'TransactionTransportLineItemGuid', CT.[FK_ParentPK] 'TransactionGuid', CT.DeletedRowVersion '_RowVersion'
    ...
    ELSE
    BEGIN
        SELECT CT.PK_TransactionTransportLineItemGuid 'TransactionTransportLineItemGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblTransactionTransportLineItems] CT
            WHERE 1=2
    END
