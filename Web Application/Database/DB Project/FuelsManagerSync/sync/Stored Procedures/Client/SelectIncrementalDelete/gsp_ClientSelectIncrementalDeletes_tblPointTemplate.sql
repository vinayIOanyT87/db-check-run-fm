...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblPointTemplate]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblPointTemplate) WITH TIES CT.PK_PointTemplateGuid 'PointTemplateGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblPointTemplate] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_PointTemplateGuid 'PointTemplateGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblPointTemplate] CT
            WHERE 1=2
    END
