...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblStations]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblStations) WITH TIES CT.PK_StationGuid 'StationGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblStations] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_StationGuid 'StationGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblStations] CT
            WHERE 1=2
    END
