...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblQualityTags]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblQualityTags) WITH TIES CT.PK_QualityTagGuid 'QualityTagGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblQualityTags] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_QualityTagGuid 'QualityTagGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblQualityTags] CT
            WHERE 1=2
    END
