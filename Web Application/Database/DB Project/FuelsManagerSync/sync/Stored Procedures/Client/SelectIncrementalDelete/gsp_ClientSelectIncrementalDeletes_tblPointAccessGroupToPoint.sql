...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblPointAccessGroupToPoint]
    ...
    BEGIN 
        ...
        END
			...
			BEGIN
			  ...
			  SELECT CT.PK_PointAccessGroupToPointGuid 'PointAccessGroupToPointGuid', CT.[FK_ParentPK] 'PointGuid', CT.DeletedRowVersion '_RowVersion'
					FROM [track].[tblPointAccessGroupToPoint] CT
			...
			ELSE
			BEGIN
			  SELECT TOP(@sync_batch_size_tblPointAccessGroupToPoint) WITH TIES CT.PK_PointAccessGroupToPointGuid 'PointAccessGroupToPointGuid', CT.[FK_ParentPK] 'PointGuid', CT.DeletedRowVersion '_RowVersion'
					FROM [track].[tblPointAccessGroupToPoint] CT
