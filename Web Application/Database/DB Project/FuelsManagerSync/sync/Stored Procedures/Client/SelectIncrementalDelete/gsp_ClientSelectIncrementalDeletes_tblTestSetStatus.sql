...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblTestSetStatus]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblTestSetStatus) WITH TIES CT.PK_TestSetStatusIndex 'TestSetStatusIndex', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblTestSetStatus] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_TestSetStatusIndex 'TestSetStatusIndex', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblTestSetStatus] CT
            WHERE 1=2
    END
