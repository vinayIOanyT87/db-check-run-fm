...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblProductToLedgerView]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblProductToLedgerView) WITH TIES CT.PK_ProductToLedgerViewGuid 'ProductToLedgerViewGuid', CT.DeletedRowVersion '_RowVersion'
    ...
    ELSE
    BEGIN
        SELECT CT.PK_ProductToLedgerViewGuid 'ProductToLedgerViewGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblProductToLedgerView] CT
            WHERE 1=2
    END
