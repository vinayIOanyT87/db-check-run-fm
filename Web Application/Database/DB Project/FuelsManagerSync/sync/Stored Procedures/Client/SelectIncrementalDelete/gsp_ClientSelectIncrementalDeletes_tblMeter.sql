...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblMeter]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblMeter) WITH TIES CT.PK_MeterGuid 'MeterGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblMeter] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_MeterGuid 'MeterGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblMeter] CT
            WHERE 1=2
    END
