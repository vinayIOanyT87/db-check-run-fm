...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblProcessVariableRecipeOutputPermissive]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblProcessVariableRecipeOutputPermissive) WITH TIES CT.PK_ProcessVariableProductToPresetRecipeGuid 'ProcessVariableProductToPresetRecipeGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblProcessVariableRecipeOutputPermissive] CT
