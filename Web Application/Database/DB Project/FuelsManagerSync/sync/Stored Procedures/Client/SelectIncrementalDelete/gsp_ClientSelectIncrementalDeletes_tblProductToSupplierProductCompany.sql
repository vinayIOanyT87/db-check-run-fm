...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblProductToSupplierProductCompany]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblProductToSupplierProductCompany) WITH TIES CT.PK_ProductToSupplierProductCompanyGuid 'ProductToSupplierProductCompanyGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblProductToSupplierProductCompany] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_ProductToSupplierProductCompanyGuid 'ProductToSupplierProductCompanyGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblProductToSupplierProductCompany] CT
            WHERE 1=2
    END
