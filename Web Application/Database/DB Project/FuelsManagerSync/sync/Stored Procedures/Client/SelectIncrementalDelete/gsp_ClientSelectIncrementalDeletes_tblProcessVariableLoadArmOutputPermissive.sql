...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblProcessVariableLoadArmOutputPermissive]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblProcessVariableLoadArmOutputPermissive) WITH TIES CT.PK_ProcessVariableLoadArmGuid 'ProcessVariableLoadArmGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblProcessVariableLoadArmOutputPermissive] CT
