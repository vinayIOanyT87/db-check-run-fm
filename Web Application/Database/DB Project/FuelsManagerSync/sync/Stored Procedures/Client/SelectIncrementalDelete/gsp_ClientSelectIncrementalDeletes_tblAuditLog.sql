...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblAuditLog]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblAuditLog) WITH TIES CT.PK_AuditLogGuid 'AuditLogGuid', CT.DeletedRowVersion '_RowVersion'
    ...
    ELSE
    BEGIN
        SELECT CT.PK_AuditLogGuid 'AuditLogGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblAuditLog] CT
            WHERE 1=2
    END
