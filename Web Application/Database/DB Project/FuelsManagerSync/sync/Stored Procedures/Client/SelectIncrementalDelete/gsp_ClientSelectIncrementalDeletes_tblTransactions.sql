...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblTransactions]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblTransactions) WITH TIES CT.PK_TransactionGuid 'TransactionGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblTransactions] CT
                INNER JOIN #SyncTable 
                    ON #SyncTable.PK = CT.[PK_TransactionGuid]
    ...
    ELSE
    BEGIN
        SELECT CT.PK_TransactionGuid 'TransactionGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblTransactions] CT
            WHERE 1=2
    END
