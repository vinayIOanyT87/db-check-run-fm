...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblDrawings]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblDrawings) WITH TIES CT.PK_DrawingGuid 'DrawingGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblDrawings] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_DrawingGuid 'DrawingGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblDrawings] CT
            WHERE 1=2
    END
