...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblQualificationCompanyCertificateAndPermitToCompany]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblQualificationCompanyCertificateAndPermitToCompany) WITH TIES CT.PK_QualificationCompanyCertificateAndPermitToCompanyGuid 'QualificationCompanyCertificateAndPermitToCompanyGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblQualificationCompanyCertificateAndPermitToCompany] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_QualificationCompanyCertificateAndPermitToCompanyGuid 'QualificationCompanyCertificateAndPermitToCompanyGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblQualificationCompanyCertificateAndPermitToCompany] CT
            WHERE 1=2
    END
