...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblProcessVariableTank]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblProcessVariableTank) WITH TIES CT.PK_ProcessVariableTankGuid 'ProcessVariableTankGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblProcessVariableTank] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_ProcessVariableTankGuid 'ProcessVariableTankGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblProcessVariableTank] CT
            WHERE 1=2
    END
