...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblApplicationString]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblApplicationString) WITH TIES CT.PK_ApplicationStringGuid 'ApplicationStringGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblApplicationString] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_ApplicationStringGuid 'ApplicationStringGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblApplicationString] CT
            WHERE 1=2
    END
