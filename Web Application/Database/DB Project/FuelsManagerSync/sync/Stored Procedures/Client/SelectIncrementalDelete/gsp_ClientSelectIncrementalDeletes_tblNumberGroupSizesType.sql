...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblNumberGroupSizesType]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblNumberGroupSizesType) WITH TIES CT.PK_NumberGroupSizesTypeIndex 'NumberGroupSizesTypeIndex', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblNumberGroupSizesType] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_NumberGroupSizesTypeIndex 'NumberGroupSizesTypeIndex', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblNumberGroupSizesType] CT
            WHERE 1=2
    END
