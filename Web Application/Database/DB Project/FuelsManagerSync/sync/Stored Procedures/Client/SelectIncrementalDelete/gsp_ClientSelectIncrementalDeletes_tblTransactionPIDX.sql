...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblTransactionPIDX]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblTransactionPIDX) WITH TIES CT.PK_TransactionPIDXGuid 'TransactionPIDXGuid', CT.[FK_ParentPK] 'TransactionGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblTransactionPIDX] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_TransactionPIDXGuid 'TransactionPIDXGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblTransactionPIDX] CT
            WHERE 1=2
    END
