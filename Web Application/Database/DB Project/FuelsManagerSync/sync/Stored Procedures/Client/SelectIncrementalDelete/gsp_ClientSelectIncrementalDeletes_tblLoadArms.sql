...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblLoadArms]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblLoadArms) WITH TIES CT.PK_LoadArmGuid 'LoadArmGuid', CT.DeletedRowVersion '_RowVersion'
    ...
    ELSE
    BEGIN
        SELECT CT.PK_LoadArmGuid 'LoadArmGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblLoadArms] CT
            WHERE 1=2
    END
