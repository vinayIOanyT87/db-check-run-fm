...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblQualifications]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblQualifications) WITH TIES CT.PK_QualificationGuid 'QualificationGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblQualifications] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_QualificationGuid 'QualificationGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblQualifications] CT
            WHERE 1=2
    END
