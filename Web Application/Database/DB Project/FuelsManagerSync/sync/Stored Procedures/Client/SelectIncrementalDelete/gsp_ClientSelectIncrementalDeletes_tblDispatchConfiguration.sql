...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblDispatchConfiguration]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblDispatchConfiguration) WITH TIES CT.PK_DispatchConfigurationGuid 'DispatchConfigurationGuid', CT.DeletedRowVersion '_RowVersion'
    ...
    ELSE
    BEGIN
        SELECT CT.PK_DispatchConfigurationGuid 'DispatchConfigurationGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblDispatchConfiguration] CT
            WHERE 1=2
    END
