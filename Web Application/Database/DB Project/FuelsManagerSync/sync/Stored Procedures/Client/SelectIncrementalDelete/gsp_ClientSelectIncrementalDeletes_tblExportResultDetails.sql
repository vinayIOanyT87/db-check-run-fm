...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblExportResultDetails]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblExportResultDetails) WITH TIES CT.PK_ExportResultDetailGuid 'ExportResultDetailGuid', CT.[FK_ParentPK] 'ExportResultGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblExportResultDetails] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_ExportResultDetailGuid 'ExportResultDetailGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblExportResultDetails] CT
            WHERE 1=2
    END
