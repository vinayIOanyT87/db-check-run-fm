...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblUserDataListValueProduct]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblUserDataListValueProduct) WITH TIES CT.PK_UserDataListValueProductGuid 'UserDataListValueProductGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblUserDataListValueProduct] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_UserDataListValueProductGuid 'UserDataListValueProductGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblUserDataListValueProduct] CT
            WHERE 1=2
    END
