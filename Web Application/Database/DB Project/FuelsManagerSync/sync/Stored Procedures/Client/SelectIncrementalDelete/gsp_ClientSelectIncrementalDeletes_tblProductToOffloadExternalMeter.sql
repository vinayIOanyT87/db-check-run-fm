...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblProductToOffloadExternalMeter]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblProductToOffloadExternalMeter) WITH TIES CT.PK_ProductToOffloadExternalMeterGuid 'ProductToOffloadExternalMeterGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblProductToOffloadExternalMeter] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_ProductToOffloadExternalMeterGuid 'ProductToOffloadExternalMeterGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblProductToOffloadExternalMeter] CT
            WHERE 1=2
    END
