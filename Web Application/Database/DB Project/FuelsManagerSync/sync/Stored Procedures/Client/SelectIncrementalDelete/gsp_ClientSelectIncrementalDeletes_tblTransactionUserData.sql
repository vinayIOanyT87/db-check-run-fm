...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblTransactionUserData]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblTransactionUserData) WITH TIES CT.PK_TransactionUserDataGuid 'TransactionUserDataGuid', CT.[FK_ParentPK] 'TransactionGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblTransactionUserData] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_TransactionUserDataGuid 'TransactionUserDataGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblTransactionUserData] CT
            WHERE 1=2
    END
