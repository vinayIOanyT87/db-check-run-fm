...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblAlarmTemplate]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblAlarmTemplate) WITH TIES CT.PK_AlarmTemplateGuid 'AlarmTemplateGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblAlarmTemplate] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_AlarmTemplateGuid 'AlarmTemplateGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblAlarmTemplate] CT
            WHERE 1=2
    END
