...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblProcessVariableExternalMeterOutputPermissive]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblProcessVariableExternalMeterOutputPermissive) WITH TIES CT.PK_ProcessVariableProductToOffloadExternalMeterGuid 'ProcessVariableProductToOffloadExternalMeterGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblProcessVariableExternalMeterOutputPermissive] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_ProcessVariableProductToOffloadExternalMeterGuid 'ProcessVariableProductToOffloadExternalMeterGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblProcessVariableExternalMeterOutputPermissive] CT
            WHERE 1=2
    END
