...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblProductToBlendComponent]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblProductToBlendComponent) WITH TIES CT.PK_ProductToBlendComponentGuid 'ProductToBlendComponentGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblProductToBlendComponent] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_ProductToBlendComponentGuid 'ProductToBlendComponentGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblProductToBlendComponent] CT
            WHERE 1=2
    END
