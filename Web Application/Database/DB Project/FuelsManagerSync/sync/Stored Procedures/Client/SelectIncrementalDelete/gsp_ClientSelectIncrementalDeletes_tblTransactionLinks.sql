...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblTransactionLinks]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblTransactionLinks) WITH TIES CT.PK_TransactionLinkGuid 'TransactionLinkGuid', CT.[FK_ParentPK] 'TransactionLineItemGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblTransactionLinks] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_TransactionLinkGuid 'TransactionLinkGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblTransactionLinks] CT
            WHERE 1=2
    END
