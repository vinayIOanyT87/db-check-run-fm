...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblApplicationStringToAlarmEventCategory]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblApplicationStringToAlarmEventCategory) WITH TIES CT.PK_ApplicationStringToAlarmEventCategoryGuid 'ApplicationStringToAlarmEventCategoryGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblApplicationStringToAlarmEventCategory] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_ApplicationStringToAlarmEventCategoryGuid 'ApplicationStringToAlarmEventCategoryGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblApplicationStringToAlarmEventCategory] CT
            WHERE 1=2
    END
