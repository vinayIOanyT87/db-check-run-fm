...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblTrendPenToPointTrend]
...
BEGIN
    ...
    BEGIN 
        ...
        END
	        ...
	        SELECT CT.PK_TrendPenToPointTrendGuid 'TrendPenToPointTrendGuid', CT.FK_ParentPK 'PointTagGuid', CT.DeletedRowVersion '_RowVersion'
			...
			ELSE
			BEGIN
	        SELECT TOP(@sync_batch_size_tblTrendPenToPointTrend) WITH TIES CT.PK_TrendPenToPointTrendGuid 'TrendPenToPointTrendGuid', CT.FK_ParentPK 'PointTagGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblTrendPenToPointTrend] CT
