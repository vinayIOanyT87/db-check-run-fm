...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblProductToPresetRecipe]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblProductToPresetRecipe) WITH TIES CT.PK_ProductToPresetRecipeGuid 'ProductToPresetRecipeGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblProductToPresetRecipe] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_ProductToPresetRecipeGuid 'ProductToPresetRecipeGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblProductToPresetRecipe] CT
            WHERE 1=2
    END
