...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblTankToTankGroup]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblTankToTankGroup) WITH TIES CT.PK_TankToTankGroupGuid 'TankToTankGroupGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblTankToTankGroup] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_TankToTankGroupGuid 'TankToTankGroupGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblTankToTankGroup] CT
            WHERE 1=2
    END
