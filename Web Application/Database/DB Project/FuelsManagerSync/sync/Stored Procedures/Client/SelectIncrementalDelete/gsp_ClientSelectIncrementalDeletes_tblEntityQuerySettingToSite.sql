...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblEntityQuerySettingToSite]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblEntityQuerySettingToSite) WITH TIES CT.PK_QuerySettingToSiteGuid 'QuerySettingToSiteGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblEntityQuerySettingToSite] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_QuerySettingToSiteGuid 'QuerySettingToSiteGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblEntityQuerySettingToSite] CT
            WHERE 1=2
    END
