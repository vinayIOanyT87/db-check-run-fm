...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblUserDataFieldTransactionAlias]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblUserDataFieldTransactionAlias) WITH TIES CT.PK_UserDataFieldTransactionAliasGuid 'UserDataFieldTransactionAliasGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblUserDataFieldTransactionAlias] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_UserDataFieldTransactionAliasGuid 'UserDataFieldTransactionAliasGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblUserDataFieldTransactionAlias] CT
            WHERE 1=2
    END
