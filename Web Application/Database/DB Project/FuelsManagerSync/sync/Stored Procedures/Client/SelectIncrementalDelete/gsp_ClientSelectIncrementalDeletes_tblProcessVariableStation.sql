...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblProcessVariableStation]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblProcessVariableStation) WITH TIES CT.PK_ProcessVariableStationGuid 'ProcessVariableStationGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblProcessVariableStation] CT
