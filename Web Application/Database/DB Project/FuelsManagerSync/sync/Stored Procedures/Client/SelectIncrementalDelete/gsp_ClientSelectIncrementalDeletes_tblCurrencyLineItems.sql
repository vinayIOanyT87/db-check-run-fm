...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblCurrencyLineItems]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblCurrencyLineItems) WITH TIES CT.PK_CurrencyLineItemGuid 'CurrencyLineItemGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblCurrencyLineItems] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_CurrencyLineItemGuid 'CurrencyLineItemGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblCurrencyLineItems] CT
            WHERE 1=2
    END
