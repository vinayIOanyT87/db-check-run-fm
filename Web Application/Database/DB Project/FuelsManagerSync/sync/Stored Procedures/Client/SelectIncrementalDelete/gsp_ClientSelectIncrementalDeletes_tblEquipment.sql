...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblEquipment]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblEquipment) WITH TIES CT.PK_EquipmentGuid 'EquipmentGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblEquipment] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_EquipmentGuid 'EquipmentGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblEquipment] CT
            WHERE 1=2
    END
