...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblAlarm]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT CT.PK_AlarmGuid 'AlarmGuid', CT.[FK_ParentPK] 'InputTagGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblAlarm] CT
