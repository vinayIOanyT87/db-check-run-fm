...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblQualificationPersonQualificationToStation]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblQualificationPersonQualificationToStation) WITH TIES CT.PK_QualificationPersonQualificationToStationGuid 'QualificationPersonQualificationToStationGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblQualificationPersonQualificationToStation] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_QualificationPersonQualificationToStationGuid 'QualificationPersonQualificationToStationGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblQualificationPersonQualificationToStation] CT
            WHERE 1=2
    END
