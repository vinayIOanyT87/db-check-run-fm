...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblDispatchGridType]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblDispatchGridType) WITH TIES CT.PK_DispatchGridTypeIndex 'DispatchGridTypeIndex', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblDispatchGridType] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_DispatchGridTypeIndex 'DispatchGridTypeIndex', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblDispatchGridType] CT
            WHERE 1=2
    END
