...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblApplicationStringToFootNoteAdditiveProfile]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblApplicationStringToFootNoteAdditiveProfile) WITH TIES CT.PK_ApplicationStringToFootNoteAdditiveProfileGuid 'ApplicationStringToFootNoteAdditiveProfileGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblApplicationStringToFootNoteAdditiveProfile] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_ApplicationStringToFootNoteAdditiveProfileGuid 'ApplicationStringToFootNoteAdditiveProfileGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblApplicationStringToFootNoteAdditiveProfile] CT
            WHERE 1=2
    END
