...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblCompanyCompanyToCompanyGroup]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblCompanyCompanyToCompanyGroup) WITH TIES CT.PK_CompanyCompanyToCompanyGroupGuid 'CompanyCompanyToCompanyGroupGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblCompanyCompanyToCompanyGroup] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_CompanyCompanyToCompanyGroupGuid 'CompanyCompanyToCompanyGroupGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblCompanyCompanyToCompanyGroup] CT
            WHERE 1=2
    END
