...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblEquipmentTypes]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblEquipmentTypes) WITH TIES CT.PK_EquipmentTypeGuid 'EquipmentTypeGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblEquipmentTypes] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_EquipmentTypeGuid 'EquipmentTypeGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblEquipmentTypes] CT
            WHERE 1=2
    END
