...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblProcessVariableSite]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblProcessVariableSite) WITH TIES CT.PK_ProcessVariableSiteGuid 'ProcessVariableSiteGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblProcessVariableSite] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_ProcessVariableSiteGuid 'ProcessVariableSiteGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblProcessVariableSite] CT
            WHERE 1=2
    END
