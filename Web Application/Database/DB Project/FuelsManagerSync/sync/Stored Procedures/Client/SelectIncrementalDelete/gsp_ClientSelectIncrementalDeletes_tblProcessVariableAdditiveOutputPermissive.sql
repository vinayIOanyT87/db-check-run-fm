...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblProcessVariableAdditiveOutputPermissive]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblProcessVariableAdditiveOutputPermissive) WITH TIES CT.PK_ProcessVariableProductToPresetInjectorGuid 'ProcessVariableProductToPresetInjectorGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblProcessVariableAdditiveOutputPermissive] CT
