...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblModule]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblModule) WITH TIES CT.PK_ModuleGuid 'ModuleGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblModule] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_ModuleGuid 'ModuleGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblModule] CT
            WHERE 1=2
    END
