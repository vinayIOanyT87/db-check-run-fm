...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblProcessVariableExternalComponentOutputPermissive]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblProcessVariableExternalComponentOutputPermissive) WITH TIES CT.PK_ProcessVariableProductToPresetExternalComponentGuid 'ProcessVariableProductToPresetExternalComponentGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblProcessVariableExternalComponentOutputPermissive] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_ProcessVariableProductToPresetExternalComponentGuid 'ProcessVariableProductToPresetExternalComponentGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblProcessVariableExternalComponentOutputPermissive] CT
            WHERE 1=2
    END
