...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblExportResults]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblExportResults) WITH TIES CT.PK_ExportResultGuid 'ExportResultGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblExportResults] CT
                INNER JOIN #SyncTable 
                    ON #SyncTable.PK = CT.[PK_ExportResultGuid]
    ...
    ELSE
    BEGIN
        SELECT CT.PK_ExportResultGuid 'ExportResultGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblExportResults] CT
            WHERE 1=2
    END
