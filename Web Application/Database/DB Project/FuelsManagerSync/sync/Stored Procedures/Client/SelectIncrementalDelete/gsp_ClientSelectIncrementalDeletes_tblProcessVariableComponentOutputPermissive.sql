...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblProcessVariableComponentOutputPermissive]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblProcessVariableComponentOutputPermissive) WITH TIES CT.PK_ProcessVariableProductToPresetComponentTankOrTankGroupGuid 'ProcessVariableProductToPresetComponentTankOrTankGroupGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblProcessVariableComponentOutputPermissive] CT
