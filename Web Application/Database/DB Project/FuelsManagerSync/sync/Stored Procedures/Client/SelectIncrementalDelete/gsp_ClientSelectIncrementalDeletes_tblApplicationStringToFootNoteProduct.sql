...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblApplicationStringToFootNoteProduct]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblApplicationStringToFootNoteProduct) WITH TIES CT.PK_ApplicationStringToFootNoteProductGuid 'ApplicationStringToFootNoteProductGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblApplicationStringToFootNoteProduct] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_ApplicationStringToFootNoteProductGuid 'ApplicationStringToFootNoteProductGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblApplicationStringToFootNoteProduct] CT
            WHERE 1=2
    END
