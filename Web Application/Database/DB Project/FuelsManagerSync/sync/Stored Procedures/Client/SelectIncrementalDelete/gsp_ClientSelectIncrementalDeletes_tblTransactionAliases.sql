...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblTransactionAliases]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblTransactionAliases) WITH TIES CT.PK_TransactionAliasGuid 'TransactionAliasGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblTransactionAliases] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_TransactionAliasGuid 'TransactionAliasGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblTransactionAliases] CT
            WHERE 1=2
    END
