...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblAnimation]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblAnimation) WITH TIES CT.PK_AnimationGuid 'AnimationGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblAnimation] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_AnimationGuid 'AnimationGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblAnimation] CT
            WHERE 1=2
    END
