...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblUserDataFieldProduct]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblUserDataFieldProduct) WITH TIES CT.PK_UserDataFieldProductGuid 'UserDataFieldProductGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblUserDataFieldProduct] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_UserDataFieldProductGuid 'UserDataFieldProductGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblUserDataFieldProduct] CT
            WHERE 1=2
    END
