...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblProcessVariableEquipment]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblProcessVariableEquipment) WITH TIES CT.PK_ProcessVariableEquipmentGuid 'ProcessVariableEquipmentGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblProcessVariableEquipment] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_ProcessVariableEquipmentGuid 'ProcessVariableEquipmentGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblProcessVariableEquipment] CT
            WHERE 1=2
    END
