...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblCloseoutInventory]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblCloseoutInventory) WITH TIES CT.PK_CloseoutInventoryGuid 'CloseoutInventoryGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblCloseoutInventory] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_CloseoutInventoryGuid 'CloseoutInventoryGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblCloseoutInventory] CT
            WHERE 1=2
    END
