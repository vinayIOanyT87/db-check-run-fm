...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblUserDataListValueIata]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblUserDataListValueIata) WITH TIES CT.PK_UserDataListValueIataGuid 'UserDataListValueIataGuid', CT.DeletedRowVersion '_RowVersion'
    ...
    ELSE
    BEGIN
        SELECT CT.PK_UserDataListValueIataGuid 'UserDataListValueIataGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblUserDataListValueIata] CT
            WHERE 1=2
    END
