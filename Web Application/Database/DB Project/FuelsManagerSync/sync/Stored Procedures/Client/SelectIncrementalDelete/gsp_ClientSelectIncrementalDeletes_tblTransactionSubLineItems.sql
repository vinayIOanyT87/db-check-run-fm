...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblTransactionSubLineItems]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblTransactionSubLineItems) WITH TIES CT.PK_TransactionSubLineItemGuid 'TransactionSubLineItemGuid', CT.[FK_ParentPK] 'TransactionLineItemGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblTransactionSubLineItems] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_TransactionSubLineItemGuid 'TransactionSubLineItemGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblTransactionSubLineItems] CT
            WHERE 1=2
    END
