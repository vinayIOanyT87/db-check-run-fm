...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblQualificationPersonTrainingToPerson]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblQualificationPersonTrainingToPerson) WITH TIES CT.PK_QualificationPersonTrainingToPersonGuid 'QualificationPersonTrainingToPersonGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblQualificationPersonTrainingToPerson] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_QualificationPersonTrainingToPersonGuid 'QualificationPersonTrainingToPersonGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblQualificationPersonTrainingToPerson] CT
            WHERE 1=2
    END
