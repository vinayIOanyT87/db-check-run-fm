...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblFuelCards]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblFuelCards) WITH TIES CT.PK_FuelCardGuid 'FuelCardGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblFuelCards] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_FuelCardGuid 'FuelCardGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblFuelCards] CT
            WHERE 1=2
    END
