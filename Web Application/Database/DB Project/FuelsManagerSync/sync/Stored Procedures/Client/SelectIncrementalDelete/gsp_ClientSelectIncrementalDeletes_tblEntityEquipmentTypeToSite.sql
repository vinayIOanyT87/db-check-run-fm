...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblEntityEquipmentTypeToSite]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblEntityEquipmentTypeToSite) WITH TIES CT.PK_EquipmentTypeToSiteGuid 'EquipmentTypeToSiteGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblEntityEquipmentTypeToSite] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_EquipmentTypeToSiteGuid 'EquipmentTypeToSiteGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblEntityEquipmentTypeToSite] CT
            WHERE 1=2
    END
