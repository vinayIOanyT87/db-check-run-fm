...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblEntityCompanyToSite]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblEntityCompanyToSite) WITH TIES CT.PK_CompanyToSiteGuid 'CompanyToSiteGuid', CT.DeletedRowVersion '_RowVersion'
    ...
    ELSE
    BEGIN
        SELECT CT.PK_CompanyToSiteGuid 'CompanyToSiteGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblEntityCompanyToSite] CT
            WHERE 1=2
    END
