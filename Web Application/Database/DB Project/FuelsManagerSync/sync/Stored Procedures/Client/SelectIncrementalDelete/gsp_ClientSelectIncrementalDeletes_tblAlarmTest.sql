...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblAlarmTest]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT CT.PK_AlarmTestGuid 'AlarmTestGuid', CT.[FK_ParentPK] 'AlarmGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblAlarmTest] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_AlarmTestGuid 'AlarmTestGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblAlarmTest] CT
            WHERE 1=2
    END
