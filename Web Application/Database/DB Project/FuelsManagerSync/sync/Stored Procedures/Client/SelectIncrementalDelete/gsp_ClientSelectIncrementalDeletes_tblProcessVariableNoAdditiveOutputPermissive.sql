...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblProcessVariableNoAdditiveOutputPermissive]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblProcessVariableNoAdditiveOutputPermissive) WITH TIES CT.PK_ProcessVariableLoadArmGuid 'ProcessVariableLoadArmGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblProcessVariableNoAdditiveOutputPermissive] CT
