...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblGates]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblGates) WITH TIES CT.PK_GateGuid 'GateGuid', CT.DeletedRowVersion '_RowVersion'
    ...
    ELSE
    BEGIN
        SELECT CT.PK_GateGuid 'GateGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblGates] CT
            WHERE 1=2
    END
