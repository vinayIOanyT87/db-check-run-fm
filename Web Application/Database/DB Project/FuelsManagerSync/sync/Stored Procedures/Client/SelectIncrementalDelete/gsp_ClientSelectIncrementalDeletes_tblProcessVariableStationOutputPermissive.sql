...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblProcessVariableStationOutputPermissive]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblProcessVariableStationOutputPermissive) WITH TIES CT.PK_ProcessVariableStationGuid 'ProcessVariableStationGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblProcessVariableStationOutputPermissive] CT
