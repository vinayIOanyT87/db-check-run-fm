...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblQualificationPersonQualificationToStation]
...
BEGIN
    ...
    DELETE [map].[tblQualificationPersonQualificationToStation]  
        ...
        WHERE QualificationPersonQualificationToStationGuid = @QualificationPersonQualificationToStationGuid
