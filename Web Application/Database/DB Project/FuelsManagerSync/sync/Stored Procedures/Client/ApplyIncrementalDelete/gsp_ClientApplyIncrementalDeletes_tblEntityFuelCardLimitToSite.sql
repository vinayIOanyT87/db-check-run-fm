...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblEntityFuelCardLimitToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityFuelCardLimitToSite]  
        ...
        WHERE FuelCardLimitToSiteGuid = @FuelCardLimitToSiteGuid
