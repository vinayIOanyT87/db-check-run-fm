...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblUserDataListValueCompany]
...
BEGIN
    ...
    DELETE [dbo].[tblUserDataListValueCompany]  
        ...
        WHERE UserDataListValueCompanyGuid = @UserDataListValueCompanyGuid
