...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblProductToSupplierProductCompany]
...
BEGIN
    ...
    DELETE [map].[tblProductToSupplierProductCompany]  
        ...
        WHERE ProductToSupplierProductCompanyGuid = @ProductToSupplierProductCompanyGuid
