...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblProcessVariableExternalComponentOutputPermissive]
...
BEGIN
    ...
    DELETE [dbo].[tblProcessVariableExternalComponentOutputPermissive]  
        ...
        WHERE ProcessVariableProductToPresetExternalComponentGuid = @ProcessVariableProductToPresetExternalComponentGuid
