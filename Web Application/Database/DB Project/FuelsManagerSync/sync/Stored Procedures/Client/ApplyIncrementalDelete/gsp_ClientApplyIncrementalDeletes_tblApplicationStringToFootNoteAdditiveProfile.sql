...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblApplicationStringToFootNoteAdditiveProfile]
...
BEGIN
    ...
    DELETE [map].[tblApplicationStringToFootNoteAdditiveProfile]  
        ...
        WHERE ApplicationStringToFootNoteAdditiveProfileGuid = @ApplicationStringToFootNoteAdditiveProfileGuid
