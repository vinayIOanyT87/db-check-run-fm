...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblEntityPointTemplateToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityPointTemplateToSite]  
        ...
        WHERE PointTemplateToSiteGuid = @PointTemplateToSiteGuid
