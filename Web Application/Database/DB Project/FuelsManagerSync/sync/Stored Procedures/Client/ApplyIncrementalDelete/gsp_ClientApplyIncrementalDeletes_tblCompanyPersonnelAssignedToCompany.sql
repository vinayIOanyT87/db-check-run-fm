...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblCompanyPersonnelAssignedToCompany]
...
BEGIN
    ...
    DELETE [map].[tblCompanyPersonnelAssignedToCompany]  
        ...
        WHERE CompanyPersonnelAssignedToCompanyGuid = @CompanyPersonnelAssignedToCompanyGuid
