...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblEntityListViewToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityListViewToSite]  
        ...
        WHERE ListViewToSiteGuid = @ListViewToSiteGuid
