...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblUserDataFieldIata]
...
BEGIN
    ...
    DELETE [dbo].[tblUserDataFieldIata]  
        ...
        WHERE UserDataFieldIataGuid = @UserDataFieldIataGuid
