...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblActivationStatus]
...
BEGIN
    ...
    DELETE [lookup].[tblActivationStatus]  
        ...
        WHERE ActivationStatusIndex = @ActivationStatusIndex
