...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblEntityDotHazardousMessagesToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityDotHazardousMessagesToSite]  
        ...
        WHERE DotHazardousMessagesToSiteGuid = @DotHazardousMessagesToSiteGuid
