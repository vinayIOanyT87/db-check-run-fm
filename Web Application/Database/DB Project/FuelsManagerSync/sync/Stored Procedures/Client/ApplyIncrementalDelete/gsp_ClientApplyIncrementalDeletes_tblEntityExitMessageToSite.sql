...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblEntityExitMessageToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityExitMessageToSite]  
        ...
        WHERE ExitMessageToSiteGuid = @ExitMessageToSiteGuid
