...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblEntityEquipmentToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityEquipmentToSite]  
        ...
        WHERE EquipmentToSiteGuid = @EquipmentToSiteGuid
