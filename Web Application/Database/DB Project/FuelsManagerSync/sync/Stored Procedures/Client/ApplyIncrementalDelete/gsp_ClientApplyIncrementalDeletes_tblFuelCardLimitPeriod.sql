...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblFuelCardLimitPeriod]
...
BEGIN
    ...
    DELETE [lookup].[tblFuelCardLimitPeriod]  
        ...
        WHERE FuelCardLimitPeriodIndex = @FuelCardLimitPeriodIndex
