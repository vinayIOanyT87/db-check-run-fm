...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblEntityAlarmPriorityToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityAlarmPriorityToSite]  
        ...
        WHERE AlarmPriorityToSiteGuid = @AlarmPriorityToSiteGuid
