...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblUserDataFieldUser]
...
BEGIN
    ...
    DELETE [dbo].[tblUserDataFieldUser]  
        ...
        WHERE UserDataFieldUserGuid = @UserDataFieldUserGuid
