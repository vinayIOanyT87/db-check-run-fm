...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblEntityEquipmentTagAndLicenseToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityEquipmentTagAndLicenseToSite]  
        ...
        WHERE EquipmentTagAndLicenseToSiteGuid = @EquipmentTagAndLicenseToSiteGuid
