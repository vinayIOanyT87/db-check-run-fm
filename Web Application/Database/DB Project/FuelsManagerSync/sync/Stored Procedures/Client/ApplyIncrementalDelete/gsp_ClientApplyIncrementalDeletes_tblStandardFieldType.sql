...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblStandardFieldType]
...
BEGIN
    ...
    DELETE [lookup].[tblStandardFieldType]  
        ...
        WHERE StandardFieldTypeIndex = @StandardFieldTypeIndex
