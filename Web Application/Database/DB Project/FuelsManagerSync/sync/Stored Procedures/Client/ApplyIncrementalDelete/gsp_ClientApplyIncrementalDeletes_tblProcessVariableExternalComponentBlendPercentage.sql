...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblProcessVariableExternalComponentBlendPercentage]
...
BEGIN
    ...
    DELETE [dbo].[tblProcessVariableExternalComponentBlendPercentage]  
