...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblPointAccessGroupToUserGroup]
...
BEGIN
    ...
    DELETE [map].[tblPointAccessGroupToUserGroup]  
        ...
        WHERE PointAccessGroupToUserGroupGuid = @PointAccessGroupToUserGroupGuid
