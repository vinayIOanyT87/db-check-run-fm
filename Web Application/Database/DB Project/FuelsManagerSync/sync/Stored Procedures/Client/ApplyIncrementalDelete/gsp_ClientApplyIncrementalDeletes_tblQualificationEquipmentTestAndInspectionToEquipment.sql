...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblQualificationEquipmentTestAndInspectionToEquipment]
...
BEGIN
    ...
    DELETE [map].[tblQualificationEquipmentTestAndInspectionToEquipment]  
        ...
        WHERE QualificationEquipmentTestAndInspectionToEquipmentGuid = @QualificationEquipmentTestAndInspectionToEquipmentGuid
