...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblQualificationPersonLicenseToStation]
...
BEGIN
    ...
    DELETE [map].[tblQualificationPersonLicenseToStation]  
        ...
        WHERE QualificationPersonLicenseToStationGuid = @QualificationPersonLicenseToStationGuid
