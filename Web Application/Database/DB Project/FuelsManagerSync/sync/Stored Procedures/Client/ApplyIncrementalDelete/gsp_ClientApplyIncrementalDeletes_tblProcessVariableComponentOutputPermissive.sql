...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblProcessVariableComponentOutputPermissive]
...
BEGIN
    ...
    DELETE [dbo].[tblProcessVariableComponentOutputPermissive]  
