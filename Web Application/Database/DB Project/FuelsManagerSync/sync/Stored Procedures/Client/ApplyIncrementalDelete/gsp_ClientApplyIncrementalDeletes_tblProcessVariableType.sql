...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblProcessVariableType]
...
BEGIN
    ...
    DELETE [lookup].[tblProcessVariableType]  
        ...
        WHERE ProcessVariableTypeIndex = @ProcessVariableTypeIndex
