...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblPointTagAlarmStatus]
...
BEGIN
    ...
    DELETE [dbo].[tblPointTagAlarmStatus]  
        ...
        WHERE PointTagAlarmStatusGuid = @PointTagAlarmStatusGuid
