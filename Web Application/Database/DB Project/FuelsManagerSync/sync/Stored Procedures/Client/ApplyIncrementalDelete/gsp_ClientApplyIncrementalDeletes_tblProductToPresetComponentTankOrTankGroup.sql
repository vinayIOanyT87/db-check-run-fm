...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblProductToPresetComponentTankOrTankGroup]
...
BEGIN
    ...
    DELETE [map].[tblProductToPresetComponentTankOrTankGroup]  
