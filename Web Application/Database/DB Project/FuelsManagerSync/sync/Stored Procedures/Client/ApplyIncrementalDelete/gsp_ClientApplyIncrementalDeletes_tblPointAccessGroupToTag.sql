...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblPointAccessGroupToTag]
...
BEGIN
    ...
    DELETE [map].[tblPointAccessGroupToTag]  
        ...
        WHERE PointAccessGroupToTagGuid = @PointAccessGroupToTagGuid
