...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblEntityMobileDeviceProfileToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityMobileDeviceProfileToSite]  
        ...
        WHERE MobileDeviceProfileToSiteGuid = @MobileDeviceProfileToSiteGuid
