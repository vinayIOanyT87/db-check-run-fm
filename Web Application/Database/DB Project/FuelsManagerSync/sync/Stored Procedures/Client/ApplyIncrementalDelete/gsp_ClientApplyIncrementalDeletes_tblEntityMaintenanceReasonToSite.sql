...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblEntityMaintenanceReasonToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityMaintenanceReasonToSite]  
        ...
        WHERE MaintenanceReasonToSiteGuid = @MaintenanceReasonToSiteGuid
