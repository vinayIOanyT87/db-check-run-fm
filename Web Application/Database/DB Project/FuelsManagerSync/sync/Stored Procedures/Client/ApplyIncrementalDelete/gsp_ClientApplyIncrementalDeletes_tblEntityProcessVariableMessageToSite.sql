...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblEntityProcessVariableMessageToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityProcessVariableMessageToSite]  
        ...
        WHERE ProcessVariableMessageToSiteGuid = @ProcessVariableMessageToSiteGuid
