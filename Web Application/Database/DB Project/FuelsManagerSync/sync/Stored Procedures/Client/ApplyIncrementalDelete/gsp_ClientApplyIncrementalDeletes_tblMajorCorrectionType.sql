...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblMajorCorrectionType]
...
BEGIN
    ...
    DELETE [lookup].[tblMajorCorrectionType]  
        ...
        WHERE MajorCorrectionTypeIndex = @MajorCorrectionTypeIndex
