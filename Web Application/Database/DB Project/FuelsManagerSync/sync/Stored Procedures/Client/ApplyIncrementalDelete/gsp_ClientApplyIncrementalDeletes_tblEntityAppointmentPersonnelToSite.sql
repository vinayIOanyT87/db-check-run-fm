...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblEntityAppointmentPersonnelToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityAppointmentPersonnelToSite]  
        ...
        WHERE AppointmentPersonnelToSiteGuid = @AppointmentPersonnelToSiteGuid
