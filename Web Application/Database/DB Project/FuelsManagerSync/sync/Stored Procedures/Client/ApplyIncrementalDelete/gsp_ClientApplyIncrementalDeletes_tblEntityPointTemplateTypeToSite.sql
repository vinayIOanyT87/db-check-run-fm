...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblEntityPointTemplateTypeToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityPointTemplateTypeToSite]  
        ...
        WHERE PointTemplateTypeToSiteGuid = @PointTemplateTypeToSiteGuid
