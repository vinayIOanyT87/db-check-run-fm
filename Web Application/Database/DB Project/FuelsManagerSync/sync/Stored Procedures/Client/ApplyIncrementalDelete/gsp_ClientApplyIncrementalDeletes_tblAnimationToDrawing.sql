...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblAnimationToDrawing]
...
BEGIN
    ...
    DELETE [map].[tblAnimationToDrawing]  
        ...
        WHERE AnimationToDrawingGuid = @AnimationToDrawingGuid
