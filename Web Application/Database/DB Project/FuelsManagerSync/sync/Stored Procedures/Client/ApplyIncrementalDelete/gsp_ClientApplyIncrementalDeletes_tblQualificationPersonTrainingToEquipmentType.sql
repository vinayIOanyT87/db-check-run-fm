...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblQualificationPersonTrainingToEquipmentType]
...
BEGIN
    ...
    DELETE [map].[tblQualificationPersonTrainingToEquipmentType]  
