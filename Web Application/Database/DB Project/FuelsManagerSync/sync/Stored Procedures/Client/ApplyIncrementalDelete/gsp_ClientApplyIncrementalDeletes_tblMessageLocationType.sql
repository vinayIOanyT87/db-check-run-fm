...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblMessageLocationType]
...
BEGIN
    ...
    DELETE [lookup].[tblMessageLocationType]  
        ...
        WHERE MessageLocationTypeIndex = @MessageLocationTypeIndex
