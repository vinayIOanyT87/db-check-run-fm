...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblProductToCompany]
...
BEGIN
    ...
    DELETE [map].[tblProductToCompany]  
        ...
        WHERE ProductToCompanyGuid = @ProductToCompanyGuid
