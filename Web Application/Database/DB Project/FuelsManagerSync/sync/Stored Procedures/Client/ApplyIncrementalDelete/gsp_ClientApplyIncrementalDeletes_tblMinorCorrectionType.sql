...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblMinorCorrectionType]
...
BEGIN
    ...
    DELETE [lookup].[tblMinorCorrectionType]  
        ...
        WHERE MinorCorrectionTypeIndex = @MinorCorrectionTypeIndex
