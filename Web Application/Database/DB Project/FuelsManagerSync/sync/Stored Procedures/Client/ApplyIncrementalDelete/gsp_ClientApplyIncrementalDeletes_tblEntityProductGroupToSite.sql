...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblEntityProductGroupToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityProductGroupToSite]  
        ...
        WHERE ProductGroupToSiteGuid = @ProductGroupToSiteGuid
