...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblUsers]
...
BEGIN
    ...
    DELETE FROM [dbo].[tblMenuFavorites] WHERE UserGuid = @UserGuid
    DELETE FROM [dbo].[tblUserViewStateSettings] WHERE UserGuid = @UserGuid
    DELETE FROM [dbo].[tblSessions] WHERE UserGuid = @UserGuid
    DELETE FROM [dbo].[tblDispatchGridColumn] WHERE UserGuid = @UserGuid 
    DELETE FROM [dbo].[tblSavedQueries] WHERE UserGuid = @UserGuid 
