...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblEntityCompanyGroupToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityCompanyGroupToSite]  
        ...
        WHERE CompanyGroupToSiteGuid = @CompanyGroupToSiteGuid
