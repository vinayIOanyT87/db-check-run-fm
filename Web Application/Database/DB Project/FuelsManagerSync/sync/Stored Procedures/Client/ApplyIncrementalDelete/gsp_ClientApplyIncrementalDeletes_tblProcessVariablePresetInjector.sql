...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblProcessVariablePresetInjector]
...
BEGIN
    ...
    DELETE [dbo].[tblProcessVariablePresetInjector]  
        ...
        WHERE ProcessVariablePresetInjectorGuid = @ProcessVariablePresetInjectorGuid
