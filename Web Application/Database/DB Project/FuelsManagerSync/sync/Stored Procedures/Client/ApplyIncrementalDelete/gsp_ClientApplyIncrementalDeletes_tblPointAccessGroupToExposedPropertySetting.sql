...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblPointAccessGroupToExposedPropertySetting]
...
BEGIN
    ...
    DELETE [map].[tblPointAccessGroupToExposedPropertySetting]  
        ...
        WHERE PointAccessGroupToExposedSettingGuid = @PointAccessGroupToExposedSettingGuid
