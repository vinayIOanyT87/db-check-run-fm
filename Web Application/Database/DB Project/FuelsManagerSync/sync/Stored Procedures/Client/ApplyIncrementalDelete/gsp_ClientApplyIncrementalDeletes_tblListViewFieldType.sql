...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblListViewFieldType]
...
BEGIN
    ...
    DELETE [lookup].[tblListViewFieldType]  
        ...
        WHERE ListViewFieldTypeIndex = @ListViewFieldTypeIndex
