...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblMeterToEquipment]
...
BEGIN
    ...
    DELETE [map].[tblMeterToEquipment]  
        ...
        WHERE MeterToEquipmentGuid = @MeterToEquipmentGuid
