...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblUserDataListValueTransactionAliasLineItem]
...
BEGIN
    ...
    DELETE [dbo].[tblUserDataListValueTransactionAliasLineItem]  
