...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblStationInterfaceType]
...
BEGIN
    ...
    DELETE [lookup].[tblStationInterfaceType]  
        ...
        WHERE StationInterfaceTypeIndex = @StationInterfaceTypeIndex
