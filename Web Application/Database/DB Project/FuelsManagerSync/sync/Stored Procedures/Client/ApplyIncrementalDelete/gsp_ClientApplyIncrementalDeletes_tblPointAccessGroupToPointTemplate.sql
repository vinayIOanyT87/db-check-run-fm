...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblPointAccessGroupToPointTemplate]
...
BEGIN
    ...
    DELETE [map].[tblPointAccessGroupToPointTemplate]  
        ...
        WHERE PointAccessGroupToPointTemplateGuid = @PointAccessGroupToPointTemplateGuid
