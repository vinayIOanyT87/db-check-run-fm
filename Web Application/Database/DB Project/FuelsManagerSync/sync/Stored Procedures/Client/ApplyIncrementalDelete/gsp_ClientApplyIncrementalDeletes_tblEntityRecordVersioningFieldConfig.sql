...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblEntityRecordVersioningFieldConfig]
...
BEGIN
    ...
    DELETE [erv].[tblEntityRecordVersioningFieldConfig]  
        ...
        WHERE FieldConfigGuid = @FieldConfigGuid
