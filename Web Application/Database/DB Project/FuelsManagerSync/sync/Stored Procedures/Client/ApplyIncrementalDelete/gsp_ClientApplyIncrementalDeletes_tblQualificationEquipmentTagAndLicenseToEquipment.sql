...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblQualificationEquipmentTagAndLicenseToEquipment]
...
BEGIN
    ...
    DELETE [map].[tblQualificationEquipmentTagAndLicenseToEquipment]  
