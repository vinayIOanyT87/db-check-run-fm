...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblEntityProductMessageToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityProductMessageToSite]  
        ...
        WHERE ProductMessageToSiteGuid = @ProductMessageToSiteGuid
