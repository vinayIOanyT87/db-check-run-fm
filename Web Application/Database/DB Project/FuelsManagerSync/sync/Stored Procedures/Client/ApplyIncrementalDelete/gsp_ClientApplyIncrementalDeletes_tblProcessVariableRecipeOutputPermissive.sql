...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblProcessVariableRecipeOutputPermissive]
...
BEGIN
    ...
    DELETE [dbo].[tblProcessVariableRecipeOutputPermissive]  
        ...
        WHERE ProcessVariableProductToPresetRecipeGuid = @ProcessVariableProductToPresetRecipeGuid
