...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblPointTemplateTagAlarmStatus]
...
BEGIN
    ...
    DELETE [dbo].[tblPointTemplateTagAlarmStatus]  
        ...
        WHERE PointTemplateTagAlarmStatusGuid = @PointTemplateTagAlarmStatusGuid
