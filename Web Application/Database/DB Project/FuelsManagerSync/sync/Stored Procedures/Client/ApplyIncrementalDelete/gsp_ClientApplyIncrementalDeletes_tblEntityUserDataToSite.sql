...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblEntityUserDataToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityUserDataToSite]  
        ...
        WHERE UserDataToSiteGuid = @UserDataToSiteGuid
