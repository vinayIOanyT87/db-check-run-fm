...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblEntityFuelCardTypeToSite]
...
BEGIN
    ...
    DELETE [map].[tblEntityFuelCardTypeToSite]  
        ...
        WHERE FuelCardTypeToSiteGuid = @FuelCardTypeToSiteGuid
