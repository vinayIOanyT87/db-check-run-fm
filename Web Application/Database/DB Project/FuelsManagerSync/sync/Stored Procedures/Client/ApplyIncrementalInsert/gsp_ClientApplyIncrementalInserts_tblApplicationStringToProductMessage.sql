...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalInserts_tblApplicationStringToProductMessage]
...
BEGIN
    ...
    ;   MERGE [map].[tblApplicationStringToProductMessage] AS existingData
        USING (SELECT @ApplicationStringToProductMessageGuid 'ApplicationStringToProductMessageGuid',@ApplicationStringGuid 'ApplicationStringGuid',@ProductGuid 'ProductGuid',@Sequence 'Sequence',@CreatedDate 'CreatedDate',@CreatedBy 'CreatedBy',@UpdatedDate 'UpdatedDate',@UpdatedBy 'UpdatedBy'
        ...
        WHEN NOT MATCHED THEN
            INSERT ([ApplicationStringToProductMessageGuid],[ApplicationStringGuid],[ProductGuid],[Sequence],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy])
                VALUES (@ApplicationStringToProductMessageGuid,@ApplicationStringGuid,@ProductGuid,@Sequence,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy)
        ;
