...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalInserts_tblMailServerConnectMode]
...
BEGIN
    ...
    ;   MERGE [lookup].[tblMailServerConnectMode] AS existingData
        USING (SELECT @MailServerConnectModeIndex 'MailServerConnectModeIndex',@MailServerConnectModeCode 'MailServerConnectModeCode',@MailServerConnectModeName 'MailServerConnectModeName',@MailServerConnectModeGuid 'MailServerConnectModeGuid',@CreatedDate 'CreatedDate',@CreatedBy 'CreatedBy',@UpdatedDate 'UpdatedDate',@UpdatedBy 'UpdatedBy'
        ...
        WHEN MATCHED AND (remoteChanges.CreatedDate > existingData.CreatedDate OR remoteChanges.UpdatedDate > existingData.UpdatedDate) THEN
            UPDATE SET [MailServerConnectModeCode] = remoteChanges.[MailServerConnectModeCode]
                       ,[MailServerConnectModeName] = remoteChanges.[MailServerConnectModeName]
                       ,[MailServerConnectModeGuid] = remoteChanges.[MailServerConnectModeGuid]
        ...
        WHEN NOT MATCHED THEN
            INSERT ([MailServerConnectModeIndex],[MailServerConnectModeCode],[MailServerConnectModeName],[MailServerConnectModeGuid],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy])
                VALUES (@MailServerConnectModeIndex,@MailServerConnectModeCode,@MailServerConnectModeName,@MailServerConnectModeGuid,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy)
        ;
