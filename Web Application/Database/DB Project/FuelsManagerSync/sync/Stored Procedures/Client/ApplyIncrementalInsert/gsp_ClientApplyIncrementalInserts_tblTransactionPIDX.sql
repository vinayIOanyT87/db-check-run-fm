...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalInserts_tblTransactionPIDX]
...
BEGIN
    ...
    ;   MERGE [dbo].[tblTransactionPIDX] AS existingData
        USING (SELECT @AuthorizationNumber 'AuthorizationNumber',@SentFlag 'SentFlag',@DateSent 'DateSent',@CreatedBy 'CreatedBy',@CreatedDate 'CreatedDate',@UpdatedBy 'UpdatedBy',@UpdatedDate 'UpdatedDate',@BrokenBlend 'BrokenBlend',@TransactionPIDXGuid 'TransactionPIDXGuid',@PIDXProfileGuid 'PIDXProfileGuid',@TransactionGuid 'TransactionGuid',@CompanyPersonnelToShipToBillToGuid 'CompanyPersonnelToShipToBillToGuid',@BOLVersion 'BOLVersion'
        ...
        WHEN MATCHED AND (remoteChanges.CreatedDate > existingData.CreatedDate OR remoteChanges.UpdatedDate > existingData.UpdatedDate) THEN
            UPDATE SET [AuthorizationNumber] = remoteChanges.[AuthorizationNumber]
                       ,[SentFlag] = remoteChanges.[SentFlag]
                       ,[DateSent] = remoteChanges.[DateSent]
                       ,[CreatedBy] = remoteChanges.[CreatedBy]
                       ,[CreatedDate] = remoteChanges.[CreatedDate]
                       ,[UpdatedBy] = remoteChanges.[UpdatedBy]
                       ,[UpdatedDate] = remoteChanges.[UpdatedDate]
                       ,[BrokenBlend] = remoteChanges.[BrokenBlend]
                       ,[PIDXProfileGuid] = remoteChanges.[PIDXProfileGuid]
                       ,[TransactionGuid] = remoteChanges.[TransactionGuid]
                       ,[CompanyPersonnelToShipToBillToGuid] = remoteChanges.[CompanyPersonnelToShipToBillToGuid]
                       ,[BOLVersion] = remoteChanges.[BOLVersion]
        ...
        WHEN NOT MATCHED THEN
            INSERT ([AuthorizationNumber],[SentFlag],[DateSent],[CreatedBy],[CreatedDate],[UpdatedBy],[UpdatedDate],[BrokenBlend],[TransactionPIDXGuid],[PIDXProfileGuid],[TransactionGuid],[CompanyPersonnelToShipToBillToGuid],[BOLVersion])
                VALUES (@AuthorizationNumber,@SentFlag,@DateSent,@CreatedBy,@CreatedDate,@UpdatedBy,@UpdatedDate,@BrokenBlend,@TransactionPIDXGuid,@PIDXProfileGuid,@TransactionGuid,@CompanyPersonnelToShipToBillToGuid,@BOLVersion)
        ;
