...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalInserts_tblExciseToCompany]
...
BEGIN
    ...
    ;   MERGE [map].[tblExciseToCompany] AS existingData
        USING (SELECT @ExciseToCompanyGuid 'ExciseToCompanyGuid',@ExciseGuid 'ExciseGuid',@CompanyGuid 'CompanyGuid',@CreatedDate 'CreatedDate',@CreatedBy 'CreatedBy',@UpdatedDate 'UpdatedDate',@UpdatedBy 'UpdatedBy'
        ...
        WHEN MATCHED AND (remoteChanges.CreatedDate > existingData.CreatedDate OR remoteChanges.UpdatedDate > existingData.UpdatedDate) THEN
            UPDATE SET [ExciseGuid] = remoteChanges.[ExciseGuid]
        ...
        WHEN NOT MATCHED THEN
            INSERT ([ExciseToCompanyGuid],[ExciseGuid],[CompanyGuid],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy])
                VALUES (@ExciseToCompanyGuid,@ExciseGuid,@CompanyGuid,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy)
        ;
