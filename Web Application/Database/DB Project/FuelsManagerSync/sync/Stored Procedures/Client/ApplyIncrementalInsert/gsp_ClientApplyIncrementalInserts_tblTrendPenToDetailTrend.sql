...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalInserts_tblTrendPenToDetailTrend]
...
BEGIN
    ...
    ;   MERGE [map].[tblTrendPenToDetailTrend] AS existingData
        USING (SELECT @TrendPenToDetailTrendGuid 'TrendPenToDetailTrendGuid',@PointTemplateTagGuid 'PointTemplateTagGuid',@TrendGuid 'TrendGuid',@PenColor 'PenColor',@CreatedDate 'CreatedDate',@CreatedBy 'CreatedBy',@UpdatedDate 'UpdatedDate',@UpdatedBy 'UpdatedBy'
        ...
        WHEN MATCHED AND (remoteChanges.CreatedDate > existingData.CreatedDate OR remoteChanges.UpdatedDate > existingData.UpdatedDate) THEN
            UPDATE SET [PointTemplateTagGuid] = remoteChanges.[PointTemplateTagGuid]
        ...
        WHEN NOT MATCHED THEN
            INSERT ([TrendPenToDetailTrendGuid],[PointTemplateTagGuid],[TrendGuid],[PenColor],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy])
                VALUES (@TrendPenToDetailTrendGuid,@PointTemplateTagGuid,@TrendGuid,@PenColor,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy)
        ;
