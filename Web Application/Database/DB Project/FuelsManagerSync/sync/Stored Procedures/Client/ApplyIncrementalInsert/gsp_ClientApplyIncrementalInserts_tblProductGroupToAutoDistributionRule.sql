...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalInserts_tblProductGroupToAutoDistributionRule]
...
BEGIN
    ...
    ;   MERGE [map].[tblProductGroupToAutoDistributionRule] AS existingData
        USING (SELECT @ProductGroupToAutoDistributionRuleGuid 'ProductGroupToAutoDistributionRuleGuid',@AutoDistributionRuleGuid 'AutoDistributionRuleGuid',@ProductGroupGuid 'ProductGroupGuid',@CreatedDate 'CreatedDate',@CreatedBy 'CreatedBy',@UpdatedDate 'UpdatedDate',@UpdatedBy 'UpdatedBy'
        ...
        WHEN MATCHED AND (remoteChanges.CreatedDate > existingData.CreatedDate OR remoteChanges.UpdatedDate > existingData.UpdatedDate) THEN
            UPDATE SET [AutoDistributionRuleGuid] = remoteChanges.[AutoDistributionRuleGuid]
                       ,[ProductGroupGuid] = remoteChanges.[ProductGroupGuid]
