...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalInserts_tblActivationStatus]
...
BEGIN
    ...
    ;   MERGE [lookup].[tblActivationStatus] AS existingData
        USING (SELECT @ActivationStatusIndex 'ActivationStatusIndex',@ActivationStatusCode 'ActivationStatusCode',@ActivationStatusName 'ActivationStatusName',@ActivationStatusGuid 'ActivationStatusGuid',@CreatedDate 'CreatedDate',@CreatedBy 'CreatedBy',@UpdatedDate 'UpdatedDate',@UpdatedBy 'UpdatedBy'
        ...
        WHEN MATCHED AND (remoteChanges.CreatedDate > existingData.CreatedDate OR remoteChanges.UpdatedDate > existingData.UpdatedDate) THEN
            UPDATE SET [ActivationStatusCode] = remoteChanges.[ActivationStatusCode]
                       ,[ActivationStatusName] = remoteChanges.[ActivationStatusName]
                       ,[ActivationStatusGuid] = remoteChanges.[ActivationStatusGuid]
        ...
        WHEN NOT MATCHED THEN
            INSERT ([ActivationStatusIndex],[ActivationStatusCode],[ActivationStatusName],[ActivationStatusGuid],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy])
                VALUES (@ActivationStatusIndex,@ActivationStatusCode,@ActivationStatusName,@ActivationStatusGuid,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy)
        ;
