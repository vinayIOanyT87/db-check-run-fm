...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalInserts_tblProductToPresetExternalComponent]
...
BEGIN
    ...
    ;   MERGE [map].[tblProductToPresetExternalComponent] AS existingData
        ...
        WHEN MATCHED AND (remoteChanges.CreatedDate > existingData.CreatedDate OR remoteChanges.UpdatedDate > existingData.UpdatedDate) THEN
            UPDATE SET [TankGroupApplicationStringGuid] = remoteChanges.[TankGroupApplicationStringGuid]
