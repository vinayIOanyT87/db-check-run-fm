...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalInserts_tblProcessVariableLoadArmInputPermissive]
...
BEGIN
    ...
    ;   MERGE [dbo].[tblProcessVariableLoadArmInputPermissive] AS existingData
