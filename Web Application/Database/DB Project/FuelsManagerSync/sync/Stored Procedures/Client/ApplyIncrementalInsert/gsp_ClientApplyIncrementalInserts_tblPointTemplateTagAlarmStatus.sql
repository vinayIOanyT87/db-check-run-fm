...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalInserts_tblPointTemplateTagAlarmStatus]
...
BEGIN
    ...
    ;   MERGE [dbo].[tblPointTemplateTagAlarmStatus] AS existingData
        USING (SELECT @PointTemplateTagAlarmStatusGuid 'PointTemplateTagAlarmStatusGuid',@AlarmTestTemplateGuid 'AlarmTestTemplateGuid',@Acknowledged 'Acknowledged',@AcknowledgedTimestamp 'AcknowledgedTimestamp',@AcknowledgedBy 'AcknowledgedBy',@AcknowledgedComment 'AcknowledgedComment',@Silenced 'Silenced',@SilencedTimestamp 'SilencedTimestamp',@SilencedBy 'SilencedBy',@AlarmTestFailed 'AlarmTestFailed',@AlarmTestFailedTimestamp 'AlarmTestFailedTimestamp',@CreatedDate 'CreatedDate',@CreatedBy 'CreatedBy',@UpdatedDate 'UpdatedDate',@UpdatedBy 'UpdatedBy'
        ...
        WHEN MATCHED AND (remoteChanges.CreatedDate > existingData.CreatedDate OR remoteChanges.UpdatedDate > existingData.UpdatedDate) THEN
            UPDATE SET [AlarmTestTemplateGuid] = remoteChanges.[AlarmTestTemplateGuid]
                       ,[Acknowledged] = remoteChanges.[Acknowledged]
                       ,[AcknowledgedTimestamp] = remoteChanges.[AcknowledgedTimestamp]
                       ,[AcknowledgedBy] = remoteChanges.[AcknowledgedBy]
                       ,[AcknowledgedComment] = remoteChanges.[AcknowledgedComment]
                       ,[Silenced] = remoteChanges.[Silenced]
                       ,[SilencedTimestamp] = remoteChanges.[SilencedTimestamp]
                       ,[SilencedBy] = remoteChanges.[SilencedBy]
                       ,[AlarmTestFailed] = remoteChanges.[AlarmTestFailed]
                       ,[AlarmTestFailedTimestamp] = remoteChanges.[AlarmTestFailedTimestamp]
        ...
        WHEN NOT MATCHED THEN
            INSERT ([PointTemplateTagAlarmStatusGuid],[AlarmTestTemplateGuid],[Acknowledged],[AcknowledgedTimestamp],[AcknowledgedBy],[AcknowledgedComment],[Silenced],[SilencedTimestamp],[SilencedBy],[AlarmTestFailed],[AlarmTestFailedTimestamp],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy])
                VALUES (@PointTemplateTagAlarmStatusGuid,@AlarmTestTemplateGuid,@Acknowledged,@AcknowledgedTimestamp,@AcknowledgedBy,@AcknowledgedComment,@Silenced,@SilencedTimestamp,@SilencedBy,@AlarmTestFailed,@AlarmTestFailedTimestamp,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy)
        ;
