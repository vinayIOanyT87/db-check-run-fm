...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalInserts_tblCurrencyUnit]
...
BEGIN
    ...
    ;   MERGE [lookup].[tblCurrencyUnit] AS existingData
        USING (SELECT @CurrencyUnitIndex 'CurrencyUnitIndex',@CurrencyUnitCode 'CurrencyUnitCode',@CurrencyUnitName 'CurrencyUnitName',@CurrencyUnitGuid 'CurrencyUnitGuid',@CreatedDate 'CreatedDate',@CreatedBy 'CreatedBy',@UpdatedDate 'UpdatedDate',@UpdatedBy 'UpdatedBy'
        ...
        WHEN MATCHED AND (remoteChanges.CreatedDate > existingData.CreatedDate OR remoteChanges.UpdatedDate > existingData.UpdatedDate) THEN
            UPDATE SET [CurrencyUnitCode] = remoteChanges.[CurrencyUnitCode]
                       ,[CurrencyUnitName] = remoteChanges.[CurrencyUnitName]
                       ,[CurrencyUnitGuid] = remoteChanges.[CurrencyUnitGuid]
        ...
        WHEN NOT MATCHED THEN
            INSERT ([CurrencyUnitIndex],[CurrencyUnitCode],[CurrencyUnitName],[CurrencyUnitGuid],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy])
                VALUES (@CurrencyUnitIndex,@CurrencyUnitCode,@CurrencyUnitName,@CurrencyUnitGuid,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy)
        ;
