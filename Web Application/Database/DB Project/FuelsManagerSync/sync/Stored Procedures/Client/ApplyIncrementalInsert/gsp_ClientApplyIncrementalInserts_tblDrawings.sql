...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalInserts_tblDrawings]
...
BEGIN
    ...
    ;   MERGE [dbo].[tblDrawings] AS existingData
        USING (SELECT @DrawingGuid 'DrawingGuid',@ID 'ID',@Description 'Description',@Image 'Image',@SiteGuid 'SiteGuid',@PanelType 'PanelType',@PointTemplateGuid 'PointTemplateGuid',@Published 'Published',@CreatedDate 'CreatedDate',@CreatedBy 'CreatedBy',@UpdatedDate 'UpdatedDate',@UpdatedBy 'UpdatedBy'
        ...
        WHEN MATCHED AND (remoteChanges.CreatedDate > existingData.CreatedDate OR remoteChanges.UpdatedDate > existingData.UpdatedDate) THEN
            UPDATE SET [ID] = remoteChanges.[ID]
                       ...
                       ,[Image] = remoteChanges.[Image]
                       ,[SiteGuid] = remoteChanges.[SiteGuid]
                       ,[PanelType] = remoteChanges.[PanelType]
                       ,[PointTemplateGuid] = remoteChanges.[PointTemplateGuid]
                       ,[Published] = remoteChanges.[Published]
        ...
        WHEN NOT MATCHED THEN
            INSERT ([DrawingGuid],[ID],[Description],[Image],[SiteGuid],[PanelType],[PointTemplateGuid],[Published],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy])
                VALUES (@DrawingGuid,@ID,@Description,@Image,@SiteGuid,@PanelType,@PointTemplateGuid,@Published,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy)
        ;
