...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalInserts_tblRight]
...
BEGIN
    ...
    ;   MERGE [lookup].[tblRight] AS existingData
        USING (SELECT @RightIndex 'RightIndex',@RightCode 'RightCode',@RightName 'RightName',@RightGuid 'RightGuid',@CreatedDate 'CreatedDate',@CreatedBy 'CreatedBy',@UpdatedDate 'UpdatedDate',@UpdatedBy 'UpdatedBy',@RightDescription 'RightDescription'
        ...
        WHEN MATCHED AND (remoteChanges.CreatedDate > existingData.CreatedDate OR remoteChanges.UpdatedDate > existingData.UpdatedDate) THEN
            UPDATE SET [RightCode] = remoteChanges.[RightCode]
                       ,[RightName] = remoteChanges.[RightName]
                       ,[RightGuid] = remoteChanges.[RightGuid]
                       ,[CreatedDate] = remoteChanges.[CreatedDate]
                       ,[CreatedBy] = remoteChanges.[CreatedBy]
                       ,[UpdatedDate] = remoteChanges.[UpdatedDate]
                       ,[UpdatedBy] = remoteChanges.[UpdatedBy]
					   ,[RightDescription] = remoteChanges.[RightDescription]

        WHEN NOT MATCHED THEN
            INSERT ([RightIndex],[RightCode],[RightName],[RightGuid],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy],[RightDescription])
                VALUES (@RightIndex,@RightCode,@RightName,@RightGuid,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy, @RightDescription)
        ;
