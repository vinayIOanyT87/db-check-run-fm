...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalInserts_tblProcessVariableType]
...
BEGIN
    ...
    ;   MERGE [lookup].[tblProcessVariableType] AS existingData
        ...
        WHEN MATCHED AND (remoteChanges.CreatedDate > existingData.CreatedDate OR remoteChanges.UpdatedDate > existingData.UpdatedDate) THEN
            UPDATE SET [ProcessVariableTypeCode] = remoteChanges.[ProcessVariableTypeCode]
                       ,[ProcessVariableTypeName] = remoteChanges.[ProcessVariableTypeName]
                       ,[ProcessVariableTypeGuid] = remoteChanges.[ProcessVariableTypeGuid]
        ...
        WHEN NOT MATCHED THEN
            INSERT ([ProcessVariableTypeIndex],[ProcessVariableTypeCode],[ProcessVariableTypeName],[ProcessVariableTypeGuid],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy])
                VALUES (@ProcessVariableTypeIndex,@ProcessVariableTypeCode,@ProcessVariableTypeName,@ProcessVariableTypeGuid,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy)
        ;
