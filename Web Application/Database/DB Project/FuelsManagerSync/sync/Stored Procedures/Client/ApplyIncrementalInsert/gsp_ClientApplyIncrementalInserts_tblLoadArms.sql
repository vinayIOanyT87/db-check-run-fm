...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalInserts_tblLoadArms]
...
BEGIN
    ...
    ;   MERGE [dbo].[tblLoadArms] AS existingData
        USING (SELECT @LoadRackText 'LoadRackText',@Enabled 'Enabled',@SwingArm 'SwingArm',@BayAArmNumber 'BayAArmNumber',@BayBArmNumber 'BayBArmNumber',@CreatedDate 'CreatedDate',@CreatedBy 'CreatedBy',@UpdatedDate 'UpdatedDate',@UpdatedBy 'UpdatedBy',@LoadArmGuid 'LoadArmGuid',@LookupPresetTypeIndex 'LookupPresetTypeIndex',@BayAStationGuid 'BayAStationGuid',@BayBStationGuid 'BayBStationGuid'
        ...
        WHEN MATCHED AND (remoteChanges.CreatedDate > existingData.CreatedDate OR remoteChanges.UpdatedDate > existingData.UpdatedDate) THEN
            UPDATE SET [LoadRackText] = remoteChanges.[LoadRackText]
                       ,[Enabled] = remoteChanges.[Enabled]
                       ,[SwingArm] = remoteChanges.[SwingArm]
                       ,[BayAArmNumber] = remoteChanges.[BayAArmNumber]
                       ,[BayBArmNumber] = remoteChanges.[BayBArmNumber]
                       ,[CreatedDate] = remoteChanges.[CreatedDate]
                       ,[CreatedBy] = remoteChanges.[CreatedBy]
                       ,[UpdatedDate] = remoteChanges.[UpdatedDate]
                       ,[UpdatedBy] = remoteChanges.[UpdatedBy]
                       ,[LookupPresetTypeIndex] = remoteChanges.[LookupPresetTypeIndex]
                       ,[BayAStationGuid] = remoteChanges.[BayAStationGuid]
                       ,[BayBStationGuid] = remoteChanges.[BayBStationGuid]
        ...
        WHEN NOT MATCHED THEN
            INSERT ([LoadRackText],[Enabled],[SwingArm],[BayAArmNumber],[BayBArmNumber],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy],[LoadArmGuid],[LookupPresetTypeIndex],[BayAStationGuid],[BayBStationGuid])
                VALUES (@LoadRackText,@Enabled,@SwingArm,@BayAArmNumber,@BayBArmNumber,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy,@LoadArmGuid,@LookupPresetTypeIndex,@BayAStationGuid,@BayBStationGuid)
        ;
