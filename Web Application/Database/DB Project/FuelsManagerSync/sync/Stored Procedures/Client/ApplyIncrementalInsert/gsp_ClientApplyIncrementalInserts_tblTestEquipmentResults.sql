...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalInserts_tblTestEquipmentResults]
...
BEGIN
    ...
    ;   MERGE [dbo].[tblTestEquipmentResults] AS existingData
        USING (SELECT @TestName 'TestName',@Measurement 'Measurement',@TestDate 'TestDate',@DeleteFlag 'DeleteFlag',@CreatedDate 'CreatedDate',@CreatedBy 'CreatedBy',@UpdatedDate 'UpdatedDate',@UpdatedBy 'UpdatedBy',@PerformedBy 'PerformedBy',@Supervisor 'Supervisor',@Flag01 'Flag01',@Flag02 'Flag02',@TestCode 'TestCode',@TestEquipmentResultGuid 'TestEquipmentResultGuid',@LookupTestSetStatusIndex 'LookupTestSetStatusIndex',@TestSetEquipmentResultGuid 'TestSetEquipmentResultGuid'
        ...
        WHEN MATCHED AND (remoteChanges.CreatedDate > existingData.CreatedDate OR remoteChanges.UpdatedDate > existingData.UpdatedDate) THEN
            UPDATE SET [TestName] = remoteChanges.[TestName]
                       ...
                       ,[TestSetEquipmentResultGuid] = remoteChanges.[TestSetEquipmentResultGuid]
        ...
        WHEN NOT MATCHED THEN
            INSERT ([TestName],[Measurement],[TestDate],[DeleteFlag],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy],[PerformedBy],[Supervisor],[Flag01],[Flag02],[TestCode],[TestEquipmentResultGuid],[LookupTestSetStatusIndex],[TestSetEquipmentResultGuid])
                VALUES (@TestName,@Measurement,@TestDate,@DeleteFlag,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy,@PerformedBy,@Supervisor,@Flag01,@Flag02,@TestCode,@TestEquipmentResultGuid,@LookupTestSetStatusIndex,@TestSetEquipmentResultGuid)
        ;
