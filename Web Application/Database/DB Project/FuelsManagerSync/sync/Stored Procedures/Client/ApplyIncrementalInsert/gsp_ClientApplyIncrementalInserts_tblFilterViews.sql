...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalInserts_tblFilterViews]
...
BEGIN
    ...
    ;   MERGE [dbo].[tblFilterViews] AS existingData
        USING (SELECT @CreatedDate 'CreatedDate',@CreatedBy 'CreatedBy',@UpdatedDate 'UpdatedDate',@UpdatedBy 'UpdatedBy',@FilterViewGuid 'FilterViewGuid',@LookupTransTypeIndex 'LookupTransTypeIndex',@LookupFilterFieldIndex 'LookupFilterFieldIndex'
        ...
        WHEN MATCHED AND (remoteChanges.CreatedDate > existingData.CreatedDate OR remoteChanges.UpdatedDate > existingData.UpdatedDate) THEN
            UPDATE SET [CreatedDate] = remoteChanges.[CreatedDate]
                       ...
                       ,[LookupFilterFieldIndex] = remoteChanges.[LookupFilterFieldIndex]
