...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalInserts_tblCurrencies]
...
BEGIN
    ...
    ;   MERGE [dbo].[tblCurrencies] AS existingData
        USING (SELECT @Country 'Country',@UnitDisplayName 'UnitDisplayName',@DisplayFlag 'DisplayFlag',@CreatedBy 'CreatedBy',@CreatedDate 'CreatedDate',@UpdatedBy 'UpdatedBy',@UpdatedDate 'UpdatedDate',@CurrencyGuid 'CurrencyGuid',@SiteGuid 'SiteGuid',@LookupCurrencyUnitIndex 'LookupCurrencyUnitIndex'
        ...
        WHEN MATCHED AND (remoteChanges.CreatedDate > existingData.CreatedDate OR remoteChanges.UpdatedDate > existingData.UpdatedDate) THEN
            UPDATE SET [Country] = remoteChanges.[Country]
                       ,[UnitDisplayName] = remoteChanges.[UnitDisplayName]
                       ,[DisplayFlag] = remoteChanges.[DisplayFlag]
                       ,[CreatedBy] = remoteChanges.[CreatedBy]
                       ,[CreatedDate] = remoteChanges.[CreatedDate]
                       ,[UpdatedBy] = remoteChanges.[UpdatedBy]
                       ,[UpdatedDate] = remoteChanges.[UpdatedDate]
                       ,[SiteGuid] = remoteChanges.[SiteGuid]
                       ,[LookupCurrencyUnitIndex] = remoteChanges.[LookupCurrencyUnitIndex]
