...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalInserts_tblPointHistory]
...
BEGIN
    ...
    ;   MERGE [dbo].[tblPointHistory] AS existingData
        USING (SELECT @PointHistoryGuid 'PointHistoryGuid',@UserGuid 'UserGuid',@SiteGuid 'SiteGuid',@StartDate 'StartDate',@IntervalQuantity 'IntervalQuantity',@IntervalType 'IntervalType',@RangeQuantity 'RangeQuantity',@RangeType 'RangeType',@ColumnsDefinition 'ColumnsDefinition',@CreatedDate 'CreatedDate',@CreatedBy 'CreatedBy',@UpdatedDate 'UpdatedDate',@UpdatedBy 'UpdatedBy'
        ...
        WHEN MATCHED AND (remoteChanges.CreatedDate > existingData.CreatedDate OR remoteChanges.UpdatedDate > existingData.UpdatedDate) THEN
            UPDATE SET [UserGuid] = remoteChanges.[UserGuid]
                       ...
                       ,[IntervalQuantity] = remoteChanges.[IntervalQuantity]
                       ,[IntervalType] = remoteChanges.[IntervalType]
                       ,[RangeQuantity] = remoteChanges.[RangeQuantity]
                       ,[RangeType] = remoteChanges.[RangeType]
