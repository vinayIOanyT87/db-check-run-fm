...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalInserts_tblStandardFieldType]
...
BEGIN
    ...
    ;   MERGE [lookup].[tblStandardFieldType] AS existingData
        ...
        WHEN MATCHED AND (remoteChanges.CreatedDate > existingData.CreatedDate OR remoteChanges.UpdatedDate > existingData.UpdatedDate) THEN
            UPDATE SET [StandardFieldTypeCode] = remoteChanges.[StandardFieldTypeCode]
                       ,[StandardFieldTypeName] = remoteChanges.[StandardFieldTypeName]
                       ,[StandardFieldTypeGuid] = remoteChanges.[StandardFieldTypeGuid]
        ...
        WHEN NOT MATCHED THEN
            INSERT ([StandardFieldTypeIndex],[StandardFieldTypeCode],[StandardFieldTypeName],[StandardFieldTypeGuid],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy])
                VALUES (@StandardFieldTypeIndex,@StandardFieldTypeCode,@StandardFieldTypeName,@StandardFieldTypeGuid,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy)
        ;
