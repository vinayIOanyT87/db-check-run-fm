...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalInserts_tblMessages]
...
BEGIN
    ...
    ;   MERGE [dbo].[tblMessages] AS existingData
        USING (SELECT @ID 'ID',@CreatedDate 'CreatedDate',@CreatedBy 'CreatedBy',@UpdatedDate 'UpdatedDate',@UpdatedBy 'UpdatedBy',@MessageGuid 'MessageGuid',@SiteGuid 'SiteGuid',@LookupFrequencyTypeIndex 'LookupFrequencyTypeIndex',@LookupLocationTypeIndex 'LookupLocationTypeIndex',@CompanyGuid 'CompanyGuid',@PersonnelGuid 'PersonnelGuid'
        ...
        WHEN MATCHED AND (remoteChanges.CreatedDate > existingData.CreatedDate OR remoteChanges.UpdatedDate > existingData.UpdatedDate) THEN
            UPDATE SET [ID] = remoteChanges.[ID]
                       ...
                       ,[LookupFrequencyTypeIndex] = remoteChanges.[LookupFrequencyTypeIndex]
                       ,[LookupLocationTypeIndex] = remoteChanges.[LookupLocationTypeIndex]
        ...
        WHEN NOT MATCHED THEN
            INSERT ([ID],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy],[MessageGuid],[SiteGuid],[LookupFrequencyTypeIndex],[LookupLocationTypeIndex],[CompanyGuid],[PersonnelGuid])
                VALUES (@ID,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy,@MessageGuid,@SiteGuid,@LookupFrequencyTypeIndex,@LookupLocationTypeIndex,@CompanyGuid,@PersonnelGuid)
        ;
