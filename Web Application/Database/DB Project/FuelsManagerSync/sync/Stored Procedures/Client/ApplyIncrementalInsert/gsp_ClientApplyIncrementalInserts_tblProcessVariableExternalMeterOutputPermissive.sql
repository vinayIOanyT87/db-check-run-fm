...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalInserts_tblProcessVariableExternalMeterOutputPermissive]
    ...
    ;   MERGE [dbo].[tblProcessVariableExternalMeterOutputPermissive] AS existingData
        ...
        WHEN MATCHED AND (remoteChanges.CreatedDate > existingData.CreatedDate OR remoteChanges.UpdatedDate > existingData.UpdatedDate) THEN
            UPDATE SET [LookupProcessVariableTypeIndex] = remoteChanges.[LookupProcessVariableTypeIndex]
                       ...
                       ,[ProductToOffloadExternalMeterGuid] = remoteChanges.[ProductToOffloadExternalMeterGuid]
