...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalInserts_tblFuelCardLimitLineItem]
...
BEGIN
    ...
    ;   MERGE [dbo].[tblFuelCardLimitLineItem] AS existingData
        USING (SELECT @FuelCardLimitLineItemGuid 'FuelCardLimitLineItemGuid',@FuelCardLimitGuid 'FuelCardLimitGuid',@Limit 'Limit',@Period 'Period',@ProductGuid 'ProductGuid',@ProductGroupApplicationStringGuid 'ProductGroupApplicationStringGuid',@CreatedBy 'CreatedBy',@CreatedDate 'CreatedDate',@UpdatedBy 'UpdatedBy',@UpdatedDate 'UpdatedDate'
        ...
        WHEN NOT MATCHED THEN
            INSERT ([FuelCardLimitLineItemGuid],[FuelCardLimitGuid],[Limit],[Period],[ProductGuid],[ProductGroupApplicationStringGuid],[CreatedBy],[CreatedDate],[UpdatedBy],[UpdatedDate])
                VALUES (@FuelCardLimitLineItemGuid,@FuelCardLimitGuid,@Limit,@Period,@ProductGuid,@ProductGroupApplicationStringGuid,@CreatedBy,@CreatedDate,@UpdatedBy,@UpdatedDate)
        ;
