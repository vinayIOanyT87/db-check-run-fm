...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalInserts_tblEntityFuelCardToSite]
...
BEGIN
    ...
    ;   MERGE [map].[tblEntityFuelCardToSite] AS existingData
        USING (SELECT @FuelCardToSiteGuid 'FuelCardToSiteGuid',@FuelCardGuid 'FuelCardGuid',@SiteGuid 'SiteGuid',@CreatedDate 'CreatedDate',@CreatedBy 'CreatedBy',@UpdatedDate 'UpdatedDate',@UpdatedBy 'UpdatedBy',@AssignedFromSiteGuid 'AssignedFromSiteGuid'
        ...
        WHEN MATCHED AND (remoteChanges.CreatedDate >= existingData.CreatedDate OR remoteChanges.UpdatedDate >= existingData.UpdatedDate) THEN
            UPDATE SET [FuelCardGuid] = remoteChanges.[FuelCardGuid]
        ...
        WHEN NOT MATCHED THEN
            INSERT ([FuelCardToSiteGuid],[FuelCardGuid],[SiteGuid],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy],[AssignedFromSiteGuid])
                VALUES (@FuelCardToSiteGuid,@FuelCardGuid,@SiteGuid,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy,@AssignedFromSiteGuid)
        ;
