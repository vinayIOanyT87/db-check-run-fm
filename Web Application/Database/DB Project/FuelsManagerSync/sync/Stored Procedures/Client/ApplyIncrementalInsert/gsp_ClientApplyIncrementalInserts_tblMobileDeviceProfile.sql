...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalInserts_tblMobileDeviceProfile]
...
BEGIN
    ...
    ;   MERGE [dbo].[tblMobileDeviceProfile] AS existingData
        USING (SELECT @MobileDeviceProfileGuid 'MobileDeviceProfileGuid',@SiteGuid 'SiteGuid',@ProfileID 'ProfileID',@Description 'Description',@ShowProductScreen 'ShowProductScreen',@GenerateTicketNumber 'GenerateTicketNumber',@ShowOperatorFieldInFlightList 'ShowOperatorFieldInFlightList',@UseDefaultPrinter 'UseDefaultPrinter',@DefaultPrinter 'DefaultPrinter',@AdminPassword 'AdminPassword',@ShutdownHotKey 'ShutdownHotKey',@PrinterCOMPort 'PrinterCOMPort',@SearchType 'SearchType',@LoggingOption 'LoggingOption',@AllowableFailedLoginAttempts 'AllowableFailedLoginAttempts',@FuelDistributionPrecision 'FuelDistributionPrecision',@MakeDefaultProfile 'MakeDefaultProfile',@VehicleID 'VehicleID',@MonitorScreenTransitionTiming 'MonitorScreenTransitionTiming',@BypassFsrCheckOnScreenTrans 'BypassFsrCheckOnScreenTrans',@ShowFuelUpdateCheckStatusWin 'ShowFuelUpdateCheckStatusWin',@RTDTemperatureRangeMin 'RTDTemperatureRangeMin',@RTDTemperatureRangeMax 'RTDTemperatureRangeMax',@DefaultTemperature 'DefaultTemperature',@StrictUserValidation 'StrictUserValidation',@VerifyFuelingEquipment 'VerifyFuelingEquipment',@AllowEditRequiredFuelLoad 'AllowEditRequiredFuelLoad',@AllowBackAfterArrivalScreen 'AllowBackAfterArrivalScreen',@AllowBackAfterTicketPrinted 'AllowBackAfterTicketPrinted',@RequirePrint 'RequirePrint',@TotalFuelLoadCheck 'TotalFuelLoadCheck',@VolumetricThresholdValidation 'VolumetricThresholdValidation',@ValidateShipNumber 'ValidateShipNumber',@AllowVTOModification 'AllowVTOModification',@AllowFlightGateModification 'AllowFlightGateModification',@TankPositionBalanceVerification 'TankPositionBalanceVerification',@TankPositionBalancePercentage 'TankPositionBalancePercentage',@OverrideWingBalancePercentVar 'OverrideWingBalancePercentVar',@BypassDistributionTolerance 'BypassDistributionTolerance',@VehicleIDCheck 'VehicleIDCheck',@GSEFuelMustMatch 'GSEFuelMustMatch',@AllowManualMeter 'AllowManualMeter',@UseValidLogicGATrans 'UseValidLogicGATrans',@AllowShipNumberModification 'AllowShipNumberModification',@AllowAircraftTypeModification 'AllowAircraftTypeModification',@AllowDestinationModification 'AllowDestinationModification',@TicketPrinting 'TicketPrinting',@AircraftTypeVerification 'AircraftTypeVerification',@Destination 'Destination',@Gate 'Gate',@ShipNumber 'ShipNumber',@MeterTotal 'MeterTotal',@VolumePumped 'VolumePumped',@TankCapacity 'TankCapacity',@EAStrictUserValidation 'EAStrictUserValidation',@EAVerifyFuelingEquipment 'EAVerifyFuelingEquipment',@EAAllowEditOfRequiredFuelLoad 'EAAllowEditOfRequiredFuelLoad',@EAAllowBackAfterArrivalScreen 'EAAllowBackAfterArrivalScreen',@EAAllowBackAfterTicketPrinted 'EAAllowBackAfterTicketPrinted',@EARequirePrint 'EARequirePrint',@EATotalFuelLoad 'EATotalFuelLoad',@EAVolumetricThresholdValidation 'EAVolumetricThresholdValidation',@EAValidateShipNumber 'EAValidateShipNumber',@EAAllowVTOModification 'EAAllowVTOModification',@EAAllowFlightGateModification 'EAAllowFlightGateModification',@EATankDiffPercentage 'EATankDiffPercentage',@EAWingBalancePercentage 'EAWingBalancePercentage',@EABypassDistributionTolerance 'EABypassDistributionTolerance',@EAVehicleIDCheck 'EAVehicleIDCheck',@EAGSEFuelMustMatch 'EAGSEFuelMustMatch',@EAAllowManualMeter 'EAAllowManualMeter',@EAUseValidationLogicGATrans 'EAUseValidationLogicGATrans',@EAAllowShipNumberModification 'EAAllowShipNumberModification',@EAAllowAircraftTypeModification 'EAAllowAircraftTypeModification',@EAAllowDestinationModification 'EAAllowDestinationModification',@EADestination 'EADestination',@EATicketPrinting 'EATicketPrinting',@EAAircraftType 'EAAircraftType',@EAShipNumber 'EAShipNumber',@EAGateNumber 'EAGateNumber',@EAMeterTotal 'EAMeterTotal',@EAVolumePumped 'EAVolumePumped',@EATankCapacity 'EATankCapacity',@EquipmentType 'EquipmentType',@ForeignKeyToMapEquipment 'ForeignKeyToMapEquipment',@IssueTransaction 'IssueTransaction',@DefuelTransaction 'DefuelTransaction',@RotationTransaction 'RotationTransaction',@MeterCloseout 'MeterCloseout',@DeIceTransaction 'DeIceTransaction',@GSETransaction 'GSETransaction',@ManualConsumer 'ManualConsumer',@ManualVendor 'ManualVendor',@ManualShipper 'ManualShipper',@ManualManager 'ManualManager',@ManualSupplier 'ManualSupplier',@ManualBillTo 'ManualBillTo',@ManualProduct 'ManualProduct',@CloseoutConsumer 'CloseoutConsumer',@CloseoutOwner 'CloseoutOwner',@CloseoutVendor 'CloseoutVendor',@ManualStationID 'ManualStationID',@InhibitOverridingTemperature 'InhibitOverridingTemperature',@ManualTemperature 'ManualTemperature',@ManualDensity 'ManualDensity',@HasDCU 'HasDCU',@BluetoothDCU 'BluetoothDCU',@LogDCUActions 'LogDCUActions',@HasAveryHardoll 'HasAveryHardoll',@DCUComPort 'DCUComPort',@DCUReadRetry 'DCUReadRetry',@DCUDisconnectDelay 'DCUDisconnectDelay',@DCUCommunicationFailRestart 'DCUCommunicationFailRestart',@AveryHardollComPort 'AveryHardollComPort',@AveryHardollMeterID 'AveryHardollMeterID',@ConfirmFuelCaps 'ConfirmFuelCaps',@VTOEnabled 'VTOEnabled',@EnabledInOpGauges 'EnabledInOpGauges',@UseDispensingVehicleGSETrans 'UseDispensingVehicleGSETrans',@GSEWaitMSecForGetMeter 'GSEWaitMSecForGetMeter',@GSEInactiveLogoutMinutes 'GSEInactiveLogoutMinutes',@GSEInactiveTimeout 'GSEInactiveTimeout',@BarcodeInvalidWarningSeconds 'BarcodeInvalidWarningSeconds',@DeIceBlendDefault 'DeIceBlendDefault',@CommunicationTimeoutSeconds 'CommunicationTimeoutSeconds',@ConnectionRetries 'ConnectionRetries',@ConnectionRetryTimeout 'ConnectionRetryTimeout',@ConnectionType 'ConnectionType',@UpdateInterval 'UpdateInterval',@PingVerificationIPAddress 'PingVerificationIPAddress',@VehicleUpdateInterval 'VehicleUpdateInterval',@PresubmitDelay 'PresubmitDelay',@VerificationIPAddress 'VerificationIPAddress',@CreatedDate 'CreatedDate',@CreatedBy 'CreatedBy',@UpdatedDate 'UpdatedDate',@UpdatedBy 'UpdatedBy'
