...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalInserts_tblTransactionFieldType]
...
BEGIN
    ...
    ;   MERGE [lookup].[tblTransactionFieldType] AS existingData
        USING (SELECT @TransactionFieldTypeIndex 'TransactionFieldTypeIndex',@TransactionFieldTypeCode 'TransactionFieldTypeCode',@TransactionFieldTypeName 'TransactionFieldTypeName',@TransactionFieldTypeGuid 'TransactionFieldTypeGuid',@CreatedDate 'CreatedDate',@CreatedBy 'CreatedBy',@UpdatedDate 'UpdatedDate',@UpdatedBy 'UpdatedBy'
        ...
        WHEN MATCHED AND (remoteChanges.CreatedDate > existingData.CreatedDate OR remoteChanges.UpdatedDate > existingData.UpdatedDate) THEN
            UPDATE SET [TransactionFieldTypeCode] = remoteChanges.[TransactionFieldTypeCode]
                       ,[TransactionFieldTypeName] = remoteChanges.[TransactionFieldTypeName]
                       ,[TransactionFieldTypeGuid] = remoteChanges.[TransactionFieldTypeGuid]
        ...
        WHEN NOT MATCHED THEN
            INSERT ([TransactionFieldTypeIndex],[TransactionFieldTypeCode],[TransactionFieldTypeName],[TransactionFieldTypeGuid],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy])
                VALUES (@TransactionFieldTypeIndex,@TransactionFieldTypeCode,@TransactionFieldTypeName,@TransactionFieldTypeGuid,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy)
        ;
