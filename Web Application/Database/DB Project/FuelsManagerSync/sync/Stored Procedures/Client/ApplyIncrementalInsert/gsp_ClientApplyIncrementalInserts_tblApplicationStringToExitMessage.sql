...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalInserts_tblApplicationStringToExitMessage]
...
BEGIN
    ...
    ;   MERGE [map].[tblApplicationStringToExitMessage] AS existingData
        USING (SELECT @ApplicationStringToExitMessageGuid 'ApplicationStringToExitMessageGuid',@ApplicationStringGuid 'ApplicationStringGuid',@ProductGroupApplicationStringGuid 'ProductGroupApplicationStringGuid',@Sequence 'Sequence',@CreatedDate 'CreatedDate',@CreatedBy 'CreatedBy',@UpdatedDate 'UpdatedDate',@UpdatedBy 'UpdatedBy'
        ...
        WHEN NOT MATCHED THEN
            INSERT ([ApplicationStringToExitMessageGuid],[ApplicationStringGuid],[ProductGroupApplicationStringGuid],[Sequence],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy])
                VALUES (@ApplicationStringToExitMessageGuid,@ApplicationStringGuid,@ProductGroupApplicationStringGuid,@Sequence,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy)
        ;
