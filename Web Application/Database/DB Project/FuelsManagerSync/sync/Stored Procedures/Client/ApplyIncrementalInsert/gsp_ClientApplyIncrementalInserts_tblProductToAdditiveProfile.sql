...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalInserts_tblProductToAdditiveProfile]
    ...
    ;   MERGE [map].[tblProductToAdditiveProfile] AS existingData
        ...
        WHEN MATCHED AND (remoteChanges.CreatedDate > existingData.CreatedDate OR remoteChanges.UpdatedDate > existingData.UpdatedDate) THEN
            UPDATE SET [ProductGuid] = remoteChanges.[ProductGuid]
                       ,[AssignedToAdditiveProfileGuid] = remoteChanges.[AssignedToAdditiveProfileGuid]
                       ...
                       ,[DesiredTreatRate] = remoteChanges.[DesiredTreatRate]
