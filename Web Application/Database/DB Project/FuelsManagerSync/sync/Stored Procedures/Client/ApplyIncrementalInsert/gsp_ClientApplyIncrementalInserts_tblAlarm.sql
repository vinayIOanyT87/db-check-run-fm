...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalInserts_tblAlarm]
...
BEGIN
    ...
    ;   MERGE [dbo].[tblAlarm] AS existingData
        USING (SELECT @AlarmGuid 'AlarmGuid',@InputTagGuid 'InputTagGuid',@ID 'ID',@Enabled 'Enabled',@AlarmCategoryApplicationStringGuid 'AlarmCategoryApplicationStringGuid',@Order 'Order',@NotAlarmState 'NotAlarmState',@Comment 'Comment',@ShelvedStartTimeStamp 'ShelvedStartTimeStamp',@ShelvedEndTimeStamp 'ShelvedEndTimeStamp',@ShelvedOneShot 'ShelvedOneShot',@ShelvedBy 'ShelvedBy',@Suppressed 'Suppressed',@CreatedDate 'CreatedDate',@CreatedBy 'CreatedBy',@UpdatedDate 'UpdatedDate',@UpdatedBy 'UpdatedBy',@AlarmStateTagGuid 'AlarmStateTagGuid',@ExclusiveAlarm 'ExclusiveAlarm',@AlarmTemplateGuid 'AlarmTemplateGuid',@Notify 'Notify'
