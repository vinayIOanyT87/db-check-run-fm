...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalInserts_tblAccessibilities]
...
BEGIN
    ...
    ;   MERGE [lookup].[tblAccessibilities] AS existingData
        USING (SELECT @AccessibilityGuid 'AccessibilityGuid',@ValueType 'ValueType',@ValueRange 'ValueRange',@SettingKey 'SettingKey',@DefaultSettingValue 'DefaultSettingValue',@DisplayName 'DisplayName',@Description 'Description',@CreatedDate 'CreatedDate',@CreatedBy 'CreatedBy',@UpdatedDate 'UpdatedDate',@UpdatedBy 'UpdatedBy'
        ...
        WHEN MATCHED AND (remoteChanges.CreatedDate > existingData.CreatedDate OR remoteChanges.UpdatedDate > existingData.UpdatedDate) THEN
            UPDATE SET [ValueType] = remoteChanges.[ValueType]
                       ,[ValueRange] = remoteChanges.[ValueRange]
                       ,[SettingKey] = remoteChanges.[SettingKey]
                       ,[DefaultSettingValue] = remoteChanges.[DefaultSettingValue]
        ...
        WHEN NOT MATCHED THEN
            INSERT ([AccessibilityGuid],[ValueType],[ValueRange],[SettingKey],[DefaultSettingValue],[DisplayName],[Description],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy])
                VALUES (@AccessibilityGuid,@ValueType,@ValueRange,@SettingKey,@DefaultSettingValue,@DisplayName,@Description,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy)
        ;
