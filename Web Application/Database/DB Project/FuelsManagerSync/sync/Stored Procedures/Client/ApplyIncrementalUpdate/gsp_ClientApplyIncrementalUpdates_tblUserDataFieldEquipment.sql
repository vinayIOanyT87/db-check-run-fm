...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblUserDataFieldEquipment]
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM [track].[tblUserDataFieldEquipment] CT
    ...
    BEGIN
        ;   WITH existingData AS (
                SELECT [dbo].[tblUserDataFieldEquipment].[UserDataFieldEquipmentGuid],[dbo].[tblUserDataFieldEquipment].[TransactionAliasGuid],[dbo].[tblUserDataFieldEquipment].[SiteGuid],[dbo].[tblUserDataFieldEquipment].[Number],[dbo].[tblUserDataFieldEquipment].[DisplayOrder],[dbo].[tblUserDataFieldEquipment].[DisplayName],[dbo].[tblUserDataFieldEquipment].[LookupUserDataTypeIndex],[dbo].[tblUserDataFieldEquipment].[Required],[dbo].[tblUserDataFieldEquipment].[UserGroupGuid],[dbo].[tblUserDataFieldEquipment].[CreatedDate],[dbo].[tblUserDataFieldEquipment].[CreatedBy],[dbo].[tblUserDataFieldEquipment].[UpdatedDate],[dbo].[tblUserDataFieldEquipment].[UpdatedBy],[dbo].[tblUserDataFieldEquipment].[DispatchField],[dbo].[tblUserDataFieldEquipment].[ClearOnNew],[dbo].[tblUserDataFieldEquipment].[ReadOnly],[dbo].[tblUserDataFieldEquipment].[Visibility],[dbo].[tblUserDataFieldEquipment].[DefaultValue]
            ...
            USING (SELECT @UserDataFieldEquipmentGuid,@TransactionAliasGuid,@SiteGuid,@Number,@DisplayOrder,@DisplayName,@LookupUserDataTypeIndex,@Required,@UserGroupGuid,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy,@DispatchField,@ClearOnNew,@ReadOnly,@Visibility,@DefaultValue
            ...
            WHEN NOT MATCHED THEN
                INSERT ([UserDataFieldEquipmentGuid],[TransactionAliasGuid],[SiteGuid],[Number],[DisplayOrder],[DisplayName],[LookupUserDataTypeIndex],[Required],[UserGroupGuid],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy],[DispatchField],[ClearOnNew],[ReadOnly],[Visibility],[DefaultValue])
                    VALUES (@UserDataFieldEquipmentGuid,@TransactionAliasGuid,@SiteGuid,@Number,@DisplayOrder,@DisplayName,@LookupUserDataTypeIndex,@Required,@UserGroupGuid,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy,@DispatchField,@ClearOnNew,@ReadOnly,@Visibility,@DefaultValue)
            ;
