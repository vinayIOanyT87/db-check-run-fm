...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblCustomToolbarCommandType]
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM [track].[tblCustomToolbarCommandType] CT
    ...
    BEGIN
        ;   WITH existingData AS (
                SELECT [lookup].[tblCustomToolbarCommandType].[CustomToolbarCommandTypeIndex],[lookup].[tblCustomToolbarCommandType].[CustomToolbarCommandTypeCode],[lookup].[tblCustomToolbarCommandType].[CustomToolbarCommandTypeName],[lookup].[tblCustomToolbarCommandType].[LookupCustomToolbarTypeIndex],[lookup].[tblCustomToolbarCommandType].[CustomToolbarCommandTypeGuid],[lookup].[tblCustomToolbarCommandType].[CreatedDate],[lookup].[tblCustomToolbarCommandType].[CreatedBy],[lookup].[tblCustomToolbarCommandType].[UpdatedDate],[lookup].[tblCustomToolbarCommandType].[UpdatedBy],[lookup].[tblCustomToolbarCommandType].[Default],[lookup].[tblCustomToolbarCommandType].[DefaultOrder],[lookup].[tblCustomToolbarCommandType].[ImageSource]
            ...
            USING (SELECT @CustomToolbarCommandTypeIndex,@CustomToolbarCommandTypeCode,@CustomToolbarCommandTypeName,@LookupCustomToolbarTypeIndex,@CustomToolbarCommandTypeGuid,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy,@Default,@DefaultOrder,@ImageSource
            ...
            WHEN MATCHED AND (@sync_force_write = 1 
                ...
                THEN
                UPDATE SET [CustomToolbarCommandTypeCode] = remoteChanges.[CustomToolbarCommandTypeCode]
                       ,[CustomToolbarCommandTypeName] = remoteChanges.[CustomToolbarCommandTypeName]
                       ,[LookupCustomToolbarTypeIndex] = remoteChanges.[LookupCustomToolbarTypeIndex]
                       ,[CustomToolbarCommandTypeGuid] = remoteChanges.[CustomToolbarCommandTypeGuid]
                       ,[CreatedDate] = remoteChanges.[CreatedDate]
                       ,[CreatedBy] = remoteChanges.[CreatedBy]
                       ,[UpdatedDate] = remoteChanges.[UpdatedDate]
                       ,[UpdatedBy] = remoteChanges.[UpdatedBy]
                       ,[Default] = remoteChanges.[Default]
                       ,[DefaultOrder] = remoteChanges.[DefaultOrder]
                       ,[ImageSource] = remoteChanges.[ImageSource]
            ...
            WHEN NOT MATCHED THEN
                INSERT ([CustomToolbarCommandTypeIndex],[CustomToolbarCommandTypeCode],[CustomToolbarCommandTypeName],[LookupCustomToolbarTypeIndex],[CustomToolbarCommandTypeGuid],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy],[Default],[DefaultOrder],[ImageSource])
                    VALUES (@CustomToolbarCommandTypeIndex,@CustomToolbarCommandTypeCode,@CustomToolbarCommandTypeName,@LookupCustomToolbarTypeIndex,@CustomToolbarCommandTypeGuid,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy,@Default,@DefaultOrder,@ImageSource)
            ;
