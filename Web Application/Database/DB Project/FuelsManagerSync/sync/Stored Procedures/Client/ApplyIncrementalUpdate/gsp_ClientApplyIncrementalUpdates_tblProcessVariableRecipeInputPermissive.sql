...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblProcessVariableRecipeInputPermissive]
        ...
        ;   WITH existingData AS (
            ...
            WHEN MATCHED AND (@sync_force_write = 1 
                ...
                UPDATE SET [LookupProcessVariableTypeIndex] = remoteChanges.[LookupProcessVariableTypeIndex]
                       ...
                       ,[ProductToPresetRecipeGuid] = remoteChanges.[ProductToPresetRecipeGuid]
