...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblWeightedAverageCosts]
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM [track].[tblWeightedAverageCosts] CT
    ...
    BEGIN
        ;   WITH existingData AS (
                SELECT [dbo].[tblWeightedAverageCosts].[WacValue],[dbo].[tblWeightedAverageCosts].[IsManualOverride],[dbo].[tblWeightedAverageCosts].[Source],[dbo].[tblWeightedAverageCosts].[Notes],[dbo].[tblWeightedAverageCosts].[CreatedBy],[dbo].[tblWeightedAverageCosts].[CreatedDate],[dbo].[tblWeightedAverageCosts].[UpdatedBy],[dbo].[tblWeightedAverageCosts].[UpdatedDate],[dbo].[tblWeightedAverageCosts].[InventoryDate],[dbo].[tblWeightedAverageCosts].[WeightedAverageCostGuid],[dbo].[tblWeightedAverageCosts].[SiteGuid],[dbo].[tblWeightedAverageCosts].[ProductGuid]
            ...
            USING (SELECT @WacValue,@IsManualOverride,@Source,@Notes,@CreatedBy,@CreatedDate,@UpdatedBy,@UpdatedDate,@InventoryDate,@WeightedAverageCostGuid,@SiteGuid,@ProductGuid
            ...
            WHEN MATCHED AND (@sync_force_write = 1 
                ...
                THEN
                UPDATE SET [WacValue] = remoteChanges.[WacValue]
                       ,[IsManualOverride] = remoteChanges.[IsManualOverride]
                       ,[Source] = remoteChanges.[Source]
            ...
            WHEN NOT MATCHED THEN
                INSERT ([WacValue],[IsManualOverride],[Source],[Notes],[CreatedBy],[CreatedDate],[UpdatedBy],[UpdatedDate],[InventoryDate],[WeightedAverageCostGuid],[SiteGuid],[ProductGuid])
                    VALUES (@WacValue,@IsManualOverride,@Source,@Notes,@CreatedBy,@CreatedDate,@UpdatedBy,@UpdatedDate,@InventoryDate,@WeightedAverageCostGuid,@SiteGuid,@ProductGuid)
            ;
