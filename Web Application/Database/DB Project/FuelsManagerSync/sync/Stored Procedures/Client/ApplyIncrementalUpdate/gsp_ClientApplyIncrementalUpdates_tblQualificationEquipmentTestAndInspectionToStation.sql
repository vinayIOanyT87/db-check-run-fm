...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblQualificationEquipmentTestAndInspectionToStation]
        ...
        ;   WITH existingData AS (
            ...
            WHEN NOT MATCHED THEN
                INSERT ([QualificationEquipmentTestAndInspectionToStationGuid],[QualificationGuid],[StationGuid],[Sequence],[Instructor],[DateCompleted],[DateDue],[ExpirationDate],[ID],[Rating],[HistoricalRecord],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy])
                    VALUES (@QualificationEquipmentTestAndInspectionToStationGuid,@QualificationGuid,@StationGuid,@Sequence,@Instructor,@DateCompleted,@DateDue,@ExpirationDate,@ID,@Rating,@HistoricalRecord,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy)
            ;
