...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblModuleToPointTemplate]
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM [track].[tblModuleToPointTemplate] CT
    ...
    BEGIN
        ;   WITH existingData AS (
            ...
            USING (SELECT @ID,@Order,@ModuleToPointTemplateData,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy,@ModuleToPointTemplateGuid,@PointTemplateGuid,@ModuleGuid
            ...
            WHEN MATCHED AND (@sync_force_write = 1 
                ...
                UPDATE SET [ID] = remoteChanges.[ID]
                       ...
                       ,[ModuleToPointTemplateData] = remoteChanges.[ModuleToPointTemplateData]
                       ,[CreatedDate] = remoteChanges.[CreatedDate]
                       ,[CreatedBy] = remoteChanges.[CreatedBy]
                       ,[UpdatedDate] = remoteChanges.[UpdatedDate]
                       ,[UpdatedBy] = remoteChanges.[UpdatedBy]
                       ,[PointTemplateGuid] = remoteChanges.[PointTemplateGuid]
                       ,[ModuleGuid] = remoteChanges.[ModuleGuid]
            ...
            WHEN NOT MATCHED THEN
                INSERT ([ID],[Order],[ModuleToPointTemplateData],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy],[ModuleToPointTemplateGuid],[PointTemplateGuid],[ModuleGuid])
                    VALUES (@ID,@Order,@ModuleToPointTemplateData,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy,@ModuleToPointTemplateGuid,@PointTemplateGuid,@ModuleGuid)
            ;
