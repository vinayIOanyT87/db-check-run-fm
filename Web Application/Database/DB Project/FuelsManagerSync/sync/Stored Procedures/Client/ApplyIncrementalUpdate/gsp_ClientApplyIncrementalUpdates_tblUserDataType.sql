...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblUserDataType]
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM [track].[tblUserDataType] CT
    ...
    BEGIN
        ;   WITH existingData AS (
                SELECT [lookup].[tblUserDataType].[UserDataTypeIndex],[lookup].[tblUserDataType].[UserDataTypeCode],[lookup].[tblUserDataType].[UserDataTypeName],[lookup].[tblUserDataType].[UserDataTypeGuid],[lookup].[tblUserDataType].[CreatedDate],[lookup].[tblUserDataType].[CreatedBy],[lookup].[tblUserDataType].[UpdatedDate],[lookup].[tblUserDataType].[UpdatedBy]
            ...
            USING (SELECT @UserDataTypeIndex,@UserDataTypeCode,@UserDataTypeName,@UserDataTypeGuid,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy
            ...
            WHEN MATCHED AND (@sync_force_write = 1 
                ...
                THEN
                UPDATE SET [UserDataTypeCode] = remoteChanges.[UserDataTypeCode]
                       ,[UserDataTypeName] = remoteChanges.[UserDataTypeName]
                       ,[UserDataTypeGuid] = remoteChanges.[UserDataTypeGuid]
            ...
            WHEN NOT MATCHED THEN
                INSERT ([UserDataTypeIndex],[UserDataTypeCode],[UserDataTypeName],[UserDataTypeGuid],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy])
                    VALUES (@UserDataTypeIndex,@UserDataTypeCode,@UserDataTypeName,@UserDataTypeGuid,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy)
            ;
