...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblTestSetDefinitions]
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM [track].[tblTestSetDefinitions] CT
    ...
    BEGIN
        ;   WITH existingData AS (
            ...
            USING (SELECT @TestSetName,@DeleteFlag,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy,@Flag01,@TestSetDefinitionGuid,@OwnerSiteGuid
            ...
            WHEN MATCHED AND (@sync_force_write = 1 
                ...
                THEN
                UPDATE SET [TestSetName] = remoteChanges.[TestSetName]
            ...
            WHEN NOT MATCHED THEN
                INSERT ([TestSetName],[DeleteFlag],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy],[Flag01],[TestSetDefinitionGuid],[OwnerSiteGuid])
                    VALUES (@TestSetName,@DeleteFlag,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy,@Flag01,@TestSetDefinitionGuid,@OwnerSiteGuid)
            ;
