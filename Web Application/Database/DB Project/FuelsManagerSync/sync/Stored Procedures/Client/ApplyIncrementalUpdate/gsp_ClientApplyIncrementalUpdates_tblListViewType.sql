...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblListViewType]
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM [track].[tblListViewType] CT
    ...
    BEGIN
        ;   WITH existingData AS (
                SELECT [lookup].[tblListViewType].[ListViewTypeIndex],[lookup].[tblListViewType].[ListViewTypeCode],[lookup].[tblListViewType].[ListViewTypeName],[lookup].[tblListViewType].[ListViewTypeGuid],[lookup].[tblListViewType].[CreatedDate],[lookup].[tblListViewType].[CreatedBy],[lookup].[tblListViewType].[UpdatedDate],[lookup].[tblListViewType].[UpdatedBy]
            ...
            USING (SELECT @ListViewTypeIndex,@ListViewTypeCode,@ListViewTypeName,@ListViewTypeGuid,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy
            ...
            WHEN MATCHED AND (@sync_force_write = 1 
                ...
                THEN
                UPDATE SET [ListViewTypeCode] = remoteChanges.[ListViewTypeCode]
                       ,[ListViewTypeName] = remoteChanges.[ListViewTypeName]
                       ,[ListViewTypeGuid] = remoteChanges.[ListViewTypeGuid]
            ...
            WHEN NOT MATCHED THEN
                INSERT ([ListViewTypeIndex],[ListViewTypeCode],[ListViewTypeName],[ListViewTypeGuid],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy])
                    VALUES (@ListViewTypeIndex,@ListViewTypeCode,@ListViewTypeName,@ListViewTypeGuid,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy)
            ;
