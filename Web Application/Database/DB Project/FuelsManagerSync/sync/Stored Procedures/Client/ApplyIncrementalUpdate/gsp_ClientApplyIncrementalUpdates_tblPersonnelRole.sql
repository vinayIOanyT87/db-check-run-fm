...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblPersonnelRole]
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM [track].[tblPersonnelRole] CT
    ...
    BEGIN
        ;   WITH existingData AS (
            ...
            USING (SELECT @PersonnelRoleIndex,@PersonnelRoleCode,@PersonnelRoleName,@PersonnelRoleGuid,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy
            ...
            WHEN MATCHED AND (@sync_force_write = 1 
                ...
                THEN
                UPDATE SET [PersonnelRoleCode] = remoteChanges.[PersonnelRoleCode]
                       ,[PersonnelRoleName] = remoteChanges.[PersonnelRoleName]
                       ,[PersonnelRoleGuid] = remoteChanges.[PersonnelRoleGuid]
            ...
            WHEN NOT MATCHED THEN
                INSERT ([PersonnelRoleIndex],[PersonnelRoleCode],[PersonnelRoleName],[PersonnelRoleGuid],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy])
                    VALUES (@PersonnelRoleIndex,@PersonnelRoleCode,@PersonnelRoleName,@PersonnelRoleGuid,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy)
            ;
