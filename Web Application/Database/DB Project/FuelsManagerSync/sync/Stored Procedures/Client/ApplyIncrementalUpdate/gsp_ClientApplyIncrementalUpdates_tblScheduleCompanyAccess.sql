...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblScheduleCompanyAccess]
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM [track].[tblScheduleCompanyAccess] CT
    ...
    BEGIN
        ;   WITH existingData AS (
            ...
            USING (SELECT @ScheduleCompanyAccessGuid,@CompanyGuid,@LookupDayOfWeekIndex,@Enabled,@OpeningTime,@ClosingTime,@EndOfDayEnabled,@EndOfDayTime,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy
            ...
            WHEN NOT MATCHED THEN
                INSERT ([ScheduleCompanyAccessGuid],[CompanyGuid],[LookupDayOfWeekIndex],[Enabled],[OpeningTime],[ClosingTime],[EndOfDayEnabled],[EndOfDayTime],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy])
                    VALUES (@ScheduleCompanyAccessGuid,@CompanyGuid,@LookupDayOfWeekIndex,@Enabled,@OpeningTime,@ClosingTime,@EndOfDayEnabled,@EndOfDayTime,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy)
            ;
