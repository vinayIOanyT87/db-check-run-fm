...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblAlarmAndEventLog]
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM [track].[tblAlarmAndEventLog] CT
    ...
    BEGIN
        ;   WITH existingData AS (
                SELECT [dbo].[tblAlarmAndEventLog].[Source],[dbo].[tblAlarmAndEventLog].[Alarm],[dbo].[tblAlarmAndEventLog].[ID],[dbo].[tblAlarmAndEventLog].[AssociatedData],[dbo].[tblAlarmAndEventLog].[CategoryID],[dbo].[tblAlarmAndEventLog].[PriorityID],[dbo].[tblAlarmAndEventLog].[Acknowledged],[dbo].[tblAlarmAndEventLog].[CreatedDate],[dbo].[tblAlarmAndEventLog].[CreatedBy],[dbo].[tblAlarmAndEventLog].[UpdatedDate],[dbo].[tblAlarmAndEventLog].[UpdatedBy],[dbo].[tblAlarmAndEventLog].[AlarmAndEventLogGuid],[dbo].[tblAlarmAndEventLog].[SiteGuid],[dbo].[tblAlarmAndEventLog].[SourceNode]
            ...
            USING (SELECT @Source,@Alarm,@ID,@AssociatedData,@CategoryID,@PriorityID,@Acknowledged,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy,@AlarmAndEventLogGuid,@SiteGuid,@SourceNode
            ...
            WHEN MATCHED AND (@sync_force_write = 1 
                ...
                UPDATE SET [Source] = remoteChanges.[Source]
                       ...
                       ,[ID] = remoteChanges.[ID]
                       ,[AssociatedData] = remoteChanges.[AssociatedData]
                       ,[CategoryID] = remoteChanges.[CategoryID]
                       ,[PriorityID] = remoteChanges.[PriorityID]
            ...
            WHEN NOT MATCHED THEN
                INSERT ([Source],[Alarm],[ID],[AssociatedData],[CategoryID],[PriorityID],[Acknowledged],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy],[AlarmAndEventLogGuid],[SiteGuid],[SourceNode])
                    VALUES (@Source,@Alarm,@ID,@AssociatedData,@CategoryID,@PriorityID,@Acknowledged,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy,@AlarmAndEventLogGuid,@SiteGuid,@SourceNode)
            ;
