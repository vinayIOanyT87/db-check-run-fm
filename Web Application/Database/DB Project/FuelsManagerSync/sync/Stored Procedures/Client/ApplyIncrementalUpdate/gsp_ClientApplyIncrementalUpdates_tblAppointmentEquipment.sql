...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblAppointmentEquipment]
    ...
    BEGIN
        ;   WITH existingData AS (
            ...
            WHEN MATCHED AND (@sync_force_write = 1 
                ...
                THEN
                UPDATE SET [EquipmentGuid] = remoteChanges.[EquipmentGuid]
            ...
            WHEN NOT MATCHED THEN
                INSERT ([AppointmentEquipmentGuid],[EquipmentGuid],[TestSetDefinitionGuid],[SiteGuid],[AssetText],[AppointmentCategory],[AppointmentIsSingle],[ScheduleOnWeekends],[ScheduleOnHolidays],[StartDate],[Duration],[AppointmentPeriod],[AppointmentPeriodText],[Description],[AppointmentTimeInterval],[AppointmentDayOfTheWeekText],[AppointmentDayOfTheWeek],[AppointmentReoccuranceInterval],[AppointmentOption2Selected],[AppointmentTimeOptionSelectionText],[AppointmentTimeOptionSelection],[AppointmentMonthSelectionText],[AppointmentMonthSelection],[AppointmentDayOfTheMonth],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy])
                    VALUES (@AppointmentEquipmentGuid,@EquipmentGuid,@TestSetDefinitionGuid,@SiteGuid,@AssetText,@AppointmentCategory,@AppointmentIsSingle,@ScheduleOnWeekends,@ScheduleOnHolidays,@StartDate,@Duration,@AppointmentPeriod,@AppointmentPeriodText,@Description,@AppointmentTimeInterval,@AppointmentDayOfTheWeekText,@AppointmentDayOfTheWeek,@AppointmentReoccuranceInterval,@AppointmentOption2Selected,@AppointmentTimeOptionSelectionText,@AppointmentTimeOptionSelection,@AppointmentMonthSelectionText,@AppointmentMonthSelection,@AppointmentDayOfTheMonth,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy)
            ;
