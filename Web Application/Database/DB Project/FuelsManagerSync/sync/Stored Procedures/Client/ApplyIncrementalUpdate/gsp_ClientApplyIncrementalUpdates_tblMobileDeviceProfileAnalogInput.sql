...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblMobileDeviceProfileAnalogInput]
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM [track].[tblMobileDeviceProfileAnalogInput] CT
    ...
    BEGIN
        ;   WITH existingData AS (
                SELECT [dbo].[tblMobileDeviceProfileAnalogInput].[MobileDeviceProfileAnalogInputGuid],[dbo].[tblMobileDeviceProfileAnalogInput].[MobileDeviceProfileGuid],[dbo].[tblMobileDeviceProfileAnalogInput].[LowLimit],[dbo].[tblMobileDeviceProfileAnalogInput].[HighLimit],[dbo].[tblMobileDeviceProfileAnalogInput].[ParameterA],[dbo].[tblMobileDeviceProfileAnalogInput].[ParameterB],[dbo].[tblMobileDeviceProfileAnalogInput].[ParameterC],[dbo].[tblMobileDeviceProfileAnalogInput].[AnalogFormula],[dbo].[tblMobileDeviceProfileAnalogInput].[CreatedDate],[dbo].[tblMobileDeviceProfileAnalogInput].[CreatedBy],[dbo].[tblMobileDeviceProfileAnalogInput].[UpdatedDate],[dbo].[tblMobileDeviceProfileAnalogInput].[UpdatedBy]
            ...
            USING (SELECT @MobileDeviceProfileAnalogInputGuid,@MobileDeviceProfileGuid,@LowLimit,@HighLimit,@ParameterA,@ParameterB,@ParameterC,@AnalogFormula,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy
            ...
            WHEN MATCHED AND (@sync_force_write = 1 
                ...
                UPDATE SET [MobileDeviceProfileGuid] = remoteChanges.[MobileDeviceProfileGuid]
                       ,[LowLimit] = remoteChanges.[LowLimit]
                       ,[HighLimit] = remoteChanges.[HighLimit]
                       ,[ParameterA] = remoteChanges.[ParameterA]
                       ,[ParameterB] = remoteChanges.[ParameterB]
                       ,[ParameterC] = remoteChanges.[ParameterC]
                       ,[AnalogFormula] = remoteChanges.[AnalogFormula]
            ...
            WHEN NOT MATCHED THEN
                INSERT ([MobileDeviceProfileAnalogInputGuid],[MobileDeviceProfileGuid],[LowLimit],[HighLimit],[ParameterA],[ParameterB],[ParameterC],[AnalogFormula],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy])
                    VALUES (@MobileDeviceProfileAnalogInputGuid,@MobileDeviceProfileGuid,@LowLimit,@HighLimit,@ParameterA,@ParameterB,@ParameterC,@AnalogFormula,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy)
            ;
