...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblPIDXProfileToCompany]
    ...
    BEGIN
        ;   WITH existingData AS (
            ...
            WHEN MATCHED AND (@sync_force_write = 1 
                ...
                THEN
                UPDATE SET [PIDXProfileGuid] = remoteChanges.[PIDXProfileGuid]
                       ,[CompanyPersonnelToShipToBillToGuid] = remoteChanges.[CompanyPersonnelToShipToBillToGuid]
                       ,[SiteGuid] = remoteChanges.[SiteGuid]
                       ,[SellerID] = remoteChanges.[SellerID]
                       ,[ShipperID] = remoteChanges.[ShipperID]
                       ,[ConsigneeNumber] = remoteChanges.[ConsigneeNumber]
                       ,[DenialOverride] = remoteChanges.[DenialOverride]
                       ,[UnavailableOverride] = remoteChanges.[UnavailableOverride]
            ...
            WHEN NOT MATCHED THEN
                INSERT ([PIDXProfileToCompanyGuid],[PIDXProfileGuid],[CompanyPersonnelToShipToBillToGuid],[SiteGuid],[SellerID],[ShipperID],[ConsigneeNumber],[DenialOverride],[UnavailableOverride],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy])
                    VALUES (@PIDXProfileToCompanyGuid,@PIDXProfileGuid,@CompanyPersonnelToShipToBillToGuid,@SiteGuid,@SellerID,@ShipperID,@ConsigneeNumber,@DenialOverride,@UnavailableOverride,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy)
            ;
