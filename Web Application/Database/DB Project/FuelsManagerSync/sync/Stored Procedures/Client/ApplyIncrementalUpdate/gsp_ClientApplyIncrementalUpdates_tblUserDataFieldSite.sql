...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblUserDataFieldSite]
        ...
        ;   WITH existingData AS (
            ...
            WHEN NOT MATCHED THEN
                INSERT ([UserDataFieldSiteGuid],[TransactionAliasGuid],[SiteGuid],[Number],[DisplayOrder],[DisplayName],[LookupUserDataTypeIndex],[Required],[UserGroupGuid],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy],[DispatchField],[ClearOnNew],[ReadOnly],[Visibility],[DefaultValue])
                    VALUES (@UserDataFieldSiteGuid,@TransactionAliasGuid,@SiteGuid,@Number,@DisplayOrder,@DisplayName,@LookupUserDataTypeIndex,@Required,@UserGroupGuid,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy,@DispatchField,@ClearOnNew,@ReadOnly,@Visibility,@DefaultValue)
            ;
