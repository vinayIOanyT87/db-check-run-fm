...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblEntityFuelCardLimitToSite]
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM [track].[tblEntityFuelCardLimitToSite] CT
    ...
    BEGIN
        ;   WITH existingData AS (
            ...
            USING (SELECT @FuelCardLimitToSiteGuid,@FuelCardLimitGuid,@SiteGuid,@AssignedFromSiteGuid,@CreatedBy,@CreatedDate,@UpdatedBy,@UpdatedDate
