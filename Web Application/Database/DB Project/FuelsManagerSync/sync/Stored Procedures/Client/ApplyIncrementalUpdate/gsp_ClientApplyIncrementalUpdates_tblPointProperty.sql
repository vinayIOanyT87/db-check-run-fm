...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblPointProperty]
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM [track].[tblPointProperty] CT
    ...
    BEGIN
        ;   WITH existingData AS (
                SELECT [dbo].[tblPointProperty].[ID],[dbo].[tblPointProperty].[ValueType],[dbo].[tblPointProperty].[Value],[dbo].[tblPointProperty].[CreatedDate],[dbo].[tblPointProperty].[CreatedBy],[dbo].[tblPointProperty].[UpdatedDate],[dbo].[tblPointProperty].[UpdatedBy],[dbo].[tblPointProperty].[PointPropertyGuid],[dbo].[tblPointProperty].[PointTemplatePropertyGuid],[dbo].[tblPointProperty].[PointGuid]
            ...
            USING (SELECT @ID,@ValueType,@Value,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy,@PointPropertyGuid,@PointTemplatePropertyGuid,@PointGuid
            ...
            WHEN MATCHED AND (@sync_force_write = 1 
                ...
                UPDATE SET [ID] = remoteChanges.[ID]
                       ...
                       ,[PointTemplatePropertyGuid] = remoteChanges.[PointTemplatePropertyGuid]
            ...
            WHEN NOT MATCHED THEN
                INSERT ([ID],[ValueType],[Value],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy],[PointPropertyGuid],[PointTemplatePropertyGuid],[PointGuid])
                    VALUES (@ID,@ValueType,@Value,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy,@PointPropertyGuid,@PointTemplatePropertyGuid,@PointGuid)
            ;
