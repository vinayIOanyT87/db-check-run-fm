...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblCompanyRole]
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM [track].[tblCompanyRole] CT
    ...
    BEGIN
        ;   WITH existingData AS (
                SELECT [lookup].[tblCompanyRole].[CompanyRoleIndex],[lookup].[tblCompanyRole].[CompanyRoleCode],[lookup].[tblCompanyRole].[CompanyRoleName],[lookup].[tblCompanyRole].[CompanyRoleGuid],[lookup].[tblCompanyRole].[CreatedDate],[lookup].[tblCompanyRole].[CreatedBy],[lookup].[tblCompanyRole].[UpdatedDate],[lookup].[tblCompanyRole].[UpdatedBy]
            ...
            USING (SELECT @CompanyRoleIndex,@CompanyRoleCode,@CompanyRoleName,@CompanyRoleGuid,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy
            ...
            WHEN MATCHED AND (@sync_force_write = 1 
                ...
                THEN
                UPDATE SET [CompanyRoleCode] = remoteChanges.[CompanyRoleCode]
                       ,[CompanyRoleName] = remoteChanges.[CompanyRoleName]
                       ,[CompanyRoleGuid] = remoteChanges.[CompanyRoleGuid]
            ...
            WHEN NOT MATCHED THEN
                INSERT ([CompanyRoleIndex],[CompanyRoleCode],[CompanyRoleName],[CompanyRoleGuid],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy])
                    VALUES (@CompanyRoleIndex,@CompanyRoleCode,@CompanyRoleName,@CompanyRoleGuid,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy)
            ;
