...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblAggregateField]
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM [track].[tblAggregateField] CT
    ...
    BEGIN
        ;   WITH existingData AS (
                SELECT [lookup].[tblAggregateField].[AggregateFieldIndex],[lookup].[tblAggregateField].[AggregateFieldCode],[lookup].[tblAggregateField].[AggregateFieldName],[lookup].[tblAggregateField].[AggregateFieldGuid],[lookup].[tblAggregateField].[CreatedDate],[lookup].[tblAggregateField].[CreatedBy],[lookup].[tblAggregateField].[UpdatedDate],[lookup].[tblAggregateField].[UpdatedBy]
            ...
            USING (SELECT @AggregateFieldIndex,@AggregateFieldCode,@AggregateFieldName,@AggregateFieldGuid,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy
            ...
            WHEN MATCHED AND (@sync_force_write = 1 
                ...
                THEN
                UPDATE SET [AggregateFieldCode] = remoteChanges.[AggregateFieldCode]
                       ,[AggregateFieldName] = remoteChanges.[AggregateFieldName]
                       ,[AggregateFieldGuid] = remoteChanges.[AggregateFieldGuid]
            ...
            WHEN NOT MATCHED THEN
                INSERT ([AggregateFieldIndex],[AggregateFieldCode],[AggregateFieldName],[AggregateFieldGuid],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy])
                    VALUES (@AggregateFieldIndex,@AggregateFieldCode,@AggregateFieldName,@AggregateFieldGuid,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy)
            ;
