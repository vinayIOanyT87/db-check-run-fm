...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblApplicationString]
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM [track].[tblApplicationString] CT
    ...
    BEGIN
        ;   WITH existingData AS (
            ...
            USING (SELECT @ID,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy,@StartDate,@EndDate,@ApplicationStringGuid,@SiteGuid,@LookupApplicationStringTypeIndex
            ...
            WHEN MATCHED AND (@sync_force_write = 1 
                ...
                UPDATE SET [ID] = remoteChanges.[ID]
                       ...
                       ,[EndDate] = remoteChanges.[EndDate]
                       ,[SiteGuid] = remoteChanges.[SiteGuid]
                       ,[LookupApplicationStringTypeIndex] = remoteChanges.[LookupApplicationStringTypeIndex]
