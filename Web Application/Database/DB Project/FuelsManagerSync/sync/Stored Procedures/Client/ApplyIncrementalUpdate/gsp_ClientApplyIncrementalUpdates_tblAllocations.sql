...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblAllocations]
        ...
        ;   WITH existingData AS (
            ...
            WHEN MATCHED AND (@sync_force_write = 1 
                ...
                UPDATE SET [EffectiveDate] = remoteChanges.[EffectiveDate]
                       ...
                       ,[LoadWarning] = remoteChanges.[LoadWarning]
                       ,[LoadDenial] = remoteChanges.[LoadDenial]
                       ,[ContractNumber] = remoteChanges.[ContractNumber]
                       ,[AllocationGroupIndex] = remoteChanges.[AllocationGroupIndex]
                       ,[LastAllocationResetDate] = remoteChanges.[LastAllocationResetDate]
                       ...
                       ,[LookupCompanyMapTypeIndex] = remoteChanges.[LookupCompanyMapTypeIndex]
                       ,[AllocationGroupApplicationStringGuid] = remoteChanges.[AllocationGroupApplicationStringGuid]
