...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblQualifications]
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM [track].[tblQualifications] CT
    ...
    BEGIN
        ;   WITH existingData AS (
                SELECT [dbo].[tblQualifications].[ID],[dbo].[tblQualifications].[Description],[dbo].[tblQualifications].[Duration],[dbo].[tblQualifications].[Reoccurrence],[dbo].[tblQualifications].[CreatedDate],[dbo].[tblQualifications].[CreatedBy],[dbo].[tblQualifications].[UpdatedDate],[dbo].[tblQualifications].[UpdatedBy],[dbo].[tblQualifications].[QualificationGuid],[dbo].[tblQualifications].[SiteGuid],[dbo].[tblQualifications].[LookupQualificationTypeIndex]
            ...
            USING (SELECT @ID,@Description,@Duration,@Reoccurrence,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy,@QualificationGuid,@SiteGuid,@LookupQualificationTypeIndex
            ...
            WHEN MATCHED AND (@sync_force_write = 1 
                ...
                UPDATE SET [ID] = remoteChanges.[ID]
                       ...
                       ,[Reoccurrence] = remoteChanges.[Reoccurrence]
                       ,[CreatedDate] = remoteChanges.[CreatedDate]
                       ,[CreatedBy] = remoteChanges.[CreatedBy]
                       ,[UpdatedDate] = remoteChanges.[UpdatedDate]
                       ,[UpdatedBy] = remoteChanges.[UpdatedBy]
                       ,[SiteGuid] = remoteChanges.[SiteGuid]
                       ,[LookupQualificationTypeIndex] = remoteChanges.[LookupQualificationTypeIndex]
            ...
            WHEN NOT MATCHED THEN
                INSERT ([ID],[Description],[Duration],[Reoccurrence],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy],[QualificationGuid],[SiteGuid],[LookupQualificationTypeIndex])
                    VALUES (@ID,@Description,@Duration,@Reoccurrence,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy,@QualificationGuid,@SiteGuid,@LookupQualificationTypeIndex)
            ;
