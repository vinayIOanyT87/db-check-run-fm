...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblTestTankResults]
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM [track].[tblTestTankResults] CT
    ...
    BEGIN
        ;   WITH existingData AS (
            ...
            USING (SELECT @TestName,@Measurement,@TestDate,@DeleteFlag,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy,@PerformedBy,@Supervisor,@Flag01,@Flag02,@TestCode,@TestTankResultGuid,@LookupTestSetStatusIndex,@TestSetTankResultGuid
