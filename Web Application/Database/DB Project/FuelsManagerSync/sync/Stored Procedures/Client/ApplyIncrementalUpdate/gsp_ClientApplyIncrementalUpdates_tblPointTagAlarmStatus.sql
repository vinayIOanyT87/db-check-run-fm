...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblPointTagAlarmStatus]
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM [track].[tblPointTagAlarmStatus] CT
    ...
    BEGIN
        ;   WITH existingData AS (
            ...
            USING (SELECT @PointTagAlarmStatusGuid,@AlarmTestGuid,@Acknowledged,@AcknowledgedTimestamp,@AcknowledgedBy,@AcknowledgedComment,@Silenced,@SilencedTimestamp,@SilencedBy,@AlarmTestFailed,@AlarmTestFailedTimestamp,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy
            ...
            WHEN MATCHED AND (@sync_force_write = 1 
                ...
                THEN
                UPDATE SET [AlarmTestGuid] = remoteChanges.[AlarmTestGuid]
            ...
            WHEN NOT MATCHED THEN
                INSERT ([PointTagAlarmStatusGuid],[AlarmTestGuid],[Acknowledged],[AcknowledgedTimestamp],[AcknowledgedBy],[AcknowledgedComment],[Silenced],[SilencedTimestamp],[SilencedBy],[AlarmTestFailed],[AlarmTestFailedTimestamp],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy])
                    VALUES (@PointTagAlarmStatusGuid,@AlarmTestGuid,@Acknowledged,@AcknowledgedTimestamp,@AcknowledgedBy,@AcknowledgedComment,@Silenced,@SilencedTimestamp,@SilencedBy,@AlarmTestFailed,@AlarmTestFailedTimestamp,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy)
            ;
