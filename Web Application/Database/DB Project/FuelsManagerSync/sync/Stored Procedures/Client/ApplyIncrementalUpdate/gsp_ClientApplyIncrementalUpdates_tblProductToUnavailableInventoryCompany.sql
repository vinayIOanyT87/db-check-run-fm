...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblProductToUnavailableInventoryCompany]
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM [track].[tblProductToUnavailableInventoryCompany] CT
