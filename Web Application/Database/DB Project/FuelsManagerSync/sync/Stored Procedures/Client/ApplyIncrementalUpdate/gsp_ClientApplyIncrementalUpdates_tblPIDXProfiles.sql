...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblPIDXProfiles]
    ...
    BEGIN
        ;   WITH existingData AS (
            ...
            WHEN MATCHED AND (@sync_force_write = 1 
                ...
                THEN
                UPDATE SET [Type] = remoteChanges.[Type]
                       ,[ID] = remoteChanges.[ID]
                       ,[IPAddress] = remoteChanges.[IPAddress]
                       ,[Port] = remoteChanges.[Port]
                       ,[TerminalID] = remoteChanges.[TerminalID]
                       ,[UserID] = remoteChanges.[UserID]
                       ,[Password] = remoteChanges.[Password]
                       ,[Enabled] = remoteChanges.[Enabled]
                       ,[LoggingEnabled] = remoteChanges.[LoggingEnabled]
                       ,[LogFilePath] = remoteChanges.[LogFilePath]
            ...
            WHEN NOT MATCHED THEN
                INSERT ([Type],[ID],[IPAddress],[Port],[TerminalID],[UserID],[Password],[Enabled],[LoggingEnabled],[LogFilePath],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy],[PIDXProfileGuid],[SiteGuid],[Version])
                    VALUES (@Type,@ID,@IPAddress,@Port,@TerminalID,@UserID,@Password,@Enabled,@LoggingEnabled,@LogFilePath,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy,@PIDXProfileGuid,@SiteGuid,@Version)
            ;
