...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblEntityEquipmentTypeToSite]
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM [track].[tblEntityEquipmentTypeToSite] CT
    ...
    BEGIN
        ;   WITH existingData AS (
                SELECT [map].[tblEntityEquipmentTypeToSite].[EquipmentTypeToSiteGuid],[map].[tblEntityEquipmentTypeToSite].[EquipmentTypeGuid],[map].[tblEntityEquipmentTypeToSite].[SiteGuid],[map].[tblEntityEquipmentTypeToSite].[CreatedDate],[map].[tblEntityEquipmentTypeToSite].[CreatedBy],[map].[tblEntityEquipmentTypeToSite].[UpdatedDate],[map].[tblEntityEquipmentTypeToSite].[UpdatedBy],[map].[tblEntityEquipmentTypeToSite].[AssignedFromSiteGuid]
            ...
            USING (SELECT @EquipmentTypeToSiteGuid,@EquipmentTypeGuid,@SiteGuid,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy,@AssignedFromSiteGuid
            ...
            WHEN MATCHED AND (@sync_force_write = 1 
                ...
                THEN
                UPDATE SET [EquipmentTypeGuid] = remoteChanges.[EquipmentTypeGuid]
            ...
            WHEN NOT MATCHED THEN
                INSERT ([EquipmentTypeToSiteGuid],[EquipmentTypeGuid],[SiteGuid],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy],[AssignedFromSiteGuid])
                    VALUES (@EquipmentTypeToSiteGuid,@EquipmentTypeGuid,@SiteGuid,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy,@AssignedFromSiteGuid)
            ;
