...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblProcessVariableNoAdditiveInputPermissive]
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM [track].[tblProcessVariableNoAdditiveInputPermissive] CT
