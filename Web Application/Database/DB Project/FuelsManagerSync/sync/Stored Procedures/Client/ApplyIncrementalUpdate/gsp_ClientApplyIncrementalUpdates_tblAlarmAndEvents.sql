...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblAlarmAndEvents]
    ...
    BEGIN
        ;   WITH existingData AS (
            ...
            WHEN MATCHED AND (@sync_force_write = 1 
                ...
                THEN
                UPDATE SET [Source] = remoteChanges.[Source]
                       ,[Alarm] = remoteChanges.[Alarm]
                       ,[ID] = remoteChanges.[ID]
                       ,[CategoryIndex] = remoteChanges.[CategoryIndex]
                       ,[PriorityIndex] = remoteChanges.[PriorityIndex]
                       ...
                       ,[CategoryGuid] = remoteChanges.[CategoryGuid]
                       ,[PriorityGuid] = remoteChanges.[PriorityGuid]
