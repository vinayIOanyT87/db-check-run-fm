...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblQuantityDisplay]
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM [track].[tblQuantityDisplay] CT
    ...
    BEGIN
        ;   WITH existingData AS (
            ...
            USING (SELECT @QuantityDisplayIndex,@QuantityDisplayCode,@QuantityDisplayName,@QuantityDisplayGuid,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy
            ...
            WHEN MATCHED AND (@sync_force_write = 1 
                ...
                THEN
                UPDATE SET [QuantityDisplayCode] = remoteChanges.[QuantityDisplayCode]
                       ,[QuantityDisplayName] = remoteChanges.[QuantityDisplayName]
                       ,[QuantityDisplayGuid] = remoteChanges.[QuantityDisplayGuid]
            ...
            WHEN NOT MATCHED THEN
                INSERT ([QuantityDisplayIndex],[QuantityDisplayCode],[QuantityDisplayName],[QuantityDisplayGuid],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy])
                    VALUES (@QuantityDisplayIndex,@QuantityDisplayCode,@QuantityDisplayName,@QuantityDisplayGuid,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy)
            ;
