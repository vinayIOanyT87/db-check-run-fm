...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblTransactions]
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM [track].[tblTransactions] CT
                        WHERE CT.PK_TransactionGuid = @TransactionGuid
