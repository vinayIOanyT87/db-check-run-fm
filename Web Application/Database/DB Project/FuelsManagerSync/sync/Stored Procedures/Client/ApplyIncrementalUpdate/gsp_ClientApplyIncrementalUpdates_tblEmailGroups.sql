...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblEmailGroups]
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM [track].[tblEmailGroups] CT
    ...
    BEGIN
        ;   WITH existingData AS (
            ...
            USING (SELECT @ID,@AlwaysEnabled,@StartTime,@EndTime,@CategoriesAndPriorities,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy,@EmailGroupGuid,@SiteGuid
