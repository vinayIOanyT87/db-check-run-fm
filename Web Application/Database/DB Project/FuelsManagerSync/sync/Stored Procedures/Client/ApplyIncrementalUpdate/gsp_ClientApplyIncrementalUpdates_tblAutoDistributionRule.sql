...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblAutoDistributionRule]
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM [track].[tblAutoDistributionRule] CT
    ...
    BEGIN
        ;   WITH existingData AS (
            ...
            USING (SELECT @AutoDistributionRuleGuid,@SiteGuid,@RuleID,@RuleDescription,@RuleEnabled,@DefaultEOM,@TransactionAliasGuid,@DefaultReasonCodeGuid,@DefaultNotes,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy
