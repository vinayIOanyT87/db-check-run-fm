...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblEntitySegmentTemplate]
    ...
    BEGIN
        ;   WITH existingData AS (
            ...
            WHEN MATCHED AND (@sync_force_write = 1 
                ...
                THEN
                UPDATE SET [AppTableName] = remoteChanges.[AppTableName]
                       ,[EntityIndexFieldName] = remoteChanges.[EntityIndexFieldName]
                       ,[EntityTypeId] = remoteChanges.[EntityTypeId]
                       ,[EntityTypeDisplayName] = remoteChanges.[EntityTypeDisplayName]
                       ,[FilterFieldName] = remoteChanges.[FilterFieldName]
                       ,[FilterDisplayName] = remoteChanges.[FilterDisplayName]
                       ,[FilterValuesStoredProc] = remoteChanges.[FilterValuesStoredProc]
                       ,[FieldLevelConfigSegment] = remoteChanges.[FieldLevelConfigSegment]
                       ,[LocationBasedConstraintSegment] = remoteChanges.[LocationBasedConstraintSegment]
                       ,[SystemSegment] = remoteChanges.[SystemSegment]
                       ,[EntityAssignmentTableName] = remoteChanges.[EntityAssignmentTableName]
            ...
            WHEN NOT MATCHED THEN
                INSERT ([EntitySegmentTemplateGuid],[AppTableName],[EntityIndexFieldName],[EntityTypeId],[EntityTypeDisplayName],[FilterFieldName],[FilterDisplayName],[FilterValuesStoredProc],[FieldLevelConfigSegment],[LocationBasedConstraintSegment],[SystemSegment],[EntityAssignmentTableName],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy])
                    VALUES (@EntitySegmentTemplateGuid,@AppTableName,@EntityIndexFieldName,@EntityTypeId,@EntityTypeDisplayName,@FilterFieldName,@FilterDisplayName,@FilterValuesStoredProc,@FieldLevelConfigSegment,@LocationBasedConstraintSegment,@SystemSegment,@EntityAssignmentTableName,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy)
            ;
