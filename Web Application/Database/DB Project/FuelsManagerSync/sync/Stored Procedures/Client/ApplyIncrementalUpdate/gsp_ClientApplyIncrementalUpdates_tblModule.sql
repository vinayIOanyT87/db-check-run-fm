...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblModule]
        ...
        ;   WITH existingData AS (
            ...
            WHEN MATCHED AND (@sync_force_write = 1 
                ...
                UPDATE SET [ID] = remoteChanges.[ID]
                       ...
                       ,[ModuleCalculation] = remoteChanges.[ModuleCalculation]
                       ,[ModuleTypeName] = remoteChanges.[ModuleTypeName]
                       ,[ModuleData] = remoteChanges.[ModuleData]
                       ,[ModuleScript] = remoteChanges.[ModuleScript]
            ...
            WHEN NOT MATCHED THEN
                INSERT ([ID],[Description],[Standard],[ModuleCalculation],[ModuleTypeName],[ModuleData],[ModuleScript],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy],[ModuleGuid],[SiteGuid])
                    VALUES (@ID,@Description,@Standard,@ModuleCalculation,@ModuleTypeName,@ModuleData,@ModuleScript,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy,@ModuleGuid,@SiteGuid)
            ;
