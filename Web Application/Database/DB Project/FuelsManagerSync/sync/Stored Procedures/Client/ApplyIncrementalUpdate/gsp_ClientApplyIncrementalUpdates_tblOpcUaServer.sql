...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblOpcUaServer]
    ...
    BEGIN
        ;   WITH existingData AS (
            ...
            WHEN MATCHED AND (@sync_force_write = 1 
                ...
                THEN
                UPDATE SET [ServerEndPoint] = remoteChanges.[ServerEndPoint]
            ...
            WHEN NOT MATCHED THEN
                INSERT ([OpcUaServerGuid],[ServerEndPoint],[SecurityMode],[SecurityPolicy],[MessageEncoding],[UserIdentityMethod],[UserId],[UserPassword],[UserCertificatePath],[SiteGuid],[CreatedDate],[CreatedBy],[UpdatedDate],[UpdatedBy])
                    VALUES (@OpcUaServerGuid,@ServerEndPoint,@SecurityMode,@SecurityPolicy,@MessageEncoding,@UserIdentityMethod,@UserId,@UserPassword,@UserCertificatePath,@SiteGuid,@CreatedDate,@CreatedBy,@UpdatedDate,@UpdatedBy)
            ;
