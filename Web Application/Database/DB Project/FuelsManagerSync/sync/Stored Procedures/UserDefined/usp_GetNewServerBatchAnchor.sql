...
/* {CheckPoint: CREATING STORED PROCEDURE: [sync].[usp_GetNewServerBatchAnchor] } */
CREATE PROCEDURE [sync].[usp_GetNewServerBatchAnchor] (
        @sync_max_server_anchor bigint
...
BEGIN
	...
	IF @sync_max_server_anchor IS NOT NULL
	BEGIN
		SET @sync_max_received_anchor = @sync_max_server_anchor;
	END
