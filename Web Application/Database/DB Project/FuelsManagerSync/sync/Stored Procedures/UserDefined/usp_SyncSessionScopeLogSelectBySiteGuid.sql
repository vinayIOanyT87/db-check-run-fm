CREATE PROCEDURE [sync].[usp_SyncSessionScopeLogSelectBySiteGuid](
	...
	BEGIN TRY
        SELECT SyncSessionScopeLogGuid
    		...
    		WHERE (@SyncSessionLogGuid IS NOT NULL AND SyncSessionLogGuid = @SyncSessionLogGuid)
				AND (@SiteGuid IS NOT NULL AND SiteGuid = @SiteGuid)
	END TRY
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: usp_SyncSessionScopeLogSelectBySiteGuid' + CHAR(13)+CHAR(10)                  
