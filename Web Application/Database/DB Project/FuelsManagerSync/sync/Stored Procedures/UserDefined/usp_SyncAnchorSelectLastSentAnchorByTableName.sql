...
/* {CheckPoint: CREATING STORED PROCEDURE: [sync].[usp_SyncAnchorSelectLastSentAnchorByTableName]] } */
CREATE PROCEDURE [sync].[usp_SyncAnchorSelectLastSentAnchorByTableName] (
...
BEGIN
	...
	-- Note, Don't try to combine this stored procedure with usp_SyncAnchorSelectLastSentAnchorByTableName2.  These are used by the SyncFramework and utilize a known parameter list
	...
	SELECT @sync_table_sent_anchor = sa.LastSentAnchor1
