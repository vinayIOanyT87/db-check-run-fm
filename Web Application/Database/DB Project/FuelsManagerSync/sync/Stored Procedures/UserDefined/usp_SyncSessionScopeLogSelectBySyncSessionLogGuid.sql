CREATE PROCEDURE [sync].[usp_SyncSessionScopeLogSelectBySyncSessionLogGuid](
...
BEGIN
	BEGIN TRY
		IF (@SyncSessionLogGuid IS NULL)
			RAISERROR('SyncSessionLogGuid must be specified',16,1);
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: usp_SyncSessionScopeLogSelectBySyncSessionLogGuid' + CHAR(13)+CHAR(10)                  
