CREATE FUNCTION dbo.NSPA_OverAllocation_Transaction
(
	@StartDate		DATETIME,
	@EndDate		DATETIME
)
...
INSERT INTO @CardTable SELECT	* FROM	NSPA_OverAllocation_FuelCards('Transactional')
...
END -- NSPA_OverAllocation_Transaction