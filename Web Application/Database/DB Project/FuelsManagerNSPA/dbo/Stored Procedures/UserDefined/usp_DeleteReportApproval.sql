CREATE PROCEDURE [dbo].[usp_DeleteReportApproval] 
(
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored Procedure: [dbo].[usp_DeleteReportApproval] 
	-- Author: Shawn Marlin
	...
	BEGIN TRY	
		...
		DELETE FROM tblReportApprovals WHERE ReportApprovalGuid = @ReportApprovalGuid
	...
	BEGIN CATCH  
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: [dbo].[usp_DeleteReportApproval] ' + CHAR(13)+CHAR(10)                  
