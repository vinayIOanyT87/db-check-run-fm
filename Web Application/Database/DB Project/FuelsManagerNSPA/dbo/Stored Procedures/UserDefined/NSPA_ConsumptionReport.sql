CREATE PROCEDURE dbo.NSPA_ConsumptionReport (
...
BEGIN
	...
	BEGIN CATCH
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13) + CHAR(10) + 'Number: ' + CAST(@_ErrNumber AS VARCHAR(20)) + CHAR(13) + CHAR(10) + 'Procedure Name: [dbo].[NSPA_ConsumptionReport] ' + CHAR(13) + CHAR(10) + 'Line Number: ' + ISNULL(CAST(@_ErrLineNumber AS VARCHAR(20)), '') + CHAR(13) + CHAR(10);
