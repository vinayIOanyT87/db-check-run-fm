...
-- Description:	Gets the Load Rack records for the
--				Owner Activity Report
-- =============================================
CREATE PROCEDURE [rpt].[usp_OwnerActivityReportLoadRack]
...
BEGIN
	...
	T.DestinationRegistrationID1 as VehicleID, 
	T.DestinationSerialNumber1 as SerialNo, 
	T.SourceRegistrationID1 as Fillstand, 
