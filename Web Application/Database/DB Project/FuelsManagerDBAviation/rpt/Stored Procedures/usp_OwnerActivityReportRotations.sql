...
-- Description:	Gets the Rotation records for the
--				Owner Activity Report
-- =============================================
CREATE PROCEDURE [rpt].[usp_OwnerActivityReportRotations] 
...
BEGIN
	...
	T.DestinationRegistrationID1 as Dest, 
