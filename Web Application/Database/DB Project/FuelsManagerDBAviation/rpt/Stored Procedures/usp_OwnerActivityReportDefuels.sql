...
-- Description:	Gets the Defuel records for the
--				Owner Activity Report
-- =============================================
CREATE PROCEDURE [rpt].[usp_OwnerActivityReportDefuels] 
...
BEGIN
	...
	T.DestinationRegistrationID1 as TailNo, 
	T.DestinationSerialNumber1 as FlightNo, 
