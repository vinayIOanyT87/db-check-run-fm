/*
	DROP PROCEDURE [Staging].[usp_UpdateTransactionLineItemUserDataProcessedFlags]

	EXEC [staging].[usp_UpdateTransactionLineItemUserDataProcessedFlags] 0, 0

	EXEC [staging].[usp_UpdateTransactionLineItemUserDataProcessedFlags] 200000, 400000
	
*/
CREATE PROCEDURE [staging].[usp_UpdateTransactionLineItemUserDataProcessedFlags]
(
	@startSKey  int,
	@endSKey int
)
...
BEGIN
  ------------------------------------------------------------------------------------------------------
  -- Stored procedure: [staging].[usp_UpdateTransactionLineItemUserDataProcessedFlags]
  -- Author: Hansraj Bapoo
  -- Version/Date: 1.0.003 / 2012-07-13 14:21:10.4470770 -04:00
  -- Purpose: Sets the IsProcessed flag of transaction LineItem UserData records that have already been indirectly loaded through LineItem/SubLineItem processing.
  -- Notes:
  ...
  SET NOCOUNT ON;
  BEGIN TRY
    -- Flag LineItem UserData records that have already been processed through Line Item insertions
    UPDATE a
    SET a.IsProcessed = 1
  ...
  BEGIN CATCH
    ...
    + 'Procedure Name: [staging].[usp_UpdateTransactionUserDataProcessedFlags]' + CHAR(13) + CHAR(10)
