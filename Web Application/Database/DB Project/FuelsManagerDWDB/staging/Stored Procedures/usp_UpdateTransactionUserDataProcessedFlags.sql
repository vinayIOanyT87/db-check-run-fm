/*
	DROP PROCEDURE [Staging].[usp_UpdateTransactionUserDataProcessedFlags]

	EXEC [staging].[usp_UpdateTransactionUserDataProcessedFlags] 0, 0

	EXEC [staging].[usp_UpdateTransactionUserDataProcessedFlags] 200000, 400000
	
*/
CREATE PROCEDURE [staging].[usp_UpdateTransactionUserDataProcessedFlags]
(
	@startSKey  int,
	@endSKey int
)
...
BEGIN
  ------------------------------------------------------------------------------------------------------
  -- Stored procedure: [staging].[usp_UpdateTransactionUserDataProcessedFlags]
  -- Author: Hansraj Bapoo
  -- Version/Date: 1.0.003 / 2012-07-13 14:21:10.4470770 -04:00
  -- Purpose: Sets the IsProcessed flag of transaction UserData records that have already been indirectly loaded through LineItem/SubLineItem processing.
  -- Notes:
  ...
  SET NOCOUNT ON;
  BEGIN TRY
    -- Flag Header UserData records that have already been processed through Line Item insertions
    UPDATE a
    SET a.IsProcessed = 1
