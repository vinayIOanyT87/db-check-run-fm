CREATE TABLE [staging].[tblEntityTransactionAliasToSite](
...
GO
ALTER TABLE [staging].[tblEntityTransactionAliasToSite] ADD  DEFAULT ((0)) FOR [IsRecordDeleted]
GO
ALTER TABLE [staging].[tblEntityTransactionAliasToSite] ADD  DEFAULT ((0)) FOR [IsRecordAddedByETL]
GO
ALTER TABLE [staging].[tblEntityTransactionAliasToSite] ADD  DEFAULT ((0)) FOR [IgnoreRecord]