CREATE TABLE [staging].[tblEntityProductToSite](
...
GO
ALTER TABLE [staging].[tblEntityProductToSite] ADD  DEFAULT ((0)) FOR [IsRecordDeleted]
GO
ALTER TABLE [staging].[tblEntityProductToSite] ADD  DEFAULT ((0)) FOR [IsRecordAddedByETL]
GO
ALTER TABLE [staging].[tblEntityProductToSite] ADD  DEFAULT ((0)) FOR [IgnoreRecord]