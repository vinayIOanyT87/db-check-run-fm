CREATE TABLE [staging].[tblUserToUserGroup](
	[SKey] [int] IDENTITY(1,1) NOT NULL,
	[UserToUserGroupGuid] [uniqueidentifier] NULL,
...
GO
ALTER TABLE [staging].[tblUserToUserGroup] ADD  DEFAULT ((0)) FOR [IsRecordDeleted]
GO
ALTER TABLE [staging].[tblUserToUserGroup] ADD  DEFAULT ((0)) FOR [IsRecordAddedByETL]
GO
ALTER TABLE [staging].[tblUserToUserGroup] ADD  DEFAULT ((0)) FOR [IgnoreRecord]