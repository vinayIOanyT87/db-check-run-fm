CREATE TABLE [staging].[tblAutoDistributionReasonCodes](
	[SKey] [int] IDENTITY(1,1) NOT NULL,
	[AutoDistributionReasonCodeGuid] [uniqueidentifier] NULL,
	[AutoDistributionReasonCodeKey] [nvarchar](50) NULL,
...
GO
ALTER TABLE [staging].[tblAutoDistributionReasonCodes] ADD  DEFAULT ((0)) FOR [IsRecordDeleted]
GO
ALTER TABLE [staging].[tblAutoDistributionReasonCodes] ADD  DEFAULT ((0)) FOR [IsRecordAddedByETL]
GO
ALTER TABLE [staging].[tblAutoDistributionReasonCodes] ADD  DEFAULT ((0)) FOR [IgnoreRecord]