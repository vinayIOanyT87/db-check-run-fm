...
BEGIN
    ...
    BEGIN 
        ...
        END
			...
			ELSE
			BEGIN
	        SELECT TOP(@sync_batch_size_tblTrendPenToPointTrend) CT.PK_TrendPenToPointTrendGuid 'TrendPenToPointTrendGuid', CT.FK_ParentPK 'PointTagGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblTrendPenToPointTrend] CT
