...
/*
	SELECT * FROM [erv].[udf_GetPersonnelToSiteHierarchyByRecordVersionGuid] ('80B08634-D356-4569-B9A2-CD36DF955BD0') ORDER BY HierarchyLevel, SiteId
	SELECT * FROM [erv].[udf_GetPersonnelToSiteHierarchyByRecordVersionGuid] ('B4E4B396-1366-4BEA-BDD6-D08F35863E87') ORDER BY HierarchyLevel, SiteId	
*/



	CREATE FUNCTION [erv].[udf_GetPersonnelToSiteHierarchyByRecordVersionGuid]
	(
	...
	/*
	------------------------------------------------------------------------------------------------------
	-- Function: [erv].[udf_GetPersonnelToSiteHierarchyByRecordVersionGuid] 
	...
	*/
		...
		SELECT @startSiteGuid = SiteGuid, @masterRecordGuid = _MasterRecordGuid FROM tblPersonnel WHERE PersonnelGuid = @EntityGuid;
