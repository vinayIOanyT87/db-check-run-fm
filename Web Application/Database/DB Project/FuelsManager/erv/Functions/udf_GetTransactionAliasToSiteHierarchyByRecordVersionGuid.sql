...
/*
	SELECT * FROM [erv].[udf_GetTransactionAliasToSiteHierarchyByRecordVersionGuid] ('80B08634-D356-4569-B9A2-CD36DF955BD0') ORDER BY HierarchyLevel, SiteId
	SELECT * FROM [erv].[udf_GetTransactionAliasToSiteHierarchyByRecordVersionGuid] ('B4E4B396-1366-4BEA-BDD6-D08F35863E87') ORDER BY HierarchyLevel, SiteId	
*/



	CREATE FUNCTION [erv].[udf_GetTransactionAliasToSiteHierarchyByRecordVersionGuid]
	(
	...
	/*
	------------------------------------------------------------------------------------------------------
	-- Function: [erv].[udf_GetTransactionAliasToSiteHierarchyByRecordVersionGuid] 
	-- Author: Hansraj Bapoo
	-- Version/Date: 1.0.003 / 2012-07-13 14:21:10.4470770 -04:00
	-- Purpose: Function to return the site hierarchy below a given sitegroup based on the assignments of a given entity record version from its owner sitegroup. 
	...
	*/
		...
		SELECT @startSiteGuid = SiteGuid, @masterRecordGuid = _MasterRecordGuid FROM tblTransactionAliases WHERE TransactionAliasGuid = @EntityGuid;
