...
/*
	SELECT * FROM [erv].[udf_GetCompanyToSiteHierarchyByRecordVersionGuid] ('80B08634-D356-4569-B9A2-CD36DF955BD0') ORDER BY HierarchyLevel, SiteId
	SELECT * FROM [erv].[udf_GetCompanyToSiteHierarchyByRecordVersionGuid] ('B4E4B396-1366-4BEA-BDD6-D08F35863E87') ORDER BY HierarchyLevel, SiteId	
*/



	CREATE FUNCTION [erv].[udf_GetCompanyToSiteHierarchyByRecordVersionGuid]
	(
	...
	/*
	------------------------------------------------------------------------------------------------------
	-- Function: [erv].[udf_GetCompanyToSiteHierarchyByRecordVersionGuid] 
	...
	*/
		...
		SELECT @startSiteGuid = SiteGuid, @masterRecordGuid = _MasterRecordGuid FROM tblCompanies WHERE CompanyGuid = @EntityGuid;
