CREATE PROCEDURE [map].[usp_FuelCardLimitToFuelCardInsert]
...
BEGIN
	...
	BEGIN TRY
		...
		INSERT INTO map.tblFuelCardLimitToFuelCard
		(
	...
	BEGIN CATCH
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: map.usp_FuelCardLimitToFuelCardInsert' + CHAR(13)+CHAR(10)                  
