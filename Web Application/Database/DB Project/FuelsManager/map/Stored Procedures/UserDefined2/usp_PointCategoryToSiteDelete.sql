...
/*
	EXEC [map].[usp_PointCategoryToSiteDelete] 'B4E4B396-1366-4BEA-BDD6-D08F35863E87', 'AEBA18E3-E97B-479E-8B2D-0BCD69C1C421'
	EXEC [map].[usp_PointCategoryToSiteDelete] 'B4E4B396-1366-4BEA-BDD6-D08F35863E87', NULL
	EXEC [map].[usp_PointCategoryToSiteDelete] 'B4E4B396-1366-4BEA-BDD6-D08F35863E87', NULL, 1

*/
CREATE PROCEDURE [map].[usp_PointCategoryToSiteDelete]
(
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[usp_PointCategoryToSiteDelete]
	...
	BEGIN TRY
		...
		SELECT MappingGuid, AssignedFromSiteGuid, SiteGuid, HierarchyLevel FROM [map].[udf_GetPointCategoryToSiteHierarchyByAssignment] (@EntityRecordGuid, NULL, @AssignedToSiteGuid)
		...
		BEGIN
			INSERT INTO @tblEntityToSiteHierarchy
			(MappingGuid, AssignedFromSiteGuid, AssignedToSiteGuid, HierarchyLevel)
			SELECT b.PointCategoryToSiteGuid, a.SiteGuid, a.SiteGuid, -1 FROM dbo.tblSites a
			INNER JOIN map.tblEntityPointCategoryToSite b
		...
		DELETE a FROM map.tblEntityPointCategoryToSite a
		INNER JOIN @tblEntityToSiteHierarchy b 
		ON b.MappingGuid = a.PointCategoryToSiteGuid
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: map.usp_PointCategoryToSiteDelete' + CHAR(13)+CHAR(10)                  
