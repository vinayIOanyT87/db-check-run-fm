...
CREATE PROCEDURE [map].[gsp_EntityAppointmentTankToSiteUpdateByPK]
(
	...
	,	@NullOverrideAppointmentTankGuid BIT=0 
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[gsp_EntityAppointmentTankToSiteUpdateByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.003 / 2013-12-30 14:44:41.1251453 -05:00
	-- Purpose: Update table [map].[tblEntityAppointmentTankToSite]
	-- Notes:
	-- 1. @AppointmentTankToSiteGuid and @UpdatedBy are required parameter.
	...
	SET NOCOUNT ON;
	BEGIN TRY
		IF @_RowVersion IS NOT NULL AND NOT EXISTS(SELECT 1 FROM [map].[tblEntityAppointmentTankToSite] WHERE AppointmentTankToSiteGuid=@AppointmentTankToSiteGuid AND _RowVersion=@_RowVersion)
		BEGIN
			RAISERROR('Attempted to modify a stale copy of the record',16,1);
			RETURN;
		END
 
		UPDATE [map].[tblEntityAppointmentTankToSite] SET
			[AppointmentTankGuid]=(CASE ISNULL(@NullOverrideAppointmentTankGuid,0) WHEN 1 THEN @AppointmentTankGuid ELSE ISNULL(@AppointmentTankGuid,[AppointmentTankGuid]) END)
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_EntityAppointmentTankToSiteUpdateByPK' + CHAR(13)+CHAR(10)                  
