...
CREATE PROCEDURE [map].[gsp_EntityLedgerAggregateColumnToSiteInsertByPK]
(
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[gsp_EntityLedgerAggregateColumnToSiteInsertByPK]
	...
	BEGIN TRY
		...
		WHERE [LedgerAggregateColumnToSiteGuid] = @MappingGuid
	...
	BEGIN CATCH
		...
		BEGIN
			...
			+ 'Procedure Name: gsp_EntityLedgerAggregateColumnToSiteInsertByPK' + CHAR(13)+CHAR(10)
