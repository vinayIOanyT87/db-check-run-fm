CREATE PROCEDURE [map].[gsp_ProductToProductGroupInsertByPK]
(
		@ProductToProductGroupGuid uniqueidentifier=NULL OUTPUT
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[gsp_ProductToProductGroupInsertByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.001 / 2014-02-05 15:58:32.7352767 -05:00
	-- Purpose: Insert into table [map].[tblProductToProductGroup]
	-- Notes:
	------------------------------------------------------------------------------------------------------
	SET NOCOUNT ON;
	BEGIN TRY
		...
		SET @ProductToProductGroupGuid=NEWID();
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_ProductToProductGroupInsertByPK' + CHAR(13)+CHAR(10)                  
