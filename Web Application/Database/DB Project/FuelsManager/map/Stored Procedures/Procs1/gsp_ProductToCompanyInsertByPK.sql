CREATE PROCEDURE [map].[gsp_ProductToCompanyInsertByPK]
(
		@ProductToCompanyGuid uniqueidentifier=NULL OUTPUT
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[gsp_ProductToCompanyInsertByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.001 / 2014-02-05 15:58:32.7142767 -05:00
	-- Purpose: Insert into table [map].[tblProductToCompany]
	-- Notes:
	------------------------------------------------------------------------------------------------------
	SET NOCOUNT ON;
	BEGIN TRY
		...
		SET @ProductToCompanyGuid=NEWID();
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_ProductToCompanyInsertByPK' + CHAR(13)+CHAR(10)                  
