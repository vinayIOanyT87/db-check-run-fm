CREATE PROCEDURE [map].[gsp_ProductToPresetRecipeInsertByPK]
(
		@ProductToPresetRecipeGuid uniqueidentifier=NULL OUTPUT
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[gsp_ProductToPresetRecipeInsertByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.001 / 2014-02-05 15:58:32.7322767 -05:00
	-- Purpose: Insert into table [map].[tblProductToPresetRecipe]
	-- Notes:
	------------------------------------------------------------------------------------------------------
	SET NOCOUNT ON;
	BEGIN TRY
		...
		SET @ProductToPresetRecipeGuid=NEWID();
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_ProductToPresetRecipeInsertByPK' + CHAR(13)+CHAR(10)                  
