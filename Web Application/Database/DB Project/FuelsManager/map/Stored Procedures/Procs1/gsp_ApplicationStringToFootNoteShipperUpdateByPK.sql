CREATE PROCEDURE [map].[gsp_ApplicationStringToFootNoteShipperUpdateByPK]
(
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[gsp_ApplicationStringToFootNoteShipperUpdateByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.003 / 2014-02-05 16:52:29.9864458 -05:00
	-- Purpose: Update table [map].[tblApplicationStringToFootNoteShipper]
	-- Notes:
	-- 1. @ApplicationStringToFootNoteShipperGuid and @UpdatedBy are required parameter.
	...
	SET NOCOUNT ON;
	BEGIN TRY
		IF @_RowVersion IS NOT NULL AND NOT EXISTS(SELECT 1 FROM [map].[tblApplicationStringToFootNoteShipper] WHERE ApplicationStringToFootNoteShipperGuid=@ApplicationStringToFootNoteShipperGuid AND _RowVersion=@_RowVersion)
		BEGIN
			RAISERROR('Attempted to modify a stale copy of the record',16,1);
			RETURN;
		END
 
		UPDATE [map].[tblApplicationStringToFootNoteShipper] SET
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_ApplicationStringToFootNoteShipperUpdateByPK' + CHAR(13)+CHAR(10)                  
