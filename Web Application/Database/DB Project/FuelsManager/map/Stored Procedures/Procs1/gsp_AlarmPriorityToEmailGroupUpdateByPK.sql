CREATE PROCEDURE [map].[gsp_AlarmPriorityToEmailGroupUpdateByPK]
(
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[gsp_AlarmPriorityToEmailGroupUpdateByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.003 / 2014-02-05 16:52:29.9734445 -05:00
	-- Purpose: Update table [map].[tblAlarmPriorityToEmailGroup]
	-- Notes:
	-- 1. @AlarmPriorityEmailGroupGuid and @UpdatedBy are required parameter.
	...
	SET NOCOUNT ON;
	BEGIN TRY
		IF @_RowVersion IS NOT NULL AND NOT EXISTS(SELECT 1 FROM [map].[tblAlarmPriorityToEmailGroup] WHERE AlarmPriorityEmailGroupGuid=@AlarmPriorityEmailGroupGuid AND _RowVersion=@_RowVersion)
		BEGIN
			RAISERROR('Attempted to modify a stale copy of the record',16,1);
			RETURN;
		END
 
		UPDATE [map].[tblAlarmPriorityToEmailGroup] SET
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_AlarmPriorityToEmailGroupUpdateByPK' + CHAR(13)+CHAR(10)                  
