CREATE PROCEDURE [map].[gsp_ApplicationStringToFootNoteShipToUpdateByPK]
(
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[gsp_ApplicationStringToFootNoteShipToUpdateByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.003 / 2014-02-05 16:52:29.9884460 -05:00
	-- Purpose: Update table [map].[tblApplicationStringToFootNoteShipTo]
	-- Notes:
	-- 1. @ApplicationStringToFootNoteShipToGuid and @UpdatedBy are required parameter.
	...
	SET NOCOUNT ON;
	BEGIN TRY
		IF @_RowVersion IS NOT NULL AND NOT EXISTS(SELECT 1 FROM [map].[tblApplicationStringToFootNoteShipTo] WHERE ApplicationStringToFootNoteShipToGuid=@ApplicationStringToFootNoteShipToGuid AND _RowVersion=@_RowVersion)
		BEGIN
			RAISERROR('Attempted to modify a stale copy of the record',16,1);
			RETURN;
		END
 
		UPDATE [map].[tblApplicationStringToFootNoteShipTo] SET
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_ApplicationStringToFootNoteShipToUpdateByPK' + CHAR(13)+CHAR(10)                  
