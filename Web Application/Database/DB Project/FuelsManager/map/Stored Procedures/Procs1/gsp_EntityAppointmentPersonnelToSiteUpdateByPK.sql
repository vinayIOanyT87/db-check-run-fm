...
CREATE PROCEDURE [map].[gsp_EntityAppointmentPersonnelToSiteUpdateByPK]
(
	...
	,	@NullOverrideAppointmentPersonnelGuid BIT=0 
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[gsp_EntityAppointmentPersonnelToSiteUpdateByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.003 / 2013-12-30 14:44:41.1241453 -05:00
	-- Purpose: Update table [map].[tblEntityAppointmentPersonnelToSite]
	-- Notes:
	-- 1. @AppointmentPersonnelToSiteGuid and @UpdatedBy are required parameter.
	...
	SET NOCOUNT ON;
	BEGIN TRY
		IF @_RowVersion IS NOT NULL AND NOT EXISTS(SELECT 1 FROM [map].[tblEntityAppointmentPersonnelToSite] WHERE AppointmentPersonnelToSiteGuid=@AppointmentPersonnelToSiteGuid AND _RowVersion=@_RowVersion)
		BEGIN
			RAISERROR('Attempted to modify a stale copy of the record',16,1);
			RETURN;
		END
 
		UPDATE [map].[tblEntityAppointmentPersonnelToSite] SET
			[AppointmentPersonnelGuid]=(CASE ISNULL(@NullOverrideAppointmentPersonnelGuid,0) WHEN 1 THEN @AppointmentPersonnelGuid ELSE ISNULL(@AppointmentPersonnelGuid,[AppointmentPersonnelGuid]) END)
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_EntityAppointmentPersonnelToSiteUpdateByPK' + CHAR(13)+CHAR(10)                  
