...
CREATE PROCEDURE [map].[gsp_EntityAppointmentEquipmentToSiteUpdateByPK]
(
	...
	,	@NullOverrideAppointmentEquipmentGuid BIT=0 
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[gsp_EntityAppointmentEquipmentToSiteUpdateByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.003 / 2013-12-30 14:44:41.1221453 -05:00
	-- Purpose: Update table [map].[tblEntityAppointmentEquipmentToSite]
	-- Notes:
	-- 1. @AppointmentEquipmentToSiteGuid and @UpdatedBy are required parameter.
	...
	SET NOCOUNT ON;
	BEGIN TRY
		IF @_RowVersion IS NOT NULL AND NOT EXISTS(SELECT 1 FROM [map].[tblEntityAppointmentEquipmentToSite] WHERE AppointmentEquipmentToSiteGuid=@AppointmentEquipmentToSiteGuid AND _RowVersion=@_RowVersion)
		BEGIN
			RAISERROR('Attempted to modify a stale copy of the record',16,1);
			RETURN;
		END
 
		UPDATE [map].[tblEntityAppointmentEquipmentToSite] SET
			[AppointmentEquipmentGuid]=(CASE ISNULL(@NullOverrideAppointmentEquipmentGuid,0) WHEN 1 THEN @AppointmentEquipmentGuid ELSE ISNULL(@AppointmentEquipmentGuid,[AppointmentEquipmentGuid]) END)
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_EntityAppointmentEquipmentToSiteUpdateByPK' + CHAR(13)+CHAR(10)                  
