...
CREATE PROCEDURE [map].[gsp_EntityUserGroupToSiteInsertByPK]
(
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[gsp_EntityUserGroupToSiteInsertByPK]
	...
	BEGIN TRY
		...
		WHERE [UserGroupToSiteGuid] = @MappingGuid
	...
	BEGIN CATCH
		...
		BEGIN
			...
			+ 'Procedure Name: gsp_EntityUserGroupToSiteInsertByPK' + CHAR(13)+CHAR(10)
