...
CREATE PROCEDURE [map].[gsp_EntityReportConfigurationSettingsToSiteUpdateByPK]
(
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[gsp_EntityReportConfigurationSettingsToSiteUpdateByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.003 / 2013-12-30 14:44:41.1921453 -05:00
	-- Purpose: Update table [map].[tblEntityReportConfigurationSettingsToSite]
	-- Notes:
	-- 1. @ReportConfigurationSettingsToSiteGuid and @UpdatedBy are required parameter.
	...
	SET NOCOUNT ON;
	BEGIN TRY
		IF @_RowVersion IS NOT NULL AND NOT EXISTS(SELECT 1 FROM [map].[tblEntityReportConfigurationSettingsToSite] WHERE ReportConfigurationSettingsToSiteGuid=@ReportConfigurationSettingsToSiteGuid AND _RowVersion=@_RowVersion)
		BEGIN
			RAISERROR('Attempted to modify a stale copy of the record',16,1);
			RETURN;
		END
 
		UPDATE [map].[tblEntityReportConfigurationSettingsToSite] SET
		...
		WHERE	ReportConfigurationSettingsToSiteGuid=@ReportConfigurationSettingsToSiteGuid;
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_EntityReportConfigurationSettingsToSiteUpdateByPK' + CHAR(13)+CHAR(10)                  
