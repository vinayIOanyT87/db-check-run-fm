CREATE PROCEDURE [map].[gsp_CompanyCompanyToCompanyGroupUpdateByPK]
(
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[gsp_CompanyCompanyToCompanyGroupUpdateByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.003 / 2014-02-05 16:52:30.0004472 -05:00
	-- Purpose: Update table [map].[tblCompanyCompanyToCompanyGroup]
	-- Notes:
	-- 1. @CompanyCompanyToCompanyGroupGuid and @UpdatedBy are required parameter.
	...
	SET NOCOUNT ON;
	BEGIN TRY
		IF @_RowVersion IS NOT NULL AND NOT EXISTS(SELECT 1 FROM [map].[tblCompanyCompanyToCompanyGroup] WHERE CompanyCompanyToCompanyGroupGuid=@CompanyCompanyToCompanyGroupGuid AND _RowVersion=@_RowVersion)
		BEGIN
			RAISERROR('Attempted to modify a stale copy of the record',16,1);
			RETURN;
		END
 
		UPDATE [map].[tblCompanyCompanyToCompanyGroup] SET
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_CompanyCompanyToCompanyGroupUpdateByPK' + CHAR(13)+CHAR(10)                  
