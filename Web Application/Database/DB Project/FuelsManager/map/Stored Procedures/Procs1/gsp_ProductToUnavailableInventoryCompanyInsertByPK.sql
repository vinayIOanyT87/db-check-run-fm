CREATE PROCEDURE [map].[gsp_ProductToUnavailableInventoryCompanyInsertByPK]
(
		@ProductToUnavailableInventoryCompanyGuid uniqueidentifier=NULL OUTPUT
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[gsp_ProductToUnavailableInventoryCompanyInsertByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.001 / 2014-02-05 15:58:32.7442767 -05:00
	-- Purpose: Insert into table [map].[tblProductToUnavailableInventoryCompany]
	-- Notes:
	------------------------------------------------------------------------------------------------------
	SET NOCOUNT ON;
	BEGIN TRY
		...
		SET @ProductToUnavailableInventoryCompanyGuid=NEWID();
		...
		WHERE ProductToUnavailableInventoryCompanyGuid=@ProductToUnavailableInventoryCompanyGuid;
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_ProductToUnavailableInventoryCompanyInsertByPK' + CHAR(13)+CHAR(10)                  
