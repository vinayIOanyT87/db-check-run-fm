CREATE PROCEDURE [map].[gsp_TestDefinitionToTestSetDefinitionUpdateByPK]
(
	...
	,	@NullOverrideTestDefinitionGuid BIT=0 
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[gsp_TestDefinitionToTestSetDefinitionUpdateByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.003 / 2014-02-05 16:52:30.1454617 -05:00
	-- Purpose: Update table [map].[tblTestDefinitionToTestSetDefinition]
	-- Notes:
	-- 1. @TestDefinitionToTestSetDefinitionGuid and @UpdatedBy are required parameter.
	...
	SET NOCOUNT ON;
	BEGIN TRY
		IF @_RowVersion IS NOT NULL AND NOT EXISTS(SELECT 1 FROM [map].[tblTestDefinitionToTestSetDefinition] WHERE TestDefinitionToTestSetDefinitionGuid=@TestDefinitionToTestSetDefinitionGuid AND _RowVersion=@_RowVersion)
		BEGIN
			RAISERROR('Attempted to modify a stale copy of the record',16,1);
			RETURN;
		END
 
		UPDATE [map].[tblTestDefinitionToTestSetDefinition] SET
			[TestDefinitionGuid]=(CASE ISNULL(@NullOverrideTestDefinitionGuid,0) WHEN 1 THEN @TestDefinitionGuid ELSE ISNULL(@TestDefinitionGuid,[TestDefinitionGuid]) END)
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_TestDefinitionToTestSetDefinitionUpdateByPK' + CHAR(13)+CHAR(10)                  
