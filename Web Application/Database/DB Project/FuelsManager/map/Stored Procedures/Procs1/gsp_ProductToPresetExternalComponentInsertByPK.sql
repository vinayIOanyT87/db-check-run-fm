CREATE PROCEDURE [map].[gsp_ProductToPresetExternalComponentInsertByPK]
(
		@ProductToPresetExternalComponentGuid uniqueidentifier=NULL OUTPUT
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[gsp_ProductToPresetExternalComponentInsertByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.001 / 2014-02-05 15:58:32.7262767 -05:00
	-- Purpose: Insert into table [map].[tblProductToPresetExternalComponent]
	-- Notes:
	------------------------------------------------------------------------------------------------------
	SET NOCOUNT ON;
	BEGIN TRY
		...
		SET @ProductToPresetExternalComponentGuid=NEWID();
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_ProductToPresetExternalComponentInsertByPK' + CHAR(13)+CHAR(10)                  
