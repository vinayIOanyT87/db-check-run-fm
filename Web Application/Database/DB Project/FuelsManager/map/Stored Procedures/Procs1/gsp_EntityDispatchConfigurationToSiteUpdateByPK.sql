...
CREATE PROCEDURE [map].[gsp_EntityDispatchConfigurationToSiteUpdateByPK]
(
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[gsp_EntityDispatchConfigurationToSiteUpdateByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.003 / 2013-12-30 14:44:41.1401453 -05:00
	-- Purpose: Update table [map].[tblEntityDispatchConfigurationToSite]
	-- Notes:
	-- 1. @DispatchConfigurationToSiteGuid and @UpdatedBy are required parameter.
	...
	SET NOCOUNT ON;
	BEGIN TRY
		IF @_RowVersion IS NOT NULL AND NOT EXISTS(SELECT 1 FROM [map].[tblEntityDispatchConfigurationToSite] WHERE DispatchConfigurationToSiteGuid=@DispatchConfigurationToSiteGuid AND _RowVersion=@_RowVersion)
		BEGIN
			RAISERROR('Attempted to modify a stale copy of the record',16,1);
			RETURN;
		END
 
		UPDATE [map].[tblEntityDispatchConfigurationToSite] SET
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_EntityDispatchConfigurationToSiteUpdateByPK' + CHAR(13)+CHAR(10)                  
