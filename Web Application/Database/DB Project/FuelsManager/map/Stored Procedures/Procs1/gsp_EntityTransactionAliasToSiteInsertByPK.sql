...
CREATE PROCEDURE [map].[gsp_EntityTransactionAliasToSiteInsertByPK]
(
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[gsp_EntityTransactionAliasToSiteInsertByPK]
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.002 / 2013-12-30 14:44:52.5314423 -05:00
	-- Purpose: Insert into table [map].[tblEntityTransactionAliasToSite]
	-- Notes:
	------------------------------------------------------------------------------------------------------
	SET NOCOUNT ON;
	BEGIN TRY
		...
		WHERE [TransactionAliasToSiteGuid] = @MappingGuid
	...
	BEGIN CATCH
		...
		BEGIN
			...
			+ 'Procedure Name: gsp_EntityTransactionAliasToSiteInsertByPK' + CHAR(13)+CHAR(10)
