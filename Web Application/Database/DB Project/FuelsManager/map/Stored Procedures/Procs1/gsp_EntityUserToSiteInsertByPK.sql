...
CREATE PROCEDURE [map].[gsp_EntityUserToSiteInsertByPK]
(
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[gsp_EntityUserToSiteInsertByPK]
	...
	BEGIN TRY
		...
		WHERE [UserToSiteGuid] = @MappingGuid
	...
	BEGIN CATCH
		...
		BEGIN
			...
			+ 'Procedure Name: gsp_EntityUserToSiteInsertByPK' + CHAR(13)+CHAR(10)
