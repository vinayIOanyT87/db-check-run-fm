CREATE PROCEDURE [map].[gsp_EntityModuleToSiteInsertByPK]
(
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[gsp_EntityModuleToSiteInsertByPK]
	...
	BEGIN TRY
		...
		WHERE [ModuleToSiteGuid] = @MappingGuid
	...
	BEGIN CATCH
		...
		BEGIN
			...
			+ 'Procedure Name: gsp_EntityModuleToSiteInsertByPK' + CHAR(13)+CHAR(10)
