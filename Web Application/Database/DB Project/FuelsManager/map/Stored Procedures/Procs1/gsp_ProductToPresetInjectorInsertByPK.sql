CREATE PROCEDURE [map].[gsp_ProductToPresetInjectorInsertByPK]
(
		@ProductToPresetInjectorGuid uniqueidentifier=NULL OUTPUT
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[gsp_ProductToPresetInjectorInsertByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.001 / 2014-02-05 15:58:32.7292767 -05:00
	-- Purpose: Insert into table [map].[tblProductToPresetInjector]
	-- Notes:
	------------------------------------------------------------------------------------------------------
	SET NOCOUNT ON;
	BEGIN TRY
		...
		SET @ProductToPresetInjectorGuid=NEWID();
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_ProductToPresetInjectorInsertByPK' + CHAR(13)+CHAR(10)                  
