CREATE PROCEDURE [map].[gsp_EntityFuelCardTypeToSiteInsertByPK]
(
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[gsp_EntityFuelCardTypeToSiteInsertByPK]
	...
	BEGIN TRY
		...
		WHERE [FuelCardTypeToSiteGuid] = @MappingGuid
	...
	BEGIN CATCH
		...
		BEGIN
			...
			+ 'Procedure Name: gsp_EntityFuelCardTypeToSiteInsertByPK' + CHAR(13)+CHAR(10)
