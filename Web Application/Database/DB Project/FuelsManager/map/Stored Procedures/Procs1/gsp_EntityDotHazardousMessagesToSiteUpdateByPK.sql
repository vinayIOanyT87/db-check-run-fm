...
CREATE PROCEDURE [map].[gsp_EntityDotHazardousMessagesToSiteUpdateByPK]
(
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[gsp_EntityDotHazardousMessagesToSiteUpdateByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.003 / 2013-12-30 14:44:41.1421453 -05:00
	-- Purpose: Update table [map].[tblEntityDotHazardousMessagesToSite]
	-- Notes:
	-- 1. @DotHazardousMessagesToSiteGuid and @UpdatedBy are required parameter.
	...
	SET NOCOUNT ON;
	BEGIN TRY
		IF @_RowVersion IS NOT NULL AND NOT EXISTS(SELECT 1 FROM [map].[tblEntityDotHazardousMessagesToSite] WHERE DotHazardousMessagesToSiteGuid=@DotHazardousMessagesToSiteGuid AND _RowVersion=@_RowVersion)
		BEGIN
			RAISERROR('Attempted to modify a stale copy of the record',16,1);
			RETURN;
		END
 
		UPDATE [map].[tblEntityDotHazardousMessagesToSite] SET
	...
	BEGIN CATCH        
		...
		BEGIN
			...
			SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
							...
							+ 'Procedure Name: gsp_EntityDotHazardousMessagesToSiteUpdateByPK' + CHAR(13)+CHAR(10)                  
