...
CREATE PROCEDURE [map].[gsp_EntityCompanyToSiteInsertByPK]
(
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[gsp_EntityCompanyToSiteInsertByPK]
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.002 / 2013-12-30 14:44:52.4904341 -05:00
	-- Purpose: Insert into table [map].[tblEntityCompanyToSite]
	-- Notes:
	------------------------------------------------------------------------------------------------------
	SET NOCOUNT ON;
	BEGIN TRY
		...
		WHERE [CompanyToSiteGuid] = @MappingGuid
	...
	BEGIN CATCH
		...
		BEGIN
			...
			+ 'Procedure Name: gsp_EntityCompanyToSiteInsertByPK' + CHAR(13)+CHAR(10)
