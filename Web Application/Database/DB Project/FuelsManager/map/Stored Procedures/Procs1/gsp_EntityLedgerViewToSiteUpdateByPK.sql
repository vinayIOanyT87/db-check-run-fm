...
CREATE PROCEDURE [map].[gsp_EntityLedgerViewToSiteUpdateByPK]
(
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[gsp_EntityLedgerViewToSiteUpdateByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.003 / 2013-12-30 14:44:41.1661453 -05:00
	-- Purpose: Update table [map].[tblEntityLedgerViewToSite]
	-- Notes:
	-- 1. @LedgerViewToSiteGuid and @UpdatedBy are required parameter.
	...
	SET NOCOUNT ON;
	BEGIN TRY
		IF @_RowVersion IS NOT NULL AND NOT EXISTS(SELECT 1 FROM [map].[tblEntityLedgerViewToSite] WHERE LedgerViewToSiteGuid=@LedgerViewToSiteGuid AND _RowVersion=@_RowVersion)
		BEGIN
			RAISERROR('Attempted to modify a stale copy of the record',16,1);
			RETURN;
		END
 
		UPDATE [map].[tblEntityLedgerViewToSite] SET
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_EntityLedgerViewToSiteUpdateByPK' + CHAR(13)+CHAR(10)                  
