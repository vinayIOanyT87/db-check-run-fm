CREATE PROCEDURE [map].[gsp_ApplicationStringToProductMessageUpdateByPK]
(
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[gsp_ApplicationStringToProductMessageUpdateByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.003 / 2014-02-05 16:52:29.9914463 -05:00
	-- Purpose: Update table [map].[tblApplicationStringToProductMessage]
	-- Notes:
	-- 1. @ApplicationStringToProductMessageGuid and @UpdatedBy are required parameter.
	...
	SET NOCOUNT ON;
	BEGIN TRY
		IF @_RowVersion IS NOT NULL AND NOT EXISTS(SELECT 1 FROM [map].[tblApplicationStringToProductMessage] WHERE ApplicationStringToProductMessageGuid=@ApplicationStringToProductMessageGuid AND _RowVersion=@_RowVersion)
		BEGIN
			RAISERROR('Attempted to modify a stale copy of the record',16,1);
			RETURN;
		END
 
		UPDATE [map].[tblApplicationStringToProductMessage] SET
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_ApplicationStringToProductMessageUpdateByPK' + CHAR(13)+CHAR(10)                  
