...
CREATE PROCEDURE [map].[gsp_EntityFootNoteToSiteInsertByPK]
(
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[gsp_EntityFootNoteToSiteInsertByPK]
	...
	BEGIN TRY
		...
		WHERE [FootNoteToSiteGuid] = @MappingGuid
	...
	BEGIN CATCH
		...
		BEGIN
			...
			+ 'Procedure Name: gsp_EntityFootNoteToSiteInsertByPK' + CHAR(13)+CHAR(10)
