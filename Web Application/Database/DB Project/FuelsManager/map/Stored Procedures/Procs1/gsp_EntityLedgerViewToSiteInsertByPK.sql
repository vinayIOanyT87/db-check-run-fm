...
CREATE PROCEDURE [map].[gsp_EntityLedgerViewToSiteInsertByPK]
(
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[gsp_EntityLedgerViewToSiteInsertByPK]
	...
	BEGIN TRY
		...
		WHERE [LedgerViewToSiteGuid] = @MappingGuid
	...
	BEGIN CATCH
		...
		BEGIN
			...
			+ 'Procedure Name: gsp_EntityLedgerViewToSiteInsertByPK' + CHAR(13)+CHAR(10)
