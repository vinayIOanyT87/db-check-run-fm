CREATE PROCEDURE [map].[gsp_QualificationPersonQualificationToEquipmentTypeUpdateByPK]
(
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[gsp_QualificationPersonQualificationToEquipmentTypeUpdateByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.003 / 2014-02-05 16:52:30.1184590 -05:00
	-- Purpose: Update table [map].[tblQualificationPersonQualificationToEquipmentType]
	-- Notes:
	-- 1. @QualificationPersonQualificationToEquipmentTypeGuid and @UpdatedBy are required parameter.
	...
	SET NOCOUNT ON;
	BEGIN TRY
		IF @_RowVersion IS NOT NULL AND NOT EXISTS(SELECT 1 FROM [map].[tblQualificationPersonQualificationToEquipmentType] WHERE QualificationPersonQualificationToEquipmentTypeGuid=@QualificationPersonQualificationToEquipmentTypeGuid AND _RowVersion=@_RowVersion)
		BEGIN
			RAISERROR('Attempted to modify a stale copy of the record',16,1);
			RETURN;
		END
 
		UPDATE [map].[tblQualificationPersonQualificationToEquipmentType] SET
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_QualificationPersonQualificationToEquipmentTypeUpdateByPK' + CHAR(13)+CHAR(10)                  
