CREATE PROCEDURE [map].[gsp_ProductToSupplierProductCompanyInsertByPK]
(
		@ProductToSupplierProductCompanyGuid uniqueidentifier=NULL OUTPUT
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[gsp_ProductToSupplierProductCompanyInsertByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.001 / 2014-02-05 15:58:32.7392767 -05:00
	-- Purpose: Insert into table [map].[tblProductToSupplierProductCompany]
	-- Notes:
	------------------------------------------------------------------------------------------------------
	SET NOCOUNT ON;
	BEGIN TRY
		...
		SET @ProductToSupplierProductCompanyGuid=NEWID();
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_ProductToSupplierProductCompanyInsertByPK' + CHAR(13)+CHAR(10)                  
