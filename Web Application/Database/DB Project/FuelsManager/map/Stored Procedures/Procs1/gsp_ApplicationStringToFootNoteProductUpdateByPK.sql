CREATE PROCEDURE [map].[gsp_ApplicationStringToFootNoteProductUpdateByPK]
(
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[gsp_ApplicationStringToFootNoteProductUpdateByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.003 / 2014-02-05 16:52:29.9854457 -05:00
	-- Purpose: Update table [map].[tblApplicationStringToFootNoteProduct]
	-- Notes:
	-- 1. @ApplicationStringToFootNoteProductGuid and @UpdatedBy are required parameter.
	...
	SET NOCOUNT ON;
	BEGIN TRY
		IF @_RowVersion IS NOT NULL AND NOT EXISTS(SELECT 1 FROM [map].[tblApplicationStringToFootNoteProduct] WHERE ApplicationStringToFootNoteProductGuid=@ApplicationStringToFootNoteProductGuid AND _RowVersion=@_RowVersion)
		BEGIN
			RAISERROR('Attempted to modify a stale copy of the record',16,1);
			RETURN;
		END
 
		UPDATE [map].[tblApplicationStringToFootNoteProduct] SET
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_ApplicationStringToFootNoteProductUpdateByPK' + CHAR(13)+CHAR(10)                  
