...
CREATE PROCEDURE [map].[gsp_EntityAutoDistributionRuleToSiteInsertByPK]
(
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[gsp_EntityAutoDistributionRuleToSiteInsertByPK]
	...
	BEGIN TRY
		...
		WHERE [AutoDistributionRuleToSiteGuid] = @MappingGuid
	...
	BEGIN CATCH
		...
		BEGIN
			...
			+ 'Procedure Name: gsp_EntityAutoDistributionRuleToSiteInsertByPK' + CHAR(13)+CHAR(10)
