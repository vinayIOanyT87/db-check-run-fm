...
CREATE PROCEDURE [map].[gsp_EntityTestSetToSiteInsertByPK]
(
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[gsp_EntityTestSetToSiteInsertByPK]
	...
	BEGIN TRY
		...
		WHERE [TestSetToSiteGuid] = @MappingGuid
	...
	BEGIN CATCH
		...
		BEGIN
			...
			+ 'Procedure Name: gsp_EntityTestSetToSiteInsertByPK' + CHAR(13)+CHAR(10)
