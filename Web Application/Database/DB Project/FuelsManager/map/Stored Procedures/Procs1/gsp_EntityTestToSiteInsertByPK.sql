...
CREATE PROCEDURE [map].[gsp_EntityTestToSiteInsertByPK]
(
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[gsp_EntityTestToSiteInsertByPK]
	...
	BEGIN TRY
		...
		WHERE [TestToSiteGuid] = @MappingGuid
	...
	BEGIN CATCH
		...
		BEGIN
			...
			+ 'Procedure Name: gsp_EntityTestToSiteInsertByPK' + CHAR(13)+CHAR(10)
