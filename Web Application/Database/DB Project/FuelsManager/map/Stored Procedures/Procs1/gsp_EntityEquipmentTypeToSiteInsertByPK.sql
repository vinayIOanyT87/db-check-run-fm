...
CREATE PROCEDURE [map].[gsp_EntityEquipmentTypeToSiteInsertByPK]
(
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[gsp_EntityEquipmentTypeToSiteInsertByPK]
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.002 / 2013-12-30 14:44:52.5064373 -05:00
	-- Purpose: Insert into table [map].[tblEntityEquipmentTypeToSite]
	-- Notes:
	------------------------------------------------------------------------------------------------------
	SET NOCOUNT ON;
	BEGIN TRY
		...
		WHERE [EquipmentTypeToSiteGuid] = @MappingGuid
	...
	BEGIN CATCH
		...
		BEGIN
			...
			+ 'Procedure Name: gsp_EntityEquipmentTypeToSiteInsertByPK' + CHAR(13)+CHAR(10)
