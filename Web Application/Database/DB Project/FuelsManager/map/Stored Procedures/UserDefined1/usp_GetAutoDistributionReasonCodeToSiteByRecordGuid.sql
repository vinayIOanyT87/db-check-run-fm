...
/*
	EXEC [map].[usp_GetAutoDistributionReasonCodeToSiteByRecordGuid] '1B23C717-CFA1-4180-819F-058400969A89', NULL
	EXEC [map].[usp_GetAutoDistributionReasonCodeToSiteByRecordGuid] '05C7D1E0-745D-488D-AF05-00DF1A70D05D', 'F4761A16-AB2F-41EE-B6FA-D17658DF2602', 1
*/

CREATE PROCEDURE [map].[usp_GetAutoDistributionReasonCodeToSiteByRecordGuid]
(
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[usp_GetAutoDistributionReasonCodeToSiteByRecordGuid]
	-- Author: Hansraj Bapoo
	-- Version/Date: 1.0.003 / 2012-07-13 14:21:10.4470770 -04:00
	-- Purpose: Retrieves the AutoDistributionReasonCodeToSite assignments for a given AutoDistributionReasonCode RecordGuid to a given site/sitegroup, and optionally to children site/sitegroup of the given sitegroup as well. 	
	-- Notes:
	-- 1. @EntityRecordGuid: Guid of the AutoDistributionReasonCode record for which the mapping hierarchy is to be retrieved.
	...
	-- 7. This stored procedure replaces the EntityTositeMapClass.SelectSQL() inline SQL for the case where entityType is AUTODISTRIBUTION_REASONCODE and bInTransaction is false.
	------------------------------------------------------------------------------------------------------
	SET NOCOUNT ON;
	BEGIN TRY
		...
		BEGIN
			SELECT @AssignedToSiteGuid = SiteGuid FROM tblAutoDistributionReasonCodes
			WHERE AutoDistributionReasonCodeGuid = @EntityRecordGuid
		END;
		...
		SELECT a.AutoDistributionReasonCodeToSiteGuid MappingGuid, a.AutoDistributionReasonCodeGuid EntityRecordGuid, d.ReasonCode EntityId, a.SiteGuid AssignedToSiteGuid, b.SiteGroupId AssignedToSiteId, b.HierarchyLevel, a.CreatedDate, a.CreatedBy, a.UpdatedDate, a.UpdatedBy, a._RowVersion, a.AssignedFromSiteGuid , c.ID AssignedFromSiteId 
		...
		INNER JOIN tblAutoDistributionReasonCodes d
		ON d.AutoDistributionReasonCodeGuid = a.AutoDistributionReasonCodeGuid
		WHERE a.AutoDistributionReasonCodeGuid = @EntityRecordGuid
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: map.usp_GetAutoDistributionReasonCodeToSiteByRecordGuid' + CHAR(13)+CHAR(10)                  
