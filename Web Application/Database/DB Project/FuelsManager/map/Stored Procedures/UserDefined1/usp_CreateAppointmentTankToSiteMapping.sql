/*
	DROP PROCEDURE [map].[usp_CreateAppointmentTankToSiteMapping]

*/

CREATE PROCEDURE [map].[usp_CreateAppointmentTankToSiteMapping]
(
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[usp_CreateAppointmentTankToSiteMapping]
	-- Author: Vivian Kiarie /  Hansraj Bapoo
	-- Version/Date: 1.0.002 / 2013-12-30 14:44:52.4824325 -05:00
	-- Purpose: Insert into table [map].[tblEntityAppointmentTankToSite]
	-- Notes:
	...
	BEGIN TRY
		...
		BEGIN
		  ...
		  INSERT INTO [map].[tblEntityAppointmentTankToSite]
		  (
				[AppointmentTankGuid]
				,	[SiteGuid]
				,	[CreatedDate]
		...
		OPEN TableCursor 
			...
			BEGIN 
				...
				WHERE NOT EXISTS
				(
					 SELECT * FROM [map].[tblEntityAppointmentTankToSite]
	...
	BEGIN CATCH
		...
		BEGIN
			...
			+ 'Procedure Name: usp_CreateAppointmentTankToSiteMapping' + CHAR(13)+CHAR(10)
