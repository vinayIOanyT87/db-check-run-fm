/*
	DROP PROCEDURE [map].[usp_CreateEquipmentTestAndInspectionToSiteMapping]

*/  
CREATE PROCEDURE [map].[usp_CreateEquipmentTestAndInspectionToSiteMapping]
(
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[usp_CreateEquipmentTestAndInspectionToSiteMapping]
	-- Author: Vivian Kiarie /  Hansraj Bapoo
	-- Version/Date: 1.0.002 / 2013-12-30 14:44:52.5044369 -05:00
	-- Purpose: Insert into table [map].[tblEntityEquipmentTestAndInspectionToSite]
		-- Notes:
	...
	BEGIN TRY
		...
		INSERT INTO [map].[tblEntityEquipmentTestAndInspectionToSite]
		(
		  [QualificationGuid]
		  ,	[SiteGuid]
		  ,	[CreatedDate]
		...
		OPEN TableCursor 
			...
			BEGIN 
				...
				WHERE NOT EXISTS
				(
					SELECT * FROM [map].[tblEntityEquipmentTestAndInspectionToSite]
	...
	BEGIN CATCH
		...
		BEGIN
			...
			+ 'Procedure Name: usp_CreateEquipmentTestAndInspectionToSiteMapping' + CHAR(13)+CHAR(10)
