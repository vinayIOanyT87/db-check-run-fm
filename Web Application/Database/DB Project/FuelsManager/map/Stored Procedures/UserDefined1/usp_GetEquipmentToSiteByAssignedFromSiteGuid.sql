...
/*
	EXEC [map].[usp_GetEquipmentToSiteByAssignedFromSiteGuid] '00000000-0000-0000-0000-000000000001'
*/

CREATE PROCEDURE [map].[usp_GetEquipmentToSiteByAssignedFromSiteGuid]
(
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[usp_GetEquipmentToSiteByAssignedFromSiteGuid]
	-- Author: Warren Gray
	-- Version/Date: 1.0.001 / 2013-12-20 14:21:10.4470770 -04:00
	-- Purpose: Retrieves the EquipmentToSite assignments from a given sitegroup. 	
	-- Notes:
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: map.usp_GetEquipmentToSiteByAssignedFromSiteGuid' + CHAR(13)+CHAR(10)                  
