/*
	...
	DROP PROCEDURE [map].[usp_CreateDataDictionaryToSiteMapping]

	EXEC [map].[usp_CreateDataDictionaryToSiteMapping] @entityToSiteGuid, '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'F4761A16-AB2F-41EE-B6FA-D17658DF2602', '05/22/2026', 'Administrator', @rowVer

*/

CREATE PROCEDURE [map].[usp_CreateDataDictionaryToSiteMapping]
(
	...
	BEGIN TRY
		...
		BEGIN
			 INSERT INTO [map].[tblEntityDataDictionaryToSite]
			 (
				  [OwnerSiteGuid]
				  ,	[MapToSiteGuid]
				  ,	[CreatedDate]
		...
		OPEN TableCursor 
			...
			BEGIN 
				...
				WHERE NOT EXISTS
				(
					SELECT * FROM [map].[tblEntityDataDictionaryToSite]
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: map.usp_CreateDataDictionaryToSiteMapping' + CHAR(13)+CHAR(10)                  
