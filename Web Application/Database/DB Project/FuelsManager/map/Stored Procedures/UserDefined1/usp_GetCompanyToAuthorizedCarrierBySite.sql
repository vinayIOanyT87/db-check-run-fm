...
CREATE PROCEDURE [map].[usp_GetCompanyToAuthorizedCarrierBySite]
(
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored Procedure: [map].[usp_GetCompanyToAuthorizedCarrierBySite] 
	-- Author: Shawn Marlin
	-- Version/Date: 1.0.003 / 2013-04-04 14:21:10.4470770 -10:00
	-- Purpose: Retrieves the Company-To-Authorized Carrier mappings for a given Site/Sitegroup.
	-- Notes:
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: [map].usp_GetCompanyToAuthorizedCarrierBySite' + CHAR(13)+CHAR(10)                  
