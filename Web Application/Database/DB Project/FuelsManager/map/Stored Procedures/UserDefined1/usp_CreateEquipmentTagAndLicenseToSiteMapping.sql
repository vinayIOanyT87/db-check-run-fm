/*
	DROP PROCEDURE [map].[usp_CreateEquipmentTagAndLicenseToSiteMapping]

*/ 
CREATE PROCEDURE [map].[usp_CreateEquipmentTagAndLicenseToSiteMapping]
(
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[usp_CreateEquipmentTagAndLicenseToSiteMapping]
	-- Author: Vivian Kiarie /  Hansraj Bapoo
	-- Version/Date: 1.0.002 / 2013-12-30 14:44:52.5034367 -05:00
	-- Purpose: Insert into table [map].[tblEntityEquipmentTagAndLicenseToSite]
		-- Notes:
	...
	BEGIN TRY
		...
		INSERT INTO [map].[tblEntityEquipmentTagAndLicenseToSite]
		(
		  [QualificationGuid]
		  ,	[SiteGuid]
		  ,	[CreatedDate]
		...
		OPEN TableCursor 
			...
			BEGIN 
				...
				WHERE NOT EXISTS
				(
					SELECT * FROM [map].[tblEntityEquipmentTagAndLicenseToSite]
	...
	BEGIN CATCH
		...
		BEGIN
			...
			+ 'Procedure Name: usp_CreateEquipmentTagAndLicenseToSiteMapping' + CHAR(13)+CHAR(10)
