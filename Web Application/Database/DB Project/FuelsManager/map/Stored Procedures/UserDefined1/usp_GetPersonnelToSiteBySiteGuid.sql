...
/*
	EXEC [map].[usp_GetPersonnelToSiteBySiteGuid] '00000000-0000-0000-0000-000000000001'
*/

CREATE PROCEDURE [map].[usp_GetPersonnelToSiteBySiteGuid]
(
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[usp_GetPersonnelToSiteBySiteGuid]
	-- Author: Shawn Marlin
	-- Version/Date: 1.0.003 / 2013-03-29 08:21:10.4470770 -10:00
	-- Purpose: Retrieves the PersonnelToSite assignments to a given site/sitegroup. 	
	-- Notes:
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: map.usp_GetPersonnelToSiteBySiteGuid' + CHAR(13)+CHAR(10)                  
