CREATE PROCEDURE [map].[usp_GetAssetTrackingDeviceToSiteBySiteGuid]
(
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[usp_GetAssetTrackingDeviceToSiteBySiteGuid]
	-- Author: Richard R. Panachida
	-- Version/Date: 1.0.003 / 2016-04-26 14:21:10.4470770 -04:00
	-- Purpose: Retrieves the AssetTrackingDeviceToSite assignments to a given site/sitegroup. 	
	-- Notes:
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: map.usp_GetAssetTrackingDeviceToSiteBySiteGuid' + CHAR(13)+CHAR(10)                  
