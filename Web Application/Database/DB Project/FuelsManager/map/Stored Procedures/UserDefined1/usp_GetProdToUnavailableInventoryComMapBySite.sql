...
/*
	DROP PROCEDURE [map].[usp_GetProdToUnavailableInventoryComMapBySite]

	EXEC [map].[usp_GetProdToUnavailableInventoryComMapBySite] '00000000-0000-0000-0000-000000000001'


*/

CREATE PROCEDURE [map].[usp_GetProdToUnavailableInventoryComMapBySite]
(
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored Procedure: [map].[usp_GetProdToUnavailableInventoryComMapBySite] 
	-- Author: Shawn Marlin
	-- Version/Date: 1.0.003 / 2013-04-04 14:21:10.4470770 -10:00
	-- Purpose: Retrieves the map.tblProductToUnavailableInventoryCompany mappings for a given Site/Sitegroup.
	-- Notes:
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: [map].usp_GetProdToUnavailableInventoryComMapBySite' + CHAR(13)+CHAR(10)                  
