/*
	DROP PROCEDURE [map].[usp_CreateAutoDistributionRuleToSiteMapping]

*/ 
CREATE PROCEDURE [map].[usp_CreateAutoDistributionRuleToSiteMapping]
(
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[usp_CreateAutoDistributionRuleToSiteMapping]
	-- Author: Vivian Kiarie /  Hansraj Bapoo
	-- Version/Date: 1.0.002 / 2013-12-30 14:44:52.4874335 -05:00
	-- Purpose: Insert into table [map].[tblEntityAutoDistributionRuleToSite]
	-- Notes:
	...
	BEGIN TRY
		...
		OPEN TableCursor 
			...
			BEGIN 
				...
				WHERE NOT EXISTS
				(
					SELECT * FROM [map].[tblEntityAutoDistributionRuleToSite]
	...
	BEGIN CATCH
		...
		BEGIN
			...
			+ 'Procedure Name: usp_CreateAutoDistributionRuleToSiteMapping' + CHAR(13)+CHAR(10)
