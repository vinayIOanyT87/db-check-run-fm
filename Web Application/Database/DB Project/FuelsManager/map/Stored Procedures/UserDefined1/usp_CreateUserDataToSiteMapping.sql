/*
	...
	DROP PROCEDURE [map].[usp_CreateUserDataToSiteMapping]

	EXEC [map].[usp_CreateUserDataToSiteMapping] @entityToSiteGuid, '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'F4761A16-AB2F-41EE-B6FA-D17658DF2602', '05/22/2026', 'Administrator', @rowVer

*/

CREATE PROCEDURE [map].[usp_CreateUserDataToSiteMapping]
(
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[usp_CreateUserDataToSiteMapping]
	-- Author: Hansraj Bapoo
	-- Version/Date: 1.0.003 / 2012-07-13 14:21:10.4470770 -04:00
	-- Purpose: Creates a new UserDataToSite mapping record. 	
	-- Notes:
	-- 1. UserDataToSite mappings are not applied/managed on individual UserData records, but across all UserData records for a given sitegroup (@EntityRecordGuid).
	-- 2. @EntityRecordGuid: Guid of the sitegroup for which all the UserData records are to be mapped.
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: map.usp_CreateUserDataToSiteMapping' + CHAR(13)+CHAR(10)                  
