/*
	DROP PROCEDURE [map].[usp_CreateModuleToSiteMapping]

*/ 

CREATE PROCEDURE [map].[usp_CreateModuleToSiteMapping]
(
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[usp_CreateModuleToSiteMapping]
	-- Author: Vivian Kiarie /  Hansraj Bapoo
	-- Version/Date: 1.0.002 / 2013-12-30 14:44:52.5244409 -05:00
	-- Purpose: Insert into table [map].[tblEntityModuleToSite]
		-- Notes:
	...
	BEGIN TRY
		...
		INSERT INTO [map].[tblEntityModuleToSite]
		(		
		  [ModuleGuid]
		  ,	[SiteGuid]
		  ,	[CreatedDate]
		...
		OPEN TableCursor 
			...
			BEGIN 
				...
				WHERE NOT EXISTS
				(
					SELECT * FROM [map].[tblEntityModuleToSite]
	...
	BEGIN CATCH
		...
		BEGIN
			...
			+ 'Procedure Name: usp_CreateModuleToSiteMapping' + CHAR(13)+CHAR(10)
