/*
	DROP PROCEDURE [map].usp_CreateFootNoteToSiteMapping]

*/ 
CREATE PROCEDURE [map].[usp_CreateFootNoteToSiteMapping]
(
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[usp_CreateFootNoteToSiteMapping]
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.002 / 2013-12-30 14:44:52.5084377 -05:00
	-- Purpose: Insert into table [map].[tblEntityFootNoteToSite]
	-- Notes:
	...
	BEGIN TRY
		...
		INSERT INTO [map].[tblEntityFootNoteToSite]
		(	
		...
		OPEN TableCursor 
			...
			BEGIN 
				...
				WHERE NOT EXISTS
				(
					SELECT * FROM [map].[tblEntityFootNoteToSite]
	...
	BEGIN CATCH
		...
		BEGIN
			...
			+ 'Procedure Name: usp_CreateFootNoteToSiteMapping' + CHAR(13)+CHAR(10)
