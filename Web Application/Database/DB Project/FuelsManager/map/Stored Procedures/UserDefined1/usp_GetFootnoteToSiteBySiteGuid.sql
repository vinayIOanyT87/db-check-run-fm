...
/*
	EXEC [map].[usp_GetFootnoteToSiteBySiteGuid] '00000000-0000-0000-0000-000000000001'
*/

CREATE PROCEDURE [map].[usp_GetFootnoteToSiteBySiteGuid]
(
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[usp_GetFootnoteToSiteBySiteGuid]
	-- Author: Hansraj Bapoo
	-- Version/Date: 1.0.003 / 2012-07-13 14:21:10.4470770 -04:00
	-- Purpose: Retrieves the FootnoteToSite assignments to a given site/sitegroup. 	
	-- Notes:
	...
	BEGIN TRY
		...
		SELECT a.FootnoteToSiteGuid MappingGuid, a.ApplicationStringGuid EntityRecordGuid, d.Id EntityId, a.SiteGuid AssignedToSiteGuid, b.Id AssignedToSiteId, a.CreatedDate, a.CreatedBy, a.UpdatedDate, a.UpdatedBy, a._RowVersion, a.AssignedFromSiteGuid , c.ID AssignedFromSiteId 
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: map.usp_GetFootnoteToSiteBySiteGuid' + CHAR(13)+CHAR(10)                  
