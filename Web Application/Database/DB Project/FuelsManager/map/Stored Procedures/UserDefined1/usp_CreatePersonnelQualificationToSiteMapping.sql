/*
	DROP PROCEDURE [map].[usp_CreatePersonnelQualificationToSiteMapping]

*/

CREATE PROCEDURE [map].[usp_CreatePersonnelQualificationToSiteMapping]
(
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[usp_CreatePersonnelQualificationToSiteMapping]
	-- Author: Hansraj Bapoo
	-- Version/Date: 1.0.002 / 2013-12-30 14:44:52.5174395 -05:00
	-- Purpose: Creates a new PersonnelQualification mapping record.
	-- Notes:
	...
	BEGIN TRY
		...
		BEGIN
			...
			INSERT INTO [map].[tblEntityPersonnelQualificationToSite]
			(
				[QualificationGuid]
				,	[SiteGuid]
				,	[CreatedDate]
		...
		OPEN TableCursor 
			...
			BEGIN 
				...
				WHERE NOT EXISTS
				(
					SELECT * FROM [map].[tblEntityPersonnelQualificationToSite]
	...
	BEGIN CATCH
		...
		BEGIN
			...
			+ 'Procedure Name: usp_CreatePersonnelQualificationToSiteMapping' + CHAR(13)+CHAR(10)
