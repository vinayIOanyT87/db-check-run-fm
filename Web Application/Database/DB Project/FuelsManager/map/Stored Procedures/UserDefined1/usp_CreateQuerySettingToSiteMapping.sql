/*
	...
	DROP PROCEDURE [map].[usp_CreateQuerySettingToSiteMapping]

	EXEC [map].[usp_CreateQuerySettingToSiteMapping] @entityToSiteGuid, '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'F4761A16-AB2F-41EE-B6FA-D17658DF2602', '05/22/2026', 'Administrator', @rowVer

*/

CREATE PROCEDURE [map].[usp_CreateQuerySettingToSiteMapping]
(
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[usp_CreateQuerySettingToSiteMapping]
	-- Author: Hansraj Bapoo
	-- Version/Date: 1.0.003 / 2012-07-13 14:21:10.4470770 -04:00
	-- Purpose: Creates a new QuerySettingToSite mapping record. 	
	-- Notes:
	-- 1. QuerySettingToSite mappings are not applied/managed on individual QuerySetting records, but across all QuerySetting records for a given sitegroup (@EntityRecordGuid).
	-- 2. @EntityRecordGuid: Guid of the sitegroup for which all the QuerySetting records are to be mapped.
	...
	BEGIN TRY
		...
		BEGIN
			 INSERT INTO [map].[tblEntityQuerySettingToSite]
			 (
				[SiteGuid]
				,	[MapToSiteGuid]
				,	[CreatedDate]
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: map.usp_CreateQuerySettingToSiteMapping' + CHAR(13)+CHAR(10)                  
