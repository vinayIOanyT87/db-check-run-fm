/*
	DROP PROCEDURE [map].[usp_CreateListViewToSiteMapping]

*/

CREATE PROCEDURE [map].[usp_CreateListViewToSiteMapping]
(
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[usp_CreateListViewToSiteMapping]
	-- Author: Hansraj Bapoo
	-- Version/Date: 1.0.002 / 2013-12-30 14:44:52.5174395 -05:00
	-- Purpose: Creates a new ListView mapping record.
	-- Notes:
	...
	BEGIN CATCH
		...
		BEGIN
			...
			+ 'Procedure Name: usp_CreateListViewToSiteMapping' + CHAR(13)+CHAR(10)
