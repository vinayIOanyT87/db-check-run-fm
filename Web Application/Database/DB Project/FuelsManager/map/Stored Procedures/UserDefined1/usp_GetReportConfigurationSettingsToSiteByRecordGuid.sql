...
/*
	EXEC [map].[usp_GetReportConfigurationSettingsToSiteByRecordGuid] 'C0DA2E5F-711C-4245-B4DA-7085831674F1', NULL
	EXEC [map].[usp_GetReportConfigurationSettingsToSiteByRecordGuid] '05C7D1E0-745D-488D-AF05-00DF1A70D05D', 'F4761A16-AB2F-41EE-B6FA-D17658DF2602', 1
*/

CREATE PROCEDURE [map].[usp_GetReportConfigurationSettingsToSiteByRecordGuid]
(
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[usp_GetReportConfigurationSettingsToSiteByRecordGuid]
	-- Author: Hansraj Bapoo
	-- Version/Date: 1.0.003 / 2012-07-13 14:21:10.4470770 -04:00
	-- Purpose: Retrieves the ReportConfigurationSettingsToSite assignments for a given ReportConfigurationSetting Owner SiteGuid to a given site/sitegroup, and optionally to children site/sitegroup of the given sitegroup as well. 	
	-- Notes:
	-- 1. @EntityRecordGuid: Guid of the ReportConfigurationSetting owner sitegroup for which the mapping hierarchy is to be retrieved.
	...
	-- 7. ReportConfigurationSettingsToSite mappings are not applied/managed on individual tblReportConfigurationSettings records, but across all tblReportConfigurationSettings records for a given sitegroup (@EntityRecordGuid)
	-- 8. This stored procedure replaces the EntityTositeMapClass.SelectSQL() inline SQL for the case where entityType is REPORT_CONFIGURATION_SETTINGS and bInTransaction is false.
	------------------------------------------------------------------------------------------------------
	SET NOCOUNT ON;
	BEGIN TRY
		...
		SELECT a.ReportConfigurationSettingsToSiteGuid MappingGuid, a.SiteGuid EntityRecordGuid, d.Id EntityId, a.MapToSiteGuid AssignedToSiteGuid, b.SiteGroupId AssignedToSiteId, b.HierarchyLevel, a.CreatedDate, a.CreatedBy, a.UpdatedDate, a.UpdatedBy, a._RowVersion, a.AssignedFromSiteGuid , c.ID AssignedFromSiteId 
		...
		WHERE a.SiteGuid = @EntityRecordGuid
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: map.usp_GetReportConfigurationSettingsToSiteByRecordGuid' + CHAR(13)+CHAR(10)                  
