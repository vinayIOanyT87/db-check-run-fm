/*
	DROP PROCEDURE [map].[usp_CreateAllocationGroupToSiteMapping]

*/

CREATE PROCEDURE [map].[usp_CreateAllocationGroupToSiteMapping]
(
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[usp_CreateAllocationGroupToSiteMapping]
	-- Author: Vivian Kiarie /  Hansraj Bapoo
	-- Version/Date: 1.0.002 / 2013-12-30 14:44:52.4574275 -05:00
	-- Purpose: Insert into table [map].[tblEntityAllocationGroupToSite]
		-- Notes:
	...
	BEGIN
		...
		INSERT INTO [map].[tblEntityAllocationGroupToSite]
		(
		...
		OPEN TableCursor 
		  ...
		  BEGIN 
				...
				WHERE NOT EXISTS
				(
					 SELECT * FROM [map].[tblEntityAllocationGroupToSite]
	...
	BEGIN CATCH
		...
		BEGIN
			...
			+ 'Procedure Name: usp_CreateAllocationGroupToSiteMapping' + CHAR(13)+CHAR(10)
