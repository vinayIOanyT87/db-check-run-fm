/*
	DROP PROCEDURE [map].[usp_CreatePointTemplateTypeToSiteMapping]

*/ 

CREATE PROCEDURE [map].[usp_CreatePointTemplateTypeToSiteMapping]
(	
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[usp_CreatePointTemplateTypeToSiteMapping]
	-- Author: Vivian Kiarie /  Hansraj Bapoo
	-- Version/Date: 1.0.002 / 2013-12-30 14:44:52.4924345 -05:00
	-- Purpose: Insert into table [map].[tblEntityPointTemplateTypeToSite]
		-- Notes:
	...
	BEGIN TRY
		...
		INSERT INTO [map].[tblEntityPointTemplateTypeToSite]
		(
		...
		OPEN TableCursor 
			...
			BEGIN 
				...
				WHERE NOT EXISTS
				(
					SELECT * FROM [map].[tblEntityPointTemplateTypeToSite]
	...
	BEGIN CATCH
		...
		BEGIN
			...
			+ 'Procedure Name: usp_CreatePointTemplateTypeToSiteMapping' + CHAR(13)+CHAR(10)
