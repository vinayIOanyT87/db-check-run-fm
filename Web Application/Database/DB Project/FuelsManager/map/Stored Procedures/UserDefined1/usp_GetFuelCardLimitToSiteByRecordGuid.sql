CREATE PROCEDURE [map].[usp_GetFuelCardLimitToSiteByRecordGuid]
(
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[usp_GetFuelCardLimitToSiteByRecordGuid]
	-- Author: Ryan Hill
	-- Purpose: Retrieves the FuelCardLimitToSite assignments for a given Fuel Card Limit RecordGuid to a given site/sitegroup, and optionally to children site/sitegroup of the given sitegroup as well. 	
	-- Notes:
	-- 1. @EntityRecordGuid: Guid of the Fuel Card Limit record for which the mapping hierarchy is to be retrieved.
	...
	BEGIN TRY
		...
		WHERE a.FuelCardLimitGuid = @EntityRecordGuid
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: map.usp_GetFuelCardLimitToSiteByRecordGuid' + CHAR(13)+CHAR(10)                  
