/*
	DROP PROCEDURE [map].[usp_CreateAlarmAndEventCategoryToSiteMapping]

*/

CREATE PROCEDURE [map].[usp_CreateAlarmAndEventCategoryToSiteMapping]
(
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[usp_CreateAlarmAndEventCategoryToSiteMapping]
	-- Author: Vivian Kiarie /  Hansraj Bapoo
	-- Version/Date: 1.0.002 / 2013-12-30 14:44:52.4314223 -05:00
	-- Purpose: Insert into table [map].[tblEntityAlarmAndEventCategoryToSite]
	-- Notes:
	...
	BEGIN TRY
		...
		INSERT INTO [map].[tblEntityAlarmAndEventCategoryToSite]
		(
		...
		OPEN TableCursor 
			...
			BEGIN 
				...
				WHERE NOT EXISTS
				(
					SELECT * FROM [map].[tblEntityAlarmAndEventCategoryToSite]
	...
	BEGIN CATCH
		...
		BEGIN
			...
			+ 'Procedure Name: usp_CreateAlarmAndEventCategoryToSiteMapping' + CHAR(13)+CHAR(10)
