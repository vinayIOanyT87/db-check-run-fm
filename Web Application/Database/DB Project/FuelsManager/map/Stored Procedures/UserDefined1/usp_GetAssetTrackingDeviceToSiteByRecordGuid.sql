CREATE PROCEDURE [map].[usp_GetAssetTrackingDeviceToSiteByRecordGuid]
(
	...
	-- Purpose: Retrieves the AssetTrackingDeviceToSite assignments for a given AssetTrackingDevice RecordGuid to a given site/sitegroup, and optionally to children site/sitegroup of the given sitegroup as well. 	
	-- Notes:
	...
	-- 7. This stored procedure replaces the EntityTositeMapClass.SelectSQL() inline SQL for the case where entityType is ASSET_TRACKING_DEVICE and bInTransaction is false.
	------------------------------------------------------------------------------------------------------
	SET NOCOUNT ON;
	BEGIN TRY
		...
		BEGIN
			SELECT @AssignedToSiteGuid = SiteGuid FROM tblAssetTrackingDevice
		...
		WHERE a.AssetTrackingDeviceGuid = @EntityRecordGuid
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: map.usp_GetAssetTrackingDeviceToSiteByRecordGuid' + CHAR(13)+CHAR(10)                  
