...
/*
	EXEC [map].[usp_GetProductToSiteByAssignedFromSiteGuid] '00000000-0000-0000-0000-000000000001'
*/

CREATE PROCEDURE [map].[usp_GetProductToSiteByAssignedFromSiteGuid]
(
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[usp_GetProductToSiteByAssignedFromSiteGuid]
	-- Author: Warren Gray
	-- Version/Date: 1.0.001 / 2013-12-20 14:21:10.4470770 -04:00
	-- Purpose: Retrieves the ProductToSite assignments from a given sitegroup. 	
	-- Notes:
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: map.usp_GetProductToSiteByAssignedFromSiteGuid' + CHAR(13)+CHAR(10)                  
