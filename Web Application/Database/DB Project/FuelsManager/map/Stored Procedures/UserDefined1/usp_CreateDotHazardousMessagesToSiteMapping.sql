/*
	DROP PROCEDURE [map].[usp_CreateDotHazardousMessagesToSiteMapping]

*/
 
CREATE PROCEDURE [map].[usp_CreateDotHazardousMessagesToSiteMapping]
(
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[usp_CreateDotHazardousMessagesToSiteMapping]
	-- Author: Vivian Kiarie /  Hansraj Bapoo
	-- Version/Date: 1.0.002 / 2013-12-30 14:44:52.4984357 -05:00
	-- Purpose: Insert into table [map].[tblEntityDotHazardousMessagesToSite]
		-- Notes:
	...
	BEGIN TRY
		...
		BEGIN
		  ...
		  INSERT INTO [map].[tblEntityDotHazardousMessagesToSite]
		  (	
		...
		OPEN TableCursor 
		  ...
		  BEGIN 
				...
				WHERE NOT EXISTS
				(
					 SELECT * FROM [map].[tblEntityDotHazardousMessagesToSite]
	...
	BEGIN CATCH
		...
		BEGIN
			...
			+ 'Procedure Name: usp_CreateDotHazardousMessagesToSiteMapping' + CHAR(13)+CHAR(10)
