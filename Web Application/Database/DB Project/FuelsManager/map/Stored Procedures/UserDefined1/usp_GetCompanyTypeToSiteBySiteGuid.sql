...
/*
	EXEC [map].[usp_GetCompanyTypeToSiteBySiteGuid] '00000000-0000-0000-0000-000000000001'
*/

CREATE PROCEDURE [map].[usp_GetCompanyTypeToSiteBySiteGuid]
(
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[usp_GetCompanyTypeToSiteBySiteGuid]
	-- Author: Hansraj Bapoo
	-- Version/Date: 1.0.003 / 2012-07-13 14:21:10.4470770 -04:00
	-- Purpose: Retrieves the CompanyTypeToSite assignments to a given site/sitegroup. 	
	-- Notes:
	...
	BEGIN TRY
		...
		SELECT a.CompanyTypeToSiteGuid MappingGuid, a.ApplicationStringGuid EntityRecordGuid, d.ID EntityId, a.SiteGuid AssignedToSiteGuid, b.ID AssignedToSiteId, a.CreatedDate, a.CreatedBy, a.UpdatedDate, a.UpdatedBy, a._RowVersion, a.AssignedFromSiteGuid , c.ID AssignedFromSiteId 
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: map.usp_GetCompanyTypeToSiteBySiteGuid' + CHAR(13)+CHAR(10)                  
