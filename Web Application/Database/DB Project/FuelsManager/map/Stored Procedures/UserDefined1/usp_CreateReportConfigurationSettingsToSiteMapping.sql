/*
	...
	DROP PROCEDURE [map].[usp_CreateReportConfigurationSettingsToSiteMapping]

	EXEC [map].[usp_CreateReportConfigurationSettingsToSiteMapping] @entityToSiteGuid, '00000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'F4761A16-AB2F-41EE-B6FA-D17658DF2602', '05/22/2026', 'Administrator', @rowVer

*/

CREATE PROCEDURE [map].[usp_CreateReportConfigurationSettingsToSiteMapping]
(
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[usp_CreateReportConfigurationSettingsToSiteMapping]
	-- Author: Hansraj Bapoo
	-- Version/Date: 1.0.003 / 2012-07-13 14:21:10.4470770 -04:00
	-- Purpose: Creates a new ReportConfigurationSettingsToSite mapping record. 	
	-- Notes:
	-- 1. ReportConfigurationSettingsToSite mappings are not applied/managed on individual ReportConfigurationSettings records, but across all ReportConfigurationSettings records for a given sitegroup (@EntityRecordGuid).
	-- 2. @EntityRecordGuid: Guid of the sitegroup for which all the ReportConfigurationSettings records are to be mapped.
	...
	BEGIN TRY
		...
		BEGIN
			...
			INSERT INTO [map].[tblEntityReportConfigurationSettingsToSite]
			(
				[SiteGuid]
				,	[MapToSiteGuid]
				,	[CreatedDate]
		...
		OPEN TableCursor 
			...
			BEGIN 
				...
				(
					...
					AND MapToSiteGuid = @ChildSiteGuid   /* Entity Types that are mapped as a whole do not support multiple mappings to a site/sitegroup. If there has already been a mapping to a sitegroup, irrespective of its EntityRecordGuid (OwnersiteGuid), that mapping would have to be deleted before that sitegroup can be the recipient of a new mapping from another sitegroup */			
				)
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: map.usp_CreateReportConfigurationSettingsToSiteMapping' + CHAR(13)+CHAR(10)                  
