...
/*
	EXEC [map].[usp_GetAlarmAndEventToSiteBySiteGuid] '00000000-0000-0000-0000-000000000001'
*/

CREATE PROCEDURE [map].[usp_GetAlarmAndEventToSiteBySiteGuid]
(
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[usp_GetAlarmAndEventToSiteBySiteGuid]
	...
	-- 2. AlarmAndEventToSite mappings are not applied/managed on individual tblAlarmAndEvents records, but across all tblAlarmAndEvents records for a given sitegroup (@EntityRecordGuid)
	------------------------------------------------------------------------------------------------------
	SET NOCOUNT ON;
	BEGIN TRY
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: map.usp_GetAlarmAndEventToSiteBySiteGuid' + CHAR(13)+CHAR(10)                  
