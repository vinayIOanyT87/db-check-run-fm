/*
	DROP PROCEDURE [map].[usp_CreateAppointmentPersonnelToSiteMapping]

*/

CREATE PROCEDURE [map].[usp_CreateAppointmentPersonnelToSiteMapping]
(
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[usp_CreateAppointmentPersonnelToSiteMapping]
	-- Author: Vivian Kiarie /  Hansraj Bapoo
	-- Version/Date: 1.0.002 / 2013-12-30 14:44:52.4754311 -05:00
	-- Purpose: Insert into table [map].[tblEntityAppointmentPersonnelToSite]
	-- Notes:
	...
	BEGIN TRY
		...
		INSERT INTO [map].[tblEntityAppointmentPersonnelToSite]
		(
		...
		OPEN TableCursor 
		  ...
		  BEGIN 
				...
				WHERE NOT EXISTS
				(
					 SELECT * FROM [map].[tblEntityAppointmentPersonnelToSite]
	...
	BEGIN CATCH
		...
		BEGIN
			...
			+ 'Procedure Name: usp_CreateAppointmentPersonnelToSiteMapping' + CHAR(13)+CHAR(10)
