CREATE PROCEDURE [map].[usp_GetAssetTrackingMapConfigurationToSiteByAssignedFromSiteGuid]
(
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[usp_GetAssetTrackingMapConfigurationToSiteByAssignedFromSiteGuid]
	-- Author: Richard R. Panachida
	-- Version/Date: 1.0.001 / 2016-04-26 14:21:10.4470770 -04:00
	-- Purpose: Retrieves the AssetTrackingMapConfigurationToSite assignments from a given sitegroup. 	
	-- Notes:
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: map.usp_GetAssetTrackingMapConfigurationToSiteByAssignedFromSiteGuid' + CHAR(13)+CHAR(10)                  
