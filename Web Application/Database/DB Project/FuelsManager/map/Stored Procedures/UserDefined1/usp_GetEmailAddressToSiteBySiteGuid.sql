...
/*
	EXEC [map].[usp_GetEmailAddressToSiteBySiteGuid] '00000000-0000-0000-0000-000000000001'
*/

CREATE PROCEDURE [map].[usp_GetEmailAddressToSiteBySiteGuid]
(
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[usp_GetEmailAddressToSiteBySiteGuid]
	-- Author: Hansraj Bapoo
	-- Version/Date: 1.0.003 / 2012-07-13 14:21:10.4470770 -04:00
	-- Purpose: Retrieves the EmailAddressToSite assignments to a given site/sitegroup. 	
	-- Notes:
	...
	BEGIN TRY
		...
		SELECT a.EmailAddressToSiteGuid MappingGuid, a.ApplicationStringGuid EntityRecordGuid, d.ID EntityId, a.SiteGuid AssignedToSiteGuid, b.ID AssignedToSiteId, a.CreatedDate, a.CreatedBy, a.UpdatedDate, a.UpdatedBy, a._RowVersion, a.AssignedFromSiteGuid , c.ID AssignedFromSiteId 
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: map.usp_GetEmailAddressToSiteBySiteGuid' + CHAR(13)+CHAR(10)                  
