...
/*
	...
	EXEC [map].[usp_GetProdToSupplierProdComMapByProdGuid] '38B24944-C577-4193-B9FC-554205CB39D7', '00000000-0000-0000-0000-000000000001'


*/

CREATE PROCEDURE [map].[usp_GetProdToSupplierProdComMapByProdGuid]
(
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored Procedure: [map].[usp_GetProdToSupplierProdComMapByProdGuid] 
	-- Author: Hansraj Bapoo
	-- Version/Date: 1.0.003 / 2013-04-04 14:21:10.4470770 -10:00
	-- Purpose: Retrieves the map.tblProductToSupplierProductCompany mappings for a given ProductGuid and Site/Sitegroup.
	-- Notes:
	...
	-- 3. This stored procedure replaces the ProductMapClass.EnumerateByAssignedGuidAndTypeSQL() inline SQL, for the case where Type = PRODUCT_MAP_TYPE.SUPPLIER_PRODUCT_COMPANY_MAP.
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: [map].usp_GetProdToSupplierProdComMapByProdGuid' + CHAR(13)+CHAR(10)                  
