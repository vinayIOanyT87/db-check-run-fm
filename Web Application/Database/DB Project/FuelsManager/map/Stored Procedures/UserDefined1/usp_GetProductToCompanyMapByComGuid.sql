...
/*
	...
	EXEC [map].[usp_GetProductToCompanyMapByComGuid] '38B24944-C577-4193-B9FC-554205CB39D7', '00000000-0000-0000-0000-000000000001'
	EXEC [map].[usp_GetProductToCompanyMapByComGuid] '8a65bd18-a7da-49e0-aa9a-eb215b0a3abc', 'aeba18e3-e97b-479e-8b2d-0bcd69c1c421'
	EXEC [map].[usp_GetProductToCompanyMapByComGuid] 'e599efc5-9b85-4dda-bc17-dc6084e6d176', 'aeba18e3-e97b-479e-8b2d-0bcd69c1c421'

*/

CREATE PROCEDURE [map].[usp_GetProductToCompanyMapByComGuid]
(
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored Procedure: [map].[usp_GetProductToCompanyMapByComGuid] 
	...
	-- 4. This stored procedure replaces the ProductMapClass.EnumerateByAssignedToGuidAndTypeSQL() inline SQL, for the case where Type = PRODUCT_MAP_TYPE.PRODUCT_COMPANY_MAP and where bInTransaction is false.
	...
	BEGIN TRY	
		...
		SELECT a.* , b.MasterRecordGuid ProductMasterRecordGuid, c.ProductID AS AssignedID, c.ProductCode AS AssignedCode, c.Description AS AssignedDescription, 
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: [map].usp_GetProductToCompanyMapByComGuid' + CHAR(13)+CHAR(10)                  
