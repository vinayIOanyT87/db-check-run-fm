...
/*
	EXEC [map].[usp_GetFootnoteToShipperMapsByFootnote] '00000000-0000-0000-0000-000000000001', 'eb5826b2-2acb-418c-9985-65999152b9d2'

*/

CREATE PROCEDURE [map].[usp_GetFootnoteToShipperMapsByFootnote]
(
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored Procedure: [dbo].[usp_GetFootnoteToShipperMapsByFootnote] 
	-- Author: Hansraj Bapoo
	-- Version/Date: 1.0.003 / 2012-07-13 14:21:10.4470770 -04:00
	-- Purpose: Retrieve the map.tblApplicationStringToFootNoteShipper records for a given Footnote and a given Site/SiteGroup.
	-- Notes:
	...
	-- 3. This stored procedure replaces the ApplicationStringMapClass.EnumerateByApplicationStringGuidAndTypeSQL SQL inline SQL for the case where Type = STRING_MAP_TYPE.FOOT_NOTE_SHIPPER and where the bInTransaction is false.
