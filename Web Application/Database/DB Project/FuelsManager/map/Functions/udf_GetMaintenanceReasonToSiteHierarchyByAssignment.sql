/*
	SELECT * FROM [map].[udf_GetMaintenanceReasonToSiteHierarchyByAssignment] ( 'C0DA2E5F-711C-4245-B4DA-7085831674F1', '00000000-0000-0000-0000-000000000001', NULL) ORDER BY HierarchyLevel, SiteId	
	SELECT * FROM [map].[udf_GetMaintenanceReasonToSiteHierarchyByAssignment] ( 'C0DA2E5F-711C-4245-B4DA-7085831674F1', '00000000-0000-0000-0000-000000000001', 'F4761A16-AB2F-41EE-B6FA-D17658DF2602') ORDER BY HierarchyLevel, SiteId	
	SELECT * FROM [map].[udf_GetMaintenanceReasonToSiteHierarchyByAssignment] ( 'C0DA2E5F-711C-4245-B4DA-7085831674F1', NULL, NULL) ORDER BY HierarchyLevel, SiteId	

*/

CREATE FUNCTION [map].[udf_GetMaintenanceReasonToSiteHierarchyByAssignment]
(
...
BEGIN
	/*
	------------------------------------------------------------------------------------------------------
	-- Function: [map].[udf_GetMaintenanceReasonToSiteHierarchyByAssignment] 
	-- Author: Richard R. Panachida
	-- Version/Date: 1.0.003 / 2012-07-13 14:21:10.4470770 -04:00
	-- Purpose: Retrieves the MaintenanceReasonToSite assignment hierarchy below a given MaintenanceReason assignment. 	
	-- Notes:
	...
	*/
	...
	BEGIN
		SELECT @AssignedFromSiteGuid = SiteGuid FROM tblMaintenanceReasons WHERE MaintenanceReasonGuid = @EntityRecordGuid
	...
	BEGIN
		...
		WHERE MaintenanceReasonGuid = @EntityRecordGuid AND SiteGuid = @AssignedToSiteGuid
	END;
	...
	(
		...
		SELECT MaintenanceReasonToSiteGuid, AssignedFromSiteGuid, SiteGuid, 0
		FROM map.tblEntityMaintenanceReasonToSite
		...
		-- Recursive Call
		UNION ALL
		SELECT a.MaintenanceReasonToSiteGuid, a.AssignedFromSiteGuid, a.SiteGuid, lvl + 1
		FROM map.tblEntityMaintenanceReasonToSite a INNER JOIN AssignmentHierarchy b
			ON a.MaintenanceReasonGuid = @EntityRecordGuid
