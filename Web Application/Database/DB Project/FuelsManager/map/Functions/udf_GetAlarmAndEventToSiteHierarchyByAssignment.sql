...
/*
	SELECT * FROM [map].[udf_GetAlarmAndEventToSiteHierarchyByAssignment] ( 'C0DA2E5F-711C-4245-B4DA-7085831674F1', '00000000-0000-0000-0000-000000000001', NULL) ORDER BY HierarchyLevel, SiteId	
	SELECT * FROM [map].[udf_GetAlarmAndEventToSiteHierarchyByAssignment] ( 'C0DA2E5F-711C-4245-B4DA-7085831674F1', '00000000-0000-0000-0000-000000000001', 'F4761A16-AB2F-41EE-B6FA-D17658DF2602') ORDER BY HierarchyLevel, SiteId	
	SELECT * FROM [map].[udf_GetAlarmAndEventToSiteHierarchyByAssignment] ( 'C0DA2E5F-711C-4245-B4DA-7085831674F1', NULL, NULL) ORDER BY HierarchyLevel, SiteId	

*/

CREATE FUNCTION [map].[udf_GetAlarmAndEventToSiteHierarchyByAssignment]
(
...
BEGIN
	/*
	------------------------------------------------------------------------------------------------------
	-- Function: [map].[udf_GetAlarmAndEventToSiteHierarchyByAssignment] 
	-- Author: Hansraj Bapoo
	-- Version/Date: 1.0.003 / 2012-07-13 14:21:10.4470770 -04:00
	-- Purpose: Retrieves the AlarmAndEventToSite assignment hierarchy below a given AlarmAndEvent assignment. 	
	-- Notes:
	-- 1. @EntityRecordGuid: Guid of the AlarmAndEvent record for which the mapping hierarchy is to be retrieved.
	...
	*/
	...
	BEGIN
		SELECT @AssignedFromSiteGuid = AssignedFromSiteGuid FROM map.tblEntityAlarmAndEventToSite WHERE OwnerSiteGuid = @EntityRecordGuid AND MapToSiteGuid = @AssignedToSiteGuid
	END;
	...
	(
		...
		SELECT AlarmAndEventToSiteGuid, AssignedFromSiteGuid, MapToSiteGuid, 0
		...
		-- Recursive Call
		UNION ALL
		SELECT a.AlarmAndEventToSiteGuid, a.AssignedFromSiteGuid, a.MapToSiteGuid, lvl + 1
