...
/*
	SELECT * FROM [map].[udf_GetProductGroupToSiteHierarchyByAssignment] ( 'C0DA2E5F-711C-4245-B4DA-7085831674F1', '00000000-0000-0000-0000-000000000001', NULL) ORDER BY HierarchyLevel, SiteId	
	SELECT * FROM [map].[udf_GetProductGroupToSiteHierarchyByAssignment] ( 'C0DA2E5F-711C-4245-B4DA-7085831674F1', '00000000-0000-0000-0000-000000000001', 'F4761A16-AB2F-41EE-B6FA-D17658DF2602') ORDER BY HierarchyLevel, SiteId	
	SELECT * FROM [map].[udf_GetProductGroupToSiteHierarchyByAssignment] ( 'C0DA2E5F-711C-4245-B4DA-7085831674F1', NULL, NULL) ORDER BY HierarchyLevel, SiteId	



	SELECT * FROM [map].[udf_GetProductGroupToSiteHierarchyByAssignment] ( 'EF31829B-F3C1-4B36-9DC7-F85A2AC1C9CD', NULL, '00000000-0000-0000-0000-000000000001') ORDER BY HierarchyLevel, SiteId	

*/

CREATE FUNCTION [map].[udf_GetProductGroupToSiteHierarchyByAssignment]
(
...
BEGIN
	/*
	------------------------------------------------------------------------------------------------------
	-- Function: [map].[udf_GetProductGroupToSiteHierarchyByAssignment] 
	-- Author: Hansraj Bapoo
	-- Version/Date: 1.0.003 / 2012-07-13 14:21:10.4470770 -04:00
	-- Purpose: Retrieves the ProductGroupToSite assignment hierarchy below a given ProductGroup assignment. 	
	-- Notes:
	-- 1. @EntityRecordGuid: Guid of the ProductGroup record for which the mapping hierarchy is to be retrieved.
	...
	*/
	...
	BEGIN
		SELECT @AssignedFromSiteGuid = AssignedFromSiteGuid FROM map.tblEntityProductGroupToSite WHERE ApplicationStringGuid = @EntityRecordGuid AND SiteGuid = @AssignedToSiteGuid
	END;
	...
	(
		...
		SELECT ProductGroupToSiteGuid, AssignedFromSiteGuid, SiteGuid, 0
		...
		-- Recursive Call
		UNION ALL
		SELECT a.ProductGroupToSiteGuid, a.AssignedFromSiteGuid, a.SiteGuid, lvl + 1
