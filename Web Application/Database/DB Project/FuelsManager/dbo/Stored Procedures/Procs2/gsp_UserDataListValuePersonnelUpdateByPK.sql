CREATE PROCEDURE [dbo].[gsp_UserDataListValuePersonnelUpdateByPK]
(
	...
	,	@NullOverrideUserDataFieldPersonnelGuid BIT=0 
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [dbo].[gsp_UserDataListValuePersonnelUpdateByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.003 / 2014-02-05 16:52:29.9534425 -05:00
	-- Purpose: Update table [dbo].[tblUserDataListValuePersonnel]
	-- Notes:
	-- 1. @UserDataListValuePersonnelGuid and @UpdatedBy are required parameter.
	...
	SET NOCOUNT ON;
	BEGIN TRY
		IF @_RowVersion IS NOT NULL AND NOT EXISTS(SELECT 1 FROM [dbo].[tblUserDataListValuePersonnel] WHERE UserDataListValuePersonnelGuid=@UserDataListValuePersonnelGuid AND _RowVersion=@_RowVersion)
		BEGIN
			RAISERROR('Attempted to modify a stale copy of the record',16,1);
			RETURN;
		END
 
		UPDATE [dbo].[tblUserDataListValuePersonnel] SET
			[UserDataFieldPersonnelGuid]=(CASE ISNULL(@NullOverrideUserDataFieldPersonnelGuid,0) WHEN 1 THEN @UserDataFieldPersonnelGuid ELSE ISNULL(@UserDataFieldPersonnelGuid,[UserDataFieldPersonnelGuid]) END)
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_UserDataListValuePersonnelUpdateByPK' + CHAR(13)+CHAR(10)                  
