CREATE PROCEDURE [dbo].[gsp_UserDataListValueEquipmentUpdateByPK]
(
	...
	,	@NullOverrideUserDataFieldEquipmentGuid BIT=0 
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [dbo].[gsp_UserDataListValueEquipmentUpdateByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.003 / 2014-02-05 16:52:29.9494421 -05:00
	-- Purpose: Update table [dbo].[tblUserDataListValueEquipment]
	-- Notes:
	-- 1. @UserDataListValueEquipmentGuid and @UpdatedBy are required parameter.
	...
	SET NOCOUNT ON;
	BEGIN TRY
		IF @_RowVersion IS NOT NULL AND NOT EXISTS(SELECT 1 FROM [dbo].[tblUserDataListValueEquipment] WHERE UserDataListValueEquipmentGuid=@UserDataListValueEquipmentGuid AND _RowVersion=@_RowVersion)
		BEGIN
			RAISERROR('Attempted to modify a stale copy of the record',16,1);
			RETURN;
		END
 
		UPDATE [dbo].[tblUserDataListValueEquipment] SET
			[UserDataFieldEquipmentGuid]=(CASE ISNULL(@NullOverrideUserDataFieldEquipmentGuid,0) WHEN 1 THEN @UserDataFieldEquipmentGuid ELSE ISNULL(@UserDataFieldEquipmentGuid,[UserDataFieldEquipmentGuid]) END)
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_UserDataListValueEquipmentUpdateByPK' + CHAR(13)+CHAR(10)                  
