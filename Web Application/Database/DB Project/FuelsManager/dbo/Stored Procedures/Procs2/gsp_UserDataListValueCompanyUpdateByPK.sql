CREATE PROCEDURE [dbo].[gsp_UserDataListValueCompanyUpdateByPK]
(
	...
	,	@NullOverrideUserDataFieldCompanyGuid BIT=0 
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [dbo].[gsp_UserDataListValueCompanyUpdateByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.003 / 2014-02-05 16:52:29.9474419 -05:00
	-- Purpose: Update table [dbo].[tblUserDataListValueCompany]
	-- Notes:
	-- 1. @UserDataListValueCompanyGuid and @UpdatedBy are required parameter.
	...
	SET NOCOUNT ON;
	BEGIN TRY
		IF @_RowVersion IS NOT NULL AND NOT EXISTS(SELECT 1 FROM [dbo].[tblUserDataListValueCompany] WHERE UserDataListValueCompanyGuid=@UserDataListValueCompanyGuid AND _RowVersion=@_RowVersion)
		BEGIN
			RAISERROR('Attempted to modify a stale copy of the record',16,1);
			RETURN;
		END
 
		UPDATE [dbo].[tblUserDataListValueCompany] SET
			[UserDataFieldCompanyGuid]=(CASE ISNULL(@NullOverrideUserDataFieldCompanyGuid,0) WHEN 1 THEN @UserDataFieldCompanyGuid ELSE ISNULL(@UserDataFieldCompanyGuid,[UserDataFieldCompanyGuid]) END)
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_UserDataListValueCompanyUpdateByPK' + CHAR(13)+CHAR(10)                  
