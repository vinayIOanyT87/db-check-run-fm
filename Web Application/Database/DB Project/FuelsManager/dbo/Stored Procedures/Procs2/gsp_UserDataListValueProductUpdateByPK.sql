CREATE PROCEDURE [dbo].[gsp_UserDataListValueProductUpdateByPK]
(
	...
	,	@NullOverrideUserDataFieldProductGuid BIT=0 
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [dbo].[gsp_UserDataListValueProductUpdateByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.003 / 2014-02-05 16:52:29.9554427 -05:00
	-- Purpose: Update table [dbo].[tblUserDataListValueProduct]
	-- Notes:
	-- 1. @UserDataListValueProductGuid and @UpdatedBy are required parameter.
	...
	SET NOCOUNT ON;
	BEGIN TRY
		IF @_RowVersion IS NOT NULL AND NOT EXISTS(SELECT 1 FROM [dbo].[tblUserDataListValueProduct] WHERE UserDataListValueProductGuid=@UserDataListValueProductGuid AND _RowVersion=@_RowVersion)
		BEGIN
			RAISERROR('Attempted to modify a stale copy of the record',16,1);
			RETURN;
		END
 
		UPDATE [dbo].[tblUserDataListValueProduct] SET
			[UserDataFieldProductGuid]=(CASE ISNULL(@NullOverrideUserDataFieldProductGuid,0) WHEN 1 THEN @UserDataFieldProductGuid ELSE ISNULL(@UserDataFieldProductGuid,[UserDataFieldProductGuid]) END)
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_UserDataListValueProductUpdateByPK' + CHAR(13)+CHAR(10)                  
