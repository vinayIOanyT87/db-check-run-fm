CREATE PROCEDURE [dbo].[gsp_UserDataListValueSiteUpdateByPK]
(
	...
	,	@NullOverrideUserDataFieldSiteGuid BIT=0 
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [dbo].[gsp_UserDataListValueSiteUpdateByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.003 / 2014-02-05 16:52:29.9564428 -05:00
	-- Purpose: Update table [dbo].[tblUserDataListValueSite]
	-- Notes:
	-- 1. @UserDataListValueSiteGuid and @UpdatedBy are required parameter.
	...
	SET NOCOUNT ON;
	BEGIN TRY
		IF @_RowVersion IS NOT NULL AND NOT EXISTS(SELECT 1 FROM [dbo].[tblUserDataListValueSite] WHERE UserDataListValueSiteGuid=@UserDataListValueSiteGuid AND _RowVersion=@_RowVersion)
		BEGIN
			RAISERROR('Attempted to modify a stale copy of the record',16,1);
			RETURN;
		END
 
		UPDATE [dbo].[tblUserDataListValueSite] SET
			[UserDataFieldSiteGuid]=(CASE ISNULL(@NullOverrideUserDataFieldSiteGuid,0) WHEN 1 THEN @UserDataFieldSiteGuid ELSE ISNULL(@UserDataFieldSiteGuid,[UserDataFieldSiteGuid]) END)
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_UserDataListValueSiteUpdateByPK' + CHAR(13)+CHAR(10)                  
