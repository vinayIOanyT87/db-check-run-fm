CREATE PROCEDURE [dbo].[gsp_UserDataListValueTransactionAliasLineItemUpdateByPK]
(
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [dbo].[gsp_UserDataListValueTransactionAliasLineItemUpdateByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.003 / 2014-02-05 16:52:29.9614433 -05:00
	-- Purpose: Update table [dbo].[tblUserDataListValueTransactionAliasLineItem]
	-- Notes:
	-- 1. @UserDataListValueTransactionAliasLineItemGuid and @UpdatedBy are required parameter.
	...
	SET NOCOUNT ON;
	BEGIN TRY
		IF @_RowVersion IS NOT NULL AND NOT EXISTS(SELECT 1 FROM [dbo].[tblUserDataListValueTransactionAliasLineItem] WHERE UserDataListValueTransactionAliasLineItemGuid=@UserDataListValueTransactionAliasLineItemGuid AND _RowVersion=@_RowVersion)
		BEGIN
			RAISERROR('Attempted to modify a stale copy of the record',16,1);
			RETURN;
		END
 
		UPDATE [dbo].[tblUserDataListValueTransactionAliasLineItem] SET
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_UserDataListValueTransactionAliasLineItemUpdateByPK' + CHAR(13)+CHAR(10)                  
