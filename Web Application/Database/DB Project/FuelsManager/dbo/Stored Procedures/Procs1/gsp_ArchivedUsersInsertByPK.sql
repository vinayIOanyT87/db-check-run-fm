CREATE PROCEDURE [dbo].[gsp_ArchivedUsersInsertByPK]
(
		@ArchivedUserGuid uniqueidentifier=NULL OUTPUT
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [dbo].[gsp_ArchivedUsersInsertByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.001 / 2014-02-05 15:58:32.0772767 -05:00
	-- Purpose: Insert into table [dbo].[tblArchivedUsers]
	-- Notes:
	------------------------------------------------------------------------------------------------------
	SET NOCOUNT ON;
	BEGIN TRY
		...
		SET @ArchivedUserGuid=NEWID();
		SET @CreatedDate=ISNULL(@CreatedDate,sysdatetimeoffset())
 
		INSERT INTO [dbo].[tblArchivedUsers] 
		(
			[ArchivedUserGuid]
		,	[UserID]
		,	[Password]
		...
		WHERE ArchivedUserGuid=@ArchivedUserGuid;
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_ArchivedUsersInsertByPK' + CHAR(13)+CHAR(10)                  
