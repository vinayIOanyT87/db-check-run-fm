CREATE PROCEDURE [dbo].[gsp_SRMAdaptorFPESUpdateByPK]
(
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [dbo].[gsp_SRMAdaptorFPESUpdateByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.003 / 2014-02-05 16:52:29.7874259 -05:00
	-- Purpose: Update table [dbo].[tblSRMAdaptorFPES]
	-- Notes:
	-- 1. @SRMAdaptorFPESGuid and @UpdatedBy are required parameter.
	...
	SET NOCOUNT ON;
	BEGIN TRY
		IF @_RowVersion IS NOT NULL AND NOT EXISTS(SELECT 1 FROM [dbo].[tblSRMAdaptorFPES] WHERE SRMAdaptorFPESGuid=@SRMAdaptorFPESGuid AND _RowVersion=@_RowVersion)
		BEGIN
			RAISERROR('Attempted to modify a stale copy of the record',16,1);
			RETURN;
		END
 
		UPDATE [dbo].[tblSRMAdaptorFPES] SET
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_SRMAdaptorFPESUpdateByPK' + CHAR(13)+CHAR(10)                  
