CREATE PROCEDURE [dbo].[gsp_ProcessVariableExternalComponentInputPermissiveInsertByPK]
(
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [dbo].[gsp_ProcessVariableExternalComponentInputPermissiveInsertByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.001 / 2014-02-05 15:58:32.3412767 -05:00
	-- Purpose: Insert into table [dbo].[tblProcessVariableExternalComponentInputPermissive]
	-- Notes:
	------------------------------------------------------------------------------------------------------
	SET NOCOUNT ON;
	BEGIN TRY
		...
		INSERT INTO [dbo].[tblProcessVariableExternalComponentInputPermissive] 
		(
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_ProcessVariableExternalComponentInputPermissiveInsertByPK' + CHAR(13)+CHAR(10)                  
