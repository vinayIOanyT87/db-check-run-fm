CREATE PROCEDURE [dbo].[gsp_ProcessVariableExternalComponenendPercentageInsertByPK]
(
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [dbo].[gsp_ProcessVariableExternalComponenendPercentageInsertByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.001 / 2014-02-05 15:58:32.3382767 -05:00
	-- Purpose: Insert into table [dbo].[tblProcessVariableExternalComponentBlendPercentage]
	-- Notes:
	------------------------------------------------------------------------------------------------------
	SET NOCOUNT ON;
	BEGIN TRY
		...
		INSERT INTO [dbo].[tblProcessVariableExternalComponentBlendPercentage] 
		(
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_ProcessVariableExternalComponenendPercentageInsertByPK' + CHAR(13)+CHAR(10)                  
