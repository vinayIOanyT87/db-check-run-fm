CREATE PROCEDURE [dbo].[gsp_SiteAdminUpdateByPK]
(
		@SiteAdminGuid uniqueidentifier
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [dbo].[gsp_SiteAdminUpdateByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.003 / 2014-02-05 16:52:29.7494221 -05:00
	-- Purpose: Update table [dbo].[tblSiteAdmin]
	-- Notes:
	-- 1. @SiteAdminGuid and @UpdatedBy are required parameter.
	...
	SET NOCOUNT ON;
	BEGIN TRY
		IF @_RowVersion IS NOT NULL AND NOT EXISTS(SELECT 1 FROM [dbo].[tblSiteAdmin] WHERE SiteAdminGuid=@SiteAdminGuid AND _RowVersion=@_RowVersion)
		BEGIN
			RAISERROR('Attempted to modify a stale copy of the record',16,1);
			RETURN;
		END
 
		UPDATE [dbo].[tblSiteAdmin] SET
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_SiteAdminUpdateByPK' + CHAR(13)+CHAR(10)                  
