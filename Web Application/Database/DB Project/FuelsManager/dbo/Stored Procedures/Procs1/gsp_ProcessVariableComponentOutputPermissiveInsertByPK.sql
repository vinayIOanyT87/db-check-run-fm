CREATE PROCEDURE [dbo].[gsp_ProcessVariableComponentOutputPermissiveInsertByPK]
(
		@ProcessVariableProductToPresetComponentTankOrTankGroupGuid uniqueidentifier=NULL OUTPUT
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [dbo].[gsp_ProcessVariableComponentOutputPermissiveInsertByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.001 / 2014-02-05 15:58:32.3322767 -05:00
	-- Purpose: Insert into table [dbo].[tblProcessVariableComponentOutputPermissive]
	-- Notes:
	------------------------------------------------------------------------------------------------------
	SET NOCOUNT ON;
	BEGIN TRY
		...
		SET @ProcessVariableProductToPresetComponentTankOrTankGroupGuid=NEWID();
		SET @CreatedDate=ISNULL(@CreatedDate,sysdatetimeoffset())
 
		INSERT INTO [dbo].[tblProcessVariableComponentOutputPermissive] 
		(
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_ProcessVariableComponentOutputPermissiveInsertByPK' + CHAR(13)+CHAR(10)                  
