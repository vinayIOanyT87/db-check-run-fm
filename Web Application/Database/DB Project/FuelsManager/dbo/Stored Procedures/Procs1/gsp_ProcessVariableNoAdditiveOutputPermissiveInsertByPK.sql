CREATE PROCEDURE [dbo].[gsp_ProcessVariableNoAdditiveOutputPermissiveInsertByPK]
(
		@ProcessVariableLoadArmGuid uniqueidentifier=NULL OUTPUT
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [dbo].[gsp_ProcessVariableNoAdditiveOutputPermissiveInsertByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.001 / 2014-02-05 15:58:32.3632767 -05:00
	-- Purpose: Insert into table [dbo].[tblProcessVariableNoAdditiveOutputPermissive]
	-- Notes:
	------------------------------------------------------------------------------------------------------
	SET NOCOUNT ON;
	BEGIN TRY
		...
		SET @ProcessVariableLoadArmGuid=NEWID();
		SET @CreatedDate=ISNULL(@CreatedDate,sysdatetimeoffset())
 
		INSERT INTO [dbo].[tblProcessVariableNoAdditiveOutputPermissive] 
		(
		...
		WHERE ProcessVariableLoadArmGuid=@ProcessVariableLoadArmGuid;
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_ProcessVariableNoAdditiveOutputPermissiveInsertByPK' + CHAR(13)+CHAR(10)                  
