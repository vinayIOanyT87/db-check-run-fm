CREATE PROCEDURE [dbo].[gsp_ExStarsFilingSelect]
...
----------
CREATE PROCEDURE [dbo].[gsp_ExStarsFilingSelectByTransSetCtrlNumber]
...
GO
CREATE PROCEDURE [dbo].[gsp_ExStarsFilingSelectByGuid]
  @ManagerCompanyGuid		UNIQUEIDENTIFIER
, @SiteGuid					UNIQUEIDENTIFIER
...
CREATE PROCEDURE [dbo].[gsp_ExStarsFilingSelectLast]
  @ManagerCompanyGuid		UNIQUEIDENTIFIER
, @SiteGuid					UNIQUEIDENTIFIER
AS
BEGIN
