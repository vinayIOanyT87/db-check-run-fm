CREATE PROCEDURE [dbo].[gsp_ProcessVariableAdditiveOutputPermissiveInsertByPK]
(
		@ProcessVariableProductToPresetInjectorGuid uniqueidentifier=NULL OUTPUT
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [dbo].[gsp_ProcessVariableAdditiveOutputPermissiveInsertByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.001 / 2014-02-05 15:58:32.3262767 -05:00
	-- Purpose: Insert into table [dbo].[tblProcessVariableAdditiveOutputPermissive]
	-- Notes:
	------------------------------------------------------------------------------------------------------
	SET NOCOUNT ON;
	BEGIN TRY
		...
		SET @ProcessVariableProductToPresetInjectorGuid=NEWID();
		SET @CreatedDate=ISNULL(@CreatedDate,sysdatetimeoffset())
 
		INSERT INTO [dbo].[tblProcessVariableAdditiveOutputPermissive] 
		(
		...
		WHERE ProcessVariableProductToPresetInjectorGuid=@ProcessVariableProductToPresetInjectorGuid;
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_ProcessVariableAdditiveOutputPermissiveInsertByPK' + CHAR(13)+CHAR(10)                  
