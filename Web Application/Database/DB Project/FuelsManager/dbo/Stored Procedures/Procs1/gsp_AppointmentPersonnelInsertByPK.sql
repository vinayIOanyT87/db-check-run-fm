CREATE PROCEDURE [dbo].[gsp_AppointmentPersonnelInsertByPK]
(
		@AppointmentPersonnelGuid uniqueidentifier=NULL OUTPUT
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [dbo].[gsp_AppointmentPersonnelInsertByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.001 / 2014-02-05 15:58:32.0692767 -05:00
	-- Purpose: Insert into table [dbo].[tblAppointmentPersonnel]
	-- Notes:
	------------------------------------------------------------------------------------------------------
	SET NOCOUNT ON;
	BEGIN TRY
		...
		SET @AppointmentPersonnelGuid=NEWID();
		SET @CreatedDate=ISNULL(@CreatedDate,sysdatetimeoffset())
 
		INSERT INTO [dbo].[tblAppointmentPersonnel] 
		(
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_AppointmentPersonnelInsertByPK' + CHAR(13)+CHAR(10)                  
