CREATE PROCEDURE [dbo].[gsp_TestSetDefinitionsUpdateByPK]
(
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [dbo].[gsp_TestSetDefinitionsUpdateByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.003 / 2014-02-05 16:52:29.8334305 -05:00
	-- Purpose: Update table [dbo].[tblTestSetDefinitions]
	-- Notes:
	-- 1. @TestSetDefinitionGuid and @UpdatedBy are required parameter.
	...
	SET NOCOUNT ON;
	BEGIN TRY
		IF @_RowVersion IS NOT NULL AND NOT EXISTS(SELECT 1 FROM [dbo].[tblTestSetDefinitions] WHERE TestSetDefinitionGuid=@TestSetDefinitionGuid AND _RowVersion=@_RowVersion)
		BEGIN
			RAISERROR('Attempted to modify a stale copy of the record',16,1);
			RETURN;
		END
 
		UPDATE [dbo].[tblTestSetDefinitions] SET
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_TestSetDefinitionsUpdateByPK' + CHAR(13)+CHAR(10)                  
