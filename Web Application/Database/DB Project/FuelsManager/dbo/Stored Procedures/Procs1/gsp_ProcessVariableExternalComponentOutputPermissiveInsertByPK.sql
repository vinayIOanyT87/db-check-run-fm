CREATE PROCEDURE [dbo].[gsp_ProcessVariableExternalComponentOutputPermissiveInsertByPK]
(
		@ProcessVariableProductToPresetExternalComponentGuid uniqueidentifier=NULL OUTPUT
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [dbo].[gsp_ProcessVariableExternalComponentOutputPermissiveInsertByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.001 / 2014-02-05 15:58:32.3462767 -05:00
	-- Purpose: Insert into table [dbo].[tblProcessVariableExternalComponentOutputPermissive]
	-- Notes:
	------------------------------------------------------------------------------------------------------
	SET NOCOUNT ON;
	BEGIN TRY
		...
		SET @ProcessVariableProductToPresetExternalComponentGuid=NEWID();
		SET @CreatedDate=ISNULL(@CreatedDate,sysdatetimeoffset())
 
		INSERT INTO [dbo].[tblProcessVariableExternalComponentOutputPermissive] 
		(
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_ProcessVariableExternalComponentOutputPermissiveInsertByPK' + CHAR(13)+CHAR(10)                  
