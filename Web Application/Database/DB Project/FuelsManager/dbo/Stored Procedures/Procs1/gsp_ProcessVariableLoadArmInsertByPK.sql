CREATE PROCEDURE [dbo].[gsp_ProcessVariableLoadArmInsertByPK]
(
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [dbo].[gsp_ProcessVariableLoadArmInsertByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.001 / 2014-02-05 15:58:32.3502767 -05:00
	-- Purpose: Insert into table [dbo].[tblProcessVariableLoadArm]
	-- Notes:
	------------------------------------------------------------------------------------------------------
	SET NOCOUNT ON;
	BEGIN TRY
		...
		INSERT INTO [dbo].[tblProcessVariableLoadArm] 
		(
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_ProcessVariableLoadArmInsertByPK' + CHAR(13)+CHAR(10)                  
