CREATE PROCEDURE [dbo].[gsp_CustomToolbarUpdateByPK]
(
	...
	,	@NullOverrideLookupCustomToolbarTypeIndex BIT=0 
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [dbo].[gsp_CustomToolbarUpdateByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.003 / 2014-02-05 16:52:29.4583930 -05:00
	-- Purpose: Update table [dbo].[tblCustomToolbar]
	-- Notes:
	-- 1. @CustomToolbarGuid and @UpdatedBy are required parameter.
	...
	SET NOCOUNT ON;
	BEGIN TRY
		IF @_RowVersion IS NOT NULL AND NOT EXISTS(SELECT 1 FROM [dbo].[tblCustomToolbar] WHERE CustomToolbarGuid=@CustomToolbarGuid AND _RowVersion=@_RowVersion)
		BEGIN
			RAISERROR('Attempted to modify a stale copy of the record',16,1);
			RETURN;
		END
 
		UPDATE [dbo].[tblCustomToolbar] SET
		...
		,	[LookupCustomToolbarTypeIndex]=(CASE ISNULL(@NullOverrideLookupCustomToolbarTypeIndex,0) WHEN 1 THEN @LookupCustomToolbarTypeIndex ELSE ISNULL(@LookupCustomToolbarTypeIndex,[LookupCustomToolbarTypeIndex]) END)
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_CustomToolbarUpdateByPK' + CHAR(13)+CHAR(10)                  
