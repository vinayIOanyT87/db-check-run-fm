CREATE PROCEDURE [dbo].[gsp_ProcessVariablePresetInjectorInsertByPK]
(
		@ProcessVariablePresetInjectorGuid uniqueidentifier=NULL OUTPUT
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [dbo].[gsp_ProcessVariablePresetInjectorInsertByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.001 / 2014-02-05 15:58:32.3662767 -05:00
	-- Purpose: Insert into table [dbo].[tblProcessVariablePresetInjector]
	-- Notes:
	------------------------------------------------------------------------------------------------------
	SET NOCOUNT ON;
	BEGIN TRY
		...
		SET @ProcessVariablePresetInjectorGuid=NEWID();
		SET @CreatedDate=ISNULL(@CreatedDate,sysdatetimeoffset())
 
		INSERT INTO [dbo].[tblProcessVariablePresetInjector] 
		(
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_ProcessVariablePresetInjectorInsertByPK' + CHAR(13)+CHAR(10)                  
