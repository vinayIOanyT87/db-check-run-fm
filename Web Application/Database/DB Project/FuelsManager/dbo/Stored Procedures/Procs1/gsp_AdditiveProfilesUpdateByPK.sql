CREATE PROCEDURE [dbo].[gsp_AdditiveProfilesUpdateByPK]
(
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [dbo].[gsp_AdditiveProfilesUpdateByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.003 / 2014-02-05 16:52:29.3113783 -05:00
	-- Purpose: Update table [dbo].[tblAdditiveProfiles]
	-- Notes:
	-- 1. @AdditiveProfileGuid and @UpdatedBy are required parameter.
	...
	SET NOCOUNT ON;
	BEGIN TRY
		IF @_RowVersion IS NOT NULL AND NOT EXISTS(SELECT 1 FROM [dbo].[tblAdditiveProfiles] WHERE AdditiveProfileGuid=@AdditiveProfileGuid AND _RowVersion=@_RowVersion)
		BEGIN
			RAISERROR('Attempted to modify a stale copy of the record',16,1);
			RETURN;
		END
 
		UPDATE [dbo].[tblAdditiveProfiles] SET
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_AdditiveProfilesUpdateByPK' + CHAR(13)+CHAR(10)                  
