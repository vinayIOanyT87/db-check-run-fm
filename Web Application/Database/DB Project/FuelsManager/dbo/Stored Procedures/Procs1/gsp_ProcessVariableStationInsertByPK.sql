CREATE PROCEDURE [dbo].[gsp_ProcessVariableStationInsertByPK]
(
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [dbo].[gsp_ProcessVariableStationInsertByPK] 
	-- Author: DBA - Auto generated
	-- Version/Date: 1.0.001 / 2014-02-05 15:58:32.3792767 -05:00
	-- Purpose: Insert into table [dbo].[tblProcessVariableStation]
	-- Notes:
	------------------------------------------------------------------------------------------------------
	SET NOCOUNT ON;
	BEGIN TRY
		...
		INSERT INTO [dbo].[tblProcessVariableStation] 
		(
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: gsp_ProcessVariableStationInsertByPK' + CHAR(13)+CHAR(10)                  
