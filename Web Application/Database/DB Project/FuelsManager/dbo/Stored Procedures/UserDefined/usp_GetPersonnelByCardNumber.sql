...
/*
	DROP PROCEDURE [dbo].[usp_GetPersonnelByCardNumber]

	EXEC [dbo].[usp_GetPersonnelByCardNumber] 'AD74B677-F294-4BF8-8861-30D6B424ADC6', '640401', '640403', 0
	EXEC [dbo].[usp_GetPersonnelByCardNumber] 'AD74B677-F294-4BF8-8861-30D6B424ADC6', '640401', '640403', 1

*/



CREATE PROCEDURE [dbo].[usp_GetPersonnelByCardNumber]
(
	@TargetSiteGuid uniqueidentifier, @CardNumber1 nvarchar(30), @CardNumber2 nvarchar(30), @InTransaction bit
)
AS
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored Procedure: [dbo].[usp_GetPersonnelByCardNumber] 
	-- Author: Shawn Marlin
	...
	-- 2. @CardNumber1: Limit the results to Personnel that have an CardNumber value that correspond to the  @CardNumber1 value
	-- 3. @CardNumber2: Limit the results to Personnel that have an CardNumber value not equal to the  @CardNumber2 value.  This seems redundant, but was in the code
	-- 3. @InTransaction: Specifies whether to use a lock.
	-- 3. This stored procedure replaces the PersonnelClass.SelectByCardNumberSQL inline SQL.
	...
	BEGIN
		...
		WHERE b.CardNumber = @CardNumber1 AND b.CardNumber <> @CardNumber2
	END
	ELSE
	BEGIN
		SELECT b.*, 
	...
	BEGIN CATCH  
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: [dbo].usp_GetPersonnelByCardNumber' + CHAR(13)+CHAR(10)                  
