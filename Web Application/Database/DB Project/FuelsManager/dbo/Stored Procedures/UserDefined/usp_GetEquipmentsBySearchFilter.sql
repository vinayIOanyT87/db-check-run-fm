...
/*
	EXEC [dbo].[usp_GetEquipmentsBySearchFilter] NULL, NULL, NULL, NULL
	EXEC [dbo].[usp_GetEquipmentsBySearchFilter] NULL, NULL, NULL, '%HBEquipment%'
	EXEC [dbo].[usp_GetEquipmentsBySearchFilter] 'F4761A16-AB2F-41EE-B6FA-D17658DF2602', NULL, '291C57D1-06CF-49B3-A732-47F37A1267A0', NULL	
*/

CREATE PROCEDURE [dbo].[usp_GetEquipmentsBySearchFilter]
(
	@TargetSiteGuid uniqueidentifier,
	@EquipmentType int,
	@ProductGuid uniqueidentifier,
	@SearchFilter nvarchar(32),
	@ExcludeNonEditableCompanyGuid bit = NULL,
	@ExcludeNonEditableFuelCardGuid bit = NULL,
	@HideHiddenEquipmentRecords BIT = 0
)
	AS
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored Procedure: [dbo].[usp_GetEquipmentsBySearchFilter] 
	-- Author: Hansraj Bapoo
	-- Version/Date: 1.0.003 / 2012-07-13 14:21:10.4470770 -04:00
	-- Purpose: Retrieve Equipment records for a given target site/sitegroup, by EquipmentType, Product, and by a search string on the ID and Description fields.
	-- Notes:
	...
	-- 4. @SearchFilter: Search string to be used to filter the ID and Description fields
	-- 5. @ExcludeNonEditableCompanyGuid: 
	...
	-- 6. @ExcludeNonEditableFuelCardGuid: 
	...
	-- 8. This stored procedure replaces the EquipmentClass.EnumerateByTypeAndFilterAndProduct inline SQL.
	...
	BEGIN TRY	
		...
		(
			...
			(
				(b.ID LIKE(UPPER(@SearchFilter))
				OR b.CompanyEquipmentID LIKE(UPPER(@SearchFilter))
				OR c.ID LIKE(UPPER(@SearchFilter))
	...
	BEGIN CATCH  
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: [dbo].usp_GetEquipmentsBySearchFilter' + CHAR(13)+CHAR(10)                  
