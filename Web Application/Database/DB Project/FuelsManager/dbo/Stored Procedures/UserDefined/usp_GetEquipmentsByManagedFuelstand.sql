...
/*
	EXEC [dbo].[usp_GetEquipmentsByManagedFuelstand] NULL, 14
	EXEC [dbo].[usp_GetEquipmentsByManagedFuelstand] '00000000-0000-0000-0000-000000000001', 14
	
	
*/

CREATE PROCEDURE [dbo].[usp_GetEquipmentsByManagedFuelstand]
(
	@TargetSiteGuid uniqueidentifier, @FillStandType int
)
	AS
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored Procedure: [map].[usp_GetEquipmentsByManagedFuelstand] 
	-- Author: Hansraj Bapoo
	-- Version/Date: 1.0.003 / 2012-07-13 14:21:10.4470770 -04:00
	-- Purpose: Retrieve Equipment records for a given target site/sitegroup for FillStand only equipments for which the ManagedEquipmentFlag is set.
	-- Notes:
	-- 1. @TargetSiteGuid: Guid of the site/sitegroup for which to limit the search.
	-- 2. @FillStandTypeIndex: Index of the FillStand EquipmentType.
	-- 3. This stored procedure replaces the EquipmentClass.EnumerateByManagedFuelstand inline SQL.
	...
	BEGIN TRY	
		...
		WHERE (b.ManagedEquipmentFlag = 1 AND d.LookupEquipmentTypeIndex = @FillStandType)
		AND
		(
	...
	BEGIN CATCH  
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: [dbo].usp_GetEquipmentsByManagedFuelstand' + CHAR(13)+CHAR(10)                  
