CREATE PROCEDURE [dbo].[usp_PointTagAlarmStatusUpdateSilence]
(
...
WHEN MATCHED AND	temp.Silenced = 1
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: usp_PointTagAlarmStatusUpdateSilence' + CHAR(13)+CHAR(10)                  
