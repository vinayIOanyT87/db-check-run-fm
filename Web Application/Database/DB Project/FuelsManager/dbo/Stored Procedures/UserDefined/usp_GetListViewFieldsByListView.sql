...
/*
	EXEC [dbo].[usp_GetListViewFieldsByListView] '00000000-0000-0000-0000-000000000001', 'B2859CA3-5D6F-4205-A17E-93CA5AF881E8'

*/

CREATE PROCEDURE [dbo].[usp_GetListViewFieldsByListView]
(
	@TargetSiteGuid uniqueidentifier, @ListViewGuid uniqueidentifier
)
AS
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored Procedure: [dbo].[usp_GetListViewFieldsByListView]
	-- Author: Hansraj Bapoo
	-- Version/Date: 1.0.003 / 2012-07-13 14:21:10.4470770 -04:00
	-- Purpose: Retrieve the List View Fields of a List View for a given ListView, for a given Site/SiteGroup.
	-- Notes:
	-- 1. @TargetSiteGuid: Limit results to List View that have been assigned to this site/sitegroup only
	-- 2. @ListViewGuid: Limit results to List View Field that belong to the List View that has a Guid corresponding to  @ListViewGuid.
	-- 4. This stored procedure replaces the ListViewField.EnumerateSQL inline SQL for the case where bInTransaction is false.
	...
	BEGIN TRY	
		...
		WHERE a.ListViewGuid = @ListViewGuid
