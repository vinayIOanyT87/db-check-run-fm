CREATE PROCEDURE [dbo].[usp_PointHistoryUpdateByUserSite]
...
BEGIN
	...
	BEGIN TRY
		...
		UPDATE tblPointHistory
		SET 
			PointHistoryGuid = @PointHistoryGuid,
			StartDate = @StartDate,
	...
	BEGIN CATCH
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: usp_PointHistoryUpdateByUserSite' + CHAR(13)+CHAR(10)                  
