/*
	DROP PROCEDURE [dbo].[usp_GetPersonnelEnumerateByRole_SortByCompany]

	EXEC [dbo].[usp_GetPersonnelEnumerateByRole_SortByCompany] 'AD74B677-F294-4BF8-8861-30D6B424ADC6', 2

*/



CREATE PROCEDURE [dbo].[usp_GetPersonnelEnumerateByRole_SortByCompany]
(
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored Procedure: [dbo].[usp_GetPersonnelEnumerateByRole_SortByCompany] 
	-- Author: Shawn Marlin
	...
	BEGIN TRY	
		...
		ORDER BY b.CompanyGuid,b.PersonID ASC
	END TRY
	BEGIN CATCH  
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: [dbo].usp_GetPersonnelEnumerateByRole_SortByCompany' + CHAR(13)+CHAR(10)                  
