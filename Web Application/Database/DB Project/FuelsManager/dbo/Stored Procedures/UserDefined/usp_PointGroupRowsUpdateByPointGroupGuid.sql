CREATE PROCEDURE [dbo].[usp_PointGroupRowsUpdateByPointGroupGuid]
...
BEGIN
	...
	BEGIN TRY
		...
		UPDATE tblPointGroupRows
			SET RowsDefinition = @RowsDefinition,
			SiteGuid = @SiteGuid,
	...
	BEGIN CATCH
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: usp_PointGroupRowsUpdateByPointGroupGuid' + CHAR(13)+CHAR(10)                  
