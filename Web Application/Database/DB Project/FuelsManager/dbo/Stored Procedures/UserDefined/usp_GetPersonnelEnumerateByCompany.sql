/*
	DROP PROCEDURE [dbo].[usp_GetPersonnelEnumerateByCompany]

	EXEC [dbo].[usp_GetPersonnelEnumerateByCompany] 'AD74B677-F294-4BF8-8861-30D6B424ADC6', 'C31EA259-DB6F-4324-BC0E-AC04675AAC54'

*/



CREATE PROCEDURE [dbo].[usp_GetPersonnelEnumerateByCompany]
(
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored Procedure: [dbo].[usp_GetPersonnelEnumerateByCompany] 
	-- Author: Shawn Marlin
	...
	-- 2. @CompanyGuid: Limit results to Personnel that have the specific company specified.
	...
	BEGIN CATCH  
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: [dbo].usp_GetPersonnelEnumerateByCompany' + CHAR(13)+CHAR(10)                  
