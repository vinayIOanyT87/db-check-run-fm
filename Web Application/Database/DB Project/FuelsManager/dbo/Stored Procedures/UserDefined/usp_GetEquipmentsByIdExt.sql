...
/*
	EXEC [dbo].[usp_GetEquipmentsByIdExt] NULL, NULL
	EXEC [dbo].[usp_GetEquipmentsByIdExt] '00000000-0000-0000-0000-000000000001', NULL
	EXEC [dbo].[usp_GetEquipmentsByIdExt] NULL, 'HBEquipment1'
	EXEC [dbo].[usp_GetEquipmentsByIdExt] 'F4761A16-AB2F-41EE-B6FA-D17658DF2602', 'HBEquipment1'
	EXEC [dbo].[usp_GetEquipmentsByIdExt] 'B7BD440B-674F-46F6-977A-CEFC540B1A90', NULL
	EXEC [dbo].[usp_GetEquipmentsByIdExt] 'B7BD440B-674F-46F6-977A-CEFC540B1A90', 'HBEquipment1'
	
*/

CREATE PROCEDURE [dbo].[usp_GetEquipmentsByIdExt]
(
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored Procedure: [map].[usp_GetEquipmentsByIdExt] 
	...
	-- 5. This extended version of the GetEquipmentsById query extends the resultset to include a larger set of related attributes of the Equipment entity.
	------------------------------------------------------------------------------------------------------
	BEGIN TRY	

		SELECT a.MasterRecordGuid, a.AssignedFromSiteGuid, h.Id AssignedFromSiteId, a.AssignedToSiteGuid, i.Id AssignedToSiteId, b.*, c.ID AS CompanyID, c.Name, c.Address1, c.City, c.State, d.EqTypeName, d.LookupEquipmentTypeIndex, d.Capacity, 
		...
		LEFT JOIN tblEquipmentMaintenanceLog e ON e.EquipmentGuid = b.EquipmentGuid  
		LEFT JOIN tblTestSetEquipmentResults f ON f.EquipmentGuid = b.EquipmentGuid  
		LEFT JOIN 
		(
		...
		ON g.EquipmentGuid = b.EquipmentGuid  
		INNER JOIN tblSites h
		ON h.SiteGuid = a.AssignedFromSiteGuid
		INNER JOIN tblSites i
		ON i.SiteGuid = a.AssignedToSiteGuid
	...
	BEGIN CATCH  
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: [dbo].usp_GetEquipmentsByIdExt' + CHAR(13)+CHAR(10)                  
