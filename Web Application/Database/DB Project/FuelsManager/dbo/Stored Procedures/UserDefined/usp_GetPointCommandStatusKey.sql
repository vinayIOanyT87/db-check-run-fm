CREATE PROCEDURE [dbo].[usp_GetPointCommandStatusKey]
(
...
BEGIN
	...
	BEGIN TRY
	 ...
	 SELECT y.CommandStatusElementList.value('./Key[1]', 'nvarchar(255)') as [Key]
		FROM (
		...
		AND y.CommandStatusElementList.exist('./Value[text()=sql:variable("@Value")]') = 1
	END TRY
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: usp_GetPointCommandStatusKey' + CHAR(13)+CHAR(10)                  
