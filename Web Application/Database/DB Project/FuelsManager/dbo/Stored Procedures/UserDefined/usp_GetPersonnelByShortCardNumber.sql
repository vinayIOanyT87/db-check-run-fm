...
/*
	DROP PROCEDURE [dbo].[usp_GetPersonnelByShortCardNumber]

	EXEC [dbo].[usp_GetPersonnelByShortCardNumber] 'AD74B677-F294-4BF8-8861-30D6B424ADC6', '41646', '00000', 0
	EXEC [dbo].[usp_GetPersonnelByShortCardNumber] 'AD74B677-F294-4BF8-8861-30D6B424ADC6', '41646', '00000', 1

*/



CREATE PROCEDURE [dbo].[usp_GetPersonnelByShortCardNumber]
(
	@TargetSiteGuid uniqueidentifier, @ShortCardNumber1 nvarchar(30),@ShortCardNumber2 nvarchar(30), @InTransaction bit
)
AS
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored Procedure: [dbo].[usp_GetPersonnelByShortCardNumber] 
	-- Author: Shawn Marlin
	...
	-- 2. @ShortCardNumber1: Limit the results to Personnel that have an ShortCardNumber value that correspond to the  @ShortCardNumber1 value
	-- 3. @ShortCardNumber2: Limit the results to Personnel that have an ShortCardNumber value not equal to the  @ShortCardNumber2 value.  This seems redundant, but was in the code
	-- 3. @InTransaction: Specifies whether to use a lock.
	-- 3. This stored procedure replaces the PersonnelClass.SelectByShortCardNumberSQL inline SQL.
	...
	BEGIN
		...
		WHERE b.ShortCardNumber = @ShortCardNumber1 AND b.ShortCardNumber <> @ShortCardNumber2
	END
	ELSE
	BEGIN
		SELECT b.*, 
	...
	BEGIN CATCH  
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: [dbo].usp_GetPersonnelByShortCardNumber' + CHAR(13)+CHAR(10)                  
