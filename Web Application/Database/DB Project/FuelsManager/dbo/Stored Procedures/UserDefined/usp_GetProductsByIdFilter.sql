...
/*
	EXEC [dbo].[usp_GetProductsByIdFilter] '00000000-0000-0000-0000-000000000001', NULL
	EXEC [dbo].[usp_GetProductsByIdFilter] '00000000-0000-0000-0000-000000000001', '%HBProduct%'

*/



CREATE PROCEDURE [dbo].[usp_GetProductsByIdFilter]
(
	@TargetSiteGuid uniqueidentifier, @ProductIDFilter nvarchar(255), @HideHiddenProducts BIT = 0
)
AS
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored Procedure: [dbo].[usp_GetProductsByIdFilter] 
	...
	-- 2. @ProductIDFilter: Limit the results to Products that have an ID value that contains the @ProductIdString value
	-- 3. @HideHiddenProducts: If true (1), only products with a NULL HiddenDate will be returned
	-- 4. This stored procedure replaces the ProductClass.EnumerateByFilterSQL inline SQL.
	...
	BEGIN TRY	
		...
		WHERE ((@ProductIDFilter IS NULL) OR (b.ProductID LIKE (@ProductIDFilter)))
	...
	BEGIN CATCH  
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: [dbo].usp_GetProductsByIdFilter' + CHAR(13)+CHAR(10)                  
