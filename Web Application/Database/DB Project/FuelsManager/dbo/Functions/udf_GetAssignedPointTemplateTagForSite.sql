CREATE FUNCTION [dbo].[udf_GetAssignedPointTemplateTagForSite](
...
BEGIN
	...
	INSERT INTO @tblPointTemplateList 
		SELECT [map].[tblEntityPointTemplateToSite].[PointTemplateToSiteGuid]
                , [dbo].[tblPointTemplateTag].[PointTemplateTagGuid]
		...
		INNER JOIN [dbo].[tblPointTemplateTag]
				ON [dbo].[tblPointTemplateTag].[PointTemplateGuid] = [dbo].[tblPointTemplate].[PointTemplateGuid]
