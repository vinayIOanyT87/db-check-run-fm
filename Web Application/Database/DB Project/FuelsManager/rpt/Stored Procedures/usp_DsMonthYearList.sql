...
BEGIN
	...
	IF(MONTH(@EndDate) = 1)
		INSERT INTO @MonthYear (MonthYearID) VALUES ('Jan ' + CONVERT(nvarchar,YEAR(@EndDate),4))
	ELSE IF(MONTH(@EndDate) = 2)
		INSERT INTO @MonthYear (MonthYearID) VALUES ('Feb ' + CONVERT(nvarchar,YEAR(@EndDate),4))
	ELSE IF(MONTH(@EndDate) = 3)
		INSERT INTO @MonthYear (MonthYearID) VALUES ('Mar ' + CONVERT(nvarchar,YEAR(@EndDate),4))
	ELSE IF(MONTH(@EndDate) = 4)
		INSERT INTO @MonthYear (MonthYearID) VALUES ('Apr ' + CONVERT(nvarchar,YEAR(@EndDate),4))
	...
	ELSE IF(MONTH(@EndDate) = 6)
		INSERT INTO @MonthYear (MonthYearID) VALUES ('Jun ' + CONVERT(nvarchar,YEAR(@EndDate),4))
	ELSE IF(MONTH(@EndDate) = 7)
		INSERT INTO @MonthYear (MonthYearID) VALUES ('Jul ' + CONVERT(nvarchar,YEAR(@EndDate),4))
	ELSE IF(MONTH(@EndDate) = 8)
		INSERT INTO @MonthYear (MonthYearID) VALUES ('Aug ' + CONVERT(nvarchar,YEAR(@EndDate),4))
	ELSE IF(MONTH(@EndDate) = 9)
		INSERT INTO @MonthYear (MonthYearID) VALUES ('Sep ' + CONVERT(nvarchar,YEAR(@EndDate),4))
	ELSE IF(MONTH(@EndDate) = 10)
		INSERT INTO @MonthYear (MonthYearID) VALUES ('Oct ' + CONVERT(nvarchar,YEAR(@EndDate),4))
	ELSE IF(MONTH(@EndDate) = 11)
		INSERT INTO @MonthYear (MonthYearID) VALUES ('Nov ' + CONVERT(nvarchar,YEAR(@EndDate),4))
	ELSE IF(MONTH(@EndDate) = 12)
		INSERT INTO @MonthYear (MonthYearID) VALUES ('Dec ' + CONVERT(nvarchar,YEAR(@EndDate),4))
