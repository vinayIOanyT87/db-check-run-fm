CREATE TABLE [fmaudit].[tblSitesShadow](
	[ID] nvarchar (30) NULL
...
,	[_AuditEventSequence] tinyint NULL CONSTRAINT DF_tblSitesShadow_AuditEventSequence DEFAULT 0
,	[_AuditSiteGuid] uniqueidentifier NULL
,	[_AuditSessionGuid] uniqueidentifier NULL
,	[_AuditUserID] udtUserID NULL
,	[_AuditSessionTokenID] uniqueidentifier NULL
,	[_AuditCreatedDate] datetimeoffset(7) NULL CONSTRAINT DF_tblSitesShadow_AuditCreatedDate DEFAULT sysdatetimeoffset()
,	[_AuditGUID] uniqueidentifier NOT NULL CONSTRAINT DF_tblSitesShadow_AuditGUID DEFAULT newid()
...
GO
CREATE NONCLUSTERED INDEX [IX_tblSitesShadow_AuditGUID] ON [fmaudit].[tblSitesShadow](_AuditGUID ASC)