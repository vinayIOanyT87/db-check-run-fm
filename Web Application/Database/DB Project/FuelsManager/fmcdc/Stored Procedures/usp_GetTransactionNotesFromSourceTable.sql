/*
	DROP PROCEDURE [fmcdc].[usp_GetTransactionNotesFromSourceTable]
*/
CREATE PROCEDURE [fmcdc].[usp_GetTransactionNotesFromSourceTable]
(
	@startDate datetime,
	@beginIndex int,
	@endIndex int,
...
BEGIN
------------------------------------------------------------------------------------------------------
-- Stored procedure: [fmcdc].[usp_GetTransactionNotesFromSourceTable]
-- Author: Hansraj Bapoo
-- Version/Date: 1.0.003 / 2012-07-13 14:21:10.4470770 -04:00
-- Purpose: Retrieves all the records from tblTransactionNotes for which the UpdatedDate is on or greater a given date, and for 
...
------------------------------------------------------------------------------------------------------
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: [fmcdc].[usp_GetTransactionNotesFromSourceTable]' + CHAR(13)+CHAR(10)                  
