/*
	DROP PROCEDURE [fmcdc].[usp_GetTransactionUserDataFromSourceTable]
*/
CREATE PROCEDURE [fmcdc].[usp_GetTransactionUserDataFromSourceTable]
(
	@startDate datetime,
	@beginIndex int,
	@endIndex int,
...
BEGIN
------------------------------------------------------------------------------------------------------
-- Stored procedure: [fmcdc].[usp_GetTransactionUserDataFromSourceTable]
-- Author: Hansraj Bapoo
-- Version/Date: 1.0.003 / 2012-07-13 14:21:10.4470770 -04:00
-- Purpose: Retrieves all the records from tblTransactionUserData for which the UpdatedDate is on or greater a given date, and for 
...
------------------------------------------------------------------------------------------------------
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: [fmcdc].[usp_GetTransactionUserDataFromSourceTable]' + CHAR(13)+CHAR(10)                  
