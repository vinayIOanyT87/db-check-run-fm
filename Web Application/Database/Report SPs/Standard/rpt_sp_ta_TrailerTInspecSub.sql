...
If exists (Select * From dbo.sysobjects Where id = object_id(N'dbo.[rpt_sp_ta_TrailerInspecLicenTInspecSub]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
Drop Procedure dbo.[rpt_sp_ta_TrailerInspecLicenTInspecSub]
GO


CREATE PROCEDURE [dbo].[rpt_sp_ta_TrailerInspecLicenTInspecSub] 
 /*=============================================
 Author:	 			UNKNOWN
 Create date: 			
 Description:			Test & Inspections Subreport to Trailer Report
 Main Report:			rpt_sp_ta_TrailerInspectionLicenseReport
						
 Version:				7.5.1.1
 Execution:				
				execute rpt_sp_ta_TrailerInspecLicenTInspecSub 1,1,2,'530',90
...
GRANT EXECUTE ON dbo.[rpt_sp_ta_TrailerInspecLicenTInspecSub] TO [public]
GO
