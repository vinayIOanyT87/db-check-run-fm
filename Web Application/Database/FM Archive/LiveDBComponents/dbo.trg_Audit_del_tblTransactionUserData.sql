IF  EXISTS (SELECT * FROM sys.triggers WHERE object_id = OBJECT_ID(N'[dbo].[trg_Audit_del_tblTransactionUserData]')) 
	DROP TRIGGER [dbo].[trg_Audit_del_tblTransactionUserData]
GO
