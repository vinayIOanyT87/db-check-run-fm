/*
	...
	EXEC [archive].[usp_GetTransactionPIDX] '2015-08-01', 60000, 80000
	EXEC [archive].[usp_GetTransactionPIDX] '2015-08-01', NULL, NULL

*/
CREATE PROCEDURE [archive].[usp_GetTransactionPIDX]
(
	@cutOffDate date,
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [archive].[usp_GetTransactionPIDX]
	-- Author: Hansraj Bapoo
	-- Version/Date: 1.0.003 / 2012-07-13 14:21:10.4470770 -04:00
	-- Purpose: Retrieves data from the dbo.tblTransactionPIDX table up to a given cut-off date.
	-- Notes:
	-- 1. @cutOffDate: Date up to which data must be fetched from the dbo.tblTransactionPIDX table.
	...
	BEGIN TRY
		...
		SELECT a.*, CONVERT(BigInt, a._RowVersion) RowVersionInt FROM dbo.tblTransactionPIDX a WITH (NOLOCK)
