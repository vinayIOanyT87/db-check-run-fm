/*
	...
	EXEC [archive].[usp_GetExportResultDetails] '2015-08-01', 60000, 80000
	EXEC [archive].[usp_GetExportResultDetails] '2015-08-01', NULL, NULL

*/
CREATE PROCEDURE [archive].[usp_GetExportResultDetails]
(
	@cutOffDate date,
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [archive].[usp_GetExportResultDetails]
	-- Author: Hansraj Bapoo
	-- Version/Date: 1.0.003 / 2012-07-13 14:21:10.4470770 -04:00
	-- Purpose: Retrieves data from the dbo.tblExportResultDetails table up to a given cut-off date.
	-- Notes:
	-- 1. @cutOffDate: Date up to which data must be fetched from the dbo.tblExportResultDetails table.
	...
	BEGIN TRY
		...
		SELECT a.*, CONVERT(BigInt, a._RowVersion) RowVersionInt FROM dbo.tblExportResultDetails a WITH (NOLOCK)
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: [archive].[usp_GetExportResultDetails]' + CHAR(13)+CHAR(10)                  
