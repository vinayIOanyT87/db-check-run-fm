/*
	...
	EXEC [archive].[usp_PurgeProcessedAlarmAndEventLogRecords] 1000, 2000

*/
CREATE PROCEDURE [archive].[usp_PurgeProcessedAlarmAndEventLogRecords]
(
...
BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [archive].[usp_PurgeProcessedAlarmAndEventLogRecords]
	-- Author: Hansraj Bapoo
	-- Version/Date: 1.0.003 / 2012-07-13 14:21:10.4470770 -04:00
	-- Purpose: Delete a batch of the AlarmAndEventLog records that are referenced in the archive.tblAlarmAndEventLastProcessedRecords table.
	-- Notes:
	...
	BEGIN TRY		
		...
		DELETE a
		FROM [dbo].[tblAlarmAndEventLog] a
		INNER JOIN [archive].[tblAlarmAndEventLogLastProcessedRecords] b
		ON b.RecordIndex = a.SequenceNumber
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: [archive].[usp_PurgeProcessedAlarmAndEventLogRecords]' + CHAR(13)+CHAR(10)                  
