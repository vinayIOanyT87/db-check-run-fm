namespace MirgrationToolProcessing.Mapping
{
    ...
    public abstract class FootnoteMappingBase
    {
        #region Constructors
        /// <summary>
        /// This is the default constructor
        /// </summary>
        public FootnoteMappingBase()
        {
            this.Init();
        }
        #endregion
        ...
        public abstract void PerformMapping(FootnoteBaseDo footNoteDo, MigrationDatabaseDAClass migrationDA);
        #endregion
