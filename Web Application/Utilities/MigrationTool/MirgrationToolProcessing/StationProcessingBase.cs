namespace MirgrationToolProcessing
{
    ...
    public abstract class StationProcessingBase
    {
        protected MigrationDatabaseDAClass migrationDA;
        protected MigrationDatabaseDAClass migrationTargetDA;

        #region Constructors
        /// <summary>
        /// This is the default constructor
        /// </summary>
        public StationProcessingBase(DbConfigurationDO dbConfigurationDo)
        {
            this.Init();
