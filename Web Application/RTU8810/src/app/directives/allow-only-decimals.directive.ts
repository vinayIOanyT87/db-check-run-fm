...
@Directive({
  selector: '[appAllowOnlyDecimals]'
})
export class AllowOnlyDecimalsDirective {
  ...
  private specialKeys: Array<string> = [ 'Backspace', 'Tab', 'Enter', 'Escape', 'End', 'Home', 'ArrowLeft', 'Left', 'ArrowRight', 'Right', 'ArrowUp', 'Up', 'ArrowDown', 'Down', 'Delete', 'Del', 'Copy' ];
