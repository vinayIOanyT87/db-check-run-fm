...
namespace OPCWebApp.ScullyOPCWebApp
{
	...
	/// </summary>
	public partial class PortsForm : ScullyFormBase, IMenuDiscovery
    {
        /// <summary>
        ...
        public List<FMMenuItem> GetMenuItems(SecurityClass security, bool siteGroup, ushort word1, ushort word2, ushort useNewLicenseKey, uint options)
        {
            ...
            {
                MenuItemType = FMMenuItemType.CONFIG_SCULLY_OPC_PORTS,
                RootMenuName = "Configuration",
                CategoryName = "Scully OPC",
                ItemName = "Ports",
                NavigateUrl = "../ScullyOPCWebApp/PortsForm.aspx",
		...
		protected override void UpdateView()
		{
			...
			this.ScullyPortsFormPageSizeDropDown.SetPageSize( PortsDataGrid, Ports.Count );
		...
		private void PortsDataGrid_EditCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			Session.Remove("Port");
		...
		private void PortsDataGrid_DeleteCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			try
			{
				// Get Index
		...
		private void PortsDataGrid_PageIndexChanged(object source, System.Web.UI.WebControls.DataGridPageChangedEventArgs e)
		{
			try
			{
		...
		private void PortsDataGrid_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
		{
