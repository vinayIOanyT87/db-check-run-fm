...
<%@ Page language="c#" Codebehind="PortsForm.aspx.cs" AutoEventWireup="True" Inherits="OPCWebApp.ScullyOPCWebApp.PortsForm" %>
<%@ Register src="..\MenuBar\FMMenuBar.ascx" tagname="FMMenuBar" tagprefix="FMMenuBar" %>
<!DOCTYPE html>
<HTML>
	<HEAD>
		<title>PortsForm</title>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<TABLE id="Table1" style="Z-INDEX: 102; LEFT: 32px; WIDTH: 43.18%; POSITION: absolute; TOP: 80px; HEIGHT: 10px"
				...
				<tr>
					<TD vAlign="middle" width="498" height="36"><FMCONTROLS:FMBUTTON id="AddButton2" tabIndex="6" runat="server" CssClass="formfieldtitle" Text="Scully|Add"
							width="100px"></FMCONTROLS:FMBUTTON>&nbsp;&nbsp;
						<FMCONTROLS:FMPAGESIZEDROPDOWN id="ScullyPortsFormPageSizeDropDown" runat="server" StringPrefix="Scully"></FMCONTROLS:FMPAGESIZEDROPDOWN></TD>
				</tr>
				<TR>
				...
				<TR>
					<TD style="WIDTH: 498px; HEIGHT: 50px" vAlign="middle" width="498"><FMCONTROLS:FMBUTTON id="AddButton" runat="server" CssClass="formfieldtitle" Text="Scully|Add" Width="98px"></FMCONTROLS:FMBUTTON></TD>
				</TR>
			</TABLE>
			<asp:textbox id="SystemTextBox" style="Z-INDEX: 107; LEFT: 200px; POSITION: absolute; TOP: 40px"
				...
				CssClass="formfieldtitle" BackColor="Transparent">Scully|System:</FMCONTROLS:FMLABEL><asp:image id="Image1" style="Z-INDEX: 101; LEFT: 0px; POSITION: absolute; TOP: 0px" runat="server"
				...
				CssClass="headline" Width="336px" BackColor="Transparent">Scully|Ports Configuration</FMCONTROLS:FMLABEL>
