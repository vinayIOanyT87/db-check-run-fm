...
namespace OPCWebApp.OsdpOPCWebApp
{
	...
	public partial class PortsForm : OsdpFormBase, IMenuDiscovery
	{
        ...
        public List<FMMenuItem> GetMenuItems(SecurityClass security, bool siteGroup, ushort word1, ushort word2, ushort useNewLicenseKey, uint options)
        {
			...
			{
				MenuItemType = FMMenuItemType.CONFIG_OSDP_OPC_PORTS,
				RootMenuName = "Configuration",
				CategoryName = "OSDP OPC",
				ItemName = "Ports",
				NavigateUrl = "../OsdpOPCWebApp/PortsForm.aspx",
		...
		private void UpdateView()
		{
			...
			this.OsdpPortsFormPageSizeDropDown.SetPageSize(this.PortsDataGrid, ports.Count);
		...
		private ICollection EnumeratePorts()
		{
			...
			try
			{
				IPorts ports = (IPorts)OpcCom.Interop.CreateInstance(
					new Guid("{61cbf9b2-19af-4532-82ae-99b6e23b6efa}"),
