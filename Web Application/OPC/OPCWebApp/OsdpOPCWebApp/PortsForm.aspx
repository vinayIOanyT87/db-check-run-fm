<%@ Page language="c#" Codebehind="PortsForm.aspx.cs" AutoEventWireup="True" Inherits="OPCWebApp.OsdpOPCWebApp.PortsForm" %>
	...
	<body MS_POSITIONING="GridLayout">
        ...
        <div style="position:absolute">
			...
			<FMControls:FMLabel ID="FMLabel2" Style="z-index: 102; left: 8px; position: absolute; top: 8px" runat="server"
				CssClass="headline" Width="368px" BackColor="Transparent">Osdp|Ports Configuration</FMControls:FMLabel>
			<FMControls:FMLabel ID="FMLabel3" Style="z-index: 103; left: 32px; position: absolute; top: 40px" runat="server"
				CssClass="formfieldtitle" BackColor="Transparent">Osdp|System:</FMControls:FMLabel>
			...
			<TABLE id="Table1" style="Z-INDEX: 101; LEFT: 32px; WIDTH: 43.18%; POSITION: absolute; TOP: 80px; HEIGHT: 10px"
				...
				<tr>
					<TD width="498" height="36" vAlign="middle">
						<FMControls:FMButton width="100px" id="AddButton2" runat="server" Text="Osdp|Add" CssClass="formfieldtitle"
							tabIndex="6" />
						&nbsp;&nbsp;
						<FMControls:FMPageSizeDropDown ID="OsdpPortsFormPageSizeDropDown" StringPrefix="Osdp" runat="server" onselectedindexchanged="PageSizeDropDown_SelectedIndexChanged" />
					</TD>
				</tr>
				<TR>
					<TD style="WIDTH: 498px; HEIGHT: 10px" width="498"><FMCONTROLS:FMDatagrid id="PortsDataGrid" style="LEFT: 1px; TOP: 0px" runat="server" PageSize="12" CssClass="tabletext"
							AllowPaging="True" CellPadding="3" BorderColor="White" AllowSorting="True" BorderWidth="1px" Width="344px" GridLines="Vertical" AutoGenerateColumns="False"
							...
							<Columns>
								<asp:TemplateColumn HeaderText="Osdp|Edit">
								...
								<asp:BoundColumn DataField="ID" HeaderText="Osdp|ID">
									<HeaderStyle Wrap="False"></HeaderStyle>
									<ItemStyle Wrap="False"></ItemStyle>
									<FooterStyle Wrap="False"></FooterStyle>
								</asp:BoundColumn>
								<asp:TemplateColumn HeaderText="Osdp|Delete">
				...
				<TR>
					<TD style="WIDTH: 498px; HEIGHT: 32px" vAlign="middle" width="498"><FMCONTROLS:FMButton id="AddButton" runat="server" CssClass="formfieldtitle" Width="98px" Text="Osdp|Add"></FMCONTROLS:FMButton>
					</TD>
				</TR>
			</TABLE>
        </div>
