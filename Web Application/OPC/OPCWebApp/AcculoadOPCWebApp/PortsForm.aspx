<%@ Page language="c#" Codebehind="PortsForm.aspx.cs" AutoEventWireup="true" Inherits="OPCWebApp.AcculoadOPCWebApp.PortsForm" %>
	...
	<body MS_POSITIONING="GridLayout">
        ...
        <div style="position:absolute">
			...
			<FMControls:FMLabel ID="Label2" Style="z-index: 103; left: 8px; position: absolute; top: 8px" runat="server"
				CssClass="headline" Width="336px" BackColor="Transparent">SmithMeter|Ports Configuration</FMControls:FMLabel>

			<FMControls:FMLabel ID="Label3" Style="z-index: 104; left: 32px; position: absolute; top: 40px" runat="server"
			...
			<asp:DropDownList ID="SystemDropDownList" Style="z-index: 105; left: 240px; position: absolute; top: 40px"
				runat="server" Width="144px" CssClass="formfield" AutoPostBack="True">
			</asp:DropDownList>
			...
			<TABLE id="Table1" style="Z-INDEX: 102; LEFT: 32px; WIDTH: 43.18%; POSITION: absolute; TOP: 80px; HEIGHT: 10px"
				...
				<tr>
					<TD width="498" height="36" vAlign="middle">
						...
						&nbsp;&nbsp;
						<FMControls:FMPageSizeDropDown ID="AcculoadPortsFormPageSizeDropDown" StringPrefix="SmithMeter" runat="server" />
					</TD>
				</tr>
				<TR>
					<TD style="WIDTH: 498px; HEIGHT: 10px" width="498"><FMCONTROLS:FMDATAGRID id="PortsDataGrid" runat="server" BorderStyle="None" BackColor="White" AutoGenerateColumns="False"
							GridLines="Vertical" Width="344px" BorderWidth="1px" AllowSorting="True" BorderColor="White" CellPadding="3" AllowPaging="True" CssClass="tabletext"
				...
				<TR>
					<TD style="WIDTH: 498px; HEIGHT: 50px" vAlign="middle" width="498"><FMControls:FMButton id="AddButton" runat="server" Width="98px" Text="SmithMeter|Add" CssClass="formfieldtitle"></FMControls:FMButton></TD>
				</TR>
			</TABLE>
