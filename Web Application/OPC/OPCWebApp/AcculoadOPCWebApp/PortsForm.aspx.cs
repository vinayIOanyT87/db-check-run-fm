...
namespace OPCWebApp.AcculoadOPCWebApp
{
	...
	/// </summary>
	public class PortsForm :	AcculoadFormBase, IMenuDiscovery
	{
		protected FMDataGrid PortsDataGrid;
		protected FMButton AddButton;
		protected FMLabel Label3;
		protected Image Image1;
		protected FMLabel Label2;
		protected FMButton AddButton2;
		protected FMPageSizeDropDown AcculoadPortsFormPageSizeDropDown;
        ...
        public List<FMMenuItem> GetMenuItems(SecurityClass security, bool siteGroup, ushort word1, ushort word2, ushort useNewLicenseKey, uint options)
        {
			...
			{
				MenuItemType = FMMenuItemType.CONFIG_SMITH_METER_OPC_PORTS,
				RootMenuName = "Configuration",
				CategoryName = "Smith Meter OPC",
				ItemName = "Ports",
				NavigateUrl = "../AcculoadOPCWebApp/PortsForm.aspx",
		...
		protected override void UpdateView()
		{
			...
			this.AcculoadPortsFormPageSizeDropDown.SetPageSize( this.PortsDataGrid, ports.Count );
		...
		private ICollection EnumeratePorts()
		{
			...
			try
			{
				IPorts ports=(IPorts) OpcCom.Interop.CreateInstance(
					...
					this.Session["SmithMeterSystem"] as string,
		    ...
		    portDataTable.Columns.Add("Index",typeof(int));
		...
		{    
			...
			this.AcculoadPortsFormPageSizeDropDown.SelectedIndexChanged += new System.EventHandler(this.PageSizeDropDown_SelectedIndexChanged);
