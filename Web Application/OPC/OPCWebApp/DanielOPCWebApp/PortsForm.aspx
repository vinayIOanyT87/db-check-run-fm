...
<%@ Page language="c#" Codebehind="PortsForm.aspx.cs" AutoEventWireup="True" Inherits="OPCWebApp.DanielOPCWebApp.PortsForm" %>
	...
	<body MS_POSITIONING="GridLayout">
        ...
        <div style="position:absolute">
			...
			<FMControls:FMLabel ID="FMLabel2" Style="z-index: 103; left: 8px; position: absolute; top: 8px" runat="server"
				CssClass="headline" Width="336px" BackColor="Transparent">Daniel|Ports Configuration</FMControls:FMLabel>
			...
			<TABLE id="Table1" style="Z-INDEX: 102; LEFT: 32px; WIDTH: 43.18%; POSITION: absolute; TOP: 80px; HEIGHT: 10px"
				...
				<tr>
					<TD vAlign="middle" width="498" height="36"><FMCONTROLS:FMBUTTON id="AddButton2" tabIndex="6" runat="server" CssClass="formfieldtitle" Text="Daniel|Add"
							width="100px"></FMCONTROLS:FMBUTTON>&nbsp;&nbsp;
						<FMCONTROLS:FMPAGESIZEDROPDOWN id="DanielPortsFormPageSizeDropDown" runat="server" StringPrefix="Daniel"></FMCONTROLS:FMPAGESIZEDROPDOWN></TD>
				</tr>
				<TR>
				...
				<TR>
					<TD style="WIDTH: 498px; HEIGHT: 50px" vAlign="middle" width="498"><FMCONTROLS:FMBUTTON id="AddButton" runat="server" CssClass="formfieldtitle" Text="Daniel|Add" Width="98px"></FMCONTROLS:FMBUTTON></TD>
				</TR>
			</TABLE>
