...
namespace OPCWebApp.DanielOPCWebApp
{
   ...
   /// </summary>
   public partial class PortsForm :	DanielFormBase, IMenuDiscovery
	{
        ...
        public List<FMMenuItem> GetMenuItems(SecurityClass security, bool siteGroup, ushort word1, ushort word2, ushort useNewLicenseKey, uint options)
        {
		    ...
		    //{
		    //	MenuItemType = FMMenuItemType.CONFIG_DANIEL_OPC_PORTS,
		    //	RootMenuName = "Configuration",
		    //	CategoryName = "Daniel OPC",
		    //	ItemName = "Ports",
		    //	NavigateUrl = "../DanielOPCWebApp/PortsForm.aspx",
		...
		protected override void UpdateView()
		{
			...
			this.DanielPortsFormPageSizeDropDown.SetPageSize( this.PortsDataGrid, ports.Count );
		...
		private ICollection EnumeratePorts()
		{
			...
			try
			{
				IPorts ports=(IPorts) OpcCom.Interop.CreateInstance(
					new Guid("{265331A0-40D0-4DEC-B614-1A21CDC5CC1F}"),
