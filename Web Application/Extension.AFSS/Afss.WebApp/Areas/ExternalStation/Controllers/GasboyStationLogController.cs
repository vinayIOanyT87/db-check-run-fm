...
namespace FuelsManager.Afss.WebApp.Areas.ExternalStation.Controllers
{
    ...
    using FuelsManager.Afss.WebApp.Areas.ExternalStation.Models;
    ...
    public class GasboyStationLogController : FMBaseController, IDataDictionary
    {
        ...
        public ActionResult ExternalStationLogSummaryIndex(GasboyStationLogSummaryModel model)
        {
            try
            {
                model.ExternalStations = GasboyChannelHelper.MakeCall<IGasboyStations, List<GasboyStation>>(externalStationsService => externalStationsService.Enumerate(this.Security));
        ...
        [NonAction]
        private List<GasboyStationLog> GetExternalStationLogs(GasboyStationLogSummaryModel model)
        {
