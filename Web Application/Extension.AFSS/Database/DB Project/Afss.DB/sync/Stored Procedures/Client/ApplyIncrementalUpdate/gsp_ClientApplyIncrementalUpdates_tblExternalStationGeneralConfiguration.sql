...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblExternalStationGeneralConfiguration]
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM [dbo].[tblExternalStationGeneralConfiguration]
    ...
    BEGIN
        ;   WITH existingData AS (
            ...
            USING (SELECT @ExternalStationGeneralConfigurationGuid,@SiteGuid,@RetailSaleTransactionAliasGuid,@DownloadTransactionsIntervalMinutes,@DownloadEventsIntervalMinutes,@CreatedBy,@CreatedDate,@UpdatedBy,@UpdatedDate
            ...
            WHEN MATCHED AND (@sync_force_write = 1 
                ...
                UPDATE SET [SiteGuid] = remoteChanges.[SiteGuid]
                       ,[RetailSaleTransactionAliasGuid] = remoteChanges.[RetailSaleTransactionAliasGuid]
                       ,[DownloadTransactionsIntervalMinutes] = remoteChanges.[DownloadTransactionsIntervalMinutes]
                       ,[DownloadEventsIntervalMinutes] = remoteChanges.[DownloadEventsIntervalMinutes]
            ...
            WHEN NOT MATCHED THEN
                INSERT ([ExternalStationGeneralConfigurationGuid],[SiteGuid],[RetailSaleTransactionAliasGuid],[DownloadTransactionsIntervalMinutes],[DownloadEventsIntervalMinutes],[CreatedBy],[CreatedDate],[UpdatedBy],[UpdatedDate])
                    VALUES (@ExternalStationGeneralConfigurationGuid,@SiteGuid,@RetailSaleTransactionAliasGuid,@DownloadTransactionsIntervalMinutes,@DownloadEventsIntervalMinutes,@CreatedBy,@CreatedDate,@UpdatedBy,@UpdatedDate)
            ;
    END
