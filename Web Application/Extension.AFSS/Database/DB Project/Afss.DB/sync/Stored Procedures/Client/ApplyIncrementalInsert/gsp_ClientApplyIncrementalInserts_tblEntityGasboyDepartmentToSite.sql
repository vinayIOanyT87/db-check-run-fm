...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalInserts_tblEntityGasboyDepartmentToSite]
...
AS
BEGIN
    ;   MERGE [map].[tblEntityGasboyDepartmentToSite] AS existingData
        USING (SELECT @GasboyDepartmentToSiteGuid 'GasboyDepartmentToSiteGuid',@GasboyDepartmentGuid 'GasboyDepartmentGuid',@SiteGuid 'SiteGuid',@AssignedFromSiteGuid 'AssignedFromSiteGuid',@CreatedBy 'CreatedBy',@CreatedDate 'CreatedDate',@UpdatedBy 'UpdatedBy',@UpdatedDate 'UpdatedDate'
        ...
        WHEN MATCHED AND (remoteChanges.CreatedDate >= existingData.CreatedDate OR remoteChanges.UpdatedDate >= existingData.UpdatedDate) THEN
            UPDATE SET [GasboyDepartmentGuid] = remoteChanges.[GasboyDepartmentGuid]
