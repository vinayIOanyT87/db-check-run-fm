...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalInserts_tblExternalStationLogType]
...
AS
BEGIN
    ;   MERGE [lookup].[tblExternalStationLogType] AS existingData
        USING (SELECT @ExternalStationLogTypeIndex 'ExternalStationLogTypeIndex',@ExternalStationLogTypeCode 'ExternalStationLogTypeCode',@ExternalStationLogTypeName 'ExternalStationLogTypeName',@ExternalStationLogTypeGuid 'ExternalStationLogTypeGuid',@CreatedBy 'CreatedBy',@CreatedDate 'CreatedDate',@UpdatedBy 'UpdatedBy',@UpdatedDate 'UpdatedDate'
        ...
        WHEN MATCHED AND (remoteChanges.CreatedDate > existingData.CreatedDate OR remoteChanges.UpdatedDate > existingData.UpdatedDate) THEN
            UPDATE SET [ExternalStationLogTypeCode] = remoteChanges.[ExternalStationLogTypeCode]
                       ,[ExternalStationLogTypeName] = remoteChanges.[ExternalStationLogTypeName]
                       ,[ExternalStationLogTypeGuid] = remoteChanges.[ExternalStationLogTypeGuid]
