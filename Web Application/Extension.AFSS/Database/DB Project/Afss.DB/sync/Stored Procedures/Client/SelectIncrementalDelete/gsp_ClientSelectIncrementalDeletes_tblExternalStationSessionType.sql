...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblExternalStationSessionType]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblExternalStationSessionType) CT.PK_ExternalStationSessionTypeIndex 'ExternalStationSessionTypeIndex', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblExternalStationSessionType] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_ExternalStationSessionTypeIndex 'ExternalStationSessionTypeIndex', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblExternalStationSessionType] CT
            WHERE 1=2
    END
