...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblGasboyErrorCode]
...
AS
BEGIN
    DELETE [lookup].[tblGasboyErrorCode]  
        ...
        WHERE GasboyErrorCodeIndex = @GasboyErrorCodeIndex
