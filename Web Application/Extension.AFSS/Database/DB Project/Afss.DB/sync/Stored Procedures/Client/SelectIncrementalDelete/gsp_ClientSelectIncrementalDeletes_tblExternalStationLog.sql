...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblExternalStationLog]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblExternalStationLog) CT.PK_ExternalStationLogGuid 'ExternalStationLogGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblExternalStationLog] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_ExternalStationLogGuid 'ExternalStationLogGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblExternalStationLog] CT
            WHERE 1=2
    END
