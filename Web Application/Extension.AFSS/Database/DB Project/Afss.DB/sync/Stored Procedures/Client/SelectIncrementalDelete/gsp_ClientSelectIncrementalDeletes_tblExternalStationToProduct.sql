...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblExternalStationToProduct]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblExternalStationToProduct) CT.PK_ExternalStationToProductGuid 'ExternalStationToProductGuid', CT.DeletedRowVersion '_RowVersion'
    ...
    ELSE
    BEGIN
        SELECT CT.PK_ExternalStationToProductGuid 'ExternalStationToProductGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblExternalStationToProduct] CT
            WHERE 1=2
    END
