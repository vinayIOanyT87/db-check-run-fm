...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblGasboyFleet]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblGasboyFleet) CT.PK_GasboyFleetGuid 'GasboyFleetGuid', CT.DeletedRowVersion '_RowVersion'
    ...
    ELSE
    BEGIN
        SELECT CT.PK_GasboyFleetGuid 'GasboyFleetGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblGasboyFleet] CT
            WHERE 1=2
    END
