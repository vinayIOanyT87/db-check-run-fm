...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblGasboyTwoStageDriverValidationType]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblGasboyTwoStageDriverValidationType) CT.PK_GasboyTwoStageDriverValidationTypeIndex 'GasboyTwoStageDriverValidationTypeIndex', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblGasboyTwoStageDriverValidationType] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_GasboyTwoStageDriverValidationTypeIndex 'GasboyTwoStageDriverValidationTypeIndex', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblGasboyTwoStageDriverValidationType] CT
            WHERE 1=2
    END
