...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblEntityExternalStationToSite]
...
AS
BEGIN
    DELETE [map].[tblEntityExternalStationToSite]  
        ...
        WHERE ExternalStationToSiteGuid = @ExternalStationToSiteGuid
