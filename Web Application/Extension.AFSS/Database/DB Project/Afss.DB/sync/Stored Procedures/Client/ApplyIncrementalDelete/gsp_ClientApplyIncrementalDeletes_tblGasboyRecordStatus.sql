...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblGasboyRecordStatus]
...
AS
BEGIN
    DELETE [lookup].[tblGasboyRecordStatus]  
        ...
        WHERE GasboyRecordStatusIndex = @GasboyRecordStatusIndex
