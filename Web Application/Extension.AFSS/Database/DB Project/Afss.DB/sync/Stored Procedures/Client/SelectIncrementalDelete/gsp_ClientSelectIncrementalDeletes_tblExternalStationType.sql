...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblExternalStationType]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblExternalStationType) CT.PK_ExternalStationTypeIndex 'ExternalStationTypeIndex', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblExternalStationType] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_ExternalStationTypeIndex 'ExternalStationTypeIndex', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblExternalStationType] CT
            WHERE 1=2
    END
