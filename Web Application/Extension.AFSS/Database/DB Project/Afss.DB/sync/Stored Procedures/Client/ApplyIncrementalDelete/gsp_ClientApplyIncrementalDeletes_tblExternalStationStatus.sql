...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblExternalStationStatus]
...
AS
BEGIN
    DELETE [lookup].[tblExternalStationStatus]  
        ...
        WHERE ExternalStationStatusIndex = @ExternalStationStatusIndex
