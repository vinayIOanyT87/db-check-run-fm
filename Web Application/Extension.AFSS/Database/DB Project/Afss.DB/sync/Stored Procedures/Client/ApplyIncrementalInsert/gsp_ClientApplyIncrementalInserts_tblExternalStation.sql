...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalInserts_tblExternalStation]
...
AS
BEGIN
    ;   MERGE [dbo].[tblExternalStation] AS existingData
        USING (SELECT @ExternalStationGuid 'ExternalStationGuid',@SiteGuid 'SiteGuid',@ID 'ID',@LookupExternalStationTypeIndex 'LookupExternalStationTypeIndex',@BillingID 'BillingID',@DownloadTransactionsAutomatically 'DownloadTransactionsAutomatically',@LookupExternalStationStatusIndex 'LookupExternalStationStatusIndex',@LastSuccessfulConnection 'LastSuccessfulConnection',@LastConnectionAttempt 'LastConnectionAttempt',@LastTransactionID 'LastTransactionID',@CreatedBy 'CreatedBy',@CreatedDate 'CreatedDate',@UpdatedBy 'UpdatedBy',@UpdatedDate 'UpdatedDate',@LastDeviceCount 'LastDeviceCount'
        ...
        WHEN MATCHED AND (remoteChanges.CreatedDate > existingData.CreatedDate OR remoteChanges.UpdatedDate > existingData.UpdatedDate) THEN
            UPDATE SET [SiteGuid] = remoteChanges.[SiteGuid]
                       ,[ID] = remoteChanges.[ID]
                       ,[LookupExternalStationTypeIndex] = remoteChanges.[LookupExternalStationTypeIndex]
                       ,[BillingID] = remoteChanges.[BillingID]
                       ,[DownloadTransactionsAutomatically] = remoteChanges.[DownloadTransactionsAutomatically]
                       ,[LookupExternalStationStatusIndex] = remoteChanges.[LookupExternalStationStatusIndex]
                       ,[LastSuccessfulConnection] = remoteChanges.[LastSuccessfulConnection]
                       ,[LastConnectionAttempt] = remoteChanges.[LastConnectionAttempt]
                       ,[LastTransactionID] = remoteChanges.[LastTransactionID]
                       ,[CreatedBy] = remoteChanges.[CreatedBy]
                       ,[CreatedDate] = remoteChanges.[CreatedDate]
                       ,[UpdatedBy] = remoteChanges.[UpdatedBy]
                       ,[UpdatedDate] = remoteChanges.[UpdatedDate]
                       ,[LastDeviceCount] = remoteChanges.[LastDeviceCount]
        ...
        WHEN NOT MATCHED THEN
            INSERT ([ExternalStationGuid],[SiteGuid],[ID],[LookupExternalStationTypeIndex],[BillingID],[DownloadTransactionsAutomatically],[LookupExternalStationStatusIndex],[LastSuccessfulConnection],[LastConnectionAttempt],[LastTransactionID],[CreatedBy],[CreatedDate],[UpdatedBy],[UpdatedDate],[LastDeviceCount])
                VALUES (@ExternalStationGuid,@SiteGuid,@ID,@LookupExternalStationTypeIndex,@BillingID,@DownloadTransactionsAutomatically,@LookupExternalStationStatusIndex,@LastSuccessfulConnection,@LastConnectionAttempt,@LastTransactionID,@CreatedBy,@CreatedDate,@UpdatedBy,@UpdatedDate,@LastDeviceCount)
        ;
