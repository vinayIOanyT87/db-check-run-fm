...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalUpdates_tblGasboyStationGeneralConfiguration]
...
BEGIN
    ...
    END
        ...
        SELECT TOP(@sync_batch_size_tblGasboyStationGeneralConfiguration) [dbo].[tblGasboyStationGeneralConfiguration].[ExternalStationGeneralConfigurationGuid],[dbo].[tblGasboyStationGeneralConfiguration].[DefaultGasboyFleetGuid],[dbo].[tblGasboyStationGeneralConfiguration].[DefaultGasboyDepartmentGuid],[dbo].[tblGasboyStationGeneralConfiguration].[CreatedBy],[dbo].[tblGasboyStationGeneralConfiguration].[CreatedDate],[dbo].[tblGasboyStationGeneralConfiguration].[UpdatedBy],[dbo].[tblGasboyStationGeneralConfiguration].[UpdatedDate],CT.UpdatedRowVersion AS '_RowVersion'
            FROM [dbo].[tblGasboyStationGeneralConfiguration]
