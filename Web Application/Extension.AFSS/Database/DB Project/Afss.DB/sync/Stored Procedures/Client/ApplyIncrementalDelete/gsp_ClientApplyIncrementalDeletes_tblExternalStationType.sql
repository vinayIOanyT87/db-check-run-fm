...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblExternalStationType]
...
AS
BEGIN
    DELETE [lookup].[tblExternalStationType]  
        ...
        WHERE ExternalStationTypeIndex = @ExternalStationTypeIndex
