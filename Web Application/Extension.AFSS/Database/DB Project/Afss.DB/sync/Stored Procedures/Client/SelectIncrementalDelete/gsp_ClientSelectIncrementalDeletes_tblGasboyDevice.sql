...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblGasboyDevice]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblGasboyDevice) CT.PK_GasboyDeviceGuid 'GasboyDeviceGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblGasboyDevice] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_GasboyDeviceGuid 'GasboyDeviceGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblGasboyDevice] CT
            WHERE 1=2
    END
