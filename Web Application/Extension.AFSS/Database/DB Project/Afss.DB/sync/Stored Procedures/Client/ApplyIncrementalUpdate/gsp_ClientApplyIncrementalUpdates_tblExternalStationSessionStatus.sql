...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblExternalStationSessionStatus]
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM [lookup].[tblExternalStationSessionStatus]
    ...
    BEGIN
        ;   WITH existingData AS (
            ...
            USING (SELECT @ExternalStationSessionStatusIndex,@ExternalStationSessionStatusCode,@ExternalStationSessionStatusName,@ExternalStationSessionStatusGuid,@LongDescription,@CreatedBy,@CreatedDate,@UpdatedBy,@UpdatedDate
            ...
            WHEN MATCHED AND (@sync_force_write = 1 
                ...
                THEN
                UPDATE SET [ExternalStationSessionStatusCode] = remoteChanges.[ExternalStationSessionStatusCode]
                       ,[ExternalStationSessionStatusName] = remoteChanges.[ExternalStationSessionStatusName]
                       ,[ExternalStationSessionStatusGuid] = remoteChanges.[ExternalStationSessionStatusGuid]
            ...
            WHEN NOT MATCHED THEN
                INSERT ([ExternalStationSessionStatusIndex],[ExternalStationSessionStatusCode],[ExternalStationSessionStatusName],[ExternalStationSessionStatusGuid],[LongDescription],[CreatedBy],[CreatedDate],[UpdatedBy],[UpdatedDate])
                    VALUES (@ExternalStationSessionStatusIndex,@ExternalStationSessionStatusCode,@ExternalStationSessionStatusName,@ExternalStationSessionStatusGuid,@LongDescription,@CreatedBy,@CreatedDate,@UpdatedBy,@UpdatedDate)
            ;
    END
