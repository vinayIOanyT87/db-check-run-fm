...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblGasboyEventErrorClassCode]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblGasboyEventErrorClassCode) CT.PK_GasboyEventErrorClassCodeIndex 'GasboyEventErrorClassCodeIndex', CT.DeletedRowVersion '_RowVersion'
    ...
    ELSE
    BEGIN
        SELECT CT.PK_GasboyEventErrorClassCodeIndex 'GasboyEventErrorClassCodeIndex', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblGasboyEventErrorClassCode] CT
            WHERE 1=2
    END
