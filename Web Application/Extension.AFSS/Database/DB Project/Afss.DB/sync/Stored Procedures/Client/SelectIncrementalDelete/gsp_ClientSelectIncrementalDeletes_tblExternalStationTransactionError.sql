...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblExternalStationTransactionError]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblExternalStationTransactionError) CT.PK_ExternalStationTransactionErrorGuid 'ExternalStationTransactionErrorGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblExternalStationTransactionError] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_ExternalStationTransactionErrorGuid 'ExternalStationTransactionErrorGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblExternalStationTransactionError] CT
            WHERE 1=2
    END
