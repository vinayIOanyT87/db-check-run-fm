...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblGasboyDepartmentToGasboyFleet]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblGasboyDepartmentToGasboyFleet) CT.PK_GasboyDepartmentToGasboyFleetGuid 'GasboyDepartmentToGasboyFleetGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblGasboyDepartmentToGasboyFleet] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_GasboyDepartmentToGasboyFleetGuid 'GasboyDepartmentToGasboyFleetGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblGasboyDepartmentToGasboyFleet] CT
            WHERE 1=2
    END
