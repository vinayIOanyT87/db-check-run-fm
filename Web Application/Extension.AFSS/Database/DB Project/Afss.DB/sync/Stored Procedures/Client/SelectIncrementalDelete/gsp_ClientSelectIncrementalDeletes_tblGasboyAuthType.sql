...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblGasboyAuthType]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblGasboyAuthType) CT.PK_GasboyAuthTypeIndex 'GasboyAuthTypeIndex', CT.DeletedRowVersion '_RowVersion'
    ...
    ELSE
    BEGIN
        SELECT CT.PK_GasboyAuthTypeIndex 'GasboyAuthTypeIndex', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblGasboyAuthType] CT
            WHERE 1=2
    END
