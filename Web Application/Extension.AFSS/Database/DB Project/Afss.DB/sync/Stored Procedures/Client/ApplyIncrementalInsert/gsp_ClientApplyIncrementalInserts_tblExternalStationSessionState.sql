...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalInserts_tblExternalStationSessionState]
...
AS
BEGIN
    ;   MERGE [lookup].[tblExternalStationSessionState] AS existingData
        USING (SELECT @ExternalStationSessionStateIndex 'ExternalStationSessionStateIndex',@ExternalStationSessionStateCode 'ExternalStationSessionStateCode',@ExternalStationSessionStateName 'ExternalStationSessionStateName',@ExternalStationSessionStateGuid 'ExternalStationSessionStateGuid',@LongDescription 'LongDescription',@CreatedBy 'CreatedBy',@CreatedDate 'CreatedDate',@UpdatedBy 'UpdatedBy',@UpdatedDate 'UpdatedDate'
        ...
        WHEN MATCHED AND (remoteChanges.CreatedDate > existingData.CreatedDate OR remoteChanges.UpdatedDate > existingData.UpdatedDate) THEN
            UPDATE SET [ExternalStationSessionStateCode] = remoteChanges.[ExternalStationSessionStateCode]
                       ,[ExternalStationSessionStateName] = remoteChanges.[ExternalStationSessionStateName]
                       ,[ExternalStationSessionStateGuid] = remoteChanges.[ExternalStationSessionStateGuid]
        ...
        WHEN NOT MATCHED THEN
            INSERT ([ExternalStationSessionStateIndex],[ExternalStationSessionStateCode],[ExternalStationSessionStateName],[ExternalStationSessionStateGuid],[LongDescription],[CreatedBy],[CreatedDate],[UpdatedBy],[UpdatedDate])
                VALUES (@ExternalStationSessionStateIndex,@ExternalStationSessionStateCode,@ExternalStationSessionStateName,@ExternalStationSessionStateGuid,@LongDescription,@CreatedBy,@CreatedDate,@UpdatedBy,@UpdatedDate)
        ;
