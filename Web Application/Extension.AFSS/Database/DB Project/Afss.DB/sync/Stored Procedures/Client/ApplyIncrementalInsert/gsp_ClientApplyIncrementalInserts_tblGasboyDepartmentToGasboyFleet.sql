...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalInserts_tblGasboyDepartmentToGasboyFleet]
...
AS
BEGIN
    ;   MERGE [map].[tblGasboyDepartmentToGasboyFleet] AS existingData
        USING (SELECT @GasboyDepartmentToGasboyFleetGuid 'GasboyDepartmentToGasboyFleetGuid',@GasboyFleetGuid 'GasboyFleetGuid',@GasboyDepartmentGuid 'GasboyDepartmentGuid',@CreatedBy 'CreatedBy',@CreatedDate 'CreatedDate',@UpdatedBy 'UpdatedBy',@UpdatedDate 'UpdatedDate'
