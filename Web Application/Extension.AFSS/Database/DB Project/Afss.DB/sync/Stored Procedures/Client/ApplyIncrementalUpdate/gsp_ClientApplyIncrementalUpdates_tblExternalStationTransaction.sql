...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblExternalStationTransaction]
        ...
        ;   WITH existingData AS (
            ...
            WHEN MATCHED AND (@sync_force_write = 1 
                ...
                UPDATE SET [ExternalStationGuid] = remoteChanges.[ExternalStationGuid]
                       ...
                       ,[StationTransactionID] = remoteChanges.[StationTransactionID]
                       ,[RawTransactionData] = remoteChanges.[RawTransactionData]
                       ,[CreatedBy] = remoteChanges.[CreatedBy]
                       ,[CreatedDate] = remoteChanges.[CreatedDate]
                       ,[UpdatedBy] = remoteChanges.[UpdatedBy]
                       ,[UpdatedDate] = remoteChanges.[UpdatedDate]
                       ,[LookupExternalStationTransactionStatusIndex] = remoteChanges.[LookupExternalStationTransactionStatusIndex]
                       ,[LookupExternalStationTransactionFailedStatusIndex] = remoteChanges.[LookupExternalStationTransactionFailedStatusIndex]
