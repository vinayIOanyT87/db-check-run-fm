...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblEntityGasboyFleetToSite]
...
AS
BEGIN
    DELETE [map].[tblEntityGasboyFleetToSite]  
        ...
        WHERE GasboyFleetToSiteGuid = @GasboyFleetToSiteGuid
