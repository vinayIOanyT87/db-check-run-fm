-- ********************** CREATE SYNCHRONIZATION METHODS FOR tblExternalStationTransaction **********************
-- 
-- 
-- ========================================================================================
...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalInserts_tblExternalStationTransaction]
...
@sync_batch_size_tblExternalStationTransaction int,
...
BEGIN
    ...
    IF (@sync_batch_size_tblExternalStationTransaction IS NULL OR 
        (@sync_batch_size_tblExternalStationTransaction IS NOT NULL AND @sync_batch_size_tblExternalStationTransaction = 0))
    BEGIN
        SET @sync_batch_size_tblExternalStationTransaction = 2147483647;
    END

        -- Get a list of the Owned/Assigned Entities and locate any newly inserted entities
        -- and/or any new entity site assignments (if assignable).
        SELECT TOP(@sync_batch_size_tblExternalStationTransaction) [dbo].[tblExternalStationTransaction].[ExternalStationTransactionGuid],[dbo].[tblExternalStationTransaction].[ExternalStationGuid],[dbo].[tblExternalStationTransaction].[SiteGuid],[dbo].[tblExternalStationTransaction].[StationTransactionID],[dbo].[tblExternalStationTransaction].[RawTransactionData],[dbo].[tblExternalStationTransaction].[CreatedBy],[dbo].[tblExternalStationTransaction].[CreatedDate],[dbo].[tblExternalStationTransaction].[UpdatedBy],[dbo].[tblExternalStationTransaction].[UpdatedDate],[dbo].[tblExternalStationTransaction].[LookupExternalStationTransactionStatusIndex],[dbo].[tblExternalStationTransaction].[LookupExternalStationTransactionFailedStatusIndex],CT.InsertedRowVersion AS '_RowVersion'
            FROM [dbo].[tblExternalStationTransaction]
