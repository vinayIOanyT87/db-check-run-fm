...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalInserts_tblGasboyEmployeeType]
...
AS
BEGIN
    ;   MERGE [lookup].[tblGasboyEmployeeType] AS existingData
        USING (SELECT @GasboyEmployeeTypeIndex 'GasboyEmployeeTypeIndex',@GasboyEmployeeTypeCode 'GasboyEmployeeTypeCode',@GasboyEmployeeTypeName 'GasboyEmployeeTypeName',@GasboyEmployeeTypeGuid 'GasboyEmployeeTypeGuid',@CreatedBy 'CreatedBy',@CreatedDate 'CreatedDate',@UpdatedBy 'UpdatedBy',@UpdatedDate 'UpdatedDate'
        ...
        WHEN MATCHED AND (remoteChanges.CreatedDate > existingData.CreatedDate OR remoteChanges.UpdatedDate > existingData.UpdatedDate) THEN
            UPDATE SET [GasboyEmployeeTypeCode] = remoteChanges.[GasboyEmployeeTypeCode]
                       ,[GasboyEmployeeTypeName] = remoteChanges.[GasboyEmployeeTypeName]
                       ,[GasboyEmployeeTypeGuid] = remoteChanges.[GasboyEmployeeTypeGuid]
