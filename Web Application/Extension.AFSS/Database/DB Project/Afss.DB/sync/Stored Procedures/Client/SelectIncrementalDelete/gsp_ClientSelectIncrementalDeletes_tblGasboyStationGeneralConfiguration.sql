...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblGasboyStationGeneralConfiguration]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblGasboyStationGeneralConfiguration) CT.PK_ExternalStationGeneralConfigurationGuid 'ExternalStationGeneralConfigurationGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblGasboyStationGeneralConfiguration] CT
