...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblGasboyDepartment]
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM [dbo].[tblGasboyDepartment]
    ...
    BEGIN
        ;   WITH existingData AS (
                SELECT [dbo].[tblGasboyDepartment].[GasboyDepartmentGuid],[dbo].[tblGasboyDepartment].[SiteGuid],[dbo].[tblGasboyDepartment].[DepartmentCode],[dbo].[tblGasboyDepartment].[DepartmentName],[dbo].[tblGasboyDepartment].[GroupRuleName],[dbo].[tblGasboyDepartment].[PriceListName],[dbo].[tblGasboyDepartment].[LookupGasboyRecordStatusIndex],[dbo].[tblGasboyDepartment].[UsePINCodeFlag],[dbo].[tblGasboyDepartment].[PINCode],[dbo].[tblGasboyDepartment].[AuthPINFrom],[dbo].[tblGasboyDepartment].[PromptForVehiclePlateFlag],[dbo].[tblGasboyDepartment].[LookupGasboyVehiclePlateCheckTypeIndex],[dbo].[tblGasboyDepartment].[AlwaysPromptForAdditionalValidationFlag],[dbo].[tblGasboyDepartment].[CreatedBy],[dbo].[tblGasboyDepartment].[CreatedDate],[dbo].[tblGasboyDepartment].[UpdatedBy],[dbo].[tblGasboyDepartment].[UpdatedDate],[dbo].[tblGasboyDepartment].[DepartmentID]
