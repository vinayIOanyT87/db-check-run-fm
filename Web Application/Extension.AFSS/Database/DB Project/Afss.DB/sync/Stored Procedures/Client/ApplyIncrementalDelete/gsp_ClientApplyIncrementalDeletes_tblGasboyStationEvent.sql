...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblGasboyStationEvent]
...
AS
BEGIN
    DELETE [dbo].[tblGasboyStationEvent]  
        ...
        WHERE GasboyStationEventGuid = @GasboyStationEventGuid
