...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblEntityGasboyDepartmentToSite]
...
AS
BEGIN
    DELETE [map].[tblEntityGasboyDepartmentToSite]  
        ...
        WHERE GasboyDepartmentToSiteGuid = @GasboyDepartmentToSiteGuid
