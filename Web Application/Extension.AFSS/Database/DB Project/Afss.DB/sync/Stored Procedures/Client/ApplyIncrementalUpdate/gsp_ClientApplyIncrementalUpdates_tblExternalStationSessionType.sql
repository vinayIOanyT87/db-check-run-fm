...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblExternalStationSessionType]
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM [lookup].[tblExternalStationSessionType]
    ...
    BEGIN
        ;   WITH existingData AS (
            ...
            USING (SELECT @ExternalStationSessionTypeIndex,@ExternalStationSessionTypeCode,@ExternalStationSessionTypeName,@ExternalStationSessionTypeGuid,@LongDescription,@CreatedBy,@CreatedDate,@UpdatedBy,@UpdatedDate
            ...
            WHEN MATCHED AND (@sync_force_write = 1 
                ...
                THEN
                UPDATE SET [ExternalStationSessionTypeCode] = remoteChanges.[ExternalStationSessionTypeCode]
                       ,[ExternalStationSessionTypeName] = remoteChanges.[ExternalStationSessionTypeName]
                       ,[ExternalStationSessionTypeGuid] = remoteChanges.[ExternalStationSessionTypeGuid]
            ...
            WHEN NOT MATCHED THEN
                INSERT ([ExternalStationSessionTypeIndex],[ExternalStationSessionTypeCode],[ExternalStationSessionTypeName],[ExternalStationSessionTypeGuid],[LongDescription],[CreatedBy],[CreatedDate],[UpdatedBy],[UpdatedDate])
                    VALUES (@ExternalStationSessionTypeIndex,@ExternalStationSessionTypeCode,@ExternalStationSessionTypeName,@ExternalStationSessionTypeGuid,@LongDescription,@CreatedBy,@CreatedDate,@UpdatedBy,@UpdatedDate)
            ;
    END
