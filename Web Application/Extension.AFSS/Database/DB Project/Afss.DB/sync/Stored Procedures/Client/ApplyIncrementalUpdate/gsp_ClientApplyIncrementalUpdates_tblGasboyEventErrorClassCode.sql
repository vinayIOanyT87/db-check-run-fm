...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalUpdates_tblGasboyEventErrorClassCode]
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM [lookup].[tblGasboyEventErrorClassCode]
    ...
    BEGIN
        ;   WITH existingData AS (
            ...
            USING (SELECT @GasboyEventErrorClassCodeIndex,@GasboyEventErrorClassCode,@GasboyEventErrorClassCodeName,@GasboyEventErrorClassCodeGuid,@CreatedBy,@CreatedDate,@UpdatedBy,@UpdatedDate
            ...
            WHEN MATCHED AND (@sync_force_write = 1 
                ...
                THEN
                UPDATE SET [GasboyEventErrorClassCode] = remoteChanges.[GasboyEventErrorClassCode]
                       ,[GasboyEventErrorClassCodeName] = remoteChanges.[GasboyEventErrorClassCodeName]
                       ,[GasboyEventErrorClassCodeGuid] = remoteChanges.[GasboyEventErrorClassCodeGuid]
