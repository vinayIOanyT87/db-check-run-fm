...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblExternalStation]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblExternalStation) CT.PK_ExternalStationGuid 'ExternalStationGuid', CT.DeletedRowVersion '_RowVersion'
