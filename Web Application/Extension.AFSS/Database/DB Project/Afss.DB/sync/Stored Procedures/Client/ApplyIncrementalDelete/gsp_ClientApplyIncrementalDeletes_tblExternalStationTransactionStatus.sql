...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblExternalStationTransactionStatus]
...
AS
BEGIN
    DELETE [lookup].[tblExternalStationTransactionStatus]  
        ...
        WHERE ExternalStationTransactionStatusIndex = @ExternalStationTransactionStatusIndex
