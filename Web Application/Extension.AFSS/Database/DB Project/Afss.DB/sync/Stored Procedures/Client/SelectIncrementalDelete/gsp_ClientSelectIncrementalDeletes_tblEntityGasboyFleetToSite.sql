...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientSelectIncrementalDeletes_tblEntityGasboyFleetToSite]
...
BEGIN
    ...
    BEGIN 
        ...
        SELECT TOP(@sync_batch_size_tblEntityGasboyFleetToSite) CT.PK_GasboyFleetToSiteGuid 'GasboyFleetToSiteGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblEntityGasboyFleetToSite] CT
    ...
    ELSE
    BEGIN
        SELECT CT.PK_GasboyFleetToSiteGuid 'GasboyFleetToSiteGuid', CT.DeletedRowVersion '_RowVersion'
            FROM [track].[tblEntityGasboyFleetToSite] CT
            WHERE 1=2
    END
