...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ClientApplyIncrementalDeletes_tblExternalStationSessionType]
...
AS
BEGIN
    DELETE [lookup].[tblExternalStationSessionType]  
        ...
        WHERE ExternalStationSessionTypeIndex = @ExternalStationSessionTypeIndex
