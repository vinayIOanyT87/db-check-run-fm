...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblGasboyEmployeeType]
...
AS
BEGIN
    DELETE [lookup].[tblGasboyEmployeeType]  
        ...
        WHERE GasboyEmployeeTypeIndex = @GasboyEmployeeTypeIndex
