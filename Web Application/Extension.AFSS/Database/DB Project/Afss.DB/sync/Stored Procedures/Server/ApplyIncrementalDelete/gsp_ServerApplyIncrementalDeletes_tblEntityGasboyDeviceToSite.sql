...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblEntityGasboyDeviceToSite]
...
AS
BEGIN
    DELETE [map].[tblEntityGasboyDeviceToSite]  
        ...
        WHERE GasboyDeviceToSiteGuid = @GasboyDeviceToSiteGuid
