...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblGasboyVehiclePlateCheckType]
...
AS
BEGIN
    DELETE [lookup].[tblGasboyVehiclePlateCheckType]  
        ...
        WHERE GasboyVehiclePlateCheckTypeIndex = @GasboyVehiclePlateCheckTypeIndex
