...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblGasboyTwoStageDriverValidationType]
...
AS
BEGIN
    DELETE [lookup].[tblGasboyTwoStageDriverValidationType]  
        ...
        WHERE GasboyTwoStageDriverValidationTypeIndex = @GasboyTwoStageDriverValidationTypeIndex
