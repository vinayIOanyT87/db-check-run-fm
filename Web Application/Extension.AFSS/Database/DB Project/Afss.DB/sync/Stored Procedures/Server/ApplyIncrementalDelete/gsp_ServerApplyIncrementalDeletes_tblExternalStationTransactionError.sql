...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblExternalStationTransactionError]
...
AS
BEGIN
    DELETE [dbo].[tblExternalStationTransactionError]  
        ...
        WHERE ExternalStationTransactionErrorGuid = @ExternalStationTransactionErrorGuid
