...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblGasboyDeviceType]
...
AS
BEGIN
    DELETE [lookup].[tblGasboyDeviceType]  
        ...
        WHERE GasboyDeviceTypeIndex = @GasboyDeviceTypeIndex
