...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblGasboyDepartment]
...
AS
BEGIN
    DELETE [dbo].[tblGasboyDepartment]  
        ...
        WHERE GasboyDepartmentGuid = @GasboyDepartmentGuid
