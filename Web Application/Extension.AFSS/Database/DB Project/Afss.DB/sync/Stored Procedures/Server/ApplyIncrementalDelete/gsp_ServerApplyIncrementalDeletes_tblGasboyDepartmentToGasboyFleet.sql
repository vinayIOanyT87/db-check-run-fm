...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblGasboyDepartmentToGasboyFleet]
...
AS
BEGIN
    DELETE [map].[tblGasboyDepartmentToGasboyFleet]  
        ...
        WHERE GasboyDepartmentToGasboyFleetGuid = @GasboyDepartmentToGasboyFleetGuid
