...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblGasboyEventObjectType]
...
AS
BEGIN
    DELETE [lookup].[tblGasboyEventObjectType]  
        ...
        WHERE GasboyEventObjectTypeIndex = @GasboyEventObjectTypeIndex
