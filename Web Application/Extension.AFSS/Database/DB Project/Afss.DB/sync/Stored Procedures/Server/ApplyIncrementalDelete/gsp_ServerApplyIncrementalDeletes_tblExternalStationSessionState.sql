...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblExternalStationSessionState]
...
AS
BEGIN
    DELETE [lookup].[tblExternalStationSessionState]  
        ...
        WHERE ExternalStationSessionStateIndex = @ExternalStationSessionStateIndex
