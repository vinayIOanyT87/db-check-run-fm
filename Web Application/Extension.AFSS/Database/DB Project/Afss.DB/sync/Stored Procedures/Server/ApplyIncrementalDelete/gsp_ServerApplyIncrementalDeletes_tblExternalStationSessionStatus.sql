...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblExternalStationSessionStatus]
...
AS
BEGIN
    DELETE [lookup].[tblExternalStationSessionStatus]  
        ...
        WHERE ExternalStationSessionStatusIndex = @ExternalStationSessionStatusIndex
