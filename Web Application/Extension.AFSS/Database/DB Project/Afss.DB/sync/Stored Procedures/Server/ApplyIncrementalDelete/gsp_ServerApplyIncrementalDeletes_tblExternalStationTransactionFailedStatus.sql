...
-- ========================================================================================
CREATE PROCEDURE [sync].[gsp_ServerApplyIncrementalDeletes_tblExternalStationTransactionFailedStatus]
...
AS
BEGIN
    DELETE [lookup].[tblExternalStationTransactionFailedStatus]  
        ...
        WHERE ExternalStationTransactionFailedStatusIndex = @ExternalStationTransactionFailedStatusIndex
