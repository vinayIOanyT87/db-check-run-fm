CREATE PROCEDURE [dbo].[usp_ExternalStationTransactionStatusUpdate]
	@ExternalStationTransactionGuid UNIQUEIDENTIFIER,
	@ExternalStationTransactionStatus INT
AS
BEGIN
	SET NOCOUNT ON
	...
	BEGIN TRY
		...
		UPDATE [dbo].[tblExternalStationTransaction]
			SET LookupExternalStationTransactionStatusIndex = @ExternalStationTransactionStatus
