CREATE PROCEDURE [dbo].[usp_ExternalStationTransactionErrorEnumerate]
...
BEGIN
	...
	BEGIN TRY
		...
		WHERE [dbo].[tblExternalStationTransactionError].[ExternalStationTransactionGuid] = @ExternalStationTransactionGuid
	...
	BEGIN CATCH
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: usp_ExternalStationTransactionErrorEnumerate' + CHAR(13)+CHAR(10)                  
