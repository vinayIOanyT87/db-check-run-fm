CREATE PROCEDURE [dbo].[usp_GasboyDeviceGetByCardNumber]
...
BEGIN
	...
	BEGIN TRY
		...
		-- Retrieve the Gasboy Device record matching the provided Card Number
		...
		WHERE --[dbo].[tblGasboyDevice].[SiteGuid] = @SiteGuid 
				 [dbo].[tblGasboyDevice].[CardNumber] = @CardNumber
		-- Retrieve the Gasboy Device record matching the provided Card Number
	...
	BEGIN CATCH
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: usp_GasboyDeviceGetByCardNumber' + CHAR(13)+CHAR(10)                  
