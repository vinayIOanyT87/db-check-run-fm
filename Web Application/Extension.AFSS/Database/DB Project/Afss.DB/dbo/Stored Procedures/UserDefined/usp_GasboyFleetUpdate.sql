CREATE PROCEDURE [dbo].[usp_GasboyFleetUpdate]
...
BEGIN
	...
	BEGIN TRY
		...
		WHERE GasboyFleetGuid = @IdentityGuid
	...
	BEGIN CATCH
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: usp_GasboyFleetUpdate' + CHAR(13)+CHAR(10)                  
