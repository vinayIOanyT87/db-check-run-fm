CREATE PROCEDURE [dbo].[usp_ExternalStationTransactionEnumerateFailed]
...
BEGIN
	...
	BEGIN TRY
		...
		BEGIN
			...
			WHERE [dbo].[tblExternalStationTransaction].[ExternalStationGuid] = @ExternalStationGuid 
					...
					AND [dbo].[tblExternalStationTransaction].[LookupExternalStationTransactionStatusIndex] = 1
					AND [dbo].[tblExternalStationTransaction].[LookupExternalStationTransactionFailedStatusIndex] NOT IN (3,4)
	...
	BEGIN CATCH
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13) + CHAR(10)                 
						...
						+ 'Procedure Name: usp_ExternalStationTransactionEnumerateFailed' + CHAR(13) + CHAR(10)                  
