CREATE PROCEDURE [map].[usp_ExternalStationToProductEnumerate]
...
BEGIN
	...
	BEGIN TRY
		...
		WHERE ExternalStationGuid = @ExternalStationGuid 
	...
	BEGIN CATCH
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: map.usp_ExternalStationToProductEnumerate' + CHAR(13)+CHAR(10)                  
