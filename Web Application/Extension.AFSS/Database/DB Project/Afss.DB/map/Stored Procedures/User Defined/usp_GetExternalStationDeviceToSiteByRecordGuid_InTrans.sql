CREATE PROCEDURE [map].[usp_GetExternalStationDeviceToSiteByRecordGuid_InTrans]
(
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[usp_GetExternalStationDeviceToSiteByRecordGuid]
	...
	BEGIN TRY
		...
		SELECT a.GasboyDeviceToSiteGuid MappingGuid, a.OwnerSiteGuid EntityRecordGuid, d.ID EntityId, a.MapToSiteGuid AssignedToSiteGuid, b.SiteGroupId AssignedToSiteId, b.HierarchyLevel, a.CreatedDate, a.CreatedBy, a.UpdatedDate, a.UpdatedBy, a._RowVersion, a.AssignedFromSiteGuid , c.ID AssignedFromSiteId 
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: map.usp_GetExternalStationDeviceToSiteByRecordGuid_InTrans' + CHAR(13)+CHAR(10)                  
