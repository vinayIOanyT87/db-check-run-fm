CREATE PROCEDURE [map].[usp_GetExternalStationDeviceToSiteBySiteGuid]
(
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[usp_GetExternalStationDeviceToSiteBySiteGuid]
	...
	BEGIN TRY
		...
		SELECT a.GasboyDeviceToSiteGuid MappingGuid, a.OwnerSiteGuid EntityRecordGuid, d.ID EntityId, a.MapToSiteGuid AssignedToSiteGuid, b.ID AssignedToSiteId, a.CreatedDate, a.CreatedBy, a.UpdatedDate, a.UpdatedBy, a._RowVersion, a.AssignedFromSiteGuid , c.ID AssignedFromSiteId 
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: map.usp_GetExternalStationDeviceToSiteBySiteGuid' + CHAR(13)+CHAR(10)                  
