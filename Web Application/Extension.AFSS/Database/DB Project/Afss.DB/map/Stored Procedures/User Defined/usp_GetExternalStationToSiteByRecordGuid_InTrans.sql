CREATE PROCEDURE [map].[usp_GetExternalStationToSiteByRecordGuid_InTrans]
(
	...
	BEGIN
	------------------------------------------------------------------------------------------------------
	-- Stored procedure: [map].[usp_GetExternalStationToSiteByRecordGuid_InTrans]
	-- Author: Ryan Hill
	...
	BEGIN TRY
		...
		FROM map.tblEntityExternalStationToSite a WITH (UPDLOCK)
	...
	BEGIN CATCH        
		...
		SET @_ErrMessage = 'Error: ' + @_ErrMessage + CHAR(13)+CHAR(10)                 
						...
						+ 'Procedure Name: map.usp_GetExternalStationToSiteByRecordGuid_InTrans' + CHAR(13)+CHAR(10)                  
