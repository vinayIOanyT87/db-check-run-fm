// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ExternalStationLogController.cs" company="Varec, Inc.">
//   Copyright (c) Varec, Inc.  All rights reserved.
// </copyright>
// <summary>
//   Controller for the External Station Log summary and detail pages
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace FuelsManager.Afss.Module.Gasboy.WebApp.Areas.ExternalStationArea.Controllers
{
    ...
    /// <summary>
    /// Contains the search parameters last used by the user when searching from the External Station Log Summary page
    /// </summary>
    [Serializable]
    public class ExternalStationLogSummarySearchParameters
    {
        /// <summary>
    ...
    [RoutePrefix("ExternalStationLog")]
    public class ExternalStationLogController : FMBaseController, IDataDictionary
    {
        /// <summary>
        /// The session key used to store the user's last search parameters on the log summary form.
        /// </summary>
        public const string LogSummarySearchParametersSessionKey = "ExternalStationLogSummarySearchParameters";
        ...
        public new string[] Keys(SecurityClass security)
        {
            return new[]
			       {
                    "External Fuel Service Station Exception Logs",
                    "View Details",
                    "Timestamp",
                    "External Station",
                    "Log Entry",
                    ...
                    "External Station",
                    "Date Range",
                    "External Fuel Service Station Exception Log",
                    "Close"
			       };
        }

        #region External Station Log Summary Page Actions

        /// <summary>
        /// Get a view of the external station logs in the system
        /// </summary>
        /// <returns>A view of the external station logs in the system</returns>
        [HttpGet]
        public ActionResult ExternalStationLogSummaryIndex()
        {
            var model = new ExternalStationLogSummaryModel();
            ...
            try
            {
                ...
                ExternalStationLogSummarySearchParameters searchParameters = this.Session[LogSummarySearchParametersSessionKey] as ExternalStationLogSummarySearchParameters;
                ...
                model.ExternalStationLogs = this.GetExternalStationLogs(model);
            }
            catch (Exception ex)
            {
        ...
        /// <summary>
        /// The post action for the external station log summary page. Gets external station logs filtered by the parameters provided on the screen
        /// </summary>
        /// <param name="model">
        /// The model of the external station log summary screen which will contain search parameter values.
        /// </param>
        /// <returns>
        /// A view of the external station logs filtered by the parameters provided on the screen
        /// </returns>
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult ExternalStationLogSummaryIndex(ExternalStationLogSummaryModel model)
        {
            try
            {
                model.ExternalStations = GasboyChannelHelper.MakeCall<IGasboyStations, List<GasboyStation>>(externalStationsService => externalStationsService.Enumerate(this.Security));
        ...
        #region External Station Log Detail Page Actions

        /// <summary>
        /// Get a view of a single external station log record
        /// </summary>
        ...
        /// <returns>A view of the external station log record identified by the provided guid</returns>
        [HttpGet]
        public ActionResult ExternalStationLog(Guid externalStationLogGuid, ExternalStationLogType logType)
        {
            var model = new ExternalStationLogModel();
        ...
        /// <summary>
        /// Returns the external stations logs configured for the site, filtered by the find text if it was provided
        /// </summary>
        /// <param name="model">Contains the find text value and potentially any other values we need</param>
        /// <returns>The external stations configured for the site, filtered by the find text if it was provided</returns>
        [NonAction]
        private List<GasboyStationLog> GetExternalStationLogs(ExternalStationLogSummaryModel model)
        {
            ...
            this.Session[LogSummarySearchParametersSessionKey] = new ExternalStationLogSummarySearchParameters
                                                                            {
