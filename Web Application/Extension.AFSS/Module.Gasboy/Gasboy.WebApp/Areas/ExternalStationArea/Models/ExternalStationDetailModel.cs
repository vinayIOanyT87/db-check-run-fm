...
namespace FuelsManager.Afss.Module.Gasboy.WebApp.Areas.ExternalStationArea.Models
{
    ...
    /// The model for the External Station Detail Page
    /// </summary>
    public class ExternalStationDetailModel
    {
        /// <summary>
        /// Initialize refrence types to avoid potential null reference errors should an error occur.
        /// </summary>
        public ExternalStationDetailModel()
        {
