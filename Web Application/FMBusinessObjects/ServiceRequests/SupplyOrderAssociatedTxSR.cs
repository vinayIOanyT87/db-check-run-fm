...
namespace FMBusinessObjects.ServiceRequests
{
    [Serializable]
    [DataContract]
	public class SupplyOrderAssociatedTxSR : AccountingServiceRequest
	{
		#region Public enumerators
		public enum RequestTypes
		{
			GET_ASSOCIATED_TRANSACTIONS,
			NONE
		};
		#endregion
		...
		#region Constructors
		/// <summary>
		/// This is the default constructor for the supply order associated transaction
		/// service request class.
		/// </summary>
		public SupplyOrderAssociatedTxSR ( )
		{
