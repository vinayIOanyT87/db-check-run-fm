...
namespace FMBusinessObjects.ServiceRequests
{
	...
	public class ReportConfigurationGroupSR : AccountingServiceRequest
	{
		...
		[DataMember]
		private List<ReportConfigurationGroupDO> reportGroupList;
		[DataMember]
		...
		/// </summary>
		[DataMember]
		public List<ReportConfigurationGroupDO> ReportGroupList
		{
