namespace FMBusinessObjects.DataObjects
{
    ...
    [EntityImportExportWorksheet("COMPANYFOOTNOTESHIPPERMAPS")]
    class CompanyMapFootNoteShipperClass : CompanyMapClass
    {
        private const string SchemaPrefix = "map.";
        internal const string ClassMappingTableName = SchemaPrefix + "tblApplicationStringToFootNoteShipper";
        internal const string ClassMappingTablePrimaryKeyColumnName = "ApplicationStringToFootNoteShipperGuid";
        ...
        public override COMPANY_MAP_TYPE Type
        {
            get
            {
                return COMPANY_MAP_TYPE.FOOT_NOTE_SHIPPER_MAP;
            }
        ...
        protected override string SelectClause => "SELECT  map.tblApplicationStringToFootNoteShipper.*," +
                             "ID AS AssignedToID," +
                             "(SELECT ID FROM tblApplicationString WHERE tblApplicationString.ApplicationStringGuid = map.tblApplicationStringToFootNoteShipper.ApplicationStringGuid AND tblApplicationString.LookupApplicationStringTypeIndex = 12) AS AssignedID," +
