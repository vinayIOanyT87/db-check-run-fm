...
#ifndef __DanielOPCServer_h__
#define __DanielOPCServer_h__
...
#ifndef __IDanLoads_FWD_DEFINED__
#define __IDanLoads_FWD_DEFINED__
typedef interface IDanLoads IDanLoads;

#endif 	/* __IDanLoads_FWD_DEFINED__ */
...
#ifndef __DanLoads_FWD_DEFINED__
#define __DanLoads_FWD_DEFINED__

#ifdef __cplusplus
typedef class DanLoads DanLoads;
#else
typedef struct DanLoads DanLoads;
#endif /* __cplusplus */

#endif 	/* __DanLoads_FWD_DEFINED__ */
...
/* interface __MIDL_itf_DanielOPCServer_0000_0000 */
/* [local] */ 
...
extern RPC_IF_HANDLE __MIDL_itf_DanielOPCServer_0000_0000_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_DanielOPCServer_0000_0000_v0_0_s_ifspec;
...
EXTERN_C const IID IID_IDataAccess;
    ...
    MIDL_INTERFACE("1218B83B-2946-41C8-BE64-7AF687989104")
...
#ifndef __IDanLoads_INTERFACE_DEFINED__
#define __IDanLoads_INTERFACE_DEFINED__

/* interface IDanLoads */
/* [unique][helpstring][nonextensible][dual][uuid][object] */ 


EXTERN_C const IID IID_IDanLoads;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("C836DAF6-6EF0-492D-9DB8-4E1CFDE58003")
    IDanLoads : public IDispatch
    {
    public:
    ...
    interface IDanLoads
    {
        CONST_VTBL struct IDanLoadsVtbl *lpVtbl;
    };
...
#define IDanLoads_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define IDanLoads_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define IDanLoads_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define IDanLoads_GetTypeInfoCount(This,pctinfo)	\
    ( (This)->lpVtbl -> GetTypeInfoCount(This,pctinfo) ) 

#define IDanLoads_GetTypeInfo(This,iTInfo,lcid,ppTInfo)	\
    ( (This)->lpVtbl -> GetTypeInfo(This,iTInfo,lcid,ppTInfo) ) 

#define IDanLoads_GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)	\
    ( (This)->lpVtbl -> GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId) ) 

#define IDanLoads_Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)	\
    ( (This)->lpVtbl -> Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr) ) 


#define IDanLoads_Enumerate(This,ppAcculoadCollection)	\
    ( (This)->lpVtbl -> Enumerate(This,ppAcculoadCollection) ) 

#define IDanLoads_Add(This,pAccuload,pIndex)	\
    ( (This)->lpVtbl -> Add(This,pAccuload,pIndex) ) 

#define IDanLoads_Modify(This,pAccuload)	\
    ( (This)->lpVtbl -> Modify(This,pAccuload) ) 

#define IDanLoads_Purge(This,lIndex)	\
    ( (This)->lpVtbl -> Purge(This,lIndex) ) 

#define IDanLoads_GetIndex(This,bstrID,pIndex)	\
    ( (This)->lpVtbl -> GetIndex(This,bstrID,pIndex) ) 

#define IDanLoads_Get(This,lIndex,ppAccuload)	\
...
#endif 	/* __IDanLoads_INTERFACE_DEFINED__ */
...
EXTERN_C const IID IID_IPorts;
    ...
    MIDL_INTERFACE("6F92560C-9F70-4176-9311-6A0C3387FEB7")
...
#ifndef __DanielOPCServerLib_LIBRARY_DEFINED__
#define __DanielOPCServerLib_LIBRARY_DEFINED__

/* library DanielOPCServerLib */
/* [helpstring][version][uuid] */ 


EXTERN_C const IID LIBID_DanielOPCServerLib;

EXTERN_C const CLSID CLSID_DataAccess;

#ifdef __cplusplus

class DECLSPEC_UUID("6FFB871D-D415-48BA-8765-C67C60025028")
DataAccess;
#endif

EXTERN_C const CLSID CLSID_DanLoads;

#ifdef __cplusplus

class DECLSPEC_UUID("54F57ECB-6111-4A9A-AFA6-ABC5B3C4FF59")
DanLoads;
#endif
...
class DECLSPEC_UUID("265331A0-40D0-4DEC-B614-1A21CDC5CC1F")
Ports;
#endif
...
class DECLSPEC_UUID("9E033B12-2D79-41db-8AC0-D8EBF45A5B6A")
OPCServer;
#endif
#endif /* __DanielOPCServerLib_LIBRARY_DEFINED__ */
