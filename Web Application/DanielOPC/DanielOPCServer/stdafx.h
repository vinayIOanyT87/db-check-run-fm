...
#import "DanielOPCObjects.tlb" no_namespace named_guids \
			exclude("_FILETIME","IRecord")
#import "DanielOPCServer.tlb" no_namespace named_guids \
...
class CDanielOPCServerApp : public CWinApp
{
public:
...
extern CDanielOPCServerApp theApp;
