...
class ATL_NO_VTABLE CPort : 
	...
	public IProvideClassInfoImpl< &CLSID_Port, &LIBID_DanielOPCObjectsLib>,
	public IDispatchImpl<IPort, &IID_IPort, &LIBID_DanielOPCObjectsLib>,
...
public:
	...
	STDMETHOD(get_Baud)(DANLOAD_BAUD* pVal);
	STDMETHOD(put_Baud)(DANLOAD_BAUD newVal);
	STDMETHOD(get_DataBits)(DANLOAD_DATA_BITS* pVal);
	STDMETHOD(put_DataBits)(DANLOAD_DATA_BITS newVal);
	STDMETHOD(get_Parity)(DANLOAD_PARITY* pVal);
	STDMETHOD(put_Parity)(DANLOAD_PARITY newVal);
	STDMETHOD(get_StopBits)(DANLOAD_STOP_BITS* pVal);
	STDMETHOD(put_StopBits)(DANLOAD_STOP_BITS newVal);
	STDMETHOD(raw_BaudID)(DANLOAD_BAUD Baud,BSTR* pVal);
	STDMETHOD(raw_DataBitsID)(DANLOAD_DATA_BITS DataBits,BSTR* pVal);
	STDMETHOD(raw_ParityID)(DANLOAD_PARITY Parity,BSTR* pVal);
	STDMETHOD(raw_StopBitsID)(DANLOAD_STOP_BITS StopBits,BSTR* pVal);
