...
namespace FMControls
{
    ...
    public class FMUserTextBox : FMTextBoxButtonControl
    {
        /// <summary>
        /// This method will perform the page load by getting the User information and
        /// setting the tooltip.
        /// </summary>
		...
		protected override void Render ( HtmlTextWriter writer )
		{
			...
			writer.WriteAttribute ( "style", style );
			writer.WriteAttribute ( "onclick", "UserSelect('" + UniqueID + "')" );
