/******************************************************************************
	FILE NAME:		FMProductTextBox.cs
	PURPOSE:		Implementation of: FMProductTextBox
...
namespace FMControls
{
    ...
    public class FMProductTextBox : FMTextBoxButtonControl
	{
		#region Constructors
		/// <summary>
		/// This is the default constructor the FMProductTextBox base class
		/// </summary>
		public FMProductTextBox ( )
		{
		}
		#endregion

		/// <summary>
		/// This method will perform the page load by getting the product information and
		/// setting the tooltip.
		/// </summary>
			...
			try
			{
					 ...
					 Text != "{None}")
				{
					...
					ProductClass product = FMChannelHelper.MakeCall<IProducts, ProductClass>(
																	 x =>
																	 x.GetByProductAuthorizedCompanies(security, productIdentityGuid, false)
																);

					ToolTip = product.ProductToolTip;
				}
				else
				{
					ToolTip = "Product";
		...
		protected override void Render ( HtmlTextWriter writer )
		{
			...
			writer.WriteAttribute ( "style", style );
			writer.WriteAttribute ( "onclick", "ProductSelect('" + UniqueID + "')" );
