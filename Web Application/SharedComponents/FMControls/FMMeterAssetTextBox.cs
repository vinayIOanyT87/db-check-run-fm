///***************************************************************************
/// Module Name:  FMMeterAssetTextBox.cs
/// Author:       Ryan Hill
...
namespace FMControls
{
	...
	/// <summary>
	/// Allows a user to select a meter asset (tank, equipment or load arm) and displays the ID of the selected asset
	/// </summary>
	public class FMMeterAssetTextBox : FMTextBoxButtonControl
	{
		/// <summary>
		/// Default constructor
		/// </summary>
		public FMMeterAssetTextBox()
		{
		}
		...
		/// <summary>
		/// Create a text box with a button, and have the button call the javascript function to select a meter asset.
		...
		protected override void Render(HtmlTextWriter writer)
		{
			...
			writer.WriteAttribute("onclick", "MeterAssetSelect('" + this.UniqueID + "')");
