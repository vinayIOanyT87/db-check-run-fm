// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RijndaelCrypt.cs" company="Varec, Inc.">
...
namespace Crypt
{
	...
	public class RijndaelCrypt : CryptBase
	{
		...
		/// <summary>
		/// Encrypts a block of data using the Rijndael algorithm
		/// </summary>
		/// <param name="a_pt">The block of data to encrypt</param>
		/// <param name="a_key">The key to use, this key should be a type or sub type of RijndaelKey</param>
		/// <returns>A block of encrypted data</returns>
		public override byte[] Encrypt(byte[] a_pt, IKey a_key)
		{
			base.VerifyKey(a_key, typeof(RijndaelKey));

			RijndaelKey key = (RijndaelKey)a_key;
		...
		/// <summary>
		/// Decrypts a block of data using the Rijndael algorithm
		/// </summary>
