// --------------------------------------------------------------------------------------------------------------------
// <copyright file="RijndaelKey.cs" company="Varec, Inc.">
...
namespace Crypt
{
	...
	public class RijndaelKey : IKey
	{
		/// <summary>
		/// The internal Rijndael key
		/// </summary>
		/// <remarks>
		...
		/// </summary>
		/// <param name="a_key">The key to copy from, this must be a type or sub-type of RijndaelKey</param>
		public RijndaelKey(RijndaelKey a_key)
		...
		public RijndaelKey(byte[] a_key, byte[] a_IV)
		{
			Clone(a_key, a_IV);
		}
		...
		/// </summary>
		/// <returns>The encryptor which RijndaelEncryptor or its sub-classes can use</returns>
		...
		/// </summary>
		/// <returns>The decryptor which RijndaelEncryptor or its sub-classes can use</returns>
		...
		/// <summary>
		/// Generates a random Rijndael key
		/// </summary>
		...
		/// <summary>
		/// Uses the given byte form representation of an Rijndael key 
		/// </summary>
		...
		/// types of Rijndael keys, at the moment of writing it only supports Rijndael keys.
		/// </remarks>
		...
		{
			SymmetricAlgorithm theProvider = new RijndaelManaged();
			theProvider.BlockSize = 128;
			return theProvider;
		}
	}
}
