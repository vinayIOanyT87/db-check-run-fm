namespace LedgerCore
{
	...
	public class LRQuantityDO
	{
		...
		public LRQuantityDO(double gross, double net, double mass)
		{
			this.Init();
		...
		public LRQuantityDO(double gross, double net, double mass, double package, double grossPrice, double netPrice, double massPrice)
		{
			this.Init();
		...
		public LRQuantityDO(double gross,
							 double net,
							 double mass,
							 double package,
							 double grossPrice,
		...
		public double Gross
		{
			get { return Math.Abs(this.gross); }
		...
		{
			get { return Math.Abs(this.package); }
		...
		public void CombineMonikers(string inMoniker)
		{
			if ((inMoniker != null) && (inMoniker.Length > 0))
			{
				...
				{
					string aCharacter = charEnumerator.Current.ToString(CultureInfo.InvariantCulture);
