...
namespace PIDXTransactions
{
    public class PIDXConstants
    {
        ...
        public const int MAX_BOL_PRODUCTS    = 8;
        ...
        public const string ERR_MSG_005 = "Consignee ID must be populated or contain 14 AN characters";
        public const string ERR_MSG_006 = "Final Shipper ID must be populated";
        public const string ERR_MSG_007 = "Carrier ID must be populated or contain 8 AN characters";
        public const string ERR_MSG_008 = "Consignee ID must be populated or contain 1 - 14 AN characters";
        ...
        public const string ERR_MSG_016 = "Product Code must be populated or contain 6 AN characters";
