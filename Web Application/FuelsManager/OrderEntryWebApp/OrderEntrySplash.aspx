...
<%@ Page language="c#" Codebehind="OrderEntrySplash.aspx.cs" AutoEventWireup="True" Inherits="FuelsManager.OrderEntryWebApp.OrderEntrySplash" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<FMControls:FMLabel id="Label1" style="Z-INDEX: 103; LEFT: 8px; POSITION: absolute; TOP: 8px" runat="server"
				CssClass="headline" Width="500px" BackColor="Transparent">Order Entry</FMControls:FMLabel>
		</form>
	</body>
</HTML>
