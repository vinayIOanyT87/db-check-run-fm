<%@ Page language="c#" Codebehind="OrderAssociatedTxSummary.aspx.cs" AutoEventWireup="True" Inherits="FuelsManager.OrderEntryWebApp.OrderAssociatedTxSummary" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
        <form id="OrderAssociatedTxSummary" method="post" runat="server">
            ...
            <div id="pageContent" style="position: absolute">
                ...
                <FMControls:FMLabel ID="PageTitle" Style="z-index: 101; left: 16px; position: absolute; top: 8px" runat="server"
                    BackColor="Transparent" Width="500px" CssClass="headline">Order Associated Transactions</FMControls:FMLabel>
