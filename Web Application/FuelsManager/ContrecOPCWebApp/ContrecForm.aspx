...
<%@ Page language="c#" Codebehind="ContrecForm.aspx.cs" AutoEventWireup="True" Inherits="OPCWebApp.ContrecOPCWebApp.ContrecForm" %>
	...
	<body tabIndex="-1" MS_POSITIONING="GridLayout">
        ...
        <div style="position:absolute">
			...
			<FMControls:FMLabel ID="Label2" Style="z-index: 101; left: 8px; position: absolute; top: 8px" runat="server"
				BackColor="Transparent" Width="320px" CssClass="headline">Contrec|Preset Configuration</FMControls:FMLabel>
			...
			<FMControls:FMLabel ID="Label3" Style="z-index: 105; left: 16px; position: absolute; top: 80px" runat="server"
				BackColor="Transparent" CssClass="formfieldtitle">Contrec|Type:</FMControls:FMLabel>
			<asp:DropDownList ID="TypeDropDownList" Style="z-index: 106; left: 128px; position: absolute; top: 80px"
				TabIndex="2" runat="server" Width="136px" CssClass="formfield" AutoPostBack="True">
			</asp:DropDownList>
			<FMControls:FMLabel ID="Label4" Style="z-index: 107; left: 16px; position: absolute; top: 112px" runat="server"
				BackColor="Transparent" CssClass="formfieldtitle">Contrec|Port:</FMControls:FMLabel>
			...
			<FMControls:FMLabel ID="FMLABEL1" Style="z-index: 112; left: 16px; position: absolute; top: 144px" runat="server"
				BackColor="Transparent" CssClass="formfieldtitle">Contrec|Address:</FMControls:FMLabel>
			...
			<FMControls:FMButton ID="OKButton" Style="z-index: 110; left: 264px; position: absolute; top: 184px"
				TabIndex="100" runat="server" Text="Contrec|OK" Width="107px" CssClass="formfieldtitle"></FMControls:FMButton>
			<FMControls:FMButton ID="CancelButton" Style="z-index: 111; left: 384px; position: absolute; top: 184px"
				TabIndex="101" runat="server" Text="Contrec|Cancel" Width="98px" CssClass="formfieldtitle"></FMControls:FMButton>
