<%@ Page language="c#" Codebehind="WeightScalesForm.aspx.cs" AutoEventWireup="True" Inherits="WeightScaleOPCWebApp.WeightScalesForm" %>
	...
	<body MS_POSITIONING="GridLayout">
        ...
        <div style="position:absolute">
			<TABLE id="Table1" style="Z-INDEX: 101; LEFT: 32px; WIDTH: 43.18%; POSITION: absolute; TOP: 80px; HEIGHT: 10px"
				...
				<tr>
					<TD width="498" height="36" vAlign="middle">
						<FMControls:FMButton width="100px" id="AddButton2" runat="server" Text="WeightScale|Add" CssClass="formfieldtitle"
							tabIndex="6" />
						&nbsp;&nbsp;
						<FMControls:FMPageSizeDropDown ID="WeightScalesFormPageSizeDropDown" StringPrefix="WeightScale" runat="server" onselectedindexchanged="PageSizeDropDown_SelectedIndexChanged" />
					</TD>
				</tr>
				<TR>
					<TD style="WIDTH: 498px; HEIGHT: 10px" width="498"><FMCONTROLS:FMDatagrid id="WeightScalesDataGrid" runat="server" BorderStyle="None" BackColor="White" AutoGenerateColumns="False"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="Type" HeaderText="WeightScale|Type"></asp:BoundColumn>
								<asp:BoundColumn DataField="Port" HeaderText="WeightScale|Port"></asp:BoundColumn>
							</Columns>
							<PagerStyle CssClass="tablepager" ForeColor="White" BackColor="<%$ AppSettings: ColorHeaderBlue %>" Mode="NumericPages"></PagerStyle>
						</FMCONTROLS:FMDatagrid></TD>
				</TR>
				<TR>
					<TD style="WIDTH: 498px; HEIGHT: 35px" vAlign="middle" width="498"><FMCONTROLS:FMButton id="AddButton" runat="server" Width="98px" Text="WeightScale|Add" CssClass="formfieldtitle"></FMCONTROLS:FMButton></TD>
				</TR>
			</TABLE>
			...
			<FMCONTROLS:FMLABEL id="Label3" style="Z-INDEX: 103; LEFT: 32px; POSITION: absolute; TOP: 40px" runat="server"
				CssClass="formfieldtitle" BackColor="Transparent" Width="80px">WeightScale|System:</FMCONTROLS:FMLABEL>
			...
			<FMCONTROLS:FMLABEL id="Label2" style="Z-INDEX: 102; LEFT: 8px; POSITION: absolute; TOP: 8px" runat="server"
				CssClass="headline" Width="400px" BackColor="Transparent">WeightScale|Weight Scales Configuration</FMCONTROLS:FMLABEL>
