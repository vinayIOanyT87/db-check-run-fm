<%@ Page language="c#" Codebehind="PortsForm.aspx.cs" AutoEventWireup="True" Inherits="OPCWebApp.OptomuxOPCWebApp.PortsForm" %>
	...
	<body MS_POSITIONING="GridLayout">
        ...
        <div style="position:absolute">
			...
			<FMControls:FMLabel ID="FMLabel2" Style="z-index: 102; left: 8px; position: absolute; top: 8px" runat="server"
				CssClass="headline" Width="368px" BackColor="Transparent">Optomux|Ports Configuration</FMControls:FMLabel>
			...
			<TABLE id="Table1" style="Z-INDEX: 101; LEFT: 32px; WIDTH: 43.18%; POSITION: absolute; TOP: 80px; HEIGHT: 10px"
				...
				<tr>
					<TD width="498" height="36" vAlign="middle">
						<FMControls:FMButton width="100px" id="AddButton2" runat="server" Text="Optomux|Add" CssClass="formfieldtitle"
							tabIndex="6" />
						&nbsp;&nbsp;
						<FMControls:FMPageSizeDropDown ID="OptomuxPortsFormPageSizeDropDown" StringPrefix="Optomux" runat="server" onselectedindexchanged="PageSizeDropDown_SelectedIndexChanged" />
					</TD>
				</tr>
				<TR>
				...
				<TR>
					<TD style="WIDTH: 498px; HEIGHT: 32px" vAlign="middle" width="498"><FMCONTROLS:FMButton id="AddButton" runat="server" CssClass="formfieldtitle" Width="98px" Text="Optomux|Add"></FMCONTROLS:FMButton>
					</TD>
				</TR>
			</TABLE>
        </div>
