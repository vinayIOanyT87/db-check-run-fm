            ...
            function columnizeIt() {
                ...
                for (var loopCount = 0; loopCount < maxLoops && loopCount < 20; loopCount++) {
                    ...
                    if (options.overflow && !scrollHorizontally) {
                        ...
                        //FJM the wirth should be the number of columns with actual data
                        //remove all columns that has no data
                        $('.' + prefixTheClassName("column")).each(function(i) {
                            $col = $inBox.children().eq(i);
                            if (!$col.hasClass( prefixTheClassName("first") )) {
                                if ($col.children().length == 0) {
                                    $col.addClass( "column-remove");
                                }
