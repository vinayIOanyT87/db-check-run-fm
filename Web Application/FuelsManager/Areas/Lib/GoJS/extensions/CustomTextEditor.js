"use strict";
// this is a custom text editor box. It exists because version 1.7.7 of gojs code has a bud
// where text alignment does not work when in the edit mode
// B.D.Schaal - 5-16-2017
...
(function (window) {
    ...
    TextEditor.show = function (textBlock, diagram, tool) {
        ...
        var ActualTextAlign = 'left';

        if (textBlock.textAlign === 'center') {
            ActualTextAlign = 'center';
        }
        else if (textBlock.textAlign == 'end') {
            ActualTextAlign = 'right';
        }
