...
<%@ Page language="c#" Codebehind="AppointmentSplash.aspx.cs" AutoEventWireup="True" Inherits="FuelsManager.AppointmentWebApp.AppointmentSplashForm" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="AppointmentSplashForm" method="post" runat="server">
		    <FMControls:FMPageFadeImage runat="server"></FMControls:FMPageFadeImage>
			<FMControls:FMLabel id="Label1" style="Z-INDEX: 103; LEFT: 8px; POSITION: absolute; TOP: 8px" runat="server"
				CssClass="headline" Width="400px" BackColor="Transparent">Appointments</FMControls:FMLabel>
		</form>
	</body>
</HTML>
