...
<%@ Page language="c#" Codebehind="PortForm.aspx.cs" AutoEventWireup="True" Inherits="OPCWebApp.DanielOPCWebApp.PortForm" %>
	...
	<body MS_POSITIONING="GridLayout">
        ...
        <div style="position:absolute">
			...
			<FMControls:FMLabel ID="Label2" Style="z-index: 101; left: 8px; position: absolute; top: 8px" runat="server"
				CssClass="headline" Width="312px" BackColor="Transparent">Daniel|Port Configuration</FMControls:FMLabel>
			...
			<FMControls:FMLabel ID="Label6" Style="z-index: 110; left: 280px; position: absolute; top: 48px" runat="server"
				BackColor="Transparent" CssClass="formfieldtitle">Daniel|Parity:</FMControls:FMLabel>
			...
			<FMControls:FMLabel ID="Label5" Style="z-index: 108; left: 16px; position: absolute; top: 80px" runat="server"
				BackColor="Transparent" CssClass="formfieldtitle">Daniel|Baud:</FMControls:FMLabel>
			...
			<FMControls:FMLabel ID="Label7" Style="z-index: 112; left: 280px; position: absolute; top: 80px" runat="server"
				BackColor="Transparent" CssClass="formfieldtitle">Daniel|Data Bits:</FMControls:FMLabel>
			...
			<FMControls:FMLabel ID="Label8" Style="z-index: 114; left: 280px; position: absolute; top: 112px" runat="server"
				BackColor="Transparent" CssClass="formfieldtitle">Daniel|Stop Bits:</FMControls:FMLabel>
			...
			<FMControls:FMButton ID="OKButton" Style="z-index: 117; left: 352px; position: absolute; top: 208px"
				runat="server" Width="107px" Text="Daniel|OK" CssClass="formfieldtitle" TabIndex="100"></FMControls:FMButton>
			<FMControls:FMButton ID="CancelButton" Style="z-index: 118; left: 480px; position: absolute; top: 208px"
				runat="server" Width="98px" Text="Daniel|Cancel" CssClass="formfieldtitle" TabIndex="101"></FMControls:FMButton>
