<%@ Page language="c#" Codebehind="ConfigurationForm.aspx.cs" AutoEventWireup="True" Inherits="FuelsManager.FMWebApp.ConfigurationForm" %>
	...
	<body MS_POSITIONING="GridLayout" tabindex="-1">
        ...
        <div style="position:absolute">
			...
			<FMControls:FMLabel id="Label6" style="Z-INDEX: 103; LEFT: 8px; POSITION: absolute; TOP: 8px" runat="server"
				CssClass="headline" Width="400px" BackColor="Transparent">Configuration</FMControls:FMLabel>
		</div>
</form>
	</body>
</HTML>
