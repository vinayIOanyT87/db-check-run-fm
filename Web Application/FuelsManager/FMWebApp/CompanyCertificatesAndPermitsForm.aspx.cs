// --------------------------------------------------------------------------------------------------------------------
// <copyright file="CompanyCertificatesAndPermitsForm.aspx.cs" company="Varec, Inc.">
//   Copyright (c) Varec, Inc.  All rights reserved.
// </copyright>
// <summary>
//   Defines the CompanyCertificatesAndPermitsForm type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace FuelsManager.FMWebApp
{
	...
	/// <summary>
	///    Summary description for CompanyCertificatesAndPermitsForm.
	/// </summary>
	public partial class CompanyCertificatesAndPermitsForm : QualificationsFormBase,
	                                                         IEntityDiscovery,
	                                                         IMenuDiscovery
	{
		...
		public List<FMMenuItem> GetMenuItems(SecurityClass security, bool siteGroup, ushort word1,ushort word2, ushort useNewLicenseKey, uint options)
		{
			...
			var menuItem = new FMMenuItem
				{
					MenuItemType = FMMenuItemType.ACCOUNTING_COMPANIES_CERTIFICATES_AND_PERMITS,
					RootMenuName = "Accounting",
					CategoryName = "Companies",
					ItemName = "Certificates and Permits",
					NavigateUrl = "CompanyCertificatesAndPermitsForm.aspx",
		...
		{
			this.AddButton.Enabled = enable && this.Security.HasRight(RIGHT.MODIFY_COMPANY_DATA);
			this.AddButton2.Enabled = this.AddButton.Enabled;
			this.CertificatesFormPageSizeDropDown.Enabled = enable;
		}
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			try
			{
				...
				if (!this.Page.IsPostBack)
				{
					...
					qualificationCollection = FMChannelHelper.MakeCall<IQualifications, QualificationCollectionClass>(
																	 x =>
		...
		{
			this.UpdateView(this.CertificatesFormPageSizeDropDown);
		}
