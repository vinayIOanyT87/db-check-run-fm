// --------------------------------------------------------------------------------------------------------------------
// <copyright file="PersonLicensesForm.aspx.cs" company="Varec, Inc.">
//   Copyright (c) Varec, Inc.  All rights reserved.
// </copyright>
// <summary>
//   Defines the PersonLicensesForm type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace FuelsManager.FMWebApp
{
	...
	/// <summary>
	///    Summary description for PersonLicensesForm.
	/// </summary>
	public partial class PersonLicensesForm : QualificationsFormBase, IEntityDiscovery, IMenuDiscovery
	{
		...
		public List<FMMenuItem> GetMenuItems(SecurityClass security, bool siteGroup, ushort word1,ushort word2, ushort useNewLicenseKey, uint options)
		{
			...
			if (!security.HasRight(RIGHT.CONFIGURE_LICENSES))
			{
				return null;
			}
			...
			items.Add(
				new FMMenuItem
					{
						MenuItemType = FMMenuItemType.ASSETS_PERSONNEL_LICENSES,
						RootMenuName = "Assets",
						CategoryName = "Personnel",
						ItemName = "Licenses",
						NavigateUrl = "PersonLicensesForm.aspx",
		...
		protected override void EnableControls(bool enable)
		{
			...
			this.PersonLicensesFormPageSizeDropDown.Enabled = enable;
		}
		...
		{
			this.UpdateView(this.PersonLicensesFormPageSizeDropDown);
		}
