<%@ Page language="c#" Codebehind="InventoryManagementForm.aspx.cs" AutoEventWireup="True" Inherits="FuelsManager.FMWebApp.InventoryManagementForm" %>
	...
	<body MS_POSITIONING="GridLayout" tabindex=-1>
        ...
        <div id="pageContent" style="position:absolute">
			...
			<FMControls:FMLabel id="Label6" style="Z-INDEX: 103; LEFT: 8px; POSITION: absolute; TOP: 8px" runat="server"
				CssClass="headline" Width="200px" BackColor="Transparent">Inventory Management</FMControls:FMLabel>
		</div>
</form>
	</body>
</HTML>
