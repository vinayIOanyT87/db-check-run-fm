<%@ Page language="c#" Codebehind="SystemForm.aspx.cs" AutoEventWireup="True" Inherits="FuelsManager.FMWebApp.SystemForm" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout" tabindex=-1>
        ...
        <div <div id="pageContent"> style="position:absolute">
			...
			<FMControls:FMLabel id="Label6" style="Z-INDEX: 103; LEFT: 8px; POSITION: absolute; TOP: 8px" runat="server"
				CssClass="headline" Width="400px" BackColor="Transparent">System Logs</FMControls:FMLabel>
		</div>
</form>
	</body>
</HTML>
