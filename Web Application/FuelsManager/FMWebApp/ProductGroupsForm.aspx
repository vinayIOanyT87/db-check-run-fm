...
<%@ Page language="c#" Codebehind="ProductGroupsForm.aspx.cs" AutoEventWireup="True" Inherits="FuelsManager.FMWebApp.ProductGroupsForm" %>
        ...
        <form id="Form1" method="post" runat="server">
            ...
            <div id="pageContent" style="position: absolute">
                ...
                <FMControls:FMLabel ID="Label2" Style="z-index: 103; left: 8px; position: absolute; top: 8px" runat="server"
                    CssClass="headline" Width="344px" BackColor="Transparent">Product Groups Configuration</FMControls:FMLabel>
                <table id="Table1" style="z-index: 100; left: 32px; width: 43.18%; position: absolute; top: 48px; height: 10px"
                    ...
                    <tr>
                        <td width="498" height="36" valign="middle">
                            ...
                            &nbsp;&nbsp;
						<FMControls:FMPageSizeDropDown ID="ProductGroupsFormPageSizeDropDown" ToolTip="Page size" runat="server" OnSelectedIndexChanged="PageSizeDropDownSelectedIndexChanged" />
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 498px; height: 10px" width="498">
                            <FMControls:FMDataGrid ID="ProductGroupsDataGrid" runat="server" BorderStyle="None" BackColor="White" AutoGenerateColumns="False" RowHeaderColumn="ID"
