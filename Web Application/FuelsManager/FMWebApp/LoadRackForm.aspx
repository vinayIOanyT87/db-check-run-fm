...
<%@ Page language="c#" Codebehind="LoadRackForm.aspx.cs" AutoEventWireup="True" Inherits="FuelsManager.FMWebApp.LoadRackForm" %>
	...
	<body MS_POSITIONING="GridLayout" tabindex="-1">
        ...
        <div id="pageContent" style="position:absolute">
			...
			<FMControls:FMLabel id="Label1" style="Z-INDEX: 103; LEFT: 8px; POSITION: absolute; TOP: 8px" runat="server"
				CssClass="headline" Width="400px" BackColor="Transparent">Load Rack</FMControls:FMLabel>
		</div>
</form>
	</body>
</HTML>
