<%@ Control language="c#" Codebehind="PersonQualificationsPage.ascx.cs" AutoEventWireup="True" Inherits="FuelsManager.FMWebApp.PersonQualificationsPage" %>
		...
		<TBODY>
			<TR>
				<TD><FMControls:FMDataGrid id="QualificationsDataGrid" runat="server" CssClass="tabletext" BackColor="White" RowHeaderColumn="Qualification ID"
						...
						BorderColor="White" CellPadding="3" AllowPaging="True" PageSize="8" OnItemDataBound="QualificationsDataGridItemDataBound">
						...
						<Columns>
							<asp:TemplateColumn HeaderText="Edit">
								...
								<ItemTemplate>
								<FMControls:FMEditLinkButton runat="server" ID="Fmeditquallinkbutton"/>
								</ItemTemplate>
								<EditItemTemplate>
			                        <FMControls:FMUpdateLinkButton runat="server" ID="Fmupdatequallinkbutton"/>&nbsp;
                                    <FMControls:FMCancelLinkButton runat="server" ID="Fmcancelquallinkbutton"/>
                                </EditItemTemplate>
							</asp:TemplateColumn>
							...
							<asp:TemplateColumn HeaderText="Number">
								...
								<EditItemTemplate>
									<asp:TextBox Width=1.0in CssClass=tabletext runat="server" Enabled="True" ID="NumberTextBox" Text='<%# DataBinder.Eval(Container, "DataItem.ID") %>' DataTextField="Text" DataValueField="Value" MaxLength=50>
									</asp:TextBox>
								</EditItemTemplate>
							</asp:TemplateColumn>
							...
							<asp:TemplateColumn HeaderText="Delete">
								...
								<ItemStyle Wrap="False" HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
								<ItemTemplate>
									<FMControls:FMDeleteLinkButton runat="server" ID="Fmdeletequallinkbutton"/>
								</ItemTemplate>
							</asp:TemplateColumn>
						</Columns>
