...
<%@ Page language="c#" Codebehind="CompanyCertificatesAndPermitsForm.aspx.cs" AutoEventWireup="True" Inherits="FuelsManager.FMWebApp.CompanyCertificatesAndPermitsForm" %>
<!DOCTYPE html>
<HTML>
	<HEAD>
		<title></title>
	...
	<body MS_POSITIONING="GridLayout" tabindex="-1">
        ...
        <div id="pageContent" style="position:absolute">
			...
			<FMControls:FMLabel id="Label3" style="Z-INDEX: 103; LEFT: 8px; POSITION: absolute; TOP: 8px" runat="server"
				CssClass="headline" Width="600px" BackColor="Transparent">Company Certificates & Permits Configuration</FMControls:FMLabel>
				...
				<tr>
					<TD width="350" height="36" vAlign="middle">
						<FMControls:FMButton width="100px" id="AddButton2" runat="server" Text="Add" CssClass="formfieldtitle"
							tabIndex="6" />
						&nbsp;&nbsp;
						<FMControls:FMPageSizeDropDown ID="CertificatesFormPageSizeDropDown" ToolTip="Page Size" runat="server" tabIndex="7" onselectedindexchanged="PageSizeDropDownSelectedIndexChanged" />
					</TD>
				</tr>
				<TR>
					<TD style="WIDTH: 633px; HEIGHT: 10px">
						<FMControls:FMDataGrid id="QualificationsDataGrid" runat="server" BorderStyle="None" BackColor="White" RowHeaderColumn="ID"
							AutoGenerateColumns="False" GridLines="Vertical" Width="633px" BorderWidth="1px" AllowSorting="True"
							...
							<Columns>
								...
								<asp:TemplateColumn HeaderText="ID">
									...
									<EditItemTemplate>
										<asp:TextBox id=IDTextBox ToolTip="ID" runat="server" CssClass="tabletext" Text='<%# DataBinder.Eval(Container, "DataItem.ID") %>' width="2in" MaxLength="50" aria-required="true">
										</asp:TextBox>
									</EditItemTemplate>
								</asp:TemplateColumn>
