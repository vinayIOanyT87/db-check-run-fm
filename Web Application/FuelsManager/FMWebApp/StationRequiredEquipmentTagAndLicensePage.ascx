<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StationRequiredEquipmentTagAndLicensePage.ascx.cs" Inherits="FuelsManager.FMWebApp.StationRequiredEquipmentTagAndLicensePage" %>
...
<TABLE id="Table1" style="Z-INDEX: 102; LEFT: 0px; WIDTH: 238px; POSITION: absolute; TOP: 16px; HEIGHT: 10px"
		...
		<TBODY>
			<TR>
				<TD><FMControls:FMDataGrid id="EquipmentTagAndLicensesDataGrid" runat="server" CssClass="tabletext" BackColor="White"
