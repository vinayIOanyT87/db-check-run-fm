<%@ Page Language="c#" CodeBehind="FootNotesForm.aspx.cs" AutoEventWireup="True" Inherits="FuelsManager.FMWebApp.FootNotesForm" %>
        ...
        <form id="Form1" method="post" runat="server">
            ...
            <div id="pageContent" style="position: absolute">
               ...
               <FMControls:FMLabel ID="Label2" Style="z-index: 103; left: 8px; position: absolute; top: 8px" runat="server"
                   CssClass="headline" Width="344px" BackColor="Transparent" Text="Footnotes Configuration" />
                       ...
                       <tr>
                           <td width="498" height="36" valign="middle">
                               <FMControls:FMButton Width="100px" ID="AddButton2" runat="server" Text="Add" CssClass="formfieldtitle"
                                   TabIndex="6" />
                               &nbsp;&nbsp;
						   <FMControls:FMPageSizeDropDown ID="FootNotesFormPageSizeDropDown" ToolTip="Page size" runat="server" OnSelectedIndexChanged="PageSizeDropDown_SelectedIndexChanged" />
                           </td>
                       </tr>
                       <tr>
                           <td style="width: 498px; height: 10px">
                               <FMControls:FMDataGrid ID="FootNotesDataGrid" runat="server" BorderStyle="None" BackColor="White" AutoGenerateColumns="False"
                                   GridLines="Vertical" Width="768px" BorderWidth="1px" AllowSorting="True" BorderColor="White" CellPadding="3" AllowPaging="True" CssClass="tabletext"
                                   ...
                                   <Columns>
                                       ...
                                       <asp:BoundColumn DataField="ID" HeaderText="Footnote">
                                           <HeaderStyle Wrap="False"></HeaderStyle>
                                           <FooterStyle Wrap="False"></FooterStyle>
                                       </asp:BoundColumn>
                                       <asp:TemplateColumn HeaderText="Delete">
                                           ...
                                           <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
                                           <ItemTemplate>
                                               <FMControls:FMDeleteLinkButton runat="server" ID="DeleteButton" NAME="DeleteButton" />
                                           </ItemTemplate>
                                       </asp:TemplateColumn>
                                   </Columns>
