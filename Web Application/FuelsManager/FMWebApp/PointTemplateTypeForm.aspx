<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PointTemplateTypeForm.aspx.cs" Inherits="FuelsManager.FMWebApp.PointTemplateTypeForm" %>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <div id="pageContent" style="position: absolute">
                ...
                <tr>
                    <td width="498" height="36" valign="middle">
                        <FMControls:FMButton Width="100px" ID="AddButton2" runat="server" Text="Add" CssClass="formfieldtitle"
                            TabIndex="6" />
                        &nbsp;&nbsp;
						<FMControls:FMPageSizeDropDown ID="PointTemplateTypePageSizeDropDown" runat="server" OnSelectedIndexChanged="PageSizeDropDownSelectedIndexChanged" />
                    </td>
                </tr>
                <tr>
                    <td style="WIDTH: 498px; HEIGHT: 10px">
                        <FMControls:FMDataGrid ID="ApplicationStringsDataGrid" Style="LEFT: 1px; TOP: 0px;" runat="server" CssClass="tabletext"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateColumn HeaderText="Point Type">
            ...
            <FMControls:FMLabel ID="Label2" Style="Z-INDEX: 103; LEFT: 8px; POSITION: absolute; TOP: 8px" runat="server"
                CssClass="headline" Width="416px" BackColor="Transparent">Point Types Configuration</FMControls:FMLabel>
        </div>
    </form>
</body>
</html>
