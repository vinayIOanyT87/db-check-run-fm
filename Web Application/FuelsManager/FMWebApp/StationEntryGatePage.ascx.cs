/******************************************************************************
	...
	FILE NAME:		StationEntryGatePage.ascx.cs


	PURPOSE:			Implementation of StationEntryGatePage
...
{
	/// <summary>
	/// Summary description for StationEntryGatePage.
	/// </summary>
	public partial class StationEntryGatePage : FMUserControlBase
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			try
			{
				...
				&& Station.Type != STATION_TYPE.PRELOAD)
					return;
        ...
        private void AddButtonCommand(object sender, CommandEventArgs e)
        {
            ...
            NewProcessVariable.Input = false;
