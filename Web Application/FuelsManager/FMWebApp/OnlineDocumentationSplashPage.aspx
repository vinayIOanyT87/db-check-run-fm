...
<%@ Page language="c#" Codebehind="OnlineDocumentationSplashPage.aspx.cs" AutoEventWireup="True" Inherits="FuelsManager.FMWebApp.OnlineDocumentationSplashPage" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form2" method="post" runat="server">
			...
			<FMControls:FMLabel id="Label6" style="Z-INDEX: 103; LEFT: 8px; POSITION: absolute; TOP: 8px" runat="server"
				CssClass="headline" Width="400px" BackColor="Transparent">Online Documentation</FMControls:FMLabel>
		</form>
	</body>
</HTML>
