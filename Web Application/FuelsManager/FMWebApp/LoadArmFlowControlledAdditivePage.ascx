...
<%@ Control language="c#" Codebehind="LoadArmFlowControlledAdditivePage.ascx.cs" AutoEventWireup="True" Inherits="FuelsManager.FMWebApp.LoadArmFlowControlledAdditivePage" %>
<LINK href="<%= HttpRuntime.AppDomainAppVirtualPath + "/CSS/FuelsManager.css" %>" rel="stylesheet">
	<TABLE id="Table1" style="Z-INDEX: 102; LEFT: 0px; WIDTH: 39.37%; POSITION: absolute; TOP: 16px; HEIGHT: 10px"
		cellSpacing="0" cellPadding="1" border="0">
		<tr>
			<TD width="1000px" height="10"><FMControls:FMDataGrid id="DataGrid" runat="server" BackColor="White" Width="950px" CssClass="tabletext"
					...
					<Columns>
						...
						<asp:TemplateColumn HeaderText="Component">
							...
							<EditItemTemplate>
								<asp:TextBox Width=".25in" runat="server" CssClass=tabletext Text='<%# DataBinder.Eval(Container, "DataItem.PresetNumber") %>' ID="PresetNumberTextBox">
								</asp:TextBox>
							</EditItemTemplate>
						</asp:TemplateColumn>
						<asp:TemplateColumn HeaderText="Meter">
							...
							<EditItemTemplate>
                               <asp:Panel ID="Panel1" runat="server" CssClass="comboBoxInGrid"> 
								    <FMControls:FMComboBox runat="server" Width="100px" ID="MeterIDComboBox" RenderMode="Block" MaxLength="30"
                        ...
                        <asp:TemplateColumn HeaderText="Meter # of Digits">
						    ...
						    <EditItemTemplate>
								<FMControls:FMTextBox ID="NumberOfDigitsTextBox" Text='<%# DataBinder.Eval(Container, "DataItem.NumberOfDigits") %>' runat="server" MaxLength="2" Width="50px"/>
							</EditItemTemplate>
						</asp:TemplateColumn>
						...
						<asp:TemplateColumn HeaderText="Component">
							...
							<EditItemTemplate>
								<asp:dropdownlist CssClass=tabletext runat="server" Enabled="True" ID="ProductsDropDownList" DataSource="<%# EnumerateProducts()%>" DataTextField="Text" DataValueField="Value" AutoPostBack="True" OnSelectedIndexChanged="ProductDropDownList_SelectedIndexChanged">
								</asp:dropdownlist>
							</EditItemTemplate>
						</asp:TemplateColumn>
						<asp:TemplateColumn HeaderText="Type">
							...
							<EditItemTemplate>
								<FMControls:FMDropDownList CssClass=tabletext runat="server" Enabled="True" ID="TypeDropDownList" DataSource="<%# EnumerateLocationTypes()%>" DataTextField="Text" DataValueField="Value" AutoPostBack="True" OnSelectedIndexChanged="TypeDropDownList_SelectedIndexChanged">
		...
		<tr>
			<td height="35"><FMControls:FMButton id="AddButton" tabIndex="8" runat="server" Width="67px" CssClass="formfield" Text="Add" CommandName="AddFlowControlledAdditive"></FMControls:FMButton></td>
		</tr>
	</TABLE>
