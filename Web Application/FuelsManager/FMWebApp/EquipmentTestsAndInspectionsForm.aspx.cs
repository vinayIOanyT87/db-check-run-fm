// --------------------------------------------------------------------------------------------------------------------
// <copyright file="EquipmentTestsAndInspectionsForm.aspx.cs" company="Varec, Inc.">
//   Copyright (c) Varec, Inc.  All rights reserved.
// </copyright>
// <summary>
//   Defines the EquipmentTestsAndInspectionsForm type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace FuelsManager.FMWebApp
{
	...
	/// <summary>
	///    Summary description for EquipmentTestsAndInspectionsForm.
	/// </summary>
	public partial class EquipmentTestsAndInspectionsForm : QualificationsFormBase,
																			  IEntityDiscovery,
																			  IMenuDiscovery
	{
		...
		public List<FMMenuItem> GetMenuItems(SecurityClass security, bool siteGroup, ushort word1, ushort word2, ushort useNewLicenseKey, uint options)
		{
			...
			{
				MenuItemType = FMMenuItemType.ASSETS_EQUIPMENT_TESTS_AND_INSPECTIONS,
				RootMenuName = "Assets",
				CategoryName = "Equipment",
				ItemName = "Tests and Inspections",
				NavigateUrl = "EquipmentTestsAndInspectionsForm.aspx",
		...
		protected override void EnableControls(bool enable)
		{
			...
			this.EquipmentTestsFormPageSizeDropDown.Enabled = enable;
		}
		...
		protected void QualificationsDataGrid_SelectedIndexChanged(object sender, EventArgs e)
		{
		}

		protected override void UpdateView()
		{
			this.UpdateView(this.EquipmentTestsFormPageSizeDropDown);
		}
