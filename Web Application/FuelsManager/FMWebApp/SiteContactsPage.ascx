<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SiteContactsPage.ascx.cs" Inherits="FuelsManager.FMWebApp.SiteContactsPage" %>
...
<HTML>
	...
	<body>
	    <table style="Z-INDEX: 103; width:66%; LEFT: 5px; POSITION: absolute; TOP: 5px; height: 310px;" role="presentation" aria-label="layout">
            <tr>
                <td class="style1">
            ...
            <tr>
                <td class="style1">
                    &nbsp;</td>
                <td class="style2">
                    <FMCONTROLS:FMTEXTBOX id="Contact1Address2TextBox" ToolTip="Contact 1 address 2 field" tabIndex="3" Width="168px" CssClass="formfield" runat="server" 
                    MaxLength="30"></FMCONTROLS:FMTEXTBOX>
                </td>
                <td>&nbsp&nbsp</td>
                <td class="style1">
                    &nbsp;</td>
                <td class="style4">
                    <FMCONTROLS:FMTEXTBOX id="Contact2Address2TextBox" ToolTip="Contact 2 address 2 field" tabIndex="14" Width="168px" 
                        CssClass="formfield" runat="server" 
                    MaxLength="30"></FMCONTROLS:FMTEXTBOX>
                </td>
            </tr>
