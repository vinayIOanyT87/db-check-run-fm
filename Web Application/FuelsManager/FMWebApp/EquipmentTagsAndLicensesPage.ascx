<%@ Control language="c#" Codebehind="EquipmentTagsAndLicensesPage.ascx.cs" AutoEventWireup="True" Inherits="FuelsManager.FMWebApp.EquipmentTagsAndLicensesPage" %>
...
<HTML>
	...
	<TABLE id="Table1" style="Z-INDEX: 102; LEFT: 0px; WIDTH: 238px; POSITION: absolute; TOP: 16px; HEIGHT: 10px"
		...
		<TBODY>
			<TR>
				<TD><FMControls:FMDataGrid id="QualificationsDataGrid" runat="server" 
			...
			<TR>
				<TD height="21"><FMControls:FMButton id="AddButton" Width="66px" runat="server" CssClass="formfieldtitle" Text="Add"></FMControls:FMButton></TD>
			</TR>
		</TBODY>
	</TABLE>
	</body>
