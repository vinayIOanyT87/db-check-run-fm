...
<%@ Control language="c#" Codebehind="PersonLicensesPage.ascx.cs" AutoEventWireup="True" Inherits="FuelsManager.FMWebApp.PersonLicensesPage" %>
<LINK href="<%= HttpRuntime.AppDomainAppVirtualPath + "/CSS/FuelsManager.css" %>" rel="stylesheet">
	<TABLE id="Table1" style="Z-INDEX: 102; LEFT: 0px; WIDTH: 238px; POSITION: absolute; TOP: 16px; HEIGHT: 10px"
		...
		<TBODY>
			<TR>
				<TD><FMControls:FMDataGrid id="QualificationsDataGrid" runat="server" CssClass="tabletext" BackColor="White" RowHeaderColumn="License ID"
						...
						<Columns>
							...
							<asp:TemplateColumn HeaderText="Expiration Date">
								...
								<EditItemTemplate>
									<FMControls:FMDate ID="ExpirationDate"  CssClass="tabletext" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.ExpirationDate") %>'>
									</FMControls:FMDate>
								</EditItemTemplate>
							</asp:TemplateColumn>
