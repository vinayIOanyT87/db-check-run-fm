<%@ Page language="c#" Codebehind="AccountingForm.aspx.cs" AutoEventWireup="True" Inherits="FuelsManager.FMWebApp.AccountingForm" %>
	...
	<body MS_POSITIONING="GridLayout" tabindex=-1>
        ...
        <div id="pageContent" style="position:absolute">
			...
			<FMControls:FMLabel id="Label6" style="Z-INDEX: 103; LEFT: 8px; POSITION: absolute; TOP: 8px" runat="server"
				CssClass="headline" Width="200px" BackColor="Transparent">Accounting</FMControls:FMLabel>
		</div>
</form>
	</body>
</HTML>
