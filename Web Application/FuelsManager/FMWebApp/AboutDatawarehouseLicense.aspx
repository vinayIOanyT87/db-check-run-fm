<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AboutDatawarehouseLicense.aspx.cs" Inherits="FuelsManager.FMWebApp.AboutDatawarehouseLicense" %>
	...
	<form id="form1" runat="server">
		   ...
		   <div id="pageContent" style="position:absolute">
			...
			<asp:Label id="TitleLabel" style="Z-INDEX: 103; LEFT: 8px; POSITION: absolute; TOP: 8px" runat="server"
				CssClass="headline" Width="136px" BackColor="Transparent" enableviewstate="false">License Options for Enterprise <%=AppName%> </asp:Label>
			...
			<div class="formfieldtitle" style="position:relative; margin-top:0px; margin-left:10px">
				<div class="parent">
					<div class="thank-you-box">
						To activate Data Analytics, simply contact Varec Sales:<br />
