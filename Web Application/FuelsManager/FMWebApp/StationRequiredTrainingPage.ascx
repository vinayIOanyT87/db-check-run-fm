...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StationRequiredTrainingPage.ascx.cs" Inherits="FuelsManager.FMWebApp.StationRequiredTrainingPage" %>
<HTML>
	<HEAD>
	...
	<TABLE id="Table1" style="Z-INDEX: 102; LEFT: 0px; WIDTH: 238px; POSITION: absolute; TOP: 16px; HEIGHT: 10px"
		...
		<TBODY>
			<TR>
				<TD><FMControls:FMDataGrid id="TrainingDataGrid" runat="server" CssClass="tabletext" BackColor="White" Width="320px"
						BorderStyle="None" AutoGenerateColumns="False" GridLines="Vertical" BorderWidth="1px" AllowSorting="True"
						BorderColor="White" CellPadding="3" AllowPaging="True" PageSize="8" aria-label="Training">
