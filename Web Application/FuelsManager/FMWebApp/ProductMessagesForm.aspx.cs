// --------------------------------------------------------------------------------------------------------------------
// <copyright file="ProductMessagesForm.aspx.cs" company="Varec, Inc.">
//   Copyright (c) Varec, Inc.  All rights reserved.
// </copyright>
// <summary>
//   Defines the ProductMessagesForm type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace FuelsManager.FMWebApp
{
	...
	/// <summary>
	///    Summary description for ProductMessagesForm.
	/// </summary>
	public partial class ProductMessagesForm : ApplicationStringsFormBase,
	                                           IEntityDiscovery,
	                                           IMenuDiscovery
	{
		...
		{
			get { return ENTITY_TYPE.PRODUCT_MESSAGE; }
			}
		#endregion
		...
		{
			get { return STRING_TYPE.PRODUCT_MESSAGE; }
			}
		#endregion
		...
		public List<FMMenuItem> GetMenuItems(SecurityClass security, bool siteGroup, ushort word1,ushort word2, ushort useNewLicenseKey, uint options)
		{
			...
			items.Add(
				new FMMenuItem
					{
						MenuItemType = FMMenuItemType.ASSETS_PRODUCTS_PRODUCT_MESSAGES,
						RootMenuName = "Assets",
						CategoryName = "Products",
						ItemName = "Product Messages",
						NavigateUrl = "ProductMessagesForm.aspx",
		...
		protected override void EnableControls(bool bEnable)
		{
			...
			this.ProductMessagesFormPageSizeDropDown.Enabled = bEnable;
		}
			...
			try
			{
				...
				if (!this.Page.IsPostBack)
				{
					...
					ApplicationStringCollectionClass applicationStringCollection = 
						FMChannelHelper.MakeCall<IApplicationStrings, ApplicationStringCollectionClass>(
								x =>
								x.EnumerateByType(this.Security, STRING_TYPE.PRODUCT_MESSAGE)
						);
		...
		{
			this.UpdateView(this.ProductMessagesFormPageSizeDropDown);
		}
