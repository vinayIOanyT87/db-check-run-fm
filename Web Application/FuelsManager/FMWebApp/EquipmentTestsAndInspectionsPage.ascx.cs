/******************************************************************************
	FILE NAME:		EquipmentTestsAndInspectionsPage.ascx.cs
	PURPOSE:		Implementation of EquipmentTestsAndInspectionsPage
...
namespace FuelsManager.FMWebApp
{
	...
	public partial class EquipmentTestsAndInspectionsPage : QualificationPageBase
	{
	    ...
	    protected override QUALIFICATION_MAP_TYPE PageQualificationMapType => QUALIFICATION_MAP_TYPE.EQUIPMENT_TEST_AND_INSPECTION_TO_EQUIPMENT;
        ...
        protected override QualificationMapCollectionClass PageMaps
		{
			get
			{
				QualificationMapCollectionClass maps = this.Equipment.TestAndInspectionCollection;
				return maps;
			}
			set
			{
				this.Equipment.TestAndInspectionCollection = value;
			}
		}
        ...
        protected override void QualificationsDataGridItemDataBound(object sender, DataGridItemEventArgs e)
        {
            ...
            {
                if ((versionSpecificFields == null) || !versionSpecificFields.Contains("Tests and Inspections"))
                {
        ...
        private void SetFieldAccessibilityForChildRecordVersion()
        {
            ...
            this.AddButton.Enabled = (this.AddButton.Enabled && versionSpecificFields.Contains("Tests and Inspections"));
        }
	}
}
