<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MeterAssetSelectForm.aspx.cs" Inherits="FuelsManager.FMWebApp.MeterAssetSelectForm" %>
            ...
            <table id="Table1" style="z-index: 101; left: 8px; width: 50%; position: absolute; top: 45px; height: 10px"
                ...
                <tr>
                    <td style="width: 549px; height: 10px" width="549">
                        <FMControls:FMGridView ID="MeterAssetGrid" TabIndex="5" runat="server" RowHeaderColumn="ID"
                            Width="800px" Height="460px" CssClass="tabletext" OnRowCommand="MeterAssetGrid_RowCommand" DataKeyNames="IdentityGuid, ID" AllowPaging="false" FixedHeaders="true" ShowFooter="false">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="ID">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="MeterAssetIDGridColumn" Text='<%# DataBinder.Eval(Container, "DataItem.ID") %>'
                                            runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Asset Type">
                                    <HeaderStyle Width="100px"></HeaderStyle>
                                    <ItemTemplate>
                                        <asp:Label ID="AssetTypeGridColumn" Text='<%# DataBinder.Eval(Container, "DataItem.AssetTypeID") %>'
                                            runat="server" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
