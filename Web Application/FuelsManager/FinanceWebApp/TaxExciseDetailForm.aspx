<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaxExciseDetailForm.aspx.cs" Inherits="FuelsManager.FinanceWebApp.TaxExciseDetailForm" %>
...
<body>
   <form id="TaxExciseDetailForm" runat="server">
      ...
      <FMCONTROLS:FMLABEL id="EntityExportTitleLabel" style="Z-INDEX: 102; LEFT: 8px; POSITION: absolute; TOP: 8px"
				              runat="server" BackColor="Transparent" Width="272px" CssClass="headline">Excise Tax Configuration</FMCONTROLS:FMLABEL>
       <table style="Z-INDEX: 103; LEFT: 8px; WIDTH: 514px; POSITION: absolute; TOP: 48px; HEIGHT: 74px"
				 cellspacing="1" cellpadding="1" border="0">
          <tr>
             <td class="style1">
                <FMControls:FMLabel ID="ExciseProductLabel" runat="server" CssClass="formfieldtitle">Product</FMControls:FMLabel>
             </td>
             <td>
          ...
          <tr>
             <td class="style1">
                <FMControls:FMLabel ID="ExciseDateLabel" runat="server" CssClass="formfieldtitle">Excise Date</FMControls:FMLabel>
             </td>
             <td>
                <span style="COLOR: red;">*</span>
                <FMControls:FMDate ID="ExciseDateField" runat="server" />
             </td>
          </tr>
          <tr>
             <td class="style1">
                <FMControls:FMLabel ID="ExciseRateLabel" runat="server" CssClass="formfieldtitle">Excise Rate</FMControls:FMLabel>
             </td>
             <td>
                <span style="COLOR: red;">*</span>
                <asp:TextBox ID="ExciseRateTextBox" runat="server"></asp:TextBox>
             </td>
          </tr>
          <tr>
             <td colspan="2">
            ...
            <td colspan="2">           
               <FMControls:FMGrid id="DataGridAssignedCompanies" runat="server" 
                  BackColor="White" PageSize="10"
                                  CssClass="tabletext" Width="506px" 
     ...
     <script type="text/jscript">
	   function CompanySelect(Role,CompanyTextBoxID)
	   {
		...
		function ProductSelect(productTextBoxID)
		{
		   ...
		   result = window.showModalDialog("../FMWebApp/ProductSelectForm.aspx?All=false&Type=MaxProduct" +
