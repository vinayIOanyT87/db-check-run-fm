<%@ Page language="c#" Codebehind="InterfaceSplashPage.aspx.cs" AutoEventWireup="True" Inherits="FinanceWebApp.InterfaceSplashPage" %>
  ...
  <body MS_POSITIONING="GridLayout">
    <form id="Form1" method="post" runat="server">
		...
		<FMControls:FMLabel id="Label1" style="Z-INDEX: 103; LEFT: 8px; POSITION: absolute; TOP: 8px" runat="server"
			CssClass="headline" Width="400px" BackColor="Transparent">Interfaces</FMControls:FMLabel>
    </form>
