<%@ Page language="c#" Codebehind="FinanceSplashPage.aspx.cs" AutoEventWireup="True" Inherits="FinanceWebApp.FinanceSplashPage" %>
  ...
  <body MS_POSITIONING="GridLayout">
    <form id="Form1" method="post" runat="server">
		...
		<FMControls:FMLabel id="Label1" style="Z-INDEX: 103; LEFT: 8px; POSITION: absolute; TOP: 8px" runat="server"
			CssClass="headline" Width="400px" BackColor="Transparent">Finance</FMControls:FMLabel>
    </form>
  </body>
</html>
