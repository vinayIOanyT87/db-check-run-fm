...
<%@ Page language="c#" Codebehind="PortForm.aspx.cs" AutoEventWireup="True" Inherits="OPCWebApp.ScullyOPCWebApp.PortForm" %>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<asp:image id="Image1" style="Z-INDEX: 100; LEFT: 0px; POSITION: absolute; TOP: 0px" runat="server"
				...
				runat="server" Width="98px" Text="Scully|Cancel" CssClass="formfieldtitle" tabIndex="101"></FMCONTROLS:FMButton><FMCONTROLS:FMButton id="OKButton" style="Z-INDEX: 117; LEFT: 352px; POSITION: absolute; TOP: 208px"
				runat="server" Width="107px" Text="Scully|OK" CssClass="formfieldtitle" tabIndex="100"></FMCONTROLS:FMButton><asp:dropdownlist id="StopBitsDropDownList" style="Z-INDEX: 115; LEFT: 440px; POSITION: absolute; TOP: 112px"
				...
				BackColor="Transparent" CssClass="formfieldtitle">Scully|Stop Bits:</FMCONTROLS:FMLABEL>
				...
				BackColor="Transparent" CssClass="formfieldtitle">Scully|Data Bits:</FMCONTROLS:FMLABEL><FMCONTROLS:FMDropdownlist id="ParityDropDownList" style="Z-INDEX: 111; LEFT: 440px; POSITION: absolute; TOP: 48px"
				...
				BackColor="Transparent" CssClass="formfieldtitle">Scully|Parity:</FMCONTROLS:FMLABEL><asp:dropdownlist id="BaudDropDownList" style="Z-INDEX: 109; LEFT: 88px; POSITION: absolute; TOP: 80px"
			...
			<FMCONTROLS:FMLABEL id="Label5" style="Z-INDEX: 108; LEFT: 16px; POSITION: absolute; TOP: 80px" runat="server"
				BackColor="Transparent" CssClass="formfieldtitle">Scully|Baud:</FMCONTROLS:FMLABEL>
			<asp:DropDownList id="PortDropDownList" style="Z-INDEX: 119; POSITION: absolute; TOP: 48px; left: 88px;"
			...
			<FMCONTROLS:FMLABEL id="Label2" style="Z-INDEX: 101; LEFT: 8px; POSITION: absolute; TOP: 8px" runat="server"
				CssClass="headline" Width="312px" BackColor="Transparent">Scully|Port Configuration</FMCONTROLS:FMLABEL>
