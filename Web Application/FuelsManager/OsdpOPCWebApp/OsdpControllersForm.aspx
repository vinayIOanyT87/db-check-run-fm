<%@ Page language="c#" Codebehind="OsdpControllersForm.aspx.cs" AutoEventWireup="True" Inherits="OPCWebApp.OsdpOPCWebApp.OsdpControllersForm" %>
	...
	<body tabIndex="-1" MS_POSITIONING="GridLayout">
        ...
        <div style="position:absolute">
			...
			<FMControls:FMLabel ID="FMLabel2" Style="z-index: 102; left: 8px; position: absolute; top: 8px" runat="server"
				CssClass="headline" Width="344px" BackColor="Transparent">Osdp|Controllers Configuration</FMControls:FMLabel>
			...
			<TABLE id="Table1" style="Z-INDEX: 101; LEFT: 32px; WIDTH: 43.18%; POSITION: absolute; TOP: 80px; HEIGHT: 10px"
				...
				<tr>
					<TD width="498" height="36" vAlign="middle">
						<FMControls:FMButton width="100px" id="AddButton2" runat="server" Text="Osdp|Add" CssClass="formfieldtitle"
							tabIndex="6" />
						&nbsp;&nbsp;
						<FMControls:FMPageSizeDropDown ID="OsdpControllersFormPageSizeDropDown" StringPrefix="Osdp" runat="server" onselectedindexchanged="PageSizeDropDown_SelectedIndexChanged" />
					</TD>
				</tr>
				<TR>
					<TD style="WIDTH: 498px; HEIGHT: 10px" width="498"><FMCONTROLS:FMDatagrid id="OsdpControllersDataGrid" style="LEFT: 1px; TOP: 0px" runat="server" PageSize="12"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="Port" HeaderText="Osdp|Port"></asp:BoundColumn>
				...
				<TR>
					<TD style="WIDTH: 498px; HEIGHT: 36px" vAlign="middle" width="498"><FMCONTROLS:FMButton id="AddButton" runat="server" CssClass="formfieldtitle" Width="98px" Text="Osdp|Add"></FMCONTROLS:FMButton></TD>
				</TR>
			</TABLE>
        </div>
		</form>
