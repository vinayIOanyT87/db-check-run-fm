namespace DispatchPrototype
{
	partial class TotalAndAverageForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.ResponseTimeradioButton.CheckedChanged += new System.EventHandler(this.ResponseTimeradioButton_CheckedChanged);
			// 
			// VarianceradioButton
			// 
			...
			this.VarianceradioButton.CheckedChanged += new System.EventHandler(this.VarianceradioButton_CheckedChanged);
			// 
			// FuelTimeradioButton
			// 
			...
			this.FuelTimeradioButton.CheckedChanged += new System.EventHandler(this.FuelTimeradioButton_CheckedChanged);
			// 
			...
			this.IncludeFillStandcheckBox.CheckedChanged += new System.EventHandler(this.IncludeFillStandcheckBox_CheckedChanged);
			// 
			// AveragetextBox
			// 
			...
			this.IncludeRTBcheckBox.CheckedChanged += new System.EventHandler(this.IncludeFillStandcheckBox_CheckedChanged);
			// 
			// TotalAndAverageForm
			// 
