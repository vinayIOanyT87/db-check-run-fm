namespace DispatchPrototype
{
	partial class RecirculationForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.ServiceBranchLabel = new System.Windows.Forms.Label();
			this.SerialNumbertextBox = new System.Windows.Forms.TextBox();
			this.SerialNumberLabel = new System.Windows.Forms.Label();
			this.IssuePointNumbertextBox = new System.Windows.Forms.TextBox();
			this.IssuePointNumberLabel = new System.Windows.Forms.Label();
			this.IssuePointtextBox = new System.Windows.Forms.TextBox();
			this.IssuePointLabel = new System.Windows.Forms.Label();
			...
			this.OperatorDropDownList.SelectedIndexChanged += new System.EventHandler(this.OperatorDropDownList_SelectedIndexChanged);
			// 
			// ProductDropDownList
			// 
			...
			this.CardNumberLabel.Location = new System.Drawing.Point(11, 147);
			...
			// ServiceBranchLabel
			// 
			this.ServiceBranchLabel.AutoSize = true;
			this.ServiceBranchLabel.Location = new System.Drawing.Point(268, 120);
			this.ServiceBranchLabel.Name = "ServiceBranchLabel";
			this.ServiceBranchLabel.Size = new System.Drawing.Size(32, 13);
			this.ServiceBranchLabel.TabIndex = 12;
			this.ServiceBranchLabel.Text = "BOS:";
			// 
			// SerialNumbertextBox
			// 
			...
			this.SerialNumberLabel.Location = new System.Drawing.Point(268, 176);
			...
			// 
			// IssuePointNumberLabel
			// 
			this.IssuePointNumberLabel.AutoSize = true;
			this.IssuePointNumberLabel.Location = new System.Drawing.Point(268, 149);
			this.IssuePointNumberLabel.Name = "IssuePointNumberLabel";
			this.IssuePointNumberLabel.Size = new System.Drawing.Size(102, 13);
			this.IssuePointNumberLabel.TabIndex = 14;
			this.IssuePointNumberLabel.Text = "Issue Point Number:";
			// 
			// IssuePointtextBox
			// 
			...
			// IssuePointLabel
			// 
			this.IssuePointLabel.AutoSize = true;
			this.IssuePointLabel.Location = new System.Drawing.Point(11, 176);
			this.IssuePointLabel.Name = "IssuePointLabel";
			this.IssuePointLabel.Size = new System.Drawing.Size(62, 13);
			this.IssuePointLabel.TabIndex = 13;
			this.IssuePointLabel.Text = "Issue Point:";
			// 
			// groupBox2
			// 
			...
			this.Controls.Add(this.IssuePointLabel);
			...
			this.Controls.Add(this.ServiceBranchLabel);
			this.Controls.Add(this.SaveandClosebutton);
			this.Controls.Add(this.StartTimeSelection);
			this.Controls.Add(this.Closebutton);
			this.Controls.Add(this.IssuePointNumberLabel);
      ...
      private System.Windows.Forms.Button Applybutton;
		...
		private System.Windows.Forms.Label ServiceBranchLabel;
		private System.Windows.Forms.TextBox SerialNumbertextBox;
		private System.Windows.Forms.Label SerialNumberLabel;
		private System.Windows.Forms.TextBox IssuePointNumbertextBox;
		private System.Windows.Forms.Label IssuePointNumberLabel;
		private System.Windows.Forms.TextBox IssuePointtextBox;
        private System.Windows.Forms.Label IssuePointLabel;
