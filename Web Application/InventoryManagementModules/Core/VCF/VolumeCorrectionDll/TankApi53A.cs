...
namespace VCF
{
    public class TankApi53a : TankApi54a
    {
        public TankApi53a()
        {
                                          ...
                                          bool bRound)
        {
            ...
            if (!bTable60)
            {
                ...
                ApplyHydroCorrection(ref dDen, dDegC, Varec.CommonComponents.VolumeCorrection.ECorrectionTypeMajor.CORR_API_C, Varec.CommonComponents.VolumeCorrection.ECorrectionTypeMinor.CORR_API54A, false, ref dHydrometer);
            }

            // round density result value to nearest 0.01
            //	RoundDouble(dDen,  &dDen, 2, FALSE, FALSE);
