...
namespace VCF
{
    public class TankApi60a : TankApi53a
    {
        public TankApi60a()
        {
                                                        ...
                                                        bool UseDensity)				//	Optional
        {
            ...
            //FMTRACE(_T("CTankApi60a::TemperatureCorr"));
                                          ...
                                          bool bRound)
        {
            ...
            double dDen15 = 0.00, dTemp = 0.00, dVcfc = 0.00, dAlf = 0.00, dDt = 0.00;
            int iFlag = 0;
            ...
            ApplyHydroCorrection(ref dDen20, dTemp, Varec.CommonComponents.VolumeCorrection.ECorrectionTypeMajor.CORR_API_C, Varec.CommonComponents.VolumeCorrection.ECorrectionTypeMinor.CORR_API60A, false, ref dHydrometer);
