...
namespace VCF
{
    public class TankApi5d : TankApi6d
    {
        public TankApi5d()
        {
                                             ...
                                             bool UseDensity)               //	Optional
        {
            ...
            //FMTRACE(_T("CTankApi5d::TemperatureCorr"));
            ...
            {
                base.APICorrection(dApi, dDegF, ref pdVcfc, ref Iflag, true, bRound);
            }
                                                 ...
                                                 bool bRound)
        {
            ...
            {
                base.APICorrection(dApi, dDegF, ref dVcfc, ref iFlag, RangeCk, false);     // call API6D no rounding required
