...
namespace VCF
{
    ...
    public class TankVcfAPI2004Alpha60 : TankBaseVcf
    {
		...
		/*        protected override bool CalcTankStdDensity(EngineeringUnit bStdDensityUnits, // Std Density Engr Units
...
/*        protected bool CalcTankDensity(EngineeringUnit bDensityUnits,         // Density Engineering Units
                                                ...
                                                ref double dCalcDensity)
        {
                ...
                default:
                    {
                        if (!ConvertEngUnits.ConvEngrUnits(ref dTempLocal, dMeasTemp, EngineeringUnit.FmtDegF, bTempUnits, 0)
                            || !ConvertEngUnits.ConvEngrUnits(ref dAltTempLocal, dBaseTemp, EngineeringUnit.FmtDegF, bTempUnits, 0))
                            return false;
                        APITemperatureUnits = ApiUnit.ApiUnit_Temperature_F();
                        bCalcMethodToUse = EngineeringUnit.FmtDegF;
                    }
            ...
            if (bCalcMethodToUse == EngineeringUnit.FmtDegC)
            {
                ReturnCode = APIRequestStruct.SetParameters(
                                    ApiOilProduct.EProductNumber.API_COMMODITY_NOT_GIVEN,
                                    dK0, ApiUnit.ApiUnit_ThermalExp_REV_F(),
