                                                ...
                                                ref double dCalcDensity)
        {
            ...
            if (bCalcMethodToUse == EngineeringUnit.FmtDegC)
            {
                ReturnCode = APIRequestStruct.SetParameters(
                                    ApiOilProduct.EProductNumber.API_REFINED_PRODUCTS_NAME,
                                    0, null,
