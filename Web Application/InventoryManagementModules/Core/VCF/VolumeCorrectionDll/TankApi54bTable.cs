...
namespace VCF
{
    public class TankApi54bTable : TankBaseVcf
    {
        protected double m_dTable54ReferenceTemperature;

        public TankApi54bTable()
        {
                                                    ...
                                                    bool UseDensity)				//	Optional
        {
            ...
            if (lpbBetweenTable == true)
            {
                ...
                APICorrection(dHiStdDensity, dDegC, ref pdVcfc, ref Iflag, true, bRound, ref iJettoGas, m_dTable54ReferenceTemperature);
                dVcfcHi = pdVcfc;
                if (bRound)
                {
                ...
                APICorrection(dLoStdDensity, dDegC, ref pdVcfc, ref Iflag, true, bRound, ref iJettoGas, m_dTable54ReferenceTemperature);
                dVcfcLo = pdVcfc;
                if (bRound)
                {
