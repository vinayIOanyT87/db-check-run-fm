...
namespace VCF
{
    public class TankApi53bTable : TankApi54bTable
    {
        public TankApi53bTable()
        {
            m_byCorrectionTypeMajor = Varec.CommonComponents.VolumeCorrection.ECorrectionTypeMajor.CORR_JAPAN_JIS_2249_TABLE;
            m_byCorrectionTypeMinor = Varec.CommonComponents.VolumeCorrection.ECorrectionTypeMinor.CORR_API54B_TABLE;
            m_bUsesDensity = true;
                                                        ...
                                                        bool UseDensity)				//	Optional
        {
            ...
            //FMTRACE(_T("CTankApi53b::TemperatureCorr"));
            ...
            {
                //		CTankApi54bTable::APICorrection(dKgPerM3, dDegC, pdVcfc, Iflag, TRUE, TRUE, &iJettoGas, m_dTable54ReferenceTemperature);
                base.APICorrection(dKgPerM3, dDegC, ref pdVcfc, ref Iflag, true, bRound, ref iJettoGas, m_dTable54ReferenceTemperature);
            }
                                                          ...
                                                          bool bRound)
        {
            ...
            // NOTE:- hydro correction for Table 60B performed in function TnkApi60b
            if (!bTable60)
            {
                ...
                ApplyHydroCorrection(ref dDen, dDegC, Varec.CommonComponents.VolumeCorrection.ECorrectionTypeMajor.CORR_API_C, Varec.CommonComponents.VolumeCorrection.ECorrectionTypeMinor.CORR_API54B, false, ref dHydrometer);
            }
            ...
            {
                base.APICorrection(dStdDen1, dDegC, ref dVcfc, ref iFlag, RangeCk, false, ref iJettoGas, dRefDegC);	// call API54B - no rounding
                dStdDen2 = dDen / dVcfc;
