...
{
	public class ReportConfigurationDetailSR : ReportServiceRequest
	{
		...
		private ArrayList reportConfigurationDetailList;
		#endregion
		...
		/// </summary>
		public ArrayList ReportConfigurationDetailList
		{
