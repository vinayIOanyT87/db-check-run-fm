...
@Component({
  selector: 'app-transaction-generic-list-input',
  templateUrl: './transaction-generic-list-input.component.html',
  styleUrls: ['./transaction-generic-list-input.component.css']
})
export class TransactionGenericListInputComponent implements ITransactionAliasField,
  OnInit, OnDestroy {
