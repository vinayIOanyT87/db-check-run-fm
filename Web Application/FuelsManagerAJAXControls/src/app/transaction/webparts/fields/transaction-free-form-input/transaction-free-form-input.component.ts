...
@Component({
  selector: 'app-transaction-free-form-input',
  templateUrl: './transaction-free-form-input.component.html',
  styleUrls: ['./transaction-free-form-input.component.css']
})
export class TransactionFreeFormInputComponent implements ITransactionAliasField, OnInit {
