...
#import "WeightScaleOPCObjects.tlb" no_namespace named_guids \
			exclude("_FILETIME","IRecord")
#import "WeightScaleOPCServer.tlb" no_namespace named_guids \
...
class CWeightScaleOPCServerApp : public CWinApp
{
public:
...
extern CWeightScaleOPCServerApp theApp;
