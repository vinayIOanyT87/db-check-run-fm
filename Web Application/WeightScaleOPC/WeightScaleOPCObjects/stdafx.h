...
#include <atlextmarshal.h>
#include <PersistStreamImpl.h>

using namespace ATLExt;

#include <comdef.h>

#import "c:\Program Files\Common Files\System\ADO\msado20.tlb" \
			no_namespace named_guids rename ("EOF", "EndOfFile" ) 
#import "WeightScaleOPCObjects.tlb" exclude("_FILETIME") no_namespace named_guids
