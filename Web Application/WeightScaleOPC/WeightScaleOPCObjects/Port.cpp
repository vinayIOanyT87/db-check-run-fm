...
STDMETHODIMP CPort::get_Baud(WEIGHTSCALE_BAUD* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if(!pVal)
		return E_INVALIDARG;
...
STDMETHODIMP CPort::put_Baud(WEIGHTSCALE_BAUD newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	m_Baud=newVal;
	return S_OK;
...
STDMETHODIMP CPort::get_DataBits(WEIGHTSCALE_DATA_BITS* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if(!pVal)
		return E_INVALIDARG;
...
STDMETHODIMP CPort::put_DataBits(WEIGHTSCALE_DATA_BITS newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	m_DataBits=newVal;
	return S_OK;
...
STDMETHODIMP CPort::get_Parity(WEIGHTSCALE_PARITY* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if(!pVal)
		return E_INVALIDARG;
...
STDMETHODIMP CPort::put_Parity(WEIGHTSCALE_PARITY newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	m_Parity=newVal;
	return S_OK;
...
STDMETHODIMP CPort::get_StopBits(WEIGHTSCALE_STOP_BITS* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if(!pVal)
		return E_INVALIDARG;
...
STDMETHODIMP CPort::put_StopBits(WEIGHTSCALE_STOP_BITS newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	m_StopBits=newVal;
	return S_OK;
...
STDMETHODIMP CPort::raw_BaudID(WEIGHTSCALE_BAUD Baud,BSTR* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if(!pVal)
		return E_INVALIDARG;
...
STDMETHODIMP CPort::raw_DataBitsID(WEIGHTSCALE_DATA_BITS DataBits,BSTR* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if(!pVal)
		return E_INVALIDARG;
...
STDMETHODIMP CPort::raw_ParityID(WEIGHTSCALE_PARITY Baud,BSTR* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if(!pVal)
		return E_INVALIDARG;
...
STDMETHODIMP CPort::raw_StopBitsID(WEIGHTSCALE_STOP_BITS StopBits,BSTR* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if(!pVal)
		return E_INVALIDARG;
...
STDMETHODIMP CPort::raw_Reset(void)
{
	...
	m_lIndex=0;
	m_bstrID=_T("COM1");
	m_Baud=WEIGHTSCALE_BAUD_38400;
	m_DataBits=DATA_BITS_8;
	m_Parity=WEIGHTSCALE_PARITY_NONE;
