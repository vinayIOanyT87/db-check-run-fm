...
class ATL_NO_VTABLE CPort : 
	...
	public IProvideClassInfoImpl< &CLSID_Port, &LIBID_WeightScaleOPCObjectsLib>,
	public IDispatchImpl<IPort, &IID_IPort, &LIBID_WeightScaleOPCObjectsLib>,
...
protected:
	LONG							m_lIndex;
	_bstr_t						m_bstrID;
	WEIGHTSCALE_BAUD				m_Baud;
	WEIGHTSCALE_DATA_BITS			m_DataBits;
	WEIGHTSCALE_PARITY				m_Parity;
	WEIGHTSCALE_STOP_BITS			m_StopBits;
public:
	CPort()
	{
		raw_Reset();
...
public:
	...
	STDMETHOD(get_Baud)(WEIGHTSCALE_BAUD* pVal);
	STDMETHOD(put_Baud)(WEIGHTSCALE_BAUD newVal);
	STDMETHOD(get_DataBits)(WEIGHTSCALE_DATA_BITS* pVal);
	STDMETHOD(put_DataBits)(WEIGHTSCALE_DATA_BITS newVal);
	STDMETHOD(get_Parity)(WEIGHTSCALE_PARITY* pVal);
	STDMETHOD(put_Parity)(WEIGHTSCALE_PARITY newVal);
	STDMETHOD(get_StopBits)(WEIGHTSCALE_STOP_BITS* pVal);
	STDMETHOD(put_StopBits)(WEIGHTSCALE_STOP_BITS newVal);
	STDMETHOD(raw_BaudID)(WEIGHTSCALE_BAUD Baud,BSTR* pVal);
	STDMETHOD(raw_DataBitsID)(WEIGHTSCALE_DATA_BITS DataBits,BSTR* pVal);
	STDMETHOD(raw_ParityID)(WEIGHTSCALE_PARITY Parity,BSTR* pVal);
	STDMETHOD(raw_StopBitsID)(WEIGHTSCALE_STOP_BITS StopBits,BSTR* pVal);
