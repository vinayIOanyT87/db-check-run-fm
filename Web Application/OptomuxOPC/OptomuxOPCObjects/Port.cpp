...
STDMETHODIMP CPort::get_Baud(OPTOMUX_BAUD* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if(!pVal)
		return E_INVALIDARG;
...
STDMETHODIMP CPort::put_Baud(OPTOMUX_BAUD newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	m_Baud=newVal;
	return S_OK;
...
STDMETHODIMP CPort::get_DataBits(OPTOMUX_DATA_BITS* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if(!pVal)
		return E_INVALIDARG;
...
STDMETHODIMP CPort::put_DataBits(OPTOMUX_DATA_BITS newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	m_DataBits=newVal;
	return S_OK;
...
STDMETHODIMP CPort::get_Parity(OPTOMUX_PARITY* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if(!pVal)
		return E_INVALIDARG;
...
STDMETHODIMP CPort::put_Parity(OPTOMUX_PARITY newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	m_Parity=newVal;
	return S_OK;
...
STDMETHODIMP CPort::get_StopBits(OPTOMUX_STOP_BITS* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if(!pVal)
		return E_INVALIDARG;
...
STDMETHODIMP CPort::put_StopBits(OPTOMUX_STOP_BITS newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	m_StopBits=newVal;
	return S_OK;
...
STDMETHODIMP CPort::raw_BaudID(OPTOMUX_BAUD Baud,BSTR* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if(!pVal)
		return E_INVALIDARG;
...
STDMETHODIMP CPort::raw_DataBitsID(OPTOMUX_DATA_BITS DataBits,BSTR* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if(!pVal)
		return E_INVALIDARG;
...
STDMETHODIMP CPort::raw_ParityID(OPTOMUX_PARITY Baud,BSTR* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if(!pVal)
		return E_INVALIDARG;
...
STDMETHODIMP CPort::raw_StopBitsID(OPTOMUX_STOP_BITS StopBits,BSTR* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if(!pVal)
		return E_INVALIDARG;
...
STDMETHODIMP CPort::raw_Reset(void)
{
	...
	m_lIndex=0;
	m_bstrID=_T("COM1");
	m_Baud=OPTOMUX_BAUD_38400;
	m_DataBits=DATA_BITS_8;
	m_Parity=OPTOMUX_PARITY_NONE;
