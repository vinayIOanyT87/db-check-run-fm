...
class ATL_NO_VTABLE CPort : 
	...
	public IProvideClassInfoImpl< &CLSID_Port, &LIBID_OptomuxOPCObjectsLib>,
	public IDispatchImpl<IPort, &IID_IPort, &LIBID_OptomuxOPCObjectsLib>,
...
public:
	...
	STDMETHOD(get_Baud)(OPTOMUX_BAUD* pVal);
	STDMETHOD(put_Baud)(OPTOMUX_BAUD newVal);
	STDMETHOD(get_DataBits)(OPTOMUX_DATA_BITS* pVal);
	STDMETHOD(put_DataBits)(OPTOMUX_DATA_BITS newVal);
	STDMETHOD(get_Parity)(OPTOMUX_PARITY* pVal);
	STDMETHOD(put_Parity)(OPTOMUX_PARITY newVal);
	STDMETHOD(get_StopBits)(OPTOMUX_STOP_BITS* pVal);
	STDMETHOD(put_StopBits)(OPTOMUX_STOP_BITS newVal);
	STDMETHOD(raw_BaudID)(OPTOMUX_BAUD Baud,BSTR* pVal);
	STDMETHOD(raw_DataBitsID)(OPTOMUX_DATA_BITS DataBits,BSTR* pVal);
	STDMETHOD(raw_ParityID)(OPTOMUX_PARITY Parity,BSTR* pVal);
	STDMETHOD(raw_StopBitsID)(OPTOMUX_STOP_BITS StopBits,BSTR* pVal);
