// OptomuxControllerOPCServer.cpp : Implementation of DLL Exports.
//
...
COptomuxControllerManager		g_OptomuxControllerManager;

class COptomuxOPCServerModule : public CAtlDllModuleT< COptomuxOPCServerModule >
{
public :
	DECLARE_LIBID(LIBID_OptomuxOPCServerLib)
	DECLARE_REGISTRY_APPID_RESOURCEID(IDR_OPTOMUXOPCSERVER, "{D99ADF20-8324-4500-9019-97CF04A70494}")
};

COptomuxOPCServerModule _AtlModule;

#define SERVICE_NAME _T("OptomuxOPC Server")
...
BEGIN_MESSAGE_MAP(COptomuxControllerOPCServerApp, CWinApp)
END_MESSAGE_MAP()

COptomuxControllerOPCServerApp theApp;

// Logging functions
void COptomuxControllerOPCServerApp::WriteToEventLog(	WORD wEventType,
											DWORD dwEventID,
											USHORT nNumStrings,
											LPCTSTR* pszStrings,
											ULONG nDataSize,
...
void COptomuxControllerOPCServerApp::WriteTextToEventLog(WORD wEventType, LPCTSTR pszMsg) const
{
...
void COptomuxControllerOPCServerApp::LogInfo(LPCTSTR pszFormat, ...) const
{
	TCHAR		chMsg[1024];
	va_list	pArg;
...
void COptomuxControllerOPCServerApp::LogError(LPCTSTR pszFormat, ...) const
{
	TCHAR		chMsg[1024];
	va_list	pArg;
...
void COptomuxControllerOPCServerApp::LogWarning(LPCTSTR pszFormat, ...) const
{
	TCHAR		chMsg[1024];
	va_list	pArg;
...
BOOL COptomuxControllerOPCServerApp::InitInstance()
{
...
int COptomuxControllerOPCServerApp::ExitInstance()
{
    return CWinApp::ExitInstance();
}

void	COptomuxControllerOPCServerApp::GetProviderString()
{
...
void	COptomuxControllerOPCServerApp::GetConnectionString()
{
	// ODBC
	// TCHAR szString[512]={_T("Provider=MSDASQL;DSN=OptomuxOPC;")};

	// Jet OLEDB - Note: does not support transactions
	// TCHAR szString[512]={_T("Provider=Microsoft.Jet.OLEDB.4.0; Data Source=c:\\Program Files\\OptomuxOPC\\OptomuxOPC.mdb;")};

	// SQL Server OLEDB
	TCHAR szString[512]={_T("provider=SQLOLEDB;Data Source=127.0.0.1;Initial Catalog=OptomuxOPC;Integrated Security=SSPI;")};

	CRegKey RegKey;

	if(ERROR_SUCCESS == RegKey.Create(HKEY_LOCAL_MACHINE,_T("SOFTWARE\\Varec\\OptomuxOPCServer")))
	{
