...
#define WINVER 0x0602		// Change this to the appropriate value to target Windows 2000 or later.
#endif
...
#import "OptomuxOPCObjects.tlb" no_namespace named_guids \
			exclude("_FILETIME","IRecord")
#import "OptomuxOPCServer.tlb" no_namespace named_guids \
...
class COptomuxControllerOPCServerApp : public CWinApp
{
public:
...
extern COptomuxControllerOPCServerApp theApp;
