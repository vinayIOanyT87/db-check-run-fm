/******************************************************************************
	...
	FILE NAME:		OptomuxControllerManager.h


	PURPOSE:			Declaration of the COptomuxControllerManager
...
class COptomuxControllerManager 
{
	CIOList				m_IOList;
	COPCServerList		m_OPCServerList;

	void AddOptomuxController(IOptomuxControllerPtr oOptomuxController,CIO* pIO);
...
public:
	...
	void AddOptomuxController(IOptomuxControllerPtr oOptomuxController);
	void PurgeOptomuxController(IOptomuxControllerPtr oOptomuxController);
