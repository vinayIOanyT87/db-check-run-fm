                           ...
                           BOOL     bForce)
{
   ...
   if( hServerGroup == 0 )
	...
	// The following lock can cause a deadlock if group DataThread calls
	// UpdateTime at the instant the group is trying to destruct.  Need to
	// investigate origin of this logic.
