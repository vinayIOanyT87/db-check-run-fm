...
#import "ContrecOPCObjects.tlb" no_namespace named_guids \
			exclude("_FILETIME","IRecord")
#import "ContrecOPCServer.tlb" no_namespace named_guids \
...
class CContrecOPCServerApp : public CWinApp
{
public:
...
extern CContrecOPCServerApp theApp;
