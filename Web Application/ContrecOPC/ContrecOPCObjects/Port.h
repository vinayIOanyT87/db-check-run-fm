...
class ATL_NO_VTABLE CPort : 
	...
	public IProvideClassInfoImpl< &CLSID_Port, &LIBID_ContrecOPCObjectsLib>,
	public IDispatchImpl<IPort, &IID_IPort, &LIBID_ContrecOPCObjectsLib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
...
protected:
	...
	_bstr_t						m_bstrID;
	CONTREC_BAUD				m_Baud;
	CONTREC_DATA_BITS			m_DataBits;
	CONTREC_PARITY				m_Parity;
	CONTREC_STOP_BITS			m_StopBits;
public:
	CPort()
	{
		raw_Reset();
...
public:
	...
	STDMETHOD(get_Baud)(CONTREC_BAUD* pVal);
	STDMETHOD(put_Baud)(CONTREC_BAUD newVal);
	STDMETHOD(get_DataBits)(CONTREC_DATA_BITS* pVal);
	STDMETHOD(put_DataBits)(CONTREC_DATA_BITS newVal);
	STDMETHOD(get_Parity)(CONTREC_PARITY* pVal);
	STDMETHOD(put_Parity)(CONTREC_PARITY newVal);
	STDMETHOD(get_StopBits)(CONTREC_STOP_BITS* pVal);
	STDMETHOD(put_StopBits)(CONTREC_STOP_BITS newVal);
	STDMETHOD(raw_BaudID)(CONTREC_BAUD Baud,BSTR* pVal);
	STDMETHOD(raw_DataBitsID)(CONTREC_DATA_BITS DataBits,BSTR* pVal);
	STDMETHOD(raw_ParityID)(CONTREC_PARITY Parity,BSTR* pVal);
	STDMETHOD(raw_StopBitsID)(CONTREC_STOP_BITS StopBits,BSTR* pVal);
