...
class ATL_NO_VTABLE CPort : 
	...
	public IProvideClassInfoImpl< &CLSID_Port, &LIBID_OsdpOPCObjectsLib>,
	public IDispatchImpl<IPort, &IID_IPort, &LIBID_OsdpOPCObjectsLib>,
...
protected:
	...
	_bstr_t								m_bstrID;
	OSDP_BAUD						m_Baud;
	OSDP_DATA_BITS					m_DataBits;
	OSDP_PARITY						m_Parity;
	OSDP_STOP_BITS					m_StopBits;
public:
	CPort()
	{
		raw_Reset();
...
public:
	...
	STDMETHOD(get_Baud)(OSDP_BAUD* pVal);
	STDMETHOD(put_Baud)(OSDP_BAUD newVal);
	STDMETHOD(get_DataBits)(OSDP_DATA_BITS* pVal);
	STDMETHOD(put_DataBits)(OSDP_DATA_BITS newVal);
	STDMETHOD(get_Parity)(OSDP_PARITY* pVal);
	STDMETHOD(put_Parity)(OSDP_PARITY newVal);
	STDMETHOD(get_StopBits)(OSDP_STOP_BITS* pVal);
	STDMETHOD(put_StopBits)(OSDP_STOP_BITS newVal);
	STDMETHOD(raw_BaudID)(OSDP_BAUD Baud,BSTR* pVal);
	STDMETHOD(raw_DataBitsID)(OSDP_DATA_BITS DataBits,BSTR* pVal);
	STDMETHOD(raw_ParityID)(OSDP_PARITY Parity,BSTR* pVal);
	STDMETHOD(raw_StopBitsID)(OSDP_STOP_BITS StopBits,BSTR* pVal);
