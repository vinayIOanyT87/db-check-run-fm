...
#import "OsdpOPCObjects.tlb" no_namespace named_guids \
			exclude("_FILETIME","IRecord")
#import "OsdpOPCServer.tlb" no_namespace named_guids \
...
class COsdpControllerOPCServerApp : public CWinApp
{
public:
...
extern COsdpControllerOPCServerApp theApp;
