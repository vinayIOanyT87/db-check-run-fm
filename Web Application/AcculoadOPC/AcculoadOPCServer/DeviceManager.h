...
class CDeviceManager 
{
	...
	void AddAccuload3(IAcculoadPtr oAccuload,CIO* pIO);
	void AddMicroloadNet(IAcculoadPtr oAccuload,CIO* pIO);
	void AddMultiloadSMP(IAcculoadPtr oAccuload,CIO* pIO);
	void AddMultiload(IAcculoadPtr oAccuload,CIO* pIO);
	void AddSmithProximity(IAcculoadPtr oAccuload,CIO* pIO);
	void AddRcuIIOpenProtocol(IAcculoadPtr oAccuload,CIO* pIO);
	void AddRcuIIRcuProtocol(IAcculoadPtr oAccuload,CIO* pIO);
...
public:
	...
	void AddAccuload(IAcculoadPtr oAccuload);
