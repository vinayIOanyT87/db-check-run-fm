...
#import "AcculoadOPCObjects.tlb" no_namespace named_guids \
			exclude("_FILETIME","IRecord")
#import "AcculoadOPCServer.tlb" no_namespace named_guids \
...
class CAcculoadOPCServerApp : public CWinApp
{
public:
...
extern CAcculoadOPCServerApp theApp;
