...
typedef struct _AcculoadOPCServer_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } AcculoadOPCServer_MIDL_TYPE_FORMAT_STRING;

typedef struct _AcculoadOPCServer_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } AcculoadOPCServer_MIDL_PROC_FORMAT_STRING;

typedef struct _AcculoadOPCServer_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } AcculoadOPCServer_MIDL_EXPR_FORMAT_STRING;
...
extern const AcculoadOPCServer_MIDL_TYPE_FORMAT_STRING AcculoadOPCServer__MIDL_TypeFormatString;
extern const AcculoadOPCServer_MIDL_PROC_FORMAT_STRING AcculoadOPCServer__MIDL_ProcFormatString;
extern const AcculoadOPCServer_MIDL_EXPR_FORMAT_STRING AcculoadOPCServer__MIDL_ExprFormatString;
...
extern const MIDL_SERVER_INFO IAcculoads_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IAcculoads_ProxyInfo;


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO IArms_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IArms_ProxyInfo;


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO ICardReaders_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO ICardReaders_ProxyInfo;
...
static const AcculoadOPCServer_MIDL_PROC_FORMAT_STRING AcculoadOPCServer__MIDL_ProcFormatString =
    {
        0,
        {
...
/* 100 */	NdrFcShort( 0x0 ),	/* 0 */
	...
	/* Parameter ppAcculoadCollection */
...
/* 310 */	0x8,		/* FC_LONG */
	...
	/* Procedure EnumerateByAcculoadIndex */
...
/* 346 */	NdrFcShort( 0x30 ),	/* Type Offset=48 */
...
/* 436 */	NdrFcShort( 0x34 ),	/* Type Offset=52 */
...
/* 472 */	NdrFcShort( 0x4b0 ),	/* Type Offset=1200 */
...
static const AcculoadOPCServer_MIDL_TYPE_FORMAT_STRING AcculoadOPCServer__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* Standard interface: __MIDL_itf_AcculoadOPCServer_0000_0000, ver. 0.0,
...
/* Object interface: IDataAccess, ver. 0.0,
   GUID={0x2415FC12,0xF24B,0x48C6,{0x9B,0x36,0x13,0xBD,0x03,0x03,0x18,0x9C}} */
...
static const MIDL_STUBLESS_PROXY_INFO IDataAccess_ProxyInfo =
    {
    &Object_StubDesc,
    AcculoadOPCServer__MIDL_ProcFormatString.Format,
...
/* Object interface: IAcculoads, ver. 0.0,
   GUID={0xD1EBB062,0x7933,0x45BE,{0x8F,0x3E,0x04,0x40,0x52,0x15,0x45,0x58}} */

#pragma code_seg(".orpc")
static const unsigned short IAcculoads_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO IAcculoads_ProxyInfo =
    {
    &Object_StubDesc,
    AcculoadOPCServer__MIDL_ProcFormatString.Format,
    &IAcculoads_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IAcculoads_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    AcculoadOPCServer__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(13) _IAcculoadsProxyVtbl = 
{
    &IAcculoads_ProxyInfo,
    &IID_IAcculoads,
    IUnknown_QueryInterface_Proxy,
    IUnknown_AddRef_Proxy,
    IUnknown_Release_Proxy ,
    ...
    0 /* IDispatch::GetIDsOfNames */ ,
    0 /* IDispatch_Invoke_Proxy */ ,
    (void *) (INT_PTR) -1 /* IAcculoads::Enumerate */ ,
    (void *) (INT_PTR) -1 /* IAcculoads::Add */ ,
    (void *) (INT_PTR) -1 /* IAcculoads::Modify */ ,
    (void *) (INT_PTR) -1 /* IAcculoads::Purge */ ,
    (void *) (INT_PTR) -1 /* IAcculoads::GetIndex */ ,
    (void *) (INT_PTR) -1 /* IAcculoads::Get */
};


static const PRPC_STUB_FUNCTION IAcculoads_table[] =
{
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
...
CInterfaceStubVtbl _IAcculoadsStubVtbl =
{
    &IID_IAcculoads,
    &IAcculoads_ServerInfo,
    13,
    &IAcculoads_table[-3],
    CStdStubBuffer_DELEGATING_METHODS
};
...
/* Object interface: IArms, ver. 0.0,
   GUID={0xBD2E1B2F,0x73DF,0x41E7,{0x82,0x6E,0xFC,0x7B,0x2E,0x28,0xF8,0x47}} */

#pragma code_seg(".orpc")
static const unsigned short IArms_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO IArms_ProxyInfo =
    {
    &Object_StubDesc,
    AcculoadOPCServer__MIDL_ProcFormatString.Format,
    &IArms_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IArms_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    AcculoadOPCServer__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(14) _IArmsProxyVtbl = 
{
    &IArms_ProxyInfo,
    &IID_IArms,
    IUnknown_QueryInterface_Proxy,
    ...
    0 /* IDispatch::GetIDsOfNames */ ,
    0 /* IDispatch_Invoke_Proxy */ ,
    (void *) (INT_PTR) -1 /* IArms::EnumerateByAcculoadIndex */ ,
    (void *) (INT_PTR) -1 /* IArms::Add */ ,
    (void *) (INT_PTR) -1 /* IArms::Modify */ ,
    (void *) (INT_PTR) -1 /* IArms::Purge */ ,
    (void *) (INT_PTR) -1 /* IArms::GetIndex */ ,
    (void *) (INT_PTR) -1 /* IArms::Get */ ,
    (void *) (INT_PTR) -1 /* IArms::ModifyCollection */
};


static const PRPC_STUB_FUNCTION IArms_table[] =
{
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
...
CInterfaceStubVtbl _IArmsStubVtbl =
{
    &IID_IArms,
    &IArms_ServerInfo,
    14,
...
/* Object interface: ICardReaders, ver. 0.0,
   GUID={0x0345F55F,0x7273,0x4178,{0xBD,0xD8,0x9C,0x80,0x7D,0xA9,0xF1,0x04}} */

#pragma code_seg(".orpc")
static const unsigned short ICardReaders_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO ICardReaders_ProxyInfo =
    {
    &Object_StubDesc,
    AcculoadOPCServer__MIDL_ProcFormatString.Format,
    &ICardReaders_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO ICardReaders_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    AcculoadOPCServer__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(13) _ICardReadersProxyVtbl = 
{
    &ICardReaders_ProxyInfo,
    &IID_ICardReaders,
    IUnknown_QueryInterface_Proxy,
    IUnknown_AddRef_Proxy,
    IUnknown_Release_Proxy ,
    ...
    0 /* IDispatch::GetIDsOfNames */ ,
    0 /* IDispatch_Invoke_Proxy */ ,
    (void *) (INT_PTR) -1 /* ICardReaders::Enumerate */ ,
    (void *) (INT_PTR) -1 /* ICardReaders::Add */ ,
    (void *) (INT_PTR) -1 /* ICardReaders::Modify */ ,
    (void *) (INT_PTR) -1 /* ICardReaders::Purge */ ,
    (void *) (INT_PTR) -1 /* ICardReaders::GetIndex */ ,
    (void *) (INT_PTR) -1 /* ICardReaders::Get */
};


static const PRPC_STUB_FUNCTION ICardReaders_table[] =
{
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
...
CInterfaceStubVtbl _ICardReadersStubVtbl =
{
    &IID_ICardReaders,
    &ICardReaders_ServerInfo,
    13,
    &ICardReaders_table[-3],
    CStdStubBuffer_DELEGATING_METHODS
};


/* Object interface: IPorts, ver. 0.0,
   GUID={0x993CDAB0,0xB262,0x426D,{0x85,0x5B,0x84,0x40,0xB6,0xCB,0xFF,0x2C}} */
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    AcculoadOPCServer__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _AcculoadOPCServer_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IDataAccessProxyVtbl,
    ( CInterfaceProxyVtbl *) &_IArmsProxyVtbl,
    ( CInterfaceProxyVtbl *) &_ICardReadersProxyVtbl,
    ( CInterfaceProxyVtbl *) &_IAcculoadsProxyVtbl,
    ( CInterfaceProxyVtbl *) &_IPortsProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _AcculoadOPCServer_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IDataAccessStubVtbl,
    ( CInterfaceStubVtbl *) &_IArmsStubVtbl,
    ( CInterfaceStubVtbl *) &_ICardReadersStubVtbl,
...
PCInterfaceName const _AcculoadOPCServer_InterfaceNamesList[] = 
{
    "IDataAccess",
    "IArms",
    "ICardReaders",
...
const IID *  const _AcculoadOPCServer_BaseIIDList[] = 
{
    &IID_IDispatch,
    &IID_IDispatch,
    &IID_IDispatch,
...
#define _AcculoadOPCServer_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _AcculoadOPCServer, pIID, n)

int __stdcall _AcculoadOPCServer_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _AcculoadOPCServer, 5, 4 )
    IID_BS_LOOKUP_NEXT_TEST( _AcculoadOPCServer, 2 )
    IID_BS_LOOKUP_NEXT_TEST( _AcculoadOPCServer, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _AcculoadOPCServer, 5, *pIndex )
    
}

const ExtendedProxyFileInfo AcculoadOPCServer_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _AcculoadOPCServer_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _AcculoadOPCServer_StubVtblList,
    (const PCInterfaceName * ) & _AcculoadOPCServer_InterfaceNamesList,
    (const IID ** ) & _AcculoadOPCServer_BaseIIDList,
    & _AcculoadOPCServer_IID_Lookup, 
    5,
    2,
