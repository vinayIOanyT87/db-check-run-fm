...
STDMETHODIMP CPort::get_Baud(ACCULOAD_BAUD* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if(!pVal)
		return E_INVALIDARG;
...
STDMETHODIMP CPort::put_Baud(ACCULOAD_BAUD newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	m_Baud=newVal;
	return S_OK;
...
STDMETHODIMP CPort::get_DataBits(ACCULOAD_DATA_BITS* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if(!pVal)
		return E_INVALIDARG;
...
STDMETHODIMP CPort::put_DataBits(ACCULOAD_DATA_BITS newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	m_DataBits=newVal;
	return S_OK;
...
STDMETHODIMP CPort::get_Parity(ACCULOAD_PARITY* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if(!pVal)
		return E_INVALIDARG;
...
STDMETHODIMP CPort::put_Parity(ACCULOAD_PARITY newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	m_Parity=newVal;
	return S_OK;
...
STDMETHODIMP CPort::get_StopBits(ACCULOAD_STOP_BITS* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState())
	if(!pVal)
		return E_INVALIDARG;
...
STDMETHODIMP CPort::put_StopBits(ACCULOAD_STOP_BITS newVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	m_StopBits=newVal;
	return S_OK;
...
STDMETHODIMP CPort::raw_BaudID(ACCULOAD_BAUD Baud,BSTR* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if(!pVal)
		return E_INVALIDARG;
...
STDMETHODIMP CPort::raw_DataBitsID(ACCULOAD_DATA_BITS DataBits,BSTR* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if(!pVal)
		return E_INVALIDARG;
...
STDMETHODIMP CPort::raw_ParityID(ACCULOAD_PARITY Baud,BSTR* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if(!pVal)
		return E_INVALIDARG;
...
STDMETHODIMP CPort::raw_StopBitsID(ACCULOAD_STOP_BITS StopBits,BSTR* pVal)
{
	AFX_MANAGE_STATE(AfxGetStaticModuleState());
	if(!pVal)
		return E_INVALIDARG;
...
STDMETHODIMP CPort::raw_Reset(void)
{
	...
	m_lIndex=0;
	m_bstrID=_T("COM1");
	m_Baud=ACCULOAD_BAUD_38400;
	m_DataBits=DATA_BITS_8;
	m_Parity=ACCULOAD_PARITY_NONE;
