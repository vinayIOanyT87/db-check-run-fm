...
class ATL_NO_VTABLE CPort : 
	...
	public IProvideClassInfoImpl< &CLSID_Port, &LIBID_AcculoadOPCObjectsLib>,
	public IDispatchImpl<IPort, &IID_IPort, &LIBID_AcculoadOPCObjectsLib>,
...
public:
	...
	STDMETHOD(get_Baud)(ACCULOAD_BAUD* pVal);
	STDMETHOD(put_Baud)(ACCULOAD_BAUD newVal);
	STDMETHOD(get_DataBits)(ACCULOAD_DATA_BITS* pVal);
	STDMETHOD(put_DataBits)(ACCULOAD_DATA_BITS newVal);
	STDMETHOD(get_Parity)(ACCULOAD_PARITY* pVal);
	STDMETHOD(put_Parity)(ACCULOAD_PARITY newVal);
	STDMETHOD(get_StopBits)(ACCULOAD_STOP_BITS* pVal);
	STDMETHOD(put_StopBits)(ACCULOAD_STOP_BITS newVal);
	STDMETHOD(raw_BaudID)(ACCULOAD_BAUD Baud,BSTR* pVal);
	STDMETHOD(raw_DataBitsID)(ACCULOAD_DATA_BITS DataBits,BSTR* pVal);
	STDMETHOD(raw_ParityID)(ACCULOAD_PARITY Parity,BSTR* pVal);
	STDMETHOD(raw_StopBitsID)(ACCULOAD_STOP_BITS StopBits,BSTR* pVal);
